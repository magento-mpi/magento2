...
this.el.on("mouseover",this.handleMouseReturn,this);},handleMouseReturn:function(){this.el.removeListener("mouseover",this.handleMouseReturn);if(this.pressClass){this.el.addClass(this.pressClass);}
this.click();},handleMouseUp:function(){clearTimeout(this.timer);this.el.removeListener("mouseover",this.handleMouseReturn);this.el.removeListener("mouseout",this.handleMouseOut);this.docEl.removeListener("mouseup",this.handleMouseUp);this.el.removeClass(this.pressClass);this.fireEvent("mouseup",this);}});
