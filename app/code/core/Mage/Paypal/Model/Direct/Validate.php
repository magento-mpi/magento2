...
/**
 * 3D Secure Validation Library for PayPal Direct
 */
 ...
 */
class Mage_Paypal_Model_Direct_Validate extends Mage_Core_Model_Abstract
{
    ...
    public function getTermUrl()
    {
        ...
        if (Mage::app()->getStore()->isAdmin()) {
            return Mage::getUrl('*/paypal_direct/termValidate', array('_secure' => true,'_current' => true, 'form_key' => $formKey));
        } else {
            return Mage::getUrl('paypal/direct/termValidate', array('_secure' => true, 'form_key' => $formKey));
        }
    }
