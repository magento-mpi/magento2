...
class Mage_Paypal_Model_Report_Settlement_Row extends Mage_Core_Model_Abstract
{
    ...
    /**
     * Turn PayPal-supplied reference transaction types into something
     * human-sensible. Used in grid.
     */
    public function getAvailableReferenceTypes()
    {
        return array(
    ...
    /**
     *
     * Provides options to convert "CR" and "DR" as supplied by
     * PayPal into something more human-comprehensible.
     *
     */
    public function getAvailableDebitCreditOptions()
    {
        return array(
