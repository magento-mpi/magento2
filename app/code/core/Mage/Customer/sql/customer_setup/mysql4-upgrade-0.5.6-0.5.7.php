...
$this->addConfigField('customer/newsletter/confirm', 'Need Confirmation', array(
    'frontend_type'=>'select', 'source_model'=>'adminhtml/system_config_source_yesno'
));
$this->addConfigField('customer/newsletter/subscribe_email_identity', 'Subscription Email Sender', $identity);
$this->addConfigField('customer/newsletter/subscribe_email_template', 'Subscription Email Template', $template);
$this->addConfigField('customer/newsletter/unsubscribe_email_identity', 'Unsubscription Email Sender', $identity);
$this->addConfigField('customer/newsletter/unsubscribe_email_template', 'Unsubscription Email Template', $template);
