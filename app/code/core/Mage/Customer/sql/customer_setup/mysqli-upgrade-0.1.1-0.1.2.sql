...
insert into `customer` (`customer_id`,`customer_type_id`,`customer_name`,`customer_email`,`customer_pass`,`customer_login`) values (1,1,'QA','qa@varien.com','4297f44b13955235245b2497399d7a93','qa');
