 ...
 */
class Mage_Catalog_Resource_Model_Mysql4_Product_Link extends Mage_Catalog_Resource_Model_Mysql4 implements Mage_Core_Resource_Model_Db_Table_Interface 
{
    protected $_linkTable;
    
    public function __construct() 
    {
        $this->_linkTable = $this->getTableName('catalog', 'product_link');
    }
