 ...
 */
class Mage_Catalog_Resource_Model_Mysql4_Category_Tree extends Mage_Catalog_Resource_Model_Mysql4
{
    /**
     * DB tree object
     *
    ...
    public function __construct()
    {
        ...
        $treeTable = $this->_getTableName('catalog', 'category');
        ...
        try {
            ...
            $attributeValueTable = $this->_getTableName('catalog', 'category_attribute_value');
            ...
            $attributeTable = $this->_getTableName('catalog', 'category_attribute');
