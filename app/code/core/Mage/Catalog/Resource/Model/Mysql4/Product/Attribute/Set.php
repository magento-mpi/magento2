 ...
 */
class Mage_Catalog_Resource_Model_Mysql4_Product_Attribute_Set extends Mage_Catalog_Resource_Model_Mysql4 implements Mage_Core_Resource_Model_Db_Table_Interface 
{
    protected $_setTable;
    ...
    {
        parent::__construct();
        $this->_setTable    = $this->getTableName('catalog', 'product_attribute_set');
        $this->_inSetTable  = $this->getTableName('catalog', 'product_attribute_in_set');
    }
    ...
    {
        $attributeTable = $this->getTableName('catalog', 'product_attribute');
        $arrRes =array();
        $sql = "SELECT
                    $attributeTable.*
                FROM
    ...
    {
        $arrRes =array();
        $groupTable = $this->getTableName('catalog', 'product_attribute_group');
        $sql = "SELECT
                    DISTINCT $groupTable.*
                FROM
                    $this->_inSetTable,
