 ...
 */
class Mage_Catalog_Resource_Model_Mysql4_Product_Link_Type extends Mage_Catalog_Resource_Model_Mysql4 implements Mage_Core_Resource_Model_Db_Table_Interface 
{
    protected $_linkTypeTable;
    
    public function __construct() 
    {
        $this->_linkTypeTable = $this->getTableName('catalog_setup', 'product_link_type');
    }
