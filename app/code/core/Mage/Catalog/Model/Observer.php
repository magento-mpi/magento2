...
class Mage_Catalog_Model_Observer
{
    ...
    /**
     * Set flag dirty to compare product items if product was deleted
     *
     * @param Varien_Event_Observer $observer
     * @return Mage_Catalog_Model_Observer
     */
    public function markCompareProductsItemsAsDirtyByProduct(Varien_Event_Observer $observer)
    {
    ...
    /**
     * Set flag dirty to compare product items if product was disabled
     *
     * @param Varien_Event_Observer $observer
     * @return Mage_Catalog_Model_Observer
     */
    ...
    /**
     * Set flag dirty to compare product items if catalog compare item was deleted
     *
     * @param Varien_Event_Observer $observer
     * @return Mage_Catalog_Model_Observer
     */
    public function markCompareProductsItemsAsDirtyByItem(Varien_Event_Observer $observer)
    {
        $item = $observer->getEvent()->getItem();
        if ($item) {
            Mage::getResourceModel('catalog/product_compare_item')->markCompareProductItemsAsDirtyByVisitor($item->getVisitorId());
        }
        return $this;
    }
}
