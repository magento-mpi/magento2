 ...
 */
class Mage_Catalog_Model_Api2_Products_Categories_Rest_Guest_V1 extends Mage_Catalog_Model_Api2_Products_Categories_Rest
{
    /**
    ...
    protected function _retrieve()
    {
        ...
        $categoryIds = $product->getCategoryCollection()->addIsActiveFilter()->getAllIds();
