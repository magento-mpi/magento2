    ...
    public function toOptionArray()
    {
        return array(
            array(
                ...
                'label' => Mage::helper('Mage_Backend_Helper_Data')->__('Automatic (equalize price ranges)')
            ),
            array(
                'value' => Mage_Catalog_Model_Layer_Filter_Price::RANGE_CALCULATION_IMPROVED,
                'label' => Mage::helper('Mage_Backend_Helper_Data')->__('Automatic (equalize product counts)')
            ),
            array(
                'value' => Mage_Catalog_Model_Layer_Filter_Price::RANGE_CALCULATION_MANUAL,
                'label' => Mage::helper('Mage_Backend_Helper_Data')->__('Manual')
            ),
        );
    }
}
