...
class Mage_Catalog_Model_Mysql4_Category_Attribute_Set
{
    ...
    public function __construct() 
    {
        ...
        $this->_setTable    = Mage::registry('resources')->getTableName('catalog_resource', 'category_attribute_set');
        $this->_inSetTable  = Mage::registry('resources')->getTableName('catalog_resource', 'category_attribute_in_set');
    }
