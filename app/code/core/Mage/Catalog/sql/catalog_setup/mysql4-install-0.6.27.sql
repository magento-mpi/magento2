...
insert  into `catalog_product_entity`(`entity_id`,`entity_type_id`,`attribute_set_id`,`parent_id`,`store_id`,`type_id`,`created_at`,`updated_at`,`is_active`) values (136,10,9,0,0,1,'2007-09-06 13:25:43','2007-09-06 13:25:43',1);
...
insert  into `catalog_product_entity_varchar`(`value_id`,`entity_type_id`,`attribute_id`,`store_id`,`entity_id`,`value`) values (4694,10,96,0,136,'Simple Product'),(4695,10,98,0,136,'sp'),(4696,10,481,0,136,'simple-product'),(4697,10,103,0,136,'Simple Product Title'),(4698,10,105,0,136,'Simple Product Description'),(4700,10,96,1,136,'Simple Product'),(4701,10,98,1,136,'sp'),(4702,10,481,1,136,'simple-product'),(4703,10,103,1,136,'Simple Product Title'),(4704,10,105,1,136,'Simple Product Description');
