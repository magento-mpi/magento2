 ...
 */
class Mage_Launcher_Model_Promotestore_Googleanalytics_StateResolver implements Mage_Launcher_Model_Tile_StateResolver
{
    /**
    ...
    {
        if (in_array($sectionName, array('google'))) {
