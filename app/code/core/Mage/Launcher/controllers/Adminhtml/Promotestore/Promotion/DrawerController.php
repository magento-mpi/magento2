 ...
 */
class Mage_Launcher_Adminhtml_Promotestore_Promotion_DrawerController
    ...
    implements Mage_Launcher_Controller_Drawer
{
    ...
    public function saveAction()
    {
        ...
        try {
            ...
            /** @var $tileBlock Mage_Launcher_Block_Adminhtml_Promotestore_Promotion_Tile */
            $tileBlock = $this->getLayout()
                ->createBlock('Mage_Launcher_Block_Adminhtml_Promotestore_Promotion_Tile');
    ...
    public function loadAction()
    {
        ...
        try {
            ...
            $drawerBlock = $this->getLayout()
                ->createBlock('Mage_Launcher_Block_Adminhtml_Promotestore_Promotion_Drawer');
