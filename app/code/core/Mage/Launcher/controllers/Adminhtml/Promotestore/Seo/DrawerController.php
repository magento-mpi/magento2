    ...
    implements Mage_Launcher_Controller_Drawer
{
    ...
    public function saveAction()
    {
        ...
        try {
            ...
            /** @var $tileBlock Mage_Launcher_Block_Adminhtml_Promotestore_Seo_Tile */
            $tileBlock = $this->getLayout()
                ->createBlock('Mage_Launcher_Block_Adminhtml_Promotestore_Seo_Tile');
    ...
    public function loadAction()
    {
        ...
        try {
            ...
            $drawerBlock = $this->getLayout()
                ->createBlock('Mage_Launcher_Block_Adminhtml_Promotestore_Seo_Drawer');
