...
/**
 * Reports Drawer controller
 *
 * @category    Mage
 * @package     Mage_Launcher
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Mage_Launcher_Adminhtml_Promotestore_Reports_DrawerController
    ...
    implements Mage_Launcher_Controller_Drawer
{
    ...
    public function saveAction()
    {
        ...
        try {
            ...
            /** @var $tileBlock Mage_Launcher_Block_Adminhtml_Promotestore_Reports_Tile */
            $tileBlock = $this->getLayout()
                ->createBlock('Mage_Launcher_Block_Adminhtml_Promotestore_Reports_Tile');
    ...
    public function loadAction()
    {
        ...
        try {
            ...
            $drawerBlock = $this->getLayout()
                ->createBlock('Mage_Launcher_Block_Adminhtml_Promotestore_Reports_Drawer');
