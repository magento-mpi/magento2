 ...
 * @method Mage_Ideal_Model_Api_Debug setDebugAt(string $value)
 * @method string getRequestBody()
 * @method Mage_Ideal_Model_Api_Debug setRequestBody(string $value)
 * @method string getResponseBody()
 * @method Mage_Ideal_Model_Api_Debug setResponseBody(string $value)
 *
 * @category    Mage
 * @package     Mage_Ideal
