...
class Mage_Core_Model_App_Emulation extends Varien_Object
{
     ...
     */
    public function startEnvironmentEmulation($storeId, $area = 'frontend', $emulateSroreInlineTranslation = false)
    {
     ...
     */
    protected function _emulateInlineTranslation($storeId = null, $area = 'frontend')
    {
        if (is_null($storeId)) {
     ...
     */
    protected function _emulateDesign($storeId, $area = 'frontend')
    {
     ...
     */
    protected function _emulateLocale($storeId, $area = 'frontend')
    {
     ...
     * @return Mage_Core_Model_App_Emulation
     */
    protected function _restoreInitialLocale($initialLocaleCode, $initialArea = 'adminhtml')
    {
