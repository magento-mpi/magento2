 ...
 */
abstract class Mage_Core_Model_Config_Captcha_Form_Abstract extends Mage_Core_Model_Config_Data
{
    /**
     ...
     * @return string
     */
    abstract protected function _getConfigNodePath();
    ...
    public function toOptionArray()
    {
        ...
        $backendNode = Mage::getConfig()->getNode($this->_getConfigNodePath());
        if ($backendNode) {
