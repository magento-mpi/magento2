...
INSERT INTO {$this->getTable('core_store_group')} VALUES (0,0,'Default',0,0), (1,1,'Main group',2,1);
...
UPDATE {$this->getTable('core_website')} SET `default_group_id`='0' WHERE `website_id`=1;
");
