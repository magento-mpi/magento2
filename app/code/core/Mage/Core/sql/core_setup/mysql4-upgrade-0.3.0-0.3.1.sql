...
insert into `core_attribute` (`attribute_id`,`entity_type_id`,`store_id`,`attribute_code`,`attribute_type`,`attribute_table`,`position`,`is_required`,`is_deletable`,`is_visible`) values (1,1,1,'firstname','varchar','core/attribute_varchar',1,1,0,1),(2,1,1,'lastname','varchar','core/attribute_varchar',1,1,0,1),(3,1,1,'created_at','datetime','core/attribute_datetime',1,1,0,0);
...
insert into `core_entity_type` (`entity_type_id`,`parent_id`,`left_id`,`right_id`,`level`,`entity_code`,`entity_table`,`attribute_table`) values (1,NULL,0,0,0,'customer','core/entity','core/attribute');
...
insert into `core_resource` (`code`,`version`) values ('admin_setup','0.2.1'),('catalog_setup','0.2.2'),('cms_setup','0.1.2'),('core_setup','0.2.2'),('cron_setup','0.2.0'),('customer_setup','0.2.0'),('directory_setup','0.2.2'),('log_setup','0.1.4'),('poll_setup','0.2.0'),('rating_setup','0.1.3'),('review_setup','0.1.1'),('sales_setup','0.2.0'),('shiptable_setup','0.2.0'),('usa_setup','0.2.0');
