...
insert into `core_store` (`store_id`,`code`,`language_code`,`website_id`,`name`) values (0,'default','en',0,'Default'),(1,'base','en',1,'English Store'),(2,'russian','ru',1,'Russian Store'),(3,'gifts','en',2,'Gifts store'),(4,'vipgifts','en',2,'VIP Gifts');
...
insert into `core_website` (`website_id`,`code`,`name`) values (0,'default','Default'),(1,'base','Main Website'),(2,'gift','Gifts Website');
