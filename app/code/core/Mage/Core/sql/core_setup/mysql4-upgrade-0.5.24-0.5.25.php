...
$this->addConfigField('trans_email/ident_custom1', 'Custom identity 1');
...
$this->addConfigField('trans_email/ident_custom2', 'Custom identity 2');
...
$this->addConfigField('trans_email/trans_new_account/identity', 'Identity', $identity);
...
$this->addConfigField('trans_email/trans_new_order/identity', 'Identity', $identity);
...
$this->addConfigField('trans_email/trans_new_password/identity', 'Identity', $identity);
...
$this->addConfigField('trans_email/trans_order_update/identity', 'Identity', $identity);
