...
/*Table structure for table `core_table_change` */

DROP TABLE IF EXISTS `core_table_change`;

CREATE TABLE `core_table_change` (
  `change_id` int(11) unsigned NOT NULL default '0',
  `table_id` int(10) unsigned default NULL,
  `change_date` datetime NOT NULL default '0000-00-00 00:00:00',
  `data` text,
  PRIMARY KEY  (`change_id`),
  KEY `FK_CHANGED_TABLE` (`table_id`),
  CONSTRAINT `FK_CHANGED_TABLE` FOREIGN KEY (`table_id`) REFERENCES `core_table` (`table_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Tables data change history';

/*Data for the table `core_table_change` */
...
insert into `core_website` (`website_id`,`language_code`,`website_code`,`is_default`) values (1,'en','Magenta',1),(2,'en','Magenta Ext',0);
