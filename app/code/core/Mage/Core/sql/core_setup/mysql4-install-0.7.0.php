...
INSERT INTO `core_config_data` (`scope`, `scope_id`, `path`, `value`, `inherit`) VALUES
('default', 0, 'catalog/frontend/product_per_page', '9', 0),
('default', 0, 'catalog/images/category_upload_path', '{{root_dir}}/media/catalog/category/', 0),
('default', 0, 'catalog/images/category_upload_url', '{{base_path}}media/catalog/category/', 0),
('default', 0, 'catalog/images/product_upload_path', '{{root_dir}}/media/catalog/product/', 0),
('default', 0, 'catalog/images/product_upload_url', '{{base_path}}media/catalog/product/', 0),
('default', 0, 'customer/default/group', '1', 0),
('default', 0, 'design/package/area', 'frontend', 0),
('default', 0, 'design/package/default_theme', 'default', 0),
('default', 0, 'design/package/name', 'default', 0),
('default', 0, 'design/package/theme', 'default', 0),
('default', 0, 'design/package/translate', 'default', 0),
('default', 0, 'dev/mode/checksum', '1', 0),
('default', 0, 'general/country/allow', 'US', 0),
('default', 0, 'general/country/default', 'US', 0),
('default', 0, 'payment/authorizenet/model', 'paygate/authorizenet', 0),
('default', 0, 'payment/ccsave/model', 'payment/method_ccsave', 0),
('default', 0, 'payment/checkmo/model', 'payment/method_checkmo', 0),
('default', 0, 'payment/paypal/model', 'paygate/paypal', 0),
('default', 0, 'payment/purchaseorder/model', 'payment/method_purchaseorder', 0),
('default', 0, 'payment/verisign/model', 'paygate/payflow_pro', 0),
('default', 0, 'system/filesystem/base', '{{root_dir}}', 0),
('default', 0, 'system/filesystem/cache_config', '{{var_dir}}/cache/config', 0),
('default', 0, 'system/filesystem/cache_layout', '{{var_dir}}/cache/layout', 0),
('default', 0, 'system/filesystem/code', '{{app_dir}}/code', 0),
('default', 0, 'system/filesystem/design', '{{app_dir}}/design', 0),
('default', 0, 'system/filesystem/etc', '{{app_dir}}/etc', 0),
...
('default', 0, 'system/filesystem/session', '{{var_dir}}/session', 0),
('default', 0, 'system/filesystem/skin', '{{root_dir}}/skin', 0),
...
('default', 0, 'system/filesystem/upload', '{{root_dir}}/media/upload', 0),
('default', 0, 'system/filesystem/var', '{{var_dir}}', 0),
('default', 0, 'web/default/front', 'cms', 0),
('default', 0, 'web/default/no_route', 'cms/index/noRoute', 0),
('default', 0, 'web/secure/base_path', '{{base_path}}', 0),
('default', 0, 'web/secure/host', '{{host}}', 0),
('default', 0, 'web/secure/port', '{{port}}', 0),
('default', 0, 'web/secure/protocol', 'https', 0),
('default', 0, 'web/unsecure/base_path', '{{base_path}}', 0),
('default', 0, 'web/unsecure/host', '{{host}}', 0),
('default', 0, 'web/unsecure/port', '{{port}}', 0),
('default', 0, 'web/unsecure/protocol', 'http', 0),
...
('websites', 0, 'advanced/datashare/default', '0,1,5,6', 0),
('websites', 1, 'advanced/datashare/default', '1,5,6', 0);
