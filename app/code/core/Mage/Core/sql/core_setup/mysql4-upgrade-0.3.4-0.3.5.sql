...
(6,'default',0,'system/filesystem/layout','{{root_dir}}/app/view/layout',0),
(7,'default',0,'system/filesystem/template','{{root_dir}}/app/view/template',0),
(8,'default',0,'system/filesystem/translate','{{root_dir}}/app/view/translate',0),
(9,'default',0,'system/filesystem/base','{{root_dir}}',0),
(10,'default',0,'system/filesystem/media','{{root_dir}}/media',0),
(11,'default',0,'system/filesystem/skin','{{root_dir}}/skins/default',0),
(12,'default',0,'web/unsecure/protocol','{{protocol}}',0),
(13,'default',0,'web/unsecure/host','{{host}}',0),
(14,'default',0,'web/unsecure/port','{{port}}',0),
(15,'default',0,'web/unsecure/base_path','{{base_path}}',0),
(16,'default',0,'web/secure/protocol','{{secure_protocol}}',0),
(17,'default',0,'web/secure/host','{{secure_host}}',0),
(18,'default',0,'web/secure/port','{{secure_port}}',0),
(19,'default',0,'web/secure/base_path','{{secure_base_path}}',0),
(20,'default',0,'web/url/media','{{base_path}}media/',0),
(21,'default',0,'web/url/skin','{{base_path}}skins/default/',0),
(22,'default',0,'web/url/js','{{base_path}}js/',0),
(23,'default',0,'system/filesystem/etc','{{root_dir}}/app/etc/',0),
(24,'default',0,'system/filesystem/code','{{root_dir}}/app/code/',0),
(25,'default',0,'system/filesystem/upload','{{root_dir}}/media/upload/',0),
(26,'default',0,'system/filesystem/var','{{var_dir}}',0),
(27,'default',0,'system/filesystem/session','{{var_dir}}/session/',0),
(28,'default',0,'system/filesystem/cache_config','{{var_dir}}/cache/config/',0),
(29,'default',0,'system/filesystem/cache_layout','{{var_dir}}/cache/layout/',0),
