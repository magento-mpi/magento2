 ...
 * @method Mage_Api_Model_Role getParentId()
 * @method int setParentId(int $value)
 * @method Mage_Api_Model_Role getTreeLevel()
 * @method int setTreeLevel(int $value)
 * @method Mage_Api_Model_Role getSortOrder()
 * @method int setSortOrder(int $value)
 * @method Mage_Api_Model_Role getRoleType()
 * @method string setRoleType(string $value)
 * @method Mage_Api_Model_Role getUserId()
 * @method int setUserId(int $value)
 * @method Mage_Api_Model_Role getRoleName()
