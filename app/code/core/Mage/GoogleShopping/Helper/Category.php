...
class Mage_GoogleShopping_Helper_Category
{
    ...
    {
        return sprintf(
            Mage::helper('Mage_GoogleShopping_Helper_Data')->__("For information on Google's required attributes for different product categories, please see this link: %s"),
