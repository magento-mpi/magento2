 ...
 *
 * @method Mage_Api2_Model_Request getRequest() getRequest()
 * @method Mage_Api2_Model_Response getResponse() getResponse()
 */
...
abstract class Mage_Api2_Controller_Rest_ActionAbstract extends Mage_Core_Controller_Varien_Action
{
    ...
    {
        $this->_restHelper = Mage::helper('Mage_Api2_Helper_Rest');
     ...
     * @return Mage_Api2_Controller_Rest_ActionAbstract
     */
    ...
    final protected function _applyCollectionModifiers(Varien_Data_Collection_Db $collection)
    {
        ...
        if ($pageNumber != abs($pageNumber)) {
            $this->_restHelper->critical(Mage_Api2_Helper_Rest::RESOURCE_COLLECTION_PAGING_ERROR);
        }
        ...
        if (null == $pageSize) {
            ...
            if ($pageSize != abs($pageSize) || $pageSize > self::PAGE_SIZE_MAX) {
                $this->_restHelper->critical(Mage_Api2_Helper_Rest::RESOURCE_COLLECTION_PAGING_LIMIT_ERROR);
            }
        }
        ...
        if (null !== $orderField) {
            ...
            // TODO: Check if order field is allowed for specified entity
                ...
                $this->_restHelper->critical(Mage_Api2_Helper_Rest::RESOURCE_COLLECTION_ORDERING_ERROR);
            }
    ...
    protected function _getStore()
    {
        ...
        try {
            ...
            $this->_critical('Requested store is invalid', Mage_Api2_Controller_Front_Rest::HTTP_BAD_REQUEST);
        }
        return $store;
    }
