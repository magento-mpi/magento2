...
class Mage_Api2_Controller_Front_Rest_Presentation
{
    /** @var Mage_Api2_Controller_Front_Rest */
    ...
    function __construct(Mage_Api2_Controller_Front_Rest $frontController)
    {
        ...
        switch ($method) {
            case 'create':
                ...
                if ($this->getRequest()->isAssocArrayInRequestBody()) {
                    ...
                    $this->getResponse()->setHttpResponseCode(Mage_Api2_Controller_Front_Rest::HTTP_MULTI_STATUS);
                }
    ...
    {
        /* @var $apiTypeRoute Mage_Api2_Controller_Router_Route_ApiType */
        $apiTypeRoute = Mage::getModel('Mage_Api2_Controller_Router_Route_ApiType');
        ...
        $router = new Zend_Controller_Router_Route($this->_frontController->getRestConfig()->getRouteByResource(
            ...
            Mage_Api2_Controller_Front_Rest::RESOURCE_TYPE_ITEM
        ));
