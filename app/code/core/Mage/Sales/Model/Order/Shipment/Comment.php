 ...
 * @method Mage_Sales_Model_Order_Shipment_Comment getParentId()
 * @method int setParentId(int $value)
 * @method Mage_Sales_Model_Order_Shipment_Comment getIsCustomerNotified()
 * @method int setIsCustomerNotified(int $value)
 * @method Mage_Sales_Model_Order_Shipment_Comment getIsVisibleOnFront()
 * @method int setIsVisibleOnFront(int $value)
 * @method Mage_Sales_Model_Order_Shipment_Comment getComment()
 * @method string setComment(string $value)
 * @method Mage_Sales_Model_Order_Shipment_Comment getCreatedAt()
