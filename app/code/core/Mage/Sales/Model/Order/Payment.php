 ...
 * @method Mage_Sales_Model_Order_Payment getParentId()
 * @method int setParentId(int $value)
 * @method Mage_Sales_Model_Order_Payment getBaseShippingCaptured()
 * @method float setBaseShippingCaptured(float $value)
 * @method Mage_Sales_Model_Order_Payment getShippingCaptured()
 * @method float setShippingCaptured(float $value)
 * @method Mage_Sales_Model_Order_Payment getAmountRefunded()
 * @method float setAmountRefunded(float $value)
 * @method Mage_Sales_Model_Order_Payment getBaseAmountPaid()
 * @method float setBaseAmountPaid(float $value)
 * @method Mage_Sales_Model_Order_Payment getAmountCanceled()
 * @method float setAmountCanceled(float $value)
 * @method Mage_Sales_Model_Order_Payment getBaseAmountAuthorized()
 * @method float setBaseAmountAuthorized(float $value)
 * @method Mage_Sales_Model_Order_Payment getBaseAmountPaidOnline()
 * @method float setBaseAmountPaidOnline(float $value)
 * @method Mage_Sales_Model_Order_Payment getBaseAmountRefundedOnline()
 * @method float setBaseAmountRefundedOnline(float $value)
 * @method Mage_Sales_Model_Order_Payment getBaseShippingAmount()
 * @method float setBaseShippingAmount(float $value)
 * @method Mage_Sales_Model_Order_Payment getShippingAmount()
 * @method float setShippingAmount(float $value)
 * @method Mage_Sales_Model_Order_Payment getAmountPaid()
 * @method float setAmountPaid(float $value)
 * @method Mage_Sales_Model_Order_Payment getAmountAuthorized()
 * @method float setAmountAuthorized(float $value)
 * @method Mage_Sales_Model_Order_Payment getBaseAmountOrdered()
 * @method float setBaseAmountOrdered(float $value)
 * @method Mage_Sales_Model_Order_Payment getBaseShippingRefunded()
 * @method float setBaseShippingRefunded(float $value)
 * @method Mage_Sales_Model_Order_Payment getShippingRefunded()
 * @method float setShippingRefunded(float $value)
 * @method Mage_Sales_Model_Order_Payment getBaseAmountRefunded()
 * @method float setBaseAmountRefunded(float $value)
 * @method Mage_Sales_Model_Order_Payment getAmountOrdered()
 * @method float setAmountOrdered(float $value)
 * @method Mage_Sales_Model_Order_Payment getBaseAmountCanceled()
 * @method float setBaseAmountCanceled(float $value)
 * @method Mage_Sales_Model_Order_Payment getIdealTransactionChecked()
 * @method int setIdealTransactionChecked(int $value)
 * @method Mage_Sales_Model_Order_Payment getQuotePaymentId()
 * @method int setQuotePaymentId(int $value)
 * @method Mage_Sales_Model_Order_Payment getAdditionalData()
 * @method string setAdditionalData(string $value)
 * @method Mage_Sales_Model_Order_Payment getCcExpMonth()
 * @method string setCcExpMonth(string $value)
 * @method Mage_Sales_Model_Order_Payment getCcSsStartYear()
 * @method string setCcSsStartYear(string $value)
 * @method Mage_Sales_Model_Order_Payment getEcheckBankName()
 * @method string setEcheckBankName(string $value)
 * @method Mage_Sales_Model_Order_Payment getMethod()
 * @method string setMethod(string $value)
 * @method Mage_Sales_Model_Order_Payment getCcDebugRequestBody()
 * @method string setCcDebugRequestBody(string $value)
 * @method Mage_Sales_Model_Order_Payment getCcSecureVerify()
 * @method string setCcSecureVerify(string $value)
 * @method Mage_Sales_Model_Order_Payment getCybersourceToken()
 * @method string setCybersourceToken(string $value)
 * @method Mage_Sales_Model_Order_Payment getIdealIssuerTitle()
 * @method string setIdealIssuerTitle(string $value)
 * @method Mage_Sales_Model_Order_Payment getProtectionEligibility()
 * @method string setProtectionEligibility(string $value)
 * @method Mage_Sales_Model_Order_Payment getCcApproval()
 * @method string setCcApproval(string $value)
 * @method Mage_Sales_Model_Order_Payment getCcLast4()
 * @method string setCcLast4(string $value)
 * @method Mage_Sales_Model_Order_Payment getCcStatusDescription()
 * @method string setCcStatusDescription(string $value)
 * @method Mage_Sales_Model_Order_Payment getEcheckType()
 * @method string setEcheckType(string $value)
 * @method Mage_Sales_Model_Order_Payment getPayboxQuestionNumber()
 * @method string setPayboxQuestionNumber(string $value)
 * @method Mage_Sales_Model_Order_Payment getCcDebugResponseSerialized()
 * @method string setCcDebugResponseSerialized(string $value)
 * @method Mage_Sales_Model_Order_Payment getCcSsStartMonth()
 * @method string setCcSsStartMonth(string $value)
 * @method Mage_Sales_Model_Order_Payment getEcheckAccountType()
 * @method string setEcheckAccountType(string $value)
 * @method Mage_Sales_Model_Order_Payment getLastTransId()
 * @method string setLastTransId(string $value)
 * @method Mage_Sales_Model_Order_Payment getCcCidStatus()
 * @method string setCcCidStatus(string $value)
 * @method Mage_Sales_Model_Order_Payment getCcOwner()
 * @method string setCcOwner(string $value)
 * @method Mage_Sales_Model_Order_Payment getCcType()
 * @method string setCcType(string $value)
 * @method Mage_Sales_Model_Order_Payment getIdealIssuerId()
 * @method string setIdealIssuerId(string $value)
 * @method Mage_Sales_Model_Order_Payment getPoNumber()
 * @method string setPoNumber(string $value)
 * @method Mage_Sales_Model_Order_Payment getCcExpYear()
 * @method string setCcExpYear(string $value)
 * @method Mage_Sales_Model_Order_Payment getCcStatus()
 * @method string setCcStatus(string $value)
 * @method Mage_Sales_Model_Order_Payment getEcheckRoutingNumber()
 * @method string setEcheckRoutingNumber(string $value)
 * @method Mage_Sales_Model_Order_Payment getAccountStatus()
 * @method string setAccountStatus(string $value)
 * @method Mage_Sales_Model_Order_Payment getAnetTransMethod()
 * @method string setAnetTransMethod(string $value)
 * @method Mage_Sales_Model_Order_Payment getCcDebugResponseBody()
 * @method string setCcDebugResponseBody(string $value)
 * @method Mage_Sales_Model_Order_Payment getCcSsIssue()
 * @method string setCcSsIssue(string $value)
 * @method Mage_Sales_Model_Order_Payment getEcheckAccountName()
 * @method string setEcheckAccountName(string $value)
 * @method Mage_Sales_Model_Order_Payment getCcAvsStatus()
 * @method string setCcAvsStatus(string $value)
 * @method Mage_Sales_Model_Order_Payment getCcNumberEnc()
 * @method string setCcNumberEnc(string $value)
 * @method Mage_Sales_Model_Order_Payment getCcTransId()
 * @method string setCcTransId(string $value)
 * @method Mage_Sales_Model_Order_Payment getFlo2cashAccountId()
 * @method string setFlo2cashAccountId(string $value)
 * @method Mage_Sales_Model_Order_Payment getPayboxRequestNumber()
 * @method string setPayboxRequestNumber(string $value)
 * @method Mage_Sales_Model_Order_Payment getAddressStatus()
 * @method string setAddressStatus(string $value)
 *
 * @category    Mage
 * @package     Mage_Sales
