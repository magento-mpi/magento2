 ...
 * @method Mage_Sales_Model_Quote getCreatedAt()
 * @method string setCreatedAt(string $value)
 * @method Mage_Sales_Model_Quote getUpdatedAt()
 * @method string setUpdatedAt(string $value)
 * @method Mage_Sales_Model_Quote getConvertedAt()
 * @method string setConvertedAt(string $value)
 * @method Mage_Sales_Model_Quote getIsActive()
 * @method int setIsActive(int $value)
 * @method int setIsVirtual(int $value)
 * @method Mage_Sales_Model_Quote getIsMultiShipping()
 * @method int setIsMultiShipping(int $value)
 * @method Mage_Sales_Model_Quote getItemsCount()
 * @method int setItemsCount(int $value)
 * @method Mage_Sales_Model_Quote getItemsQty()
 * @method float setItemsQty(float $value)
 * @method Mage_Sales_Model_Quote getOrigOrderId()
 * @method int setOrigOrderId(int $value)
 * @method Mage_Sales_Model_Quote getStoreToBaseRate()
 * @method float setStoreToBaseRate(float $value)
 * @method Mage_Sales_Model_Quote getStoreToQuoteRate()
 * @method float setStoreToQuoteRate(float $value)
 * @method Mage_Sales_Model_Quote getBaseCurrencyCode()
 * @method string setBaseCurrencyCode(string $value)
 * @method Mage_Sales_Model_Quote getStoreCurrencyCode()
 * @method string setStoreCurrencyCode(string $value)
 * @method Mage_Sales_Model_Quote getQuoteCurrencyCode()
 * @method string setQuoteCurrencyCode(string $value)
 * @method Mage_Sales_Model_Quote getGrandTotal()
 * @method float setGrandTotal(float $value)
 * @method Mage_Sales_Model_Quote getBaseGrandTotal()
 * @method float setBaseGrandTotal(float $value)
 * @method string setCheckoutMethod(string $value)
 * @method Mage_Sales_Model_Quote getCustomerId()
 * @method int setCustomerId(int $value)
 * @method int setCustomerTaxClassId(int $value)
 * @method int setCustomerGroupId(int $value)
 * @method Mage_Sales_Model_Quote getCustomerEmail()
 * @method string setCustomerEmail(string $value)
 * @method Mage_Sales_Model_Quote getCustomerPrefix()
 * @method string setCustomerPrefix(string $value)
 * @method Mage_Sales_Model_Quote getCustomerFirstname()
 * @method string setCustomerFirstname(string $value)
 * @method Mage_Sales_Model_Quote getCustomerMiddlename()
 * @method string setCustomerMiddlename(string $value)
 * @method Mage_Sales_Model_Quote getCustomerLastname()
 * @method string setCustomerLastname(string $value)
 * @method Mage_Sales_Model_Quote getCustomerSuffix()
 * @method string setCustomerSuffix(string $value)
 * @method Mage_Sales_Model_Quote getCustomerDob()
 * @method string setCustomerDob(string $value)
 * @method Mage_Sales_Model_Quote getCustomerNote()
 * @method string setCustomerNote(string $value)
 * @method Mage_Sales_Model_Quote getCustomerNoteNotify()
 * @method int setCustomerNoteNotify(int $value)
 * @method Mage_Sales_Model_Quote getCustomerIsGuest()
 * @method int setCustomerIsGuest(int $value)
 * @method Mage_Sales_Model_Quote getRemoteIp()
 * @method string setRemoteIp(string $value)
 * @method Mage_Sales_Model_Quote getAppliedRuleIds()
 * @method string setAppliedRuleIds(string $value)
 * @method Mage_Sales_Model_Quote getReservedOrderId()
 * @method string setReservedOrderId(string $value)
 * @method Mage_Sales_Model_Quote getPasswordHash()
 * @method string setPasswordHash(string $value)
 * @method Mage_Sales_Model_Quote getCouponCode()
 * @method string setCouponCode(string $value)
 * @method Mage_Sales_Model_Quote getGlobalCurrencyCode()
 * @method string setGlobalCurrencyCode(string $value)
 * @method Mage_Sales_Model_Quote getBaseToGlobalRate()
 * @method float setBaseToGlobalRate(float $value)
 * @method Mage_Sales_Model_Quote getBaseToQuoteRate()
 * @method float setBaseToQuoteRate(float $value)
 * @method Mage_Sales_Model_Quote getCustomerTaxvat()
 * @method string setCustomerTaxvat(string $value)
 * @method Mage_Sales_Model_Quote getCustomerGender()
 * @method string setCustomerGender(string $value)
 * @method Mage_Sales_Model_Quote getSubtotal()
 * @method float setSubtotal(float $value)
 * @method Mage_Sales_Model_Quote getBaseSubtotal()
 * @method float setBaseSubtotal(float $value)
 * @method Mage_Sales_Model_Quote getSubtotalWithDiscount()
 * @method float setSubtotalWithDiscount(float $value)
 * @method Mage_Sales_Model_Quote getBaseSubtotalWithDiscount()
 * @method float setBaseSubtotalWithDiscount(float $value)
 * @method Mage_Sales_Model_Quote getIsChanged()
 * @method int setIsChanged(int $value)
 * @method Mage_Sales_Model_Quote getTriggerRecollect()
 * @method int setTriggerRecollect(int $value)
 * @method Mage_Sales_Model_Quote getExtShippingInfo()
 * @method string setExtShippingInfo(string $value)
 * @method Mage_Sales_Model_Quote getGiftMessageId()
