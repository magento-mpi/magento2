...
/**
 * API2 class for order addresses (customer)
 *
 * @category   Mage
 * @package    Mage_Sales
 * @author     Magento Core Team <core@magentocommerce.com>
 */
class Mage_Sales_Model_Api2_Order_Addresses_Rest_Customer_V1 extends Mage_Sales_Model_Api2_Order_Addresses_Rest
{
    /**
