...
class Mage_Sales_Model_Mysql4_Quote_Item_Collection extends Varien_Data_Collection_Db
{
    ...
    public function __construct() 
    {
        ...
        $this->setItemObjectClass(Mage::getConfig()->getModelClassName('sales', 'quote_item'));
    }
