 ...
 */
class Mage_Sales_Model_Mysql4_Report_Invoiced_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    ...
    public function __construct($parameters = array())
    {
        ...
        $reportDateType = (!isset($parameters['reportDateType']))
            ? Mage_Sales_Model_Order_Invoice::REPORT_DATE_TYPE_ORDER_CREATED : $parameters['reportDateType'];

        $this->setModel('varien_object');

        $table = 'sales/invoiced_aggregated_order';
        if ($reportDateType == Mage_Sales_Model_Order_Invoice::REPORT_DATE_TYPE_INVOICE_CREATED) {
     ...
     * @param mixed $from
     * @param mixed $to
     * @return Mage_Sales_Model_Mysql4_Report_Invoiced_Collection
     */
