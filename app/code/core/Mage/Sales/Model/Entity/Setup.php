        ...
        return array(
            'quote'=>array(
                ...
                'attributes' => array(
                    ...
                    'password_hash' => array(),
                    'quote_status_id' => array('label'=>__('Quote Status'), 'type'=>'int', 'source'=>'sales_entity/quote_attribute_source_status'),
                    'billing_address_id' => array('type'=>'int', 'visible'=>false),
                    'converted_at' => array('type'=>'datetime', 'visible'=>false),
                    'coupon_code' => array('label'=>__('Coupon')),
                    'giftcert_code' => array('label'=>__('Gift certificate')),
                    'custbalance_amount' => array('type'=>'decimal'),
                    'base_currency_code' => array('label'=>__('Base currency')),
                    'store_currency_code' => array('label'=>__('Store currency')),
                    'quote_currency_code' => array('label'=>__('Quote currency')),
                    'store_to_base_rate' => array('type'=>'decimal', 'label'=>__('Store to Base rate')),
                    'store_to_quote_rate' => array('type'=>'decimal', 'label'=>__('Store to Quote rate')),
                    'grand_total' => array('type'=>'decimal'),
                    'orig_order_id' => array('label'=>__('Original order ID')),
            ...
            'quote_address' => array(
                ...
                'attributes' => array(
                    ...
                    'email' => array('label'=>__('Email'), 'visible'=>false),
                    'firstname' => array('label'=>__('First Name')),
                    'lastname' => array('label'=>__('Last Name')),
                    'company' => array('label'=>__('Company')),
                    'street' => array('label'=>__('Street Address')),
                    'city' => array('label'=>__('City')),
                    'region' => array('label'=>__('State/Province')),
                    'region_id' => array('type'=>'int', 'visible'=>false),
                    'postcode' => array('label'=>__('Zip/Postal Code')),
                    'country_id' => array('type'=>'int', 'visible'=>false),
                    'telephone' => array('label'=>__('Telephone')),
                    'fax' => array('label'=>__('Fax')),
                    'same_as_billing' => array('type'=>'int', 'label'=>__('Same as billing'), 'visible'=>false),
                    'weight' => array('type'=>'decimal', 'label'=>__('Weight'), 'visible'=>false),
                    'free_shipping' => array('type'=>'int'),
                    'collect_shipping_rates' => array('type'=>'int'),
                    'shipping_method' => array('label'=>__('Shipping Method'), 'visible'=>false),
                    ...
                    'customer_notes' => array('type'=>'text', 'label'=>__('Customer Notes')),
                ),
            ),
