...
class Mage_Sales_Model_Resource_Report_Order extends Mage_Sales_Model_Resource_Report_Abstract
{
    ...
    /**
     * Aggregate Orders data by order created_at and order updated_at
     *
     * @param mixed $from
     * @param mixed $to
    ...
    public function aggregate($from = null, $to = null)
    {
        $aggregationData = array(
            'created_at' => 'sales/order_aggregated_created',
            'updated_at' => 'sales/order_aggregated_updated'
        );
        ...
        try {
            foreach ($aggregationData as $field => $tableCode) {
                $this->_init($tableCode, 'id');
                $this->_aggregateByField($field, $from, $to);
            }
