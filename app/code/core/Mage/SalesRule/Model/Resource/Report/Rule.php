...
class Mage_SalesRule_Model_Resource_Report_Rule extends Mage_Reports_Model_Resource_Report_Abstract
{
    ...
    public function aggregate($from = null, $to = null)
    {
        ...
        $aggregationData = array(
            'created_at' => 'salesrule/coupon_aggregated',
            'updated_at' => 'salesrule/coupon_aggregated_updated'
        );
        ...
        try {
            foreach ($aggregationData as $field => $tableCode) {
                $this->_aggregateByOrder($field, $tableCode, $from, $to);
            }
     ...
     * @param string $aggregationTableCode
     * @param mixed $from
     * @param mixed $to
     * @return Mage_SalesRule_Model_Resource_Report_Rule
     */
    protected function _aggregateByOrder($aggregationField, $aggregationTableCode, $from, $to)
    {
        $table = $this->getTable($aggregationTableCode);
