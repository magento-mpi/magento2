 ...
 */
class Mage_SalesRule_Model_Mysql4_Report_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    ...
    public function __construct($parameters = array())
    {
        ...
        $table = 'salesrule/coupon_aggregated_created';
        if ($reportDateType == Mage_Sales_Model_Order::REPORT_DATE_TYPE_UPDATED) {
            $table = 'salesrule/coupon_aggregated_updated';
        }
