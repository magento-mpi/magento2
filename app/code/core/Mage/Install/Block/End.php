...
{
    const IFRAME_SOURCE_URL = 'www.magentocommerce.com/instsurvey.html';
    ...
    {
        if (Mage::getSingleton('install/installer')->getHideIframe() || self::IFRAME_SOURCE_URL == '') {
            return null;
        }
        $host = $this->getRequest()->isSecure()?'https://':'http://';
        return $host . self::IFRAME_SOURCE_URL;
    }
}
