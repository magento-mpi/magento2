 ...
 * @method Mage_CatalogIndex_Model_Indexer_Price getCustomerGroupId()
 * @method int setCustomerGroupId(int $value)
 * @method Mage_CatalogIndex_Model_Indexer_Price getWebsiteId()
 * @method int setWebsiteId(int $value)
 * @method Mage_CatalogIndex_Model_Indexer_Price getTaxClassId()
 * @method int setTaxClassId(int $value)
 * @method Mage_CatalogIndex_Model_Indexer_Price getPrice()
 * @method float setPrice(float $value)
 * @method Mage_CatalogIndex_Model_Indexer_Price getFinalPrice()
 * @method float setFinalPrice(float $value)
 * @method Mage_CatalogIndex_Model_Indexer_Price getMinPrice()
 * @method float setMinPrice(float $value)
 * @method Mage_CatalogIndex_Model_Indexer_Price getMaxPrice()
 * @method float setMaxPrice(float $value)
 * @method Mage_CatalogIndex_Model_Indexer_Price getTierPrice()
