 ...
 */
class Mage_CatalogSearch_Model_Config_Backend_Search_Type extends Mage_Core_Model_Config_Data
{
    /**
     * After change Catalog Search Type process
     *
     * @return Mage_CatalogSearch_Model_Config_Backend_Search_Type|Mage_Core_Model_Abstract
     */
