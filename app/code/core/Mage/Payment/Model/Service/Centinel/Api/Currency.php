...
/**
 * Payment Currency Helper
 */
class Mage_Payment_Model_Service_Centinel_Api_Currency extends Varien_Object
{
    /**
    ...
    public function getIso4217CurrencyCode($code)
    {
        ...
        Mage::throwException(Mage::helper('payment')->__('Not supported currency code %s.', $code));
    }
}
