...
CREATE TABLE `poll` (
  ...
  `date_posted` datetime NOT NULL default CURRENT_TIME,
...
insert  into `poll`(`poll_id`,`poll_title`,`votes_count`,`store_id`,`date_posted`,`date_closed`,`active`,`closed`,`answers_display`) values (1,'What is your favorite color',0,1,NOW(),NULL,1,0,NULL);
