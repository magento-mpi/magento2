...
$table = $installer->getConnection()
    ...
    ->addIndex($installer->getIdxName('poll_answer', array('poll_id')),
        array('poll_id'))
    ->addIndex($installer->getIdxName('poll_answer', array('answer_id')),
        array('answer_id'))
...
$table = $installer->getConnection()
    ...
    ->addIndex($installer->getIdxName('poll_store', array('poll_id')),
        array('poll_id'))
...
$table = $installer->getConnection()
    ...
    ->addIndex($installer->getIdxName('poll/poll_vote', array('vote_id')),
        array('vote_id'))
