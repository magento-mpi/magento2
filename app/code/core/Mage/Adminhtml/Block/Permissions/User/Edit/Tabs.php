...
class Mage_Adminhtml_Block_Permissions_User_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('main_section', array(
            ...
            'content'   => $this->getLayout()->createBlock('Mage_Adminhtml_Block_Permissions_User_Edit_Tab_Main')->toHtml(),
            'active'    => true
        ));
        ...
        $this->addTab('roles_section', array(
            ...
            'content'   => $this->getLayout()->createBlock('Mage_Adminhtml_Block_Permissions_User_Edit_Tab_Roles', 'user.roles.grid')->toHtml(),
        ));
