...
class Mage_Adminhtml_Block_Alert_Queue_Edit extends Mage_Adminhtml_Block_Template
{
    ...
    {
        return ( $this->getIsPreview() ? Mage::helper('customeralert')->__('View Customer Alert') : Mage::helper('customeralert')->__('Edit Customer Alert'));
    }
