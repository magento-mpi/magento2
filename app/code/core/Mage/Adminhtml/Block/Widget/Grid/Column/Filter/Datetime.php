...
class Mage_Adminhtml_Block_Widget_Grid_Column_Filter_Datetime extends Mage_Adminhtml_Block_Widget_Grid_Column_Filter_Date
{
    ...
    public function getHtml()
    {
        ...
        $html = '<div class="range"><div class="range-line date">
            ...
            <img src="' . Mage::getDesign()->getSkinUrl('images/grid-cal.gif') . '" alt="" class="v-middle" id="'.$htmlId.'_from_trig" title="'.$this->htmlEscape(Mage::helper('Mage_Adminhtml_Helper_Data')->__('Date selector')).'"/>
            </div>';
        $html.= '<div class="range-line date">
            ...
            <img src="' . Mage::getDesign()->getSkinUrl('images/grid-cal.gif') . '" alt="" class="v-middle" id="'.$htmlId.'_to_trig" title="'.$this->htmlEscape(Mage::helper('Mage_Adminhtml_Helper_Data')->__('Date selector')).'"/>
            </div></div>';
