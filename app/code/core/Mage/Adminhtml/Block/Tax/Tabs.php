...
class Mage_Adminhtml_Block_Tax_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('tax_rule', array(
            ...
            'active'    => $this->_checkActiveTab('tax_rule'),
        ...
        $this->addTab('tax_rate', array(
            ...
            'active'    => $this->_checkActiveTab('tax_rate'),
        ...
        $this->addTab('tax_class_customer', array(
            ...
            'active'    => $this->_checkActiveTab('tax_class_customer'),
        ...
        $this->addTab('tax_class_product', array(
            ...
            'active'    => $this->_checkActiveTab('tax_class_product'),
    ...
    {
        return ( $this->getActiveTab() == $tabId ) ? true : false;
    }
}