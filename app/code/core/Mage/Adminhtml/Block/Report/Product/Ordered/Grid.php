...
class Mage_Adminhtml_Block_Report_Product_Ordered_Grid extends Mage_Adminhtml_Block_Report_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $this->getCollection()->initReport('Mage_Reports_Model_Resource_Product_Ordered_Collection');
    }
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addExportType('*/*/exportOrderedCsv', Mage::helper('Mage_Reports_Helper_Data')->__('CSV'));
        $this->addExportType('*/*/exportOrderedExcel', Mage::helper('Mage_Reports_Helper_Data')->__('Excel XML'));
