...
class Mage_Adminhtml_Block_Sales_Order_Status_New extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function __construct()
    {
        ...
        parent::__construct();
        $this->_updateButton('save', 'label', Mage::helper('Mage_Sales_Helper_Data')->__('Save BugsCoverage'));
    ...
    {
        return Mage::helper('Mage_Sales_Helper_Data')->__('New Order BugsCoverage');
    }
}
