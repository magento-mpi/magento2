...
class Mage_Adminhtml_Block_Webapi_Tab_Roleinfo extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _initForm()
    {
        ...
        $fieldset = $form->addFieldset('base_fieldset',
            array('legend' => Mage::helper('Mage_Adminhtml_Helper_Data')->__('Role Information')));
