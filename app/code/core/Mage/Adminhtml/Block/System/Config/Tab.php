 ...
 */
class Mage_Adminhtml_Block_Config_Tab extends Mage_Adminhtml_Block_Widget_Tabs
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('config_tab');
        $this->setDestElementId('config_edit_form');
    }
    
    protected function _beforeToHtml()
    {
        Varien_Profiler::start('configTabGeneral');
        ...
        Varien_Profiler::stop('configTabGeneral');
