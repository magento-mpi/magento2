...
/**
 * Adminhtml storefront content block
 *
 * @category   Mage
 * @package    Mage_Adminhtml
...
class Mage_Adminhtml_Block_System_Storefront_Storefront extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        $this->_controller  = 'system_storefront';
        $this->_headerText  = Mage::helper('adminhtml')->__('Manage Storefront');
        parent::__construct();
    }
    ...
    protected function _prepareLayout()
    {
        ...
        $this->_updateButton('add', 'onclick', "setLocation('".Mage::getUrl('*/*/newWebsite')."')");

        /* Add Store Group button */
        $this->_addButton('add_group', array(
            'label'     => Mage::helper('core')->__('Create Store Group'),
            'onclick'   => 'setLocation(\'' . Mage::getUrl('*/*/newGroup') .'\')',
            'class'     => 'add',
        ));
