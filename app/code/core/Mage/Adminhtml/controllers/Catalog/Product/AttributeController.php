...
class Mage_Adminhtml_Catalog_Product_AttributeController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function editAction()
    {
        ...
        $this->_initAction()
            ...
            ->_addContent($this->getLayout()->createBlock('adminhtml/catalog_product_attribute_edit')->setData('action', Mage::helper('adminhtml')->getUrl('*/catalog_product_attribute/save')))
