...
class Mage_Adminhtml_Newsletter_QueueController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function editAction()
    {
        ...
        $this->_addBreadcrumb(__('Newsletter Queue'), __('Newsletter Queue'), Mage::getUrl('*/newsletter_queue'));
    ...
    {
	    return Mage::getSingleton('admin/session')->isAllowed('customer_communication/newsletter/queue');
    }
}
