 ...
 */
class Mage_Adminhtml_Model_System_Config_Backend_Store_Logo extends Mage_Core_Model_Config_Data
{
    ...
    protected function _beforeSave(){
        ...
        if ($_FILES['groups']['tmp_name'][$this->getGroupId()]['fields'][$this->getField()]['value']){
            ...
            $uploader->save(Mage::getStoreConfig('system/filesystem/media').'/sales/store/logo');


            if ($fileName = $uploader->getUploadedFileName()) {
//                $fileName = Mage::getBaseUrl('media').'sales/store/logo/'.$fileName;
                $fileName = 'sales/store/logo/'.$fileName;
