 ...
 */
class Mage_Webapi_Block_Adminhtml_User_Edit_Tab_Roles extends Mage_Backend_Block_Widget_Grid
{
    /**
     * Initialize grid
     */
    ...
    {
        /** @var $collection Mage_Webapi_Model_Resource_Role_Collection */
        $collection = Mage::getResourceModel('Mage_Api_Model_Resource_Acl_Role_Collection');
    ...
    {
        return $this->getUrl('*/*/roles', array('user_id' => $this->getApiUser()->getId()));
    }
}
