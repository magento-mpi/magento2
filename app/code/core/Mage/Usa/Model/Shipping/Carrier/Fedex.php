    ...
    implements Mage_Shipping_Model_Carrier_Interface
{
    ...
    public function setRequest(Mage_Shipping_Model_Rate_Request $request)
    {
        ...
        if ($request->getOrigCountry()) {
            ...
            $origCountry = Mage::getStoreConfig(Mage_Shipping_Model_Config::CONFIG_XML_PATH_ORIGIN_COUNTRY_ID, $this->getStore());
        }
        ...
        if ($request->getOrigPostcode()) {
            ...
            $r->setOrigPostal(Mage::getStoreConfig(Mage_Shipping_Model_Config::CONFIG_XML_PATH_ORIGIN_POSTCODE, $this->getStore()));
        }
