    ...
    implements Mage_Shipping_Model_Carrier_Interface
{
    ...
    public function setRequest(Mage_Shipping_Model_Rate_Request $request)
    {
        ...
        if ($request->getOrigRegionCode()) {
            ...
            $origRegionCode = Mage::getStoreConfig(Mage_Shipping_Model_Config::CONFIG_XML_PATH_ORIGIN_REGION_ID, $this->getStore());
        ...
        if ($request->getOrigCity()) {
            ...
            $r->setOrigCity(Mage::getStoreConfig(Mage_Shipping_Model_Config::CONFIG_XML_PATH_ORIGIN_CITY, $this->getStore()));
        }
