 ...
 */
class Mage_Log_Model_Resource_Visitor_Collection extends Varien_Data_Collection_Db
{
    /**
     ...
     * @param unknown_type $type_code
     * @param unknown_type $customFrom
     * @param unknown_type $customTo
     * @return Mage_Log_Model_Resource_Visitor_Collection
     */
