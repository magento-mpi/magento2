...
/**
 * PaypalUk Direct Controller
 */
class Mage_PaypalUk_Adminhtml_Paypaluk_DirectController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function lookupAction()
    {
        ...
        if ($this->_getValidation()->getEnrolled() == 'Y'
            ...
            $result = array('iframeUrl' => $this->getUrl('*/paypaluk_direct/validate', array('_current' => true, '_secure' => true)));
        } else {
            $result = array('iframeUrl' => $this->getUrl('*/paypaluk_direct/finalizeValidate', array('_current' => true, '_secure' => true)));
        }
