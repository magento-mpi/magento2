 ...
 * @method Mage_Admin_Model_Rules getRoleId()
 * @method int setRoleId(int $value)
 * @method Mage_Admin_Model_Rules getResourceId()
 * @method string setResourceId(string $value)
 * @method Mage_Admin_Model_Rules getPrivileges()
 * @method string setPrivileges(string $value)
 * @method Mage_Admin_Model_Rules getAssertId()
 * @method int setAssertId(int $value)
 * @method Mage_Admin_Model_Rules getRoleType()
 * @method string setRoleType(string $value)
 * @method Mage_Admin_Model_Rules getPermission()
