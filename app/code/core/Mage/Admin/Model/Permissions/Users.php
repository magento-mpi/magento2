...
class Mage_Admin_Model_Permissions_Users extends Varien_Object {
    
    public function getResource() {
        return Mage::getResourceSingleton('admiin/permissions_users');
    }
    ...
    public function getCollection() {
        return Mage::getResourceModel('admin/permissions_users_collection');
    }
