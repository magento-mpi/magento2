 ...
 * @method Mage_Admin_Model_Roles getParentId()
 * @method int setParentId(int $value)
 * @method Mage_Admin_Model_Roles getTreeLevel()
 * @method int setTreeLevel(int $value)
 * @method Mage_Admin_Model_Roles getSortOrder()
 * @method int setSortOrder(int $value)
 * @method Mage_Admin_Model_Roles getRoleType()
 * @method string setRoleType(string $value)
 * @method Mage_Admin_Model_Roles getUserId()
 * @method int setUserId(int $value)
 * @method Mage_Admin_Model_Roles getRoleName()
