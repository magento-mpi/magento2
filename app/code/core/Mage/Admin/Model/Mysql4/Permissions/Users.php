...
class Mage_Admin_Model_Mysql4_Permissions_Users {
    ...
    public function save(Mage_Admin_Model_Permissions_Users $user) {
    	if ($user->getId()) {
    		$data = array(
	       ...
	       if ($user->getPassword()) {
	       		$data['password'] = Mage::getModel("admin/permissions_users")->encodePwd($user->getPassword());
	       }
    ...
    public function add(Mage_Admin_Model_Permissions_Users $user) {
    	if ($user->getRoleId() > 0) {
    		$row = Mage::getModel('admin/permissions_roles')->load($user->getRoleId());
    	} else {
    ...
    public function deleteFromRole(Mage_Admin_Model_Permissions_Users $users) {
    ...
    public function saveRel(Mage_Admin_Model_Permissions_Users $user) {
    	$data = array();
    	$ids = $user->getIds();
    ...
    public function delete(Mage_Admin_Model_Permissions_Users $user) {
    	$this->_write->beginTransaction();
