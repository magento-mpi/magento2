...
//Fill table review/review_entity
$reviewStatuses = array('Approved','Pending','Not Approved');
foreach($reviewStatuses as $statusCode){
    $installer->getConnection()
            ->insert($installer->getTable('review/review_status'), array('status_code' => $statusCode));
}