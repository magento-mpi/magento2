...
insert into `directory_currency` (`currency_code`,`format`,`format_decimals`,`format_dec_point`,`format_thousands_sep`) values ('CAD','%s',2,'.',''),('EUR','%s',2,'.',''),('RUB','%s',2,'.',''),('UAH','%s',2,'.',''),('USD','$ %s',2,'.','');
...
insert into `directory_currency_name` (`language_code`,`currency_code`,`currency_name`) values ('en','USD','U.S. Dollar');
