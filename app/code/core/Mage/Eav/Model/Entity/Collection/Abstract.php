...
// join table
    ...
    protected function _addAttributeJoin($attributeCode, $joinType='inner')
    {
        ...
        /*$this->getSelect()->$joinMethod(
            array($attrTable => $attribute->getBackendTable()),
            '('.join(') AND (', $condArr).')',
    ...
    {
        unset($this->_itemsById, $this->_entity, $this->_selectAttributes);
    }
}
