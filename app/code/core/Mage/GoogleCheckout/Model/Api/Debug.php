 ...
 * @method Mage_GoogleCheckout_Model_Api_Debug getDir()
 * @method string setDir(string $value)
 * @method Mage_GoogleCheckout_Model_Api_Debug getUrl()
 * @method string setUrl(string $value)
 * @method Mage_GoogleCheckout_Model_Api_Debug getRequestBody()
 * @method string setRequestBody(string $value)
 * @method Mage_GoogleCheckout_Model_Api_Debug getResponseBody()
