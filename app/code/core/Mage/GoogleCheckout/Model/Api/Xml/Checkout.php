...
EOT;
        ...
        foreach ($this->getQuote()->getAllItems() as $item) {
            ...
            $baseCalculationPrice = $item->getBaseCalculationPrice();
            if (Mage::helper('weee')->includeInSubtotal()){
                $baseCalculationPrice += $item->getBaseWeeeTaxAppliedAmount();
            }
            ...
            <item>
                ...
                <unit-price currency="{$this->getCurrency()}">{$baseCalculationPrice}</unit-price>
