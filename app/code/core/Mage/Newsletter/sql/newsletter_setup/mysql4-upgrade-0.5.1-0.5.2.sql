...
insert into `newsletter_template` (`template_id`,`template_code`,`template_text`,`template_text_preprocessed`,`template_type`,`template_subject`,`template_sender_name`,`template_sender_email`,`template_actual`,`is_system`,`added_at`,`modified_at`) values (1,'Confirmation of Subscription','<p>\r\nThank you for subscription. <br />\r\n</p>\r\n',NULL,2,'Please confirm your subscription','Magento E-Commerce Open Source','no-reply@magentocommerce.com',1,1,'2007-07-22 01:07:00','2007-07-23 04:31:11');
