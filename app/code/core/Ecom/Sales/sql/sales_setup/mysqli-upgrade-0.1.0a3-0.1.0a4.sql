...
) ENGINE=InnoDB DEFAULT CHARSET=cp1251 COMMENT='Sales entity attributes';
...
) ENGINE=InnoDB DEFAULT CHARSET=cp1251 COMMENT='Attributes type(entity)';
...
) ENGINE=InnoDB DEFAULT CHARSET=cp1251 COMMENT='Invoices';
...
) ENGINE=InnoDB DEFAULT CHARSET=cp1251 COMMENT='Invoice items';
...
) ENGINE=InnoDB DEFAULT CHARSET=cp1251 COMMENT='Invoice status';
...
) ENGINE=InnoDB DEFAULT CHARSET=cp1251 COMMENT='Orders';
...
CREATE TABLE `sales_order_address` (
  ...
  KEY `FK_Reference_22` (`order_id`),
  CONSTRAINT `FK_Reference_22` FOREIGN KEY (`order_id`) REFERENCES `sales_order` (`order_id`),
  CONSTRAINT `FK_ORDER_ADDRESS_TYPE` FOREIGN KEY (`address_type_id`) REFERENCES `sales_order_address_type` (`address_type_id`)
) ENGINE=InnoDB DEFAULT CHARSET=cp1251 COMMENT='Customer addresses info per order';
...
) ENGINE=InnoDB DEFAULT CHARSET=cp1251 COMMENT='Order adress type(shipment, payment, etc.)';
...
) ENGINE=InnoDB DEFAULT CHARSET=cp1251 COMMENT='Order attributes';
...
CREATE TABLE `sales_order_item` (
  ...
  CONSTRAINT `FK_ITEM_PRODUCT` FOREIGN KEY (`product_id`) REFERENCES `catalog_product` (`product_id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=cp1251 COMMENT='Order products';
...
CREATE TABLE `sales_order_item_attribute` (
  ...
  `attribute_code` varchar(32) default NULL,
  `attribute_decimal` decimal(10,2) default NULL,
  `attribute_text` text,
...
) ENGINE=InnoDB DEFAULT CHARSET=cp1251 COMMENT='Product information per order';
...
) ENGINE=InnoDB DEFAULT CHARSET=cp1251 COMMENT='Statuses of order item';
...
) ENGINE=InnoDB DEFAULT CHARSET=cp1251 COMMENT='Orders status';
...
CREATE TABLE `sales_order_status_history` (
  ...
  PRIMARY KEY  (`sales_order_id`,`order_status_id`),
  ...
  CONSTRAINT `FK_HYSTORY_ORDER` FOREIGN KEY (`sales_order_id`) REFERENCES `sales_order` (`order_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=cp1251 COMMENT='Order status change history';
...
) ENGINE=InnoDB DEFAULT CHARSET=cp1251 COMMENT='Payments';
...
) ENGINE=InnoDB DEFAULT CHARSET=cp1251 COMMENT='Payment transactions';
...
) ENGINE=InnoDB DEFAULT CHARSET=cp1251 COMMENT='Types of sales';
...
) ENGINE=InnoDB DEFAULT CHARSET=cp1251 COMMENT='Quotes info';
...
) ENGINE=InnoDB DEFAULT CHARSET=cp1251 COMMENT='Quote address';
...
CREATE TABLE `sales_quote_item` (
  ...
  CONSTRAINT `FK_QUOTE_ITEM_PRODUCT` FOREIGN KEY (`product_id`) REFERENCES `catalog_product` (`product_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_ITEM_QUOTE` FOREIGN KEY (`quote_id`) REFERENCES `sales_qoute` (`quote_id`),
  CONSTRAINT `FK_QUOTE_ITEM_ADDRESS` FOREIGN KEY (`quote_address_id`) REFERENCES `sales_quote_address` (`quote_address_id`)
) ENGINE=InnoDB DEFAULT CHARSET=cp1251 COMMENT='quote items';
...
) ENGINE=InnoDB DEFAULT CHARSET=cp1251 COMMENT='Quote item attributes';
...
) ENGINE=InnoDB DEFAULT CHARSET=cp1251 COMMENT='Orders shipmpments';
...
) ENGINE=InnoDB DEFAULT CHARSET=cp1251 COMMENT='Shipment methods';
