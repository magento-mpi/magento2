...
abstract class Ecom_Core_Controller_Zend_Action extends Zend_Controller_Action
{
    ...
    function preDispatch()
    {
        ...
        Ecom::dispatchEvent('controllerAction_preDispatch');

        Ecom::dispatchEvent('controllerAction_'.
    ...
    function postDispatch()
    {
        ...
        Ecom::dispatchEvent('controllerAction_postDispatch');
    }

    function norouteAction()
    {
        //$this->getResponse()->setHeader('HTTP/1.0 404 Not Found');
        Ecom::dispatchEvent('controllerAction_noRoute');
    }
