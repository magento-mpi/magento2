...
abstract class Ecom_Core_Setup_Abstract
{
    ...
    protected function _installDb($moduleVersion)
    {
        ...
        Ecom::getModel('core', 'Module') -> setDbVersion($this->_moduleInfo->getName(), $moduleVersion);
    }
    ...
    protected function _upgradeDb($oldVersion, $newVersion)
    {
    	...
    	Ecom::getModel('core', 'Module') -> setDbVersion($this->_moduleInfo->getName(), $newVersion);
    }
    ...
    protected function _modifySql($actionType, $fromVersion, $toVersion)
    {
    	...
    	foreach ($arrResources as $resName => $resInfo) {
    	    ...
    	    // Get Resource Object
    	    $resource = Ecom_Core_Resource::getResource($resName);
    	    if ($resource) {
