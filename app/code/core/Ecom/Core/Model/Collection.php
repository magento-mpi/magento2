 ...
 */
class Ecom_Core_Model_Collection implements Iterator
{
    // ITEMS
	...
	public function __construct(Ecom_Core_Model_Db $db) 
	{
		$this->_dbModel = $db;

		if (!$this->_dbModel->getReadConnection() instanceof Zend_Db_Adapter_Abstract) {
			Ecom::exception('dbModel read resource does not implement Zend_Db_Adapter_Abstract', 0, 'Ecom_Core');
		}
