...
class Enterprise_Pbridge_Model_Payment_Method_Dibs extends Mage_Payment_Model_Method_Cc
{
     ...
     * @var string
     */
    protected $_formBlockType = 'Enterprise_Pbridge_Block_Checkout_Payment_Dibs';
     ...
     * @var string
     */
    protected $_backendFormBlockType = 'Enterprise_Pbridge_Block_Adminhtml_Sales_Order_Create_Dibs';
