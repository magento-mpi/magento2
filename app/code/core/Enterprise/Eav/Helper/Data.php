            ...
            case 'multiline':
                if (isset($validateRules['min_text_length']) && isset($validateRules['max_text_length'])) {
                    ...
                    if ($minTextLength > $maxTextLength) {
                        $errors[] = Mage::helper('enterprise_eav')
                            ->__('Wrong values for minimum and maximum text length validation rules.');
                    }
                }
                break;
            case 'date':
                if (isset($validateRules['date_range_min']) && isset($validateRules['date_range_max'])) {
                    ...
                    if ($minValue > $maxValue) {
                        $errors[] = Mage::helper('enterprise_eav')
                            ->__('Wrong values for minimum and maximum date validation rules.');
                    }
                }
                break;
            default:
