 ...
 * @package    Enterprise_GiftRegistry
 */
class Enterprise_GiftRegistry_Block_Search_Advanced extends Enterprise_Enterprise_Block_Core_Template
{

    protected $_elements;

    /**
     * Block prepare layout
     *
     * @return Enterprise_GiftRegistry_Block_Search_Advanced
     */
