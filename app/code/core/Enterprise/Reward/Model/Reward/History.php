 ...
 * @method Enterprise_Reward_Model_Reward_History getRewardId()
 * @method int setRewardId(int $value)
 * @method Enterprise_Reward_Model_Reward_History getWebsiteId()
 * @method int setWebsiteId(int $value)
 * @method Enterprise_Reward_Model_Reward_History getStoreId()
 * @method int setStoreId(int $value)
 * @method Enterprise_Reward_Model_Reward_History getAction()
 * @method int setAction(int $value)
 * @method Enterprise_Reward_Model_Reward_History getEntity()
 * @method int setEntity(int $value)
 * @method Enterprise_Reward_Model_Reward_History getPointsBalance()
 * @method int setPointsBalance(int $value)
 * @method Enterprise_Reward_Model_Reward_History getPointsDelta()
 * @method int setPointsDelta(int $value)
 * @method Enterprise_Reward_Model_Reward_History getPointsUsed()
 * @method int setPointsUsed(int $value)
 * @method Enterprise_Reward_Model_Reward_History getCurrencyAmount()
 * @method float setCurrencyAmount(float $value)
 * @method Enterprise_Reward_Model_Reward_History getCurrencyDelta()
 * @method float setCurrencyDelta(float $value)
 * @method Enterprise_Reward_Model_Reward_History getBaseCurrencyCode()
 * @method string setBaseCurrencyCode(string $value)
 * @method string setAdditionalData(string $value)
 * @method Enterprise_Reward_Model_Reward_History getComment()
 * @method string setComment(string $value)
 * @method Enterprise_Reward_Model_Reward_History getCreatedAt()
 * @method string setCreatedAt(string $value)
 * @method Enterprise_Reward_Model_Reward_History getExpiredAtStatic()
 * @method string setExpiredAtStatic(string $value)
 * @method Enterprise_Reward_Model_Reward_History getExpiredAtDynamic()
 * @method string setExpiredAtDynamic(string $value)
 * @method Enterprise_Reward_Model_Reward_History getIsExpired()
 * @method int setIsExpired(int $value)
 * @method Enterprise_Reward_Model_Reward_History getIsDuplicateOf()
 * @method int setIsDuplicateOf(int $value)
 * @method Enterprise_Reward_Model_Reward_History getNotificationSent()
 * @method int setNotificationSent(int $value)
 *
 * @category    Enterprise
 * @package     Enterprise_Reward
