...
$installer->run("
-- DROP TABLE IF EXISTS `{$installer->getTable('enterprise_customer/order')}`;
CREATE TABLE `{$installer->getTable('enterprise_customer/order')}` (
...
-- DROP TABLE IF EXISTS `{$installer->getTable('enterprise_customer/order_address')}`;
CREATE TABLE `{$installer->getTable('enterprise_customer/order_address')}` (
  `entity_id` int(10) unsigned NOT NULL default '0',
  PRIMARY KEY  (`entity_id`),
...
-- DROP TABLE IF EXISTS `{$installer->getTable('enterprise_customer/quote')}`;
CREATE TABLE `{$installer->getTable('enterprise_customer/quote')}` (
  `entity_id` int(10) unsigned NOT NULL default '0',
  PRIMARY KEY  (`entity_id`),
...
-- DROP TABLE IF EXISTS `{$installer->getTable('enterprise_customer/quote_address')}`;
CREATE TABLE `{$installer->getTable('enterprise_customer/quote_address')}` (
  `entity_id` int(10) unsigned NOT NULL default '0',
  PRIMARY KEY  (`entity_id`),
