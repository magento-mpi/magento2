 ...
 *
 */
class Enterprise_AdminGws_Block_Adminhtml_Permissions_Grid_Renderer_Gws extends Enterprise_Enterprise_Block_Adminhtml_Widget_Grid_Column_Renderer_Abstract
{
    /**
     * @var array
     */
