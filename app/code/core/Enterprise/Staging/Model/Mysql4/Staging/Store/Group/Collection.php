...
class Enterprise_Staging_Model_Mysql4_Staging_Store_Group_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
     ...
     * @return  object  Enterprise_Staging_Model_Mysql4_Staging_Store_Group_Collection
     */
    ...
    {
        return parent::_toOptionArray('staging_store_group_id', 'name');
    }

    public function toOptionHash()
    {
        return parent::_toOptionHash('staging_store_group_id', 'name');
    }
}
