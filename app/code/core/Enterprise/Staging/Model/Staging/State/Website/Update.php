...
class Enterprise_Staging_Model_Staging_State_Website_Update extends Enterprise_Staging_Model_Staging_State_Website_Abstract
{
    /**
    ...
    {
        $this->_updateStagingWebsite($staging);
     ...
     * @return  Enterprise_Staging_Model_Staging_State_Website_Create
     */
    protected function _updateStagingWebsite($staging)
    {
