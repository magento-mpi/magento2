 ...
 */
class Enterprise_Staging_Block_Adminhtml_Staging_Edit_Tabs_Website extends Enterprise_Enterprise_Block_Adminhtml_Widget_Form
{
    /**
     * Constructor
     */
    ...
    protected function _initWebsiteItems($form, $staging, $websiteId, $stagingWebsite = null)
    {
        ...
        if ($stagingWebsite) {
            $fieldset = $form->addFieldset('staging_website_items',
                array('legend'=>Mage::helper('enterprise_staging')->__('Items copied')));
        } else {
            $fieldset = $form->addFieldset('staging_website_items',
                array('legend' => Mage::helper('enterprise_staging')->__('Select Original Website Content to be Copied to Staging Website')));
        }
    ...
    protected function _initWebsiteStore($form, $masterWebsite, $stagingWebsite = null)
    {
        ...
        if ($stagingWebsite) {
            $fieldset = $form->addFieldset('staging_website_stores',
                array('legend' => Mage::helper('enterprise_staging')->__('Store views copied')));
        } else {
            $fieldset = $form->addFieldset('staging_website_stores',
