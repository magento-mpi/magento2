...
class Magento_Api_Model_Server
{
    ...
    public function getAdapterCodeByAlias($alias)
    {
        ...
        if (!method_exists($object, $method)) {
            Mage::throwException(Mage::helper('Magento_Api_Helper_Data')->__('Can not find webservice adapter.'));
        }
    ...
    public function initialize($adapterCode, $handler = null)
    {
        ...
        if (isset($adapters[$adapterCode])) {
            ...
            if (!($adapterModel instanceof Magento_Api_Model_Server_Adapter_Soap)) {
                Mage::throwException(Mage::helper('Magento_Api_Helper_Data')->__('Please correct the webservice adapter specified.'));
            }
            ...
            if (!isset($handlers->$handler)) {
                Mage::throwException(Mage::helper('Magento_Api_Helper_Data')->__('Please correct the webservice handler specified.'));
            }
