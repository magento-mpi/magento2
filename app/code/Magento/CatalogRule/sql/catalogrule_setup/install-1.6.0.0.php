...
$table = $installer->getConnection()
    ...
    ->addColumn('rule_product_id', \Magento\DB\Ddl\Table::TYPE_INTEGER, null, array(
        'identity'  => true,
        'unsigned'  => true,
        'nullable'  => false,
        'primary'   => true,
    ...
    ->addColumn('from_time', \Magento\DB\Ddl\Table::TYPE_INTEGER, null, array(
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => '0',
        ), 'From Time')
    ->addColumn('to_time', \Magento\DB\Ddl\Table::TYPE_INTEGER, null, array(
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => '0',
        ), 'To time')
    ...
    ->addColumn('action_operator', \Magento\DB\Ddl\Table::TYPE_TEXT, 10, array(
        'default'   => 'to_fixed',
        ), 'Action Operator')
    ->addColumn('action_amount', \Magento\DB\Ddl\Table::TYPE_DECIMAL, array(12,4), array(
        'nullable'  => false,
        'default'   => '0.0000',
        ), 'Action Amount')
    ->addColumn('action_stop', \Magento\DB\Ddl\Table::TYPE_SMALLINT, null, array(
        'nullable'  => false,
        'default'   => '0',
        ), 'Action Stop')
    ->addColumn('sort_order', \Magento\DB\Ddl\Table::TYPE_INTEGER, null, array(
...
$table = $installer->getConnection()
    ...
    ->addColumn('rule_product_price_id', \Magento\DB\Ddl\Table::TYPE_INTEGER, null, array(
        'identity'  => true,
        'unsigned'  => true,
        'nullable'  => false,
        'primary'   => true,
        ), 'Rule Product PriceId')
    ->addColumn('rule_date', \Magento\DB\Ddl\Table::TYPE_DATE, null, array(
        'nullable'  => false,
        ), 'Rule Date')
    ->addColumn('customer_group_id', \Magento\DB\Ddl\Table::TYPE_SMALLINT, null, array(
        'unsigned'  => true,
    ...
    ->addColumn('rule_price', \Magento\DB\Ddl\Table::TYPE_DECIMAL, array(12,4), array(
        'nullable'  => false,
        'default'   => '0.0000',
        ), 'Rule Price')
    ->addColumn('website_id', \Magento\DB\Ddl\Table::TYPE_SMALLINT, null, array(
    ...
    ->addColumn('latest_start_date', \Magento\DB\Ddl\Table::TYPE_DATE, null, array(
        ), 'Latest StartDate')
    ->addColumn('earliest_end_date', \Magento\DB\Ddl\Table::TYPE_DATE, null, array(
        ), 'Earliest EndDate')

    ->addIndex($installer->getIdxName('catalogrule_product_price', array('rule_date', 'website_id', 'customer_group_id', 'product_id'), \Magento\DB\Adapter\AdapterInterface::INDEX_TYPE_UNIQUE),
        array('rule_date', 'website_id', 'customer_group_id', 'product_id'), array('type' => \Magento\DB\Adapter\AdapterInterface::INDEX_TYPE_UNIQUE))
