 ...
 */
class Magento_Usa_Model_Shipping_Carrier_Ups
    ...
    implements Magento_Shipping_Model_Carrier_Interface
{
     ...
     * Rate request data
     *
     * @var Magento_Shipping_Model_Rate_Request
     */
    protected $_request;
     ...
     * Rate result data
     *
     * @var Magento_Shipping_Model_Rate_Result
     */
    protected $_result;
    ...
    protected function _getCgiQuotes()
    {
        ...
        if (Magento_Usa_Model_Shipping_Carrier_Abstract::USA_COUNTRY_ID == $rowRequest->getDestCountry()) {
        ...
        if (strlen(trim($response)) > 0) {
            ...
            foreach ($rRows as $rRow) {
                ...
                switch (substr($row[0], -1)) {
                    ...
                    case 5:
                        $errorTitle = $row[1];
                        Mage::log(Mage::helper('Magento_Usa_Helper_Data')->__('Sorry, something went wrong. Please try again or contact us and we\'ll try to help.') . ': ' . $errorTitle);
                        break;
                    case 6:
        ...
        $codes = array(
            ...
            'originShipment' => array(
                ...
                'United States Domestic Shipments' => array(
                    '01' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Next Day Air'),
                    '02' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Second Day Air'),
                    '03' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Ground'),
                    '07' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Worldwide Express'),
                    '08' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Worldwide Expedited'),
                    '11' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Standard'),
                    '12' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Three-Day Select'),
                    '13' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Next Day Air Saver'),
                    '14' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Next Day Air Early A.M.'),
                    '54' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Worldwide Express Plus'),
                    '59' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Second Day Air A.M.'),
                    '65' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Saver'),
                ),
                ...
                'Shipments Originating in United States' => array(
                    ...
                    '54' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Worldwide Express Plus'),
                    '59' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Second Day Air A.M.'),
                    '65' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Worldwide Saver'),
                ),
                // Shipments Originating in Canada
                'Shipments Originating in Canada' => array(
                    '01' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Express'),
                    '02' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Expedited'),
                    '07' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Worldwide Express'),
                    '08' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Worldwide Expedited'),
                    '11' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Standard'),
                    '12' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Three-Day Select'),
                    '14' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Express Early A.M.'),
                    '65' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Saver'),
                ),
                // Shipments Originating in the European Union
                'Shipments Originating in the European Union' => array(
                    '07' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Express'),
                    '08' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Expedited'),
                    '11' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Standard'),
                    '54' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Worldwide Express PlusSM'),
                    '65' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Saver'),
                ),
                ...
                'Polish Domestic Shipments' => array(
                    ...
                    '54' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Worldwide Express Plus'),
                    '65' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Saver'),
                    '82' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Today Standard'),
                    '83' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Today Dedicated Courrier'),
                    '84' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Today Intercity'),
                    '85' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Today Express'),
                    '86' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Today Express Saver'),
                ),
                // Puerto Rico Origin
                ...
                'Shipments Originating in Mexico' => array(
                    '07' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Express'),
                    '08' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Expedited'),
                    '54' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Express Plus'),
                    '65' => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Saver'),
                ),
            ...
            'method'=>array(
                ...
                '1DML'   => Mage::helper('Magento_Usa_Helper_Data')->__('Next Day Air Early AM Letter'),
                '1DA'    => Mage::helper('Magento_Usa_Helper_Data')->__('Next Day Air'),
                '1DAL'   => Mage::helper('Magento_Usa_Helper_Data')->__('Next Day Air Letter'),
                '1DAPI'  => Mage::helper('Magento_Usa_Helper_Data')->__('Next Day Air Intra (Puerto Rico)'),
                '1DP'    => Mage::helper('Magento_Usa_Helper_Data')->__('Next Day Air Saver'),
                '1DPL'   => Mage::helper('Magento_Usa_Helper_Data')->__('Next Day Air Saver Letter'),
                '2DM'    => Mage::helper('Magento_Usa_Helper_Data')->__('2nd Day Air AM'),
                '2DML'   => Mage::helper('Magento_Usa_Helper_Data')->__('2nd Day Air AM Letter'),
                '2DA'    => Mage::helper('Magento_Usa_Helper_Data')->__('2nd Day Air'),
                '2DAL'   => Mage::helper('Magento_Usa_Helper_Data')->__('2nd Day Air Letter'),
                '3DS'    => Mage::helper('Magento_Usa_Helper_Data')->__('3 Day Select'),
                'GND'    => Mage::helper('Magento_Usa_Helper_Data')->__('Ground'),
                'GNDCOM' => Mage::helper('Magento_Usa_Helper_Data')->__('Ground Commercial'),
                'GNDRES' => Mage::helper('Magento_Usa_Helper_Data')->__('Ground Residential'),
                'STD'    => Mage::helper('Magento_Usa_Helper_Data')->__('Canada Standard'),
                'XPR'    => Mage::helper('Magento_Usa_Helper_Data')->__('Worldwide Express'),
                'WXS'    => Mage::helper('Magento_Usa_Helper_Data')->__('Worldwide Express Saver'),
                'XPRL'   => Mage::helper('Magento_Usa_Helper_Data')->__('Worldwide Express Letter'),
                'XDM'    => Mage::helper('Magento_Usa_Helper_Data')->__('Worldwide Express Plus'),
                'XDML'   => Mage::helper('Magento_Usa_Helper_Data')->__('Worldwide Express Plus Letter'),
                'XPD'    => Mage::helper('Magento_Usa_Helper_Data')->__('Worldwide Expedited'),
            ),
            ...
            'container_description'=>array(
                'CP'     => Mage::helper('Magento_Usa_Helper_Data')->__('Customer Packaging'),
                'ULE'    => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Letter Envelope'),
                'CSP'    => Mage::helper('Magento_Usa_Helper_Data')->__('Customer Supplied Package'),
                'UT'     => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Tube'),
                'PAK'    => Mage::helper('Magento_Usa_Helper_Data')->__('PAK'),
                'UEB'    => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Express Box'),
                'UW25'   => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Worldwide 25 kilo'),
                'UW10'   => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Worldwide 10 kilo'),
                'PLT'    => Mage::helper('Magento_Usa_Helper_Data')->__('Pallet'),
                'SEB'    => Mage::helper('Magento_Usa_Helper_Data')->__('Small Express Box'),
                'MEB'    => Mage::helper('Magento_Usa_Helper_Data')->__('Medium Express Box'),
                'LEB'    => Mage::helper('Magento_Usa_Helper_Data')->__('Large Express Box'),
            ),
            ...
            'dest_type_description'=>array(
                'RES'    => Mage::helper('Magento_Usa_Helper_Data')->__('Residential'),
                'COM'    => Mage::helper('Magento_Usa_Helper_Data')->__('Commercial'),
            ),

            'unit_of_measure'=>array(
                'LBS'   =>  Mage::helper('Magento_Usa_Helper_Data')->__('Pounds'),
                'KGS'   =>  Mage::helper('Magento_Usa_Helper_Data')->__('Kilograms'),
            ),
...
XMLRequest;
    ...
    protected function _parseXmlResponse($xmlResponse)
    {
        ...
        if (empty($priceArr)) {
            ...
            $error->setCarrierTitle($this->getConfigData('title'));
            if (!isset($errorTitle)) {
                $errorTitle = Mage::helper('Magento_Usa_Helper_Data')->__('Cannot retrieve shipping rates');
            }
            $error->setErrorMessage($this->getConfigData('specificerrmsg'));
            $result->append($error);
        } else {
...
XMLAuth;
    ...
    protected function _getCgiTracking($trackings)
    {
        ...
        foreach ($trackings as $tracking) {
            $status = Mage::getModel('Magento_Shipping_Model_Tracking_Result_Status');
...
XMLAuth;
    ...
    protected function _formShipmentRequest(Magento_Object $request)
    {
        ...
        if ($deliveryConfirmation) {
            /** @var $serviceOptionsNode Magento_Usa_Model_Simplexml_Element */
        ...
        if ($request->getPackagingType() != $this->getCode('container', 'ULE')
            && $request->getShipperAddressCountryCode() == Magento_Usa_Model_Shipping_Carrier_Abstract::USA_COUNTRY_ID
    ...
    public function getContainerTypes(Magento_Object $params = null)
    {
        ...
        if (($countryShipper == self::USA_COUNTRY_ID && $countryRecipient == self::CANADA_COUNTRY_ID)
            ...
            if ($method == '07' // Worldwide Express
                ...
                if ($method != '08') {
                    $containerTypes = array(
                        '01'   => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Letter Envelope'),
                        '24'   => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Worldwide 25 kilo'),
                        '25'   => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Worldwide 10 kilo'),
                    );
                }
                $containerTypes = $containerTypes + array(
                    '03'    => Mage::helper('Magento_Usa_Helper_Data')->__('UPS Tube'),
                    '04'    => Mage::helper('Magento_Usa_Helper_Data')->__('PAK'),
                    '2a'    => Mage::helper('Magento_Usa_Helper_Data')->__('Small Express Box'),
                    '2b'    => Mage::helper('Magento_Usa_Helper_Data')->__('Medium Express Box'),
                    '2c'    => Mage::helper('Magento_Usa_Helper_Data')->__('Large Express Box'),
                );
            }
            return array('00' => Mage::helper('Magento_Usa_Helper_Data')->__('Customer Packaging')) + $containerTypes;
    ...
    public function getDeliveryConfirmationTypes(Magento_Object $params = null)
    {
        ...
        switch ($this->_getDeliveryConfirmationLevel($countryRecipient)) {
            case self::DELIVERY_CONFIRMATION_PACKAGE:
                $deliveryConfirmationTypes = array(
                    1 => Mage::helper('Magento_Usa_Helper_Data')->__('Delivery Confirmation'),
                    2 => Mage::helper('Magento_Usa_Helper_Data')->__('Signature Required'),
                    3 => Mage::helper('Magento_Usa_Helper_Data')->__('Adult Signature Required'),
                );
                break;
            case self::DELIVERY_CONFIRMATION_SHIPMENT:
                $deliveryConfirmationTypes = array(
                    1 => Mage::helper('Magento_Usa_Helper_Data')->__('Signature Required'),
                    2 => Mage::helper('Magento_Usa_Helper_Data')->__('Adult Signature Required'),
                );
                break;
            default:
                break;
        }
        array_unshift($deliveryConfirmationTypes, Mage::helper('Magento_Usa_Helper_Data')->__('Not Required'));
    ...
    protected function _getDeliveryConfirmationLevel($countyDestination = null)
    {
        ...
        if ($countyDestination == Magento_Usa_Model_Shipping_Carrier_Abstract::USA_COUNTRY_ID) {
