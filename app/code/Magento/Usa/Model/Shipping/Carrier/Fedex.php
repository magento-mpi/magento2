    ...
    implements Magento_Shipping_Model_Carrier_Interface
{
     ...
     * @return Magento_Usa_Model_Simplexml_Element|bool
     * @throws Exception
     */
    protected function _parseXml($xmlContent)
    {
        try {
            try {
                ...
                throw new Exception(Mage::helper('Magento_Usa_Helper_Data')->__('Failed to parse xml document: %s', $xmlContent));
            }
        } catch (Exception $e) {
            Mage::logException($e);
            return false;
    ...
    public function getCode($type, $code='')
    {
        $codes = array(
            'method' => array(
                'EUROPE_FIRST_INTERNATIONAL_PRIORITY' => Mage::helper('Magento_Usa_Helper_Data')->__('Europe First Priority'),
                'FEDEX_1_DAY_FREIGHT'                 => Mage::helper('Magento_Usa_Helper_Data')->__('1 Day Freight'),
                'FEDEX_2_DAY_FREIGHT'                 => Mage::helper('Magento_Usa_Helper_Data')->__('2 Day Freight'),
                'FEDEX_2_DAY'                         => Mage::helper('Magento_Usa_Helper_Data')->__('2 Day'),
                'FEDEX_2_DAY_AM'                      => Mage::helper('Magento_Usa_Helper_Data')->__('2 Day AM'),
                'FEDEX_3_DAY_FREIGHT'                 => Mage::helper('Magento_Usa_Helper_Data')->__('3 Day Freight'),
                ...
                'INTERNATIONAL_ECONOMY'               => Mage::helper('Magento_Usa_Helper_Data')->__('International Economy'),
                'INTERNATIONAL_ECONOMY_FREIGHT'       => Mage::helper('Magento_Usa_Helper_Data')->__('Intl Economy Freight'),
                'INTERNATIONAL_FIRST'                 => Mage::helper('Magento_Usa_Helper_Data')->__('International First'),
                'INTERNATIONAL_GROUND'                => Mage::helper('Magento_Usa_Helper_Data')->__('International Ground'),
                'INTERNATIONAL_PRIORITY'              => Mage::helper('Magento_Usa_Helper_Data')->__('International Priority'),
                'INTERNATIONAL_PRIORITY_FREIGHT'      => Mage::helper('Magento_Usa_Helper_Data')->__('Intl Priority Freight'),
                'PRIORITY_OVERNIGHT'                  => Mage::helper('Magento_Usa_Helper_Data')->__('Priority Overnight'),
                'SMART_POST'                          => Mage::helper('Magento_Usa_Helper_Data')->__('Smart Post'),
                'STANDARD_OVERNIGHT'                  => Mage::helper('Magento_Usa_Helper_Data')->__('Standard Overnight'),
                'FEDEX_FREIGHT'                       => Mage::helper('Magento_Usa_Helper_Data')->__('Freight'),
                'FEDEX_NATIONAL_FREIGHT'              => Mage::helper('Magento_Usa_Helper_Data')->__('National Freight'),
            ),
            'dropoff' => array(
                'REGULAR_PICKUP'          => Mage::helper('Magento_Usa_Helper_Data')->__('Regular Pickup'),
                'REQUEST_COURIER'         => Mage::helper('Magento_Usa_Helper_Data')->__('Request Courier'),
                'DROP_BOX'                => Mage::helper('Magento_Usa_Helper_Data')->__('Drop Box'),
                'BUSINESS_SERVICE_CENTER' => Mage::helper('Magento_Usa_Helper_Data')->__('Business Service Center'),
                'STATION'                 => Mage::helper('Magento_Usa_Helper_Data')->__('Station')
            ),
            'packaging' => array(
                'FEDEX_ENVELOPE' => Mage::helper('Magento_Usa_Helper_Data')->__('FedEx Envelope'),
                'FEDEX_PAK'      => Mage::helper('Magento_Usa_Helper_Data')->__('FedEx Pak'),
                'FEDEX_BOX'      => Mage::helper('Magento_Usa_Helper_Data')->__('FedEx Box'),
                'FEDEX_TUBE'     => Mage::helper('Magento_Usa_Helper_Data')->__('FedEx Tube'),
                'FEDEX_10KG_BOX' => Mage::helper('Magento_Usa_Helper_Data')->__('FedEx 10kg Box'),
                'FEDEX_25KG_BOX' => Mage::helper('Magento_Usa_Helper_Data')->__('FedEx 25kg Box'),
                'YOUR_PACKAGING' => Mage::helper('Magento_Usa_Helper_Data')->__('Your Packaging')
            ),
            ...
            'delivery_confirmation_types' => array(
                'NO_SIGNATURE_REQUIRED' => Mage::helper('Magento_Usa_Helper_Data')->__('Not Required'),
                'ADULT'                 => Mage::helper('Magento_Usa_Helper_Data')->__('Adult'),
                'DIRECT'                => Mage::helper('Magento_Usa_Helper_Data')->__('Direct'),
                'INDIRECT'              => Mage::helper('Magento_Usa_Helper_Data')->__('Indirect'),
            ),
        );
    ...
    protected function _parseTrackingResponse($trackingValue, $response)
    {
        ...
        if (isset($resultArray)) {
           ...
           $error->setErrorMessage($errorTitle ? $errorTitle : Mage::helper('Magento_Usa_Helper_Data')->__('Unable to retrieve tracking'));
                ...
                foreach ($trackings as $tracking){
                    if($data = $tracking->getAllData()){
                        if (!empty($data['status'])) {
                            $statuses .= Mage::helper('Magento_Usa_Helper_Data')->__($data['status']) . "\n<br/>";
                        } else {
    ...
    public function getContainerTypes(Magento_Object $params = null)
    {
        ...
        if (($countryShipper == self::USA_COUNTRY_ID && $countryRecipient == self::CANADA_COUNTRY_ID
            ...
            return array('YOUR_PACKAGING' => Mage::helper('Magento_Usa_Helper_Data')->__('Your Packaging'));
