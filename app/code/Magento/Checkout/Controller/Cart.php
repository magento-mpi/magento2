    ...
    implements \Magento\Catalog\Controller\Product\View\ViewInterface
{
    ...
    protected function _goBack()
    {
        ...
        } elseif (!$this->_storeConfig->getValue('checkout/cart/redirect_to_cart', \Magento\Store\Model\StoreManagerInterface::SCOPE_TYPE_STORE)
        ...
        if ($this->cart->getQuote()->getItemsCount()) {
            ...
            if (!$this->cart->getQuote()->validateMinimumAmount()) {
                ...
                $minimumAmount = $this->_objectManager->get('Magento\Locale\CurrencyInterface')
                    ...
                    ->toCurrency($this->_storeConfig->getValue('sales/minimum_order/amount', \Magento\Store\Model\StoreManagerInterface::SCOPE_TYPE_STORE));

                $warning = $this->_storeConfig->getValue('sales/minimum_order/description', \Magento\Store\Model\StoreManagerInterface::SCOPE_TYPE_STORE)
                    ? $this->_storeConfig->getValue('sales/minimum_order/description', \Magento\Store\Model\StoreManagerInterface::SCOPE_TYPE_STORE)
