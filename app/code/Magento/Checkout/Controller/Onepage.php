...
class Onepage extends Action
{
    ...
    public function indexAction()
    {
        ...
        if (!$quote->validateMinimumAmount()) {
            $error = $this->_objectManager->get('Magento\App\Config\ScopeConfigInterface')->getValue('sales/minimum_order/error_message', \Magento\Store\Model\StoreManagerInterface::SCOPE_TYPE_STORE) ?
                $this->_objectManager->get('Magento\App\Config\ScopeConfigInterface')->getValue('sales/minimum_order/error_message', \Magento\Store\Model\StoreManagerInterface::SCOPE_TYPE_STORE) :
