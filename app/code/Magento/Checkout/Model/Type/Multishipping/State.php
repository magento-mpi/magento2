    ...
    public function __construct()
    {
        ...
        $this->_steps = array(
            self::STEP_SELECT_ADDRESSES => new Magento_Object(array(
                'label' => Mage::helper('Magento_Checkout_Helper_Data')->__('Select Addresses')
            )),
            ...
            self::STEP_OVERVIEW => new Magento_Object(array(
                'label' => Mage::helper('Magento_Checkout_Helper_Data')->__('Place Order')
            )),
            self::STEP_SUCCESS => new Magento_Object(array(
                'label' => Mage::helper('Magento_Checkout_Helper_Data')->__('Order Success')
            )),
        );
