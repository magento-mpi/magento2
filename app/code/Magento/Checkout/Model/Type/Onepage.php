...
class Magento_Checkout_Model_Type_Onepage
{
    ...
    {
        if (empty($method)) {
            return array('error' => -1, 'message' => Mage::helper('Magento_Checkout_Helper_Data')->__('Invalid data'));
        }
            ...
            if ($customerAddress->getId()) {
                if ($customerAddress->getCustomerId() != $this->getQuote()->getCustomerId()) {
                    return array('error' => 1,
                        'message' => Mage::helper('Magento_Checkout_Helper_Data')->__('The customer address is not valid.')
                    );
                }
    ...
    public function saveShippingMethod($shippingMethod)
    {
        if (empty($shippingMethod)) {
            return array('error' => -1, 'message' => Mage::helper('Magento_Checkout_Helper_Data')->__('Invalid shipping method'));
        }
    ...
    public function validate()
    {
        ...
        if ($quote->getCheckoutMethod() == self::METHOD_GUEST
            ...
            Mage::throwException(Mage::helper('Magento_Checkout_Helper_Data')->__('Sorry, guest checkout is not enabled.'));
        }
    }
