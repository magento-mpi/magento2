...
$installer = $this;
/* @var $installer Magento_Checkout_Model_Resource_Setup */
...
$showPrefix = (bool)$installer->getCustomerAddress()->getConfig('prefix_show')
...
$select = $setup->select()
    ...
    ->where('value NOT LIKE ?', '0');
$showMiddlename = (bool)$installer->getCustomerAddress()->getConfig('middlename_show')
    || ($setup->fetchOne($select) > 0);
...
$select = $setup->select()
    ...
    ->where('value NOT LIKE ?', '0');
$showSuffix = (bool)$installer->getCustomerAddress()->getConfig('suffix_show')
    || ($setup->fetchOne($select) > 0);
...
$select = $setup->select()
    ...
    ->where('value NOT LIKE ?', '0');
$showDob = (bool)$installer->getCustomerAddress()->getConfig('dob_show')
    || ($setup->fetchOne($select) > 0);
...
$select = $setup->select()
    ...
    ->where('value NOT LIKE ?', '0');
$showTaxVat = (bool)$installer->getCustomerAddress()->getConfig('taxvat_show')
    || ($setup->fetchOne($select) > 0);
