...
class Magento_CatalogEvent_Block_Adminhtml_Event_Edit_Form extends Magento_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('general_fieldset',
            array(
                'legend' => Mage::helper('Magento_CatalogEvent_Helper_Data')->__('Catalog Event Information'),
                'class'  => 'fieldset-wide'
            )
        );
        ...
        $fieldset->addField('category_name', 'note',
            array(
                'id'    => 'category_span',
                'label' => Mage::helper('Magento_CatalogEvent_Helper_Data')->__('Category')
            )
        );
        ...
        $fieldset->addField('date_start', 'date', array(
                'label'        => Mage::helper('Magento_CatalogEvent_Helper_Data')->__('Start Date'),
                'name'         => 'date_start',
                'required'     => true,
        ...
        $fieldset->addField('date_end', 'date', array(
                'label'        => Mage::helper('Magento_CatalogEvent_Helper_Data')->__('End Date'),
        ...
        $fieldset->addField('image', 'image', array(
                'label' => Mage::helper('Magento_CatalogEvent_Helper_Data')->__('Image'),
                'scope' => 'store',
                'name'  => 'image'
             )
        );
        ...
        $fieldset->addField('sort_order', 'text', array(
                'label' => Mage::helper('Magento_CatalogEvent_Helper_Data')->__('Sort Order'),
                'name'  => 'sort_order',
        ...
        $statuses = array(
            Magento_CatalogEvent_Model_Event::STATUS_UPCOMING => Mage::helper('Magento_CatalogEvent_Helper_Data')->__('Upcoming'),
            Magento_CatalogEvent_Model_Event::STATUS_OPEN => Mage::helper('Magento_CatalogEvent_Helper_Data')->__('Open'),
            Magento_CatalogEvent_Model_Event::STATUS_CLOSED => Mage::helper('Magento_CatalogEvent_Helper_Data')->__('Closed')
        );

        $fieldset->addField('display_state_array', 'checkboxes', array(
                'label'  => Mage::helper('Magento_CatalogEvent_Helper_Data')->__('Display Countdown Ticker On'),
                'name'   => 'display_state[]',
                'values' => array(
                    Magento_CatalogEvent_Model_Event::DISPLAY_CATEGORY_PAGE => Mage::helper('Magento_CatalogEvent_Helper_Data')->__('Category Page'),
                    Magento_CatalogEvent_Model_Event::DISPLAY_PRODUCT_PAGE => Mage::helper('Magento_CatalogEvent_Helper_Data')->__('Product Page')
                )
            ));

        if ($this->getEvent()->getId()) {
            $fieldset->addField('status', 'note', array(
                    'label' => Mage::helper('Magento_CatalogEvent_Helper_Data')->__('Status'),
