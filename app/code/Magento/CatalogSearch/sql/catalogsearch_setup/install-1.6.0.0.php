...
$table = $installer->getConnection()
    ...
    ->addColumn('query_id', \Magento\DB\Ddl\Table::TYPE_INTEGER, null, array(
        'identity'  => true,
        'unsigned'  => true,
        'nullable'  => false,
        'primary'   => true,
        ), 'Query ID')
    ->addColumn('query_text', \Magento\DB\Ddl\Table::TYPE_TEXT, 255, array(
        ), 'Query text')
    ->addColumn('num_results', \Magento\DB\Ddl\Table::TYPE_INTEGER, null, array(
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => '0',
        ), 'Num results')
    ->addColumn('popularity', \Magento\DB\Ddl\Table::TYPE_INTEGER, null, array(
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => '0',
        ), 'Popularity')
    ->addColumn('redirect', \Magento\DB\Ddl\Table::TYPE_TEXT, 255, array(
        ), 'Redirect')
    ->addColumn('synonym_for', \Magento\DB\Ddl\Table::TYPE_TEXT, 255, array(
        ), 'Synonym for')
    ...
    ->addColumn('display_in_terms', \Magento\DB\Ddl\Table::TYPE_SMALLINT, null, array(
        'nullable'  => false,
        'default'   => '1',
        ), 'Display in terms')
    ...
    ->addColumn('is_processed', \Magento\DB\Ddl\Table::TYPE_SMALLINT, null, array(
        'default'   => '0',
        ), 'Processed status')
...
$table = $installer->getConnection()
    ...
    ->addColumn('relevance', \Magento\DB\Ddl\Table::TYPE_DECIMAL, '20,4', array(
        'nullable'  => false,
        'default'   => '0.0000'
        ), 'Relevance')
...
$table = $installer->getConnection()
    ...
    ->addColumn('fulltext_id', \Magento\DB\Ddl\Table::TYPE_INTEGER, null, array(
        'identity'  => true,
        'unsigned'  => true,
        'nullable'  => false,
        'primary'   => true,
    ...
    ->addColumn('data_index', \Magento\DB\Ddl\Table::TYPE_TEXT, '4g', array(
        ), 'Data index')
    ->addIndex(
