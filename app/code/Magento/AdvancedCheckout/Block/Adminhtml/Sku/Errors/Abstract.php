 ...
 *
 * @method Magento_AdvancedCheckout_Block_Adminhtml_Sku_Errors_Abstract setListType()
 ...
 */
abstract class Magento_AdvancedCheckout_Block_Adminhtml_Sku_Errors_Abstract extends Magento_Adminhtml_Block_Widget
{
    /*
     ...
     * Cart instance
     *
     * @var Magento_AdvancedCheckout_Model_Cart|null
     */
    protected $_cart;
