 ...
 */
class Magento_GiftCardAccount_Model_Resource_Giftcardaccount extends Magento_Core_Model_Resource_Db_Abstract
{
    /**
     ...
     * @param array $ids
     * @param int $state
     * @return Magento_GiftCardAccount_Model_Resource_Giftcardaccount
     */
