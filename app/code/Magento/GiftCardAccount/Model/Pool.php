        ...
        for ($i=0; $i<$size;$i++) {
            ...
            do {
                if ($attempt>=self::CODE_GENERATION_ATTEMPTS) {
                    Mage::throwException(Mage::helper('Magento_GiftCardAccount_Helper_Data')->__('We were unable to create full code pool size. Please check settings and try again.'));
                }
