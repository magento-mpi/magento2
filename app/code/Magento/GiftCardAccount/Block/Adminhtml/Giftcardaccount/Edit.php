...
class Magento_GiftCardAccount_Block_Adminhtml_Giftcardaccount_Edit extends Magento_Adminhtml_Block_Widget_Form_Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_updateButton('save', 'label', Mage::helper('Magento_GiftCardAccount_Helper_Data')->__('Save'));
        ...
        $this->_updateButton('delete', 'label', Mage::helper('Magento_GiftCardAccount_Helper_Data')->__('Delete'));
        ...
        $this->_addButton('send', array(
            'label'     => Mage::helper('Magento_GiftCardAccount_Helper_Data')->__('Save & Send Email'),
            'onclick'   => $clickSend,
            'class'     => 'save',
    ...
    public function getHeaderText()
    {
        if (Mage::registry('current_giftcardaccount')->getId()) {
            return Mage::helper('Magento_GiftCardAccount_Helper_Data')->__('Edit Gift Card Account: %s', $this->escapeHtml(Mage::registry('current_giftcardaccount')->getCode()));
        }
        else {
            return Mage::helper('Magento_GiftCardAccount_Helper_Data')->__('New Gift Card Account');
        }
    }
