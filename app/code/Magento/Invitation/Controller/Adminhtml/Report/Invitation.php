...
class Magento_Invitation_Controller_Adminhtml_Report_Invitation extends Magento_Adminhtml_Controller_Action
{
    ...
    public function _initAction()
    {
        $this->loadLayout()
            ...
            ->_addBreadcrumb(
                Mage::helper('Magento_Invitation_Helper_Data')->__('Invitations'),
                Mage::helper('Magento_Invitation_Helper_Data')->__('Invitations')
            );
        return $this;
    }
    ...
    public function indexAction()
    {
        ...
        $this->_initAction()
            ...
            ->_addBreadcrumb(Mage::helper('Magento_Invitation_Helper_Data')->__('General Report'),
            Mage::helper('Magento_Invitation_Helper_Data')->__('General Report'))
            ->renderLayout();
    }
    ...
    public function customerAction()
    {
        ...
        $this->_initAction()
            ...
            ->_addBreadcrumb(Mage::helper('Magento_Invitation_Helper_Data')->__('Invitation Report by Customers'),
            Mage::helper('Magento_Invitation_Helper_Data')->__('Invitation Report by Customers'))
            ->renderLayout();
    }
    ...
    public function orderAction()
    {
        ...
        $this->_initAction()->_setActiveMenu('Magento_Invitation::report_magento_invitation_order')
            ->_addBreadcrumb(Mage::helper('Magento_Invitation_Helper_Data')->__('Invitation Report by Customers'),
            Mage::helper('Magento_Invitation_Helper_Data')->__('Invitation Report by Order Conversion Rate'))
            ->renderLayout();
    }
