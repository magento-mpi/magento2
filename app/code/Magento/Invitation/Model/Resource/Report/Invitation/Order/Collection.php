 ...
 */
class Magento_Invitation_Model_Resource_Report_Invitation_Order_Collection
    extends Magento_Invitation_Model_Resource_Report_Invitation_Collection
{
    /**
     * Join custom fields
     *
     * @return Magento_Invitation_Model_Resource_Report_Invitation_Order_Collection
     */
    protected function _joinFields()
    {
        $acceptedExpr = 'SUM('
            . $this->getConnection()->getCheckSql(
                'main_table.status = '
                    . $this->getConnection()->quote(Magento_Invitation_Model_Invitation::STATUS_ACCEPTED)
