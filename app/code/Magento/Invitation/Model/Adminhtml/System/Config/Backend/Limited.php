    ...
    extends Magento_Core_Model_Config_Data
{
    ...
    protected function _beforeSave()
    {
        ...
        if ((int)$this->getValue() <= 0) {
            $parameter = Mage::helper('Magento_Invitation_Helper_Data')->__('Max Invitations Allowed to be Sent at One Time');
            ...
            Mage::getSingleton('Magento_Adminhtml_Model_Session')->addNotice(
                Mage::helper('Magento_Invitation_Helper_Data')->__('Please correct the value for "%s" parameter, otherwise we\'ll use the saved value instead.', $parameter)
            );
        }
        return $this;
    }
