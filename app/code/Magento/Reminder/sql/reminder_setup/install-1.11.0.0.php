...
$table = $installer->getConnection()
    ...
    ->addColumn('salesrule_id', \Magento\DB\Ddl\Table::TYPE_INTEGER, null, array(
        'unsigned'  => true,
        ), 'Salesrule Id')
    ->addColumn('schedule', \Magento\DB\Ddl\Table::TYPE_TEXT, 255, array(
        ), 'Schedule')
    ->addColumn('default_label', \Magento\DB\Ddl\Table::TYPE_TEXT, 255, array(
        ), 'Default Label')
    ->addColumn('default_description', \Magento\DB\Ddl\Table::TYPE_TEXT, '64k', array(
        ), 'Default Description')
    ->addColumn('active_from', \Magento\DB\Ddl\Table::TYPE_TIMESTAMP, null, array(
        ), 'Active From')
    ->addColumn('active_to', \Magento\DB\Ddl\Table::TYPE_TIMESTAMP, null, array(
        ), 'Active To')
...
$table = $installer->getConnection()
    ...
    ->addForeignKey(
        ...
        'template_id', $installer->getTable('email_template'),/* fix */ 'template_id',
        \Magento\DB\Ddl\Table::ACTION_SET_NULL, \Magento\DB\Ddl\Table::ACTION_CASCADE)
    ->addForeignKey(
...
$table = $installer->getConnection()
    ...
    ->addColumn('associated_at', \Magento\DB\Ddl\Table::TYPE_TIMESTAMP, null, array(
        'nullable'  => false,
        ), 'Associated At')
    ->addColumn('emails_failed', \Magento\DB\Ddl\Table::TYPE_SMALLINT, null, array(
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => '0',
        ), 'Emails Failed')
...
$table = $installer->getConnection()
    ...
    ->addColumn('sent_at', \Magento\DB\Ddl\Table::TYPE_TIMESTAMP, null, array(
        'nullable'  => false,
        ), 'Sent At')
