    ...
    extends Magento_Reminder_Model_Condition_Abstract
{
    ...
    public function getNewChildSelectOptions()
    {
        return array('value' => $this->getType(),
            'label' => Mage::helper('Magento_Reminder_Helper_Data')->__('Sharing'));
    }
    ...
    public function asHtml()
    {
        return $this->getTypeElementHtml()
            . Mage::helper('Magento_Reminder_Helper_Data')->__('Wish List %s shared', $this->getValueElementHtml())
    ...
    public function loadValueOptions()
    {
        $this->setValueOption(array(
            '1' => Mage::helper('Magento_Reminder_Helper_Data')->__('is'),
            '0' => Mage::helper('Magento_Reminder_Helper_Data')->__('is not'),
        ));
        return $this;
    }
