    ...
    extends Magento_Reminder_Model_Condition_Abstract
{
    ...
    public function getNewChildSelectOptions()
    {
        return array('value' => $this->getType(),
            'label' => Mage::helper('Magento_Reminder_Helper_Data')->__('Number of Items'));
    }
    ...
    public function asHtml()
    {
        return $this->getTypeElementHtml()
            . Mage::helper('Magento_Reminder_Helper_Data')->__('Number of wish list items %s %s ', $this->getOperatorElementHtml(), $this->getValueElementHtml())
