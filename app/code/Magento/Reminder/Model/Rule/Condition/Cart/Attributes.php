    ...
    extends Magento_Reminder_Model_Condition_Abstract
{
    ...
    public function getNewChildSelectOptions()
    {
        return array('value' => $this->getType(),
            'label' => Mage::helper('Magento_Reminder_Helper_Data')->__('Numeric Attribute'));
    }
    ...
    public function loadAttributeOptions()
    {
        $this->setAttributeOption(array(
            'weight' => Mage::helper('Magento_Reminder_Helper_Data')->__('weight'),
            'row_weight' => Mage::helper('Magento_Reminder_Helper_Data')->__('row weight'),
            'qty' => Mage::helper('Magento_Reminder_Helper_Data')->__('quantity'),
            'price' => Mage::helper('Magento_Reminder_Helper_Data')->__('base price'),
            'base_cost' => Mage::helper('Magento_Reminder_Helper_Data')->__('base cost')
        ));
        return $this;
    }
    ...
    public function asHtml()
    {
        return $this->getTypeElementHtml()
            . Mage::helper('Magento_Reminder_Helper_Data')->__('Item %s %s %s:', $this->getAttributeElementHtml(), $this->getOperatorElementHtml(), $this->getValueElementHtml())
    ...
    public function getConditionsSql($customer, $website)
    {
        ...
        switch ($this->getAttribute()) {
            ...
            default:
                Mage::throwException(
                    Mage::helper('Magento_Reminder_Helper_Data')->__('Unknown attribute specified')
                );
        }
