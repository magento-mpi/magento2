    ...
    extends Magento_Reminder_Model_Condition_Abstract
{
    ...
    public function getNewChildSelectOptions()
    {
        return array('value' => $this->getType(),
            'label' => Mage::helper('Magento_Reminder_Helper_Data')->__('Store View'));
    }
    ...
    public function asHtml()
    {
        return $this->getTypeElementHtml()
            . Mage::helper('Magento_Reminder_Helper_Data')->__('The item was added to shopping cart %s, store view %s.', $this->getOperatorElementHtml(), $this->getValueElementHtml())
