    ...
    extends Magento_Reminder_Model_Condition_Abstract
{
    ...
    public function getNewChildSelectOptions()
    {
        return array('value' => $this->getType(),
            'label' => Mage::helper('Magento_Reminder_Helper_Data')->__('Cart Line Items'));
    }
    ...
    public function asHtml()
    {
        return $this->getTypeElementHtml()
            . Mage::helper('Magento_Reminder_Helper_Data')->__('Number of shopping cart line items %s %s:', $this->getOperatorElementHtml(), $this->getValueElementHtml())
