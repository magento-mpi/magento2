    ...
    extends Magento_Reminder_Model_Condition_Combine_Abstract
{
    ...
    public function asHtml()
    {
        return $this->getTypeElementHtml()
            . Mage::helper('Magento_Reminder_Helper_Data')->__('Shopping cart is not empty and abandoned %s %s days and %s of these conditions match:', $this->getOperatorElementHtml(), $this->getValueElementHtml(), $this->getAggregatorElement()->getHtml())
    ...
    protected function _prepareConditionsSql($customer, $website)
    {
        ...
        if ($conditionValue < 0) {
            Mage::throwException(Mage::helper('Magento_Reminder_Helper_Data')->__('The root shopping cart condition should have a days value of 0 or greater.'));
        }
