...
class Magento_Reminder_Block_Adminhtml_Reminder extends Magento_Adminhtml_Block_Widget_Grid_Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_headerText = Mage::helper('Magento_Reminder_Helper_Data')->__('Automated Email Marketing Reminder Rules');
        $this->_addButtonLabel = Mage::helper('Magento_Reminder_Helper_Data')->__('Add New Rule');
        parent::_construct();
    }
}
