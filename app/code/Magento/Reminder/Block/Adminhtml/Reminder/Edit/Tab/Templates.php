...
class Templates extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset(
            ...
            array(
                ...
                'comment' => __(
                    'Only customers who registered on a store view will receive emails related to that store view.'
                )
            )
        );
        ...
        $fieldset->addField(
            'default_label',
            'text',
            array('name' => 'default_label', 'required' => false, 'label' => __('Rule Title for All Store Views'))
        );
        ...
        $fieldset = $form->addFieldset(
            ...
            array(
                ...
                'comment' => __(
                    'Overrides default titles and descriptions. Note that if email an template is not specified for this store view, the respective variable values will be deleted.'
                ),
                'class' => 'tree-store-scope'
            )
        );
    ...
    public function getTemplatesOptionsArray()
    {
        ...
        array_unshift($options, array('value' => '', 'label' => __('-- Not Selected --')));
        return $options;
    }
}
