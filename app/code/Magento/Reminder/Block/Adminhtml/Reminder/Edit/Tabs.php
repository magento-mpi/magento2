    ...
    extends Magento_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('general_section', array(
            'label'   => Mage::helper('Magento_Reminder_Helper_Data')->__('Rule Information'),
        ...
        $this->addTab('conditions_section', array(
            'label'   => Mage::helper('Magento_Reminder_Helper_Data')->__('Conditions'),
            'content' => $this->getLayout()->createBlock(
        ...
        $this->addTab('template_section', array(
            'label'   => Mage::helper('Magento_Reminder_Helper_Data')->__('Emails and Labels'),
            'content' => $this->getLayout()->createBlock(
        ...
        if ($rule && $rule->getId()) {
            $this->addTab('matched_customers', array(
                'label' => Mage::helper('Magento_Reminder_Helper_Data')->__('Matched Customers'),
