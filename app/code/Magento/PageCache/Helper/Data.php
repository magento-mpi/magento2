...
class Data extends \Magento\App\Helper\AbstractHelper
{
     ...
     */
    public function __construct(\Magento\Theme\Model\Layout\Config $config, \Magento\App\View $view)
    {
        $this->view = $view;
        $this->config = $config;
    }
    ...
    public function getActualHandles()
    {
        ...
        $resultHandles = array_merge(array('default'), array_values($appliedHandles));
