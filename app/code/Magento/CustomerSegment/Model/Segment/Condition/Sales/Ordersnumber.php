    ...
    extends Magento_CustomerSegment_Model_Segment_Condition_Sales_Combine
{
    ...
    public function asHtml()
    {
        return $this->getTypeElementHtml()
            . Mage::helper('Magento_CustomerSegment_Helper_Data')->__('Number of Orders %s %s while %s of these Conditions match:', $this->getOperatorElementHtml(), $this->getValueElementHtml(), $this->getAggregatorElement()->getHtml())
