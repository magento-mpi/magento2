    ...
    extends Magento_CustomerSegment_Model_Condition_Abstract
{
    ...
    public function getNewChildSelectOptions()
    {
        return array(
            'value' => $this->getType(),
            'label' => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('Order Status')
        );
    }
    ...
    public function loadValueOptions()
    {
        $this->setValueOption(array_merge(
            array(self::VALUE_ANY => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('Any')),
    ...
    public function asHtml()
    {
        return $this->getTypeElementHtml()
            . Mage::helper('Magento_CustomerSegment_Helper_Data')->__('Order Status %s %s:', $this->getOperatorElementHtml(), $this->getValueElementHtml())
