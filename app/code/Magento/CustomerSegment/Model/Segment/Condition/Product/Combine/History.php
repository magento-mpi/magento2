    ...
    extends Magento_CustomerSegment_Model_Condition_Combine_Abstract
{
    ...
    public function loadValueOptions()
    {
        $this->setValueOption(array(
            self::VIEWED  => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('viewed'),
            self::ORDERED => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('ordered'),
        ));
        return $this;
    }
    ...
    public function loadOperatorOptions()
    {
        ...
        $this->setOperatorOption(array(
            '=='  => Mage::helper('Magento_Rule_Helper_Data')->__('was'),
            '!='  => Mage::helper('Magento_Rule_Helper_Data')->__('was not')
        ));
        return $this;
    }
    ...
    public function asHtml()
    {
        return $this->getTypeElementHtml()
            . Mage::helper('Magento_CustomerSegment_Helper_Data')->__('If Product %s %s and matches %s of these Conditions:', $this->getOperatorElementHtml(), $this->getValueElementHtml(), $this->getAggregatorElement()->getHtml())
