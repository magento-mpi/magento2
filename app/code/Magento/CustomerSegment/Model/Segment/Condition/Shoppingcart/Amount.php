    ...
    extends Magento_CustomerSegment_Model_Condition_Abstract
{
    ...
    public function getNewChildSelectOptions()
    {
        return array('value' => $this->getType(),
            'label' => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('Shopping Cart Total'),
    ...
    public function loadAttributeOptions()
    {
        $this->setAttributeOption(array(
            'subtotal'  => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('Subtotal'),
            'grand_total'  => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('Grand Total'),
            'tax'  => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('Tax'),
            'shipping'  => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('Shipping'),
            'store_credit'  => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('Store Credit'),
            'gift_card'  => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('Gift Card'),
        ));
        return $this;
    }
    ...
    public function asHtml()
    {
        return $this->getTypeElementHtml()
            . Mage::helper('Magento_CustomerSegment_Helper_Data')->__('Shopping Cart %s Amount %s %s:', $this->getAttributeElementHtml(), $this->getOperatorElementHtml(), $this->getValueElementHtml())
    ...
    public function getConditionsSql($customer, $website)
    {
        ...
        switch ($this->getAttribute()) {
            ...
            default:
                Mage::throwException(
                    Mage::helper('Magento_CustomerSegment_Helper_Data')->__('Unknown quote total specified.')
                );
        }
