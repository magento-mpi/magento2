    ...
    extends Magento_CustomerSegment_Model_Condition_Abstract
{
    ...
    public function getNewChildSelectOptions()
    {
        return array(array(
            'value' => $this->getType(),
            'label' => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('Newsletter Subscription')
         ));
    }
    ...
    public function asHtml()
    {
        ...
        return $this->getTypeElementHtml()
            . Mage::helper('Magento_CustomerSegment_Helper_Data')->__('Customer is %s to newsletter.', $element)
    ...
    public function loadValueOptions()
    {
        $this->setValueOption(array(
            '1'  => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('subscribed'),
            '0' => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('not subscribed'),
        ));
        return $this;
    }
