...
class Magento_CustomerSegment_Model_Segment_Condition_Segment extends Magento_Rule_Model_Condition_Abstract
{
    ...
    public function asHtml()
    {
        ...
        return $this->getTypeElementHtml()
            . Mage::helper('Magento_CustomerSegment_Helper_Data')->__('If Customer Segment %s %s', $this->getOperatorElementHtml(), $this->_valueElement->getHtml())
    ...
    public function loadOperatorOptions()
    {
        ...
        $this->setOperatorOption(array(
            '=='  => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('matches'),
            '!='  => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('does not match'),
            '()'  => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('is one of'),
            '!()' => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('is not one of'),
        ));
        return $this;
    }
