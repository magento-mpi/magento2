...
class Magento_CustomerSegment_Controller_Adminhtml_Customersegment extends Magento_Adminhtml_Controller_Action
{
    ...
    protected function _initSegment($requestParam = 'id', $requireValidId = false)
    {
        ...
        if ($segmentId || $requireValidId) {
            ...
            if (!$segment->getId()) {
                Mage::throwException($this->__('You requested the wrong customer segment.'));
            }
        }
    ...
    public function matchAction()
    {
        try {
            ...
            $this->_getSession()->addException($e,
                Mage::helper('Magento_CustomerSegment_Helper_Data')->__('Segment Customers matching error')
            );
            $this->_redirect('*/*/');
            return;
        }
    ...
    protected function _initAction()
    {
        $this->loadLayout()
            ...
            ->_addBreadcrumb(
                Mage::helper('Magento_CustomerSegment_Helper_Data')->__('Segments'),
                Mage::helper('Magento_CustomerSegment_Helper_Data')->__('Segments')
            );
        return $this;
    }
    ...
    public function saveAction()
    {
        ...
        if ($data) {
            try {
                ...
                Mage::getSingleton('Magento_Adminhtml_Model_Session')->addSuccess($this->__('You saved the segment.'));
                ...
                Mage::getSingleton('Magento_Adminhtml_Model_Session')->addError($this->__("We're unable to save the segment."));
                Mage::logException($e);
            }
        }
        $this->_redirect('*/*/');
    ...
    public function deleteAction()
    {
        try {
            ...
            Mage::getSingleton('Magento_Adminhtml_Model_Session')->addError($this->__("We're unable to delete the segement."));
            Mage::logException($e);
        }
        $this->_redirect('*/*/');
    }
