    ...
    extends Magento_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('grid_name', array(
            'header'    => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('Name'),
            'index'     => 'name',
            'header_css_class'  => 'col-name',
            'column_css_class'  => 'col-name'
        ));
        $this->addColumn('grid_email', array(
            'header'    => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('Email'),
            'index'     => 'email',
        ...
        $this->addColumn('grid_group', array(
            'header'    =>  Mage::helper('Magento_CustomerSegment_Helper_Data')->__('Group'),
            'index'     =>  'group_id',
            'type'      =>  'options',
            'options'   =>  $groups,
        ...
        $this->addColumn('grid_telephone', array(
            'header'    => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('Phone'),
        ...
        $this->addColumn('grid_billing_postcode', array(
            'header'    => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('ZIP'),
        ...
        $this->addColumn('grid_billing_country_id', array(
            'header'    => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('Country'),
            'type'      => 'country',
        ...
        $this->addColumn('grid_billing_region', array(
            'header'    => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('State/Province'),
        ...
        $this->addColumn('grid_customer_since', array(
            'header'    => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('Customer Since'),
            'type'      => 'datetime',
            'index'     => 'created_at',
            'gmtoffset' => true,
