    ...
    extends Magento_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('segment_id', array(
            'header'    => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('ID'),
            'index'     => 'segment_id',
        ...
        $this->addColumn('name', array(
            'header'    => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('Segment'),
            'index'     => 'name',
        ...
        $this->addColumn('is_active', array(
            'header'    => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('Status'),
            'index'     => 'is_active',
            'type'      => 'options',
            'options'   => array(
                1 => 'Active',
        ...
        if (!Mage::app()->isSingleStoreMode()) {
            $this->addColumn('website', array(
                'header'    => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('Website'),
                'index'     => 'website_ids',
                'type'      => 'options',
        ...
        $this->addColumn('customer_count', array(
            'header'    => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('Customers'),
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('view', array(
            'label' => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('View Combined Report'),
            ...
            'additional' => array(
                'visibility' => array(
                     ...
                     'label'    => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('Set'),
