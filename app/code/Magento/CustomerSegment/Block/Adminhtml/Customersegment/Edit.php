...
class Magento_CustomerSegment_Block_Adminhtml_Customersegment_Edit extends Magento_Adminhtml_Block_Widget_Form_Container
{
    ...
    protected function _construct()
    {
        ...
        if ($segment && $segment->getId()) {
            $this->_addButton('match_customers', array(
                'label'     => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('Refresh Segment Data'),
        ...
        $this->_addButton('save_and_continue_edit', array(
            'class'   => 'save',
            'label'   => Mage::helper('Magento_CustomerSegment_Helper_Data')->__('Save and Continue Edit'),
    ...
    public function getHeaderText()
    {
        ...
        if ($segment->getSegmentId()) {
            return Mage::helper('Magento_CustomerSegment_Helper_Data')->__("Edit Segment '%s'", $this->escapeHtml($segment->getName()));
        }
        else {
            return Mage::helper('Magento_CustomerSegment_Helper_Data')->__('New Segment');
        }
    }
}
