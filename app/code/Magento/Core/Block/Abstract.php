    ...
    implements Magento_Core_Block
{
     ...
     * Cache group Tag
     */
    const CACHE_GROUP = Magento_Core_Model_Cache_Type_Block::TYPE_IDENTIFIER;
    /**
     ...
     *
     * @var Magento_Core_Block_Messages
     */
     ...
     *
     * @return Magento_Core_Block_Abstract|bool
     */
     ...
     */
    public function setLayout(Magento_Core_Model_Layout $layout)
    {
        $this->_layout = $layout;
     ...
     *
     * @param   string $alias
     * @param   Magento_Core_Block_Abstract|string $block
     * @return  Magento_Core_Block_Abstract
     */
     ...
     * @param string $block
     * @param array $data
     * @return Magento_Core_Block_Abstract new block
     */
     ...
     *
     * @param Magento_Core_Block_Abstract|string $element
    ...
    public function insert($element, $siblingName = 0, $after = true, $alias = '')
    {
        ...
        if ($element instanceof Magento_Core_Block_Abstract) {
     ...
     * @return  Magento_Core_Block_Abstract
     */
    public function setMessagesBlock(Magento_Core_Block_Messages $block)
    {
    ...
    {
        $args = func_get_args();
        $expr = new Magento_Core_Model_Translate_Expr(array_shift($args), $this->getModuleName());
