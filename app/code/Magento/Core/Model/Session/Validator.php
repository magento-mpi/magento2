...
class Validator implements ValidatorInterface
{
    ...
    protected function _validate()
    {
        ...
        if ($this->_storeConfig->getValue(self::XML_PATH_USE_REMOTE_ADDR, \Magento\Store\Model\StoreManagerInterface::SCOPE_TYPE_STORE)
        ...
        if ($this->_storeConfig->getValue(self::XML_PATH_USE_X_FORWARDED, \Magento\Store\Model\StoreManagerInterface::SCOPE_TYPE_STORE)
            && $httpXForwardedKey != $validatorXForwarded ) {
            return false;
        }
        if ($this->_storeConfig->getValue(self::XML_PATH_USE_USER_AGENT, \Magento\Store\Model\StoreManagerInterface::SCOPE_TYPE_STORE)
