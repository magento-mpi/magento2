...
class Emulation extends \Magento\Object
{
     ...
     */
    protected function _emulateDesign($storeId, $area = \Magento\App\Area::AREA_FRONTEND)
    {
        ...
        if ($area == \Magento\App\Area::AREA_FRONTEND) {
     ...
     */
    protected function _emulateLocale($storeId, $area = \Magento\App\Area::AREA_FRONTEND)
    {
    ...
    protected function _restoreInitialLocale(
        $initialLocaleCode,
        $initialArea = \Magento\App\Area::AREA_ADMIN
    ) {
