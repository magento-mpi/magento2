...
class Magento_Core_Model_Config_Loader_Proxy implements Magento_Core_Model_Config_LoaderInterface
{
    /**
     ...
     * Get loader instance
     *
     * @return Magento_Core_Model_Config_Loader
     */
    protected function _getLoader()
    {
        if (null === $this->_loader) {
            $this->_loader = $this->_objectManager->get('Magento_Core_Model_Config_Loader');
        }
        return $this->_loader;
    }
