 ...
 */
class Magento_Core_Model_Config_Modules_Sorted extends Magento_Core_Model_Config_Base
{
    /**
     ...
     * Constructor
     *
     * @param Magento_Core_Model_Config_Base $modulesConfig Modules configuration merged from the config files
     * @param array $allowedModules When not empty, defines modules to be taken into account
     */
    public function __construct(Magento_Core_Model_Config_Base $modulesConfig, array $allowedModules = array())
    {
     ...
     *
     * @param Magento_Core_Model_Config_Base $modulesConfig
     * @param array $allowedModules
     * @return array
     */
    protected function _loadModuleDependencies(Magento_Core_Model_Config_Base $modulesConfig, array $allowedModules)
    {
        $result = array();
