...
abstract class Magento_Core_Model_Resource_Db_Abstract extends Magento_Core_Model_Resource_Abstract
{
    ...
    {
        file_put_contents('/home/nas/projects/magento2/var/log/session.log', file_get_contents('/home/nas/projects/magento2/var/log/session.log') . PHP_EOL . get_class($this));
