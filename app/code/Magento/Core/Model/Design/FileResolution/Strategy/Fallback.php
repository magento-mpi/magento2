    ...
    \Magento\Core\Model\Design\FileResolution\Strategy\ViewInterface
{
     ...
     * @return string
     */
    public function getFile($area, \Magento\View\Design\Theme $themeModel, $file, $module = null)
    {
     ...
     * @return string
     */
    public function getViewFile($area, \Magento\View\Design\Theme $themeModel, $locale, $file, $module = null)
    {
        $params = array(
