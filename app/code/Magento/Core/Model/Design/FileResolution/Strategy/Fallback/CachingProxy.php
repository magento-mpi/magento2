    ...
    \Magento\Core\Model\Design\FileResolution\Strategy\View\NotifiableInterface
{
     ...
     * @return null|string
     */
    protected function _getFromMap($fileType, $area, \Magento\View\Design\Theme $theme, $locale, $module, $file)
    {
     ...
     * @return string
     */
    protected function _getSectionFile($area, \Magento\View\Design\Theme $themeModel, $locale)
    {
     ...
     * @return string
     */
    protected function _loadSection($area, \Magento\View\Design\Theme $themeModel, $locale)
    {
