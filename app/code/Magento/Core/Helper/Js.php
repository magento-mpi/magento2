...
class Magento_Core_Helper_Js extends Magento_Core_Helper_Abstract
{
     ...
     */
    private function _initTranslateData()
    {
        ...
        $this->_translateData = array(
            ...
            'Please enter a valid day (1-%d).' => __('Please enter a valid day (1-%d).'),
            'Please enter a valid month (1-12).' => __('Please enter a valid month (1-12).'),
            'Please enter a valid year (1900-%d).' => __('Please enter a valid year (1900-%d).'),
            ...
            'Add Products to Option "%s"' => __('Add Products to Option "%s"'),
            ...
            'Maximum length of this field must be equal or less than %s symbols.' => __('Maximum length of this field must be equal or less than %s symbols.'),
