...
class Data
{
    ...
    public function isCleanupProbability()
    {
        ...
        $configValue = (int) $this->_storeConfig->getValue(self::XML_PATH_CLEANUP_PROBABILITY, \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    ...
    {
        $minutes = (int) $this->_storeConfig->getValue(self::XML_PATH_CLEANUP_EXPIRATION_PERIOD, \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    ...
    {
        $seconds = (int)$this->_storeConfig->getValue(self::XML_PATH_CONSUMER_EXPIRATION_PERIOD, \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    ...
    {
        $redirects = (int)$this->_storeConfig->getValue(self::XML_PATH_CONSUMER_POST_MAXREDIRECTS, \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    ...
    {
        $seconds = (int)$this->_storeConfig->getValue(self::XML_PATH_CONSUMER_POST_TIMEOUT, \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
