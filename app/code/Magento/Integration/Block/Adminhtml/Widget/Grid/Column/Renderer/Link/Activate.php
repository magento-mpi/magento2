...
class Activate extends Link
{
    ...
    {
        return ($this->_row->getStatus() == Integration::STATUS_INACTIVE) ? '*/*/activate' : '*/*/reauthorize';
    }
    ...
    {
        return ($this->_row->getStatus() == Integration::STATUS_INACTIVE) ? __('Activate') : __('Re-Authorize');
    }
