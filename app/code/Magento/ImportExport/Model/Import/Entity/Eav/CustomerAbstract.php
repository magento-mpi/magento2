    ...
    extends Magento_ImportExport_Model_Import_Entity_EavAbstract
{
    ...
    public function __construct(array $data = array())
    {
        ...
        $this->addMessageTemplate(self::ERROR_WEBSITE_IS_EMPTY,
            $this->_helper('Magento_ImportExport_Helper_Data')->__('Website is not specified')
        );
        $this->addMessageTemplate(self::ERROR_EMAIL_IS_EMPTY,
            $this->_helper('Magento_ImportExport_Helper_Data')->__('E-mail is not specified')
        );
        $this->addMessageTemplate(self::ERROR_INVALID_WEBSITE,
            $this->_helper('Magento_ImportExport_Helper_Data')->__("Invalid value in website column")
        );
        $this->addMessageTemplate(self::ERROR_INVALID_EMAIL,
            $this->_helper('Magento_ImportExport_Helper_Data')->__('E-mail is invalid')
        );
        $this->addMessageTemplate(self::ERROR_VALUE_IS_REQUIRED,
            $this->_helper('Magento_ImportExport_Helper_Data')->__("Required attribute '%s' has an empty value")
        );
