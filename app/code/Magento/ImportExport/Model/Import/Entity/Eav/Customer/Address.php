    ...
    extends Magento_ImportExport_Model_Import_Entity_Eav_CustomerAbstract
{
    ...
    public function __construct(array $data = array())
    {
        ...
        $this->addMessageTemplate(self::ERROR_ADDRESS_NOT_FOUND,
            $this->_helper('Magento_ImportExport_Helper_Data')->__("Customer address for such customer doesn't exist")
        );
        $this->addMessageTemplate(self::ERROR_INVALID_REGION,
            $this->_helper('Magento_ImportExport_Helper_Data')->__('Region is invalid')
        );
