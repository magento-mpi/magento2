...
class Magento_ImportExport_Model_Import_Entity_Product_Option extends Magento_ImportExport_Model_Import_Entity_Abstract
{
    ...
    protected function _initMessageTemplates()
    {
        ...
        $this->_productEntity->addMessageTemplate(self::ERROR_INVALID_STORE,
            $this->_helper('Magento_ImportExport_Helper_Data')->__('Invalid custom option store.')
        );
        $this->_productEntity->addMessageTemplate(self::ERROR_INVALID_TYPE,
            $this->_helper('Magento_ImportExport_Helper_Data')->__('Invalid custom option type.')
        );
        $this->_productEntity->addMessageTemplate(self::ERROR_EMPTY_TITLE,
            $this->_helper('Magento_ImportExport_Helper_Data')->__('Empty custom option title.')
        );
        $this->_productEntity->addMessageTemplate(self::ERROR_INVALID_PRICE,
            $this->_helper('Magento_ImportExport_Helper_Data')->__('Invalid custom option price.')
        );
        $this->_productEntity->addMessageTemplate(self::ERROR_INVALID_MAX_CHARACTERS,
            $this->_helper('Magento_ImportExport_Helper_Data')->__('Invalid custom option maximum characters value.')
        );
        $this->_productEntity->addMessageTemplate(self::ERROR_INVALID_SORT_ORDER,
            $this->_helper('Magento_ImportExport_Helper_Data')->__('Invalid custom option sort order.')
        );
        $this->_productEntity->addMessageTemplate(self::ERROR_INVALID_ROW_PRICE,
            $this->_helper('Magento_ImportExport_Helper_Data')->__('Invalid custom option value price.')
        );
