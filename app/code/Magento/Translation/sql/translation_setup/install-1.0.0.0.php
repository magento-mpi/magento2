...
$table = $installer->getConnection()
    ...
    ->addColumn('crc_string', \Magento\DB\Ddl\Table::TYPE_BIGINT, null, array(
        'nullable' => false,
        'default'  => crc32(\Magento\TranslateInterface::DEFAULT_STRING)
        ), 'Translation String CRC32 Hash')
    ->addIndex($installer->getIdxName('translation', array('store_id', 'locale', 'crc_string', 'string'),
        \Magento\DB\Adapter\AdapterInterface::INDEX_TYPE_UNIQUE),
        array('store_id', 'locale', 'crc_string', 'string'),
        array('type' => \Magento\DB\Adapter\AdapterInterface::INDEX_TYPE_UNIQUE))
    ->addIndex($installer->getIdxName('translation', array('store_id')),
        array('store_id'))
    ->addForeignKey($installer->getFkName('translation', 'store_id', 'core_store', 'store_id'),
