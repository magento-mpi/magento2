    ...
    implements Magento_Adminhtml_Block_Widget_Tab_Interface
{
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset(
            'base_fieldset',
            array('legend'=>Mage::helper('Magento_Index_Helper_Data')->__('General'), 'class'=>'fieldset-wide')
        );

        $fieldset->addField('process_id', 'hidden', array('name' => 'process', 'value'=>$model->getId()));

        $fieldset->addField('name', 'note', array(
            'label' => Mage::helper('Magento_Index_Helper_Data')->__('Index Name'),
            'title' => Mage::helper('Magento_Index_Helper_Data')->__('Index Name'),
            'text'  => '<strong>'.$model->getIndexer()->getName().'</strong>'
        ));

        $fieldset->addField('description', 'note', array(
            'label' => Mage::helper('Magento_Index_Helper_Data')->__('Index Description'),
            'title' => Mage::helper('Magento_Index_Helper_Data')->__('Index Description'),
        ...
        $fieldset->addField('mode', 'select', array(
            ...
            'title' => Mage::helper('Magento_Index_Helper_Data')->__('Index Mode'),
            'name'  => 'mode',
            'value' => $model->getMode(),
    ...
    {
        return Mage::helper('Magento_Index_Helper_Data')->__('Process Information');
    }
