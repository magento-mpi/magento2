...
*/
        ...
        $this->addColumn('owner', array(
            'header' => Mage::helper('Magento_VersionsCms_Helper_Data')->__('Owner'),
            'index' => 'username',
            'type' => 'options',
        ...
        $this->addColumn('revisions', array(
            'header' => Mage::helper('Magento_VersionsCms_Helper_Data')->__('Quantity'),
    ...
    {
        return Mage::helper('Magento_VersionsCms_Helper_Data')->__('Versions');
    }
