...
class Magento_VersionsCms_Block_Adminhtml_Cms_Page_Version_Edit_Form extends Magento_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('version_fieldset',
            array('legend' => Mage::helper('Magento_VersionsCms_Helper_Data')->__('Version Information'),
            'class' => 'fieldset-wide'));
        ...
        $fieldset->addField('label', 'text', array(
            'name'      => 'label',
            'label'     => Mage::helper('Magento_VersionsCms_Helper_Data')->__('Version Label'),
            'disabled'  => !$isOwner,
            'required'  => true
        ));

        $fieldset->addField('access_level', 'select', array(
            'label'     => Mage::helper('Magento_VersionsCms_Helper_Data')->__('Access Level'),
            'title'     => Mage::helper('Magento_VersionsCms_Helper_Data')->__('Access Level'),
            'name'      => 'access_level',
        ...
        if ($isPublisher) {
            $fieldset->addField('user_id', 'select', array(
                'label'     => Mage::helper('Magento_VersionsCms_Helper_Data')->__('Owner'),
                'title'     => Mage::helper('Magento_VersionsCms_Helper_Data')->__('Owner'),
                'name'      => 'user_id',
