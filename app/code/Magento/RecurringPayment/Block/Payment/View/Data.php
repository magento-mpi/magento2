        ...
        $this->addData(
            [
                ...
                'cancel_url' => $this->getUrl(
                    '*/*/updateState',
                    ['payment' => $this->_recurringPayment->getId(), 'action' => 'cancel']
                ),
                'can_suspend' => $this->_recurringPayment->canSuspend(),
                'suspend_url' => $this->getUrl(
                    '*/*/updateState',
                    ['payment' => $this->_recurringPayment->getId(), 'action' => 'suspend']
                ),
                'can_activate' => $this->_recurringPayment->canActivate(),
                'activate_url' => $this->getUrl(
                    '*/*/updateState',
                    ['payment' => $this->_recurringPayment->getId(), 'action' => 'activate']
                ),
