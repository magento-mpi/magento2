...
$table = $this->getConnection()
    ->newTable($this->getTable('recurring_payment'))
    ...
    ->addColumn('payment_vendor_info', \Magento\DB\Ddl\Table::TYPE_TEXT, '64k', array(
    ), 'Payment Vendor Info')
    ...
    ->addIndex($this->getIdxName('recurring_payment', array('customer_id')),
        array('customer_id'))
    ->addIndex($this->getIdxName('recurring_payment', array('store_id')),
        array('store_id'))
