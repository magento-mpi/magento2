 ...
 */
namespace Magento\CatalogImportExport\Model\ImportExport\Import;
...
class Product extends \Magento\ImportExport\Model\Import\Entity\AbstractEntity
{
     ...
     * @var string[]
     */
    protected $_imagesArrayKeys = array('_media_image', 'image', 'small_image', 'thumbnail');
     ...
     *
     * @var \Magento\CatalogImportExport\Model\ImportExport\Import\Uploader
     */
     ...
     *
     * @var \Magento\CatalogImportExport\Model\ImportExport\Import\Product\Option
     */
    ...
    /**
     * @var \Magento\CatalogImportExport\Model\ImportExport\Import\Proxy\Product\ResourceFactory
     */
    ...
    /**
     * @var \Magento\CatalogImportExport\Model\ImportExport\Import\Product\Type\Factory
     */
    ...
    /**
     * @var \Magento\CatalogImportExport\Model\ImportExport\Import\Proxy\ProductFactory
     */
    protected $_proxyProdFactory;

    /**
     * @var \Magento\CatalogImportExport\Model\ImportExport\Import\UploaderFactory
     */
     ...
     * @param \Magento\CatalogImportExport\Model\ImportExport\Import\Proxy\Product\ResourceFactory $resourceFactory
     * @param \Magento\CatalogImportExport\Model\ImportExport\Import\Product\OptionFactory $optionFactory
     ...
     * @param \Magento\CatalogImportExport\Model\ImportExport\Import\Product\Type\Factory $productTypeFactory
     * @param \Magento\Catalog\Model\Resource\Product\LinkFactory $linkFactory
     * @param \Magento\CatalogImportExport\Model\ImportExport\Import\Proxy\ProductFactory $proxyProdFactory
     * @param \Magento\CatalogImportExport\Model\ImportExport\Import\UploaderFactory $uploaderFactory
    ...
    public function __construct(
        ...
        \Magento\CatalogImportExport\Model\ImportExport\Import\Proxy\Product\ResourceFactory $resourceFactory,
        \Magento\CatalogImportExport\Model\ImportExport\Import\Product\OptionFactory $optionFactory,
        ...
        \Magento\CatalogImportExport\Model\ImportExport\Import\Product\Type\Factory $productTypeFactory,
        \Magento\Catalog\Model\Resource\Product\LinkFactory $linkFactory,
        \Magento\CatalogImportExport\Model\ImportExport\Import\Proxy\ProductFactory $proxyProdFactory,
        \Magento\CatalogImportExport\Model\ImportExport\Import\UploaderFactory $uploaderFactory,
     ...
     *
     * @return \Magento\CatalogImportExport\Model\ImportExport\Import\Product\Option
     */
    ...
    protected function _initTypeModels()
    {
        ...
        foreach ($productTypes as $productTypeName => $productTypeConfig) {
            ...
            if (!$model instanceof \Magento\CatalogImportExport\Model\ImportExport\Import\Product\Type\AbstractType) {
                throw new \Magento\Framework\Model\Exception(
                    __(
    ...
    protected function _saveProductEntity(array $entityRowsIn, array $entityRowsUp)
    {
        ...
        if ($entityRowsUp) {
            $this->_connection->insertOnDuplicate($entityTable, $entityRowsUp, array('updated_at'));
        }
        if ($entityRowsIn) {
    ...
    {
        /** @var $resource \Magento\CatalogImportExport\Model\ImportExport\Import\Proxy\Product\Resource */
     ...
     *
     * @return \Magento\CatalogImportExport\Model\ImportExport\Import\Uploader
     * @throws \Magento\Framework\Model\Exception
     */
        ...
        foreach ($mediaGalleryData as $productSku => $mediaGalleryRows) {
            ...
            foreach ($mediaGalleryRows as $insertValue) {
                ...
                if (!in_array($insertValue['value'], $insertedGalleryImgs)) {
                    ...
                    $this->_connection->insertOnDuplicate($mediaGalleryTableName, $valueArr, array('entity_id'));
                ...
                try {
                    $this->_connection->insertOnDuplicate($mediaValueTableName, $valueArr, array('value_id'));
                } catch (\Exception $e) {
                    $this->_connection->delete(
                        $mediaGalleryTableName,
