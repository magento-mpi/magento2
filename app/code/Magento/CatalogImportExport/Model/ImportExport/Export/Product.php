...
class Product extends \Magento\ImportExport\Model\Export\Entity\AbstractEntity
{
    ...
    /**
     * @var \Magento\CatalogImportExport\Model\ImportExport\Export\Product\Type\Factory
     */
    ...
    /**
     * @var \Magento\CatalogImportExport\Model\ImportExport\Export\RowCustomizerInterface
     */
     ...
     * @param \Magento\CatalogImportExport\Model\ImportExport\Export\RowCustomizerInterface $rowCustomizer
     */
    public function __construct(
        ...
        \Magento\CatalogImportExport\Model\ImportExport\Export\Product\Type\Factory $_typeFactory,
        \Magento\Catalog\Model\Product\LinkTypeProvider $linkTypeProvider,
        \Magento\CatalogImportExport\Model\ImportExport\Export\RowCustomizerInterface $rowCustomizer
    ) {
    ...
    protected function _initTypeModels()
    {
        ...
        foreach ($productTypes as $productTypeName => $productTypeConfig) {
            ...
            if (!$model instanceof \Magento\CatalogImportExport\Model\ImportExport\Export\Product\Type\AbstractType) {
