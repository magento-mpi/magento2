...
$installer->addAttribute(\Magento\Catalog\Model\Product::ENTITY, 'msrp_enabled', array(
    ...
    'input_renderer'   => 'Magento\Catalog\Block\Adminhtml\Catalog\Product\Helper\Form\Msrp\Enabled',
...
$installer->addAttribute(\Magento\Catalog\Model\Product::ENTITY, 'msrp_display_actual_price_type', array(
    ...
    'default'       => '',
    'apply_to'      => $productTypes,
    'input_renderer'   => 'Magento\Catalog\Block\Adminhtml\Catalog\Product\Helper\Form\Msrp\Price',
    'visible_on_front' => false,
    'used_in_product_listing' => true
));
