...
class SelectAttributeMetadataBuilder extends AttributeMetadataBuilder
{
    ...
    {
        return $this->_set(SelectAttributeMetadata::IS_FILTERABLE, (bool)$isFilterable);
    }
    ...
    {
        return $this->_set(SelectAttributeMetadata::IS_FILTERABLE_IN_SEARCH, (bool)$isFilterableInSearch);
    }
    ...
    {
        return $this->_set(SelectAttributeMetadata::POSITION, (int)$position);
    }
    ...
    {
        return $this->_set(SelectAttributeMetadata::USED_FOR_SORT_BY, (bool)$usedForSortBy);
    }
}
