...
class Magento_Catalog_Block_Product_Compare_List extends Magento_Catalog_Block_Product_Compare_Abstract
{
    ...
    protected function _prepareLayout()
    {
        ...
        if ($headBlock) {
            $headBlock->setTitle(Mage::helper('Magento_Catalog_Helper_Data')->__('Products Comparison List') . ' - ' . $headBlock->getDefaultTitle());
        }
    ...
    public function getProductAttributeValue($product, $attribute)
    {
        if (!$product->hasData($attribute->getAttributeCode())) {
            return Mage::helper('Magento_Catalog_Helper_Data')->__('N/A');
        }
        ...
        return ((string)$value == '') ? Mage::helper('Magento_Catalog_Helper_Data')->__('No') : $value;
    }
