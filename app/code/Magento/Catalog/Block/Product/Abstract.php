 ...
 */
abstract class Magento_Catalog_Block_Product_Abstract extends Magento_Core_Block_Template
{
     ...
     * @var string
     */
    protected $_block = 'Magento_Catalog_Block_Product_Price';
     ...
     * @return string
     */
    public function getReviewsSummaryHtml(Magento_Catalog_Model_Product $product, $templateType = false,
     ...
     */
    protected function _addProductAttributesAndPrices(Magento_Catalog_Model_Resource_Product_Collection $collection)
    {
        return $collection
            ->addMinimalPrice()
            ->addFinalPrice()
     ...
     *
     * @return Magento_Catalog_Block_Product_Abstract
     */
    protected function _prepareLayout()
    {
        parent::_prepareLayout();

        /* @var $block Magento_Catalog_Block_Product_Price_Template */
