...
class Attributes extends \Magento\Backend\Block\Widget\Form\Generic
{
     ...
     *
     * @return \Magento\Catalog\Block\Adminhtml\Catalog\Category\Tab\Attributes
     */
            ...
            if ($attribute->getAttributeCode() == 'url_key') {
                if ($this->getCategory()->getLevel() == 1) {
                    ...
                    $form->getElement('url_key')->setRenderer(
                        $this->getLayout()
                            ->createBlock('Magento\Catalog\Block\Adminhtml\Catalog\Form\Renderer\Attribute\Urlkey')
                    );
                }
            }
        }
    ...
    {
        return array(
            'image' => 'Magento\Catalog\Block\Adminhtml\Catalog\Category\Helper\Image',
