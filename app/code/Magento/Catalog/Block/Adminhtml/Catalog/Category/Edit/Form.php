 ...
 */
namespace Magento\Catalog\Block\Adminhtml\Catalog\Category\Edit;

class Form extends \Magento\Catalog\Block\Adminhtml\Catalog\Category\AbstractCategory
{
    /**
    ...
    protected function _prepareLayout()
    {
        ...
        $this->setChild('tabs',
            $this->getLayout()->createBlock('Magento\Catalog\Block\Adminhtml\Catalog\Category\Tabs', 'tabs')
        );
...
//        $params = array('section'=>'catalog');
     ...
     * @param string $alias
     * @param array $config
     * @return \Magento\Catalog\Block\Adminhtml\Catalog\Category\Edit\Form
     */
