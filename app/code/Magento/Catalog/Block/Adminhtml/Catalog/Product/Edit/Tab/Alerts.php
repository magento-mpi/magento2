    ...
    protected function _prepareLayout()
    {
        ...
        if ($alertPriceAllow) {
            $accordion->addItem('price', array(
                ...
                'content'   => $this->getLayout()
                    ->createBlock('Magento\Catalog\Block\Adminhtml\Catalog\Product\Edit\Tab\Alerts\Price')
                    ->toHtml() . '<br />',
                'open'      => true
            ));
        }
        if ($alertStockAllow) {
            $accordion->addItem('stock', array(
                ...
                'content'   => $this->getLayout()
                    ->createBlock('Magento\Catalog\Block\Adminhtml\Catalog\Product\Edit\Tab\Alerts\Stock'),
                'open'      => true
            ));
        }
