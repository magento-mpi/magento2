 ...
 */
namespace Magento\Catalog\Block\Adminhtml\Catalog\Product\Attribute\Set;
...
class Main extends \Magento\Backend\Block\Template
{
     ...
     *
     * @return \Magento\Catalog\Block\Adminhtml\Catalog\Product\Attribute\Set\Main
     */
    protected function _prepareLayout()
    {
        $setId = $this->_getSetId();

        $this->addChild('group_tree', 'Magento\Catalog\Block\Adminhtml\Catalog\Product\Attribute\Set\Main\Tree\Group');

        $this->addChild('edit_set_form', 'Magento\Catalog\Block\Adminhtml\Catalog\Product\Attribute\Set\Main\Formset');
