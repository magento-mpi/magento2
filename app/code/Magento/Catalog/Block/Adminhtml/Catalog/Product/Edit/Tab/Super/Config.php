    ...
    implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
     ...
     * Prepare Layout data
     *
     * @return \Magento\Catalog\Block\Adminhtml\Catalog\Product\Edit\Tab\Super\Config
     */
    protected function _prepareLayout()
    {
        ...
        $this->addChild('super_settings', 'Magento\Catalog\Block\Adminhtml\Catalog\Product\Edit\Tab\Super\Settings');

// @todo: Remove unused code and blocks
//        if ($this->getProduct()->getId()) {
//            $this->setChild('simple',
//                $this->getLayout()->createBlock('Magento\Catalog\Block\Adminhtml\Catalog\Product\Edit\Tab\Super\Config\Simple',
