 ...
 */
namespace Magento\Catalog\Block\Adminhtml\Catalog\Product\Options;
...
class Ajax extends \Magento\Backend\Block\AbstractBlock
{
    ...
    {
        $results = array();
        /** @var $optionsBlock \Magento\Catalog\Block\Adminhtml\Catalog\Product\Edit\Tab\Options\Option */
        $optionsBlock = $this->getLayout()
            ->createBlock('Magento\Catalog\Block\Adminhtml\Catalog\Product\Edit\Tab\Options\Option')
