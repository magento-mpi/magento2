 ...
 */
namespace Magento\Catalog\Block\Adminhtml\Catalog\Product\Edit\Tab;

class Attributes extends \Magento\Catalog\Block\Adminhtml\Catalog\Form
{
    /**
     * Catalog data
     *
    ...
    protected function _prepareForm()
    {
        ...
        if ($group) {
            ...
            if ($urlKey) {
                $urlKey->setRenderer(
                    $this->getLayout()->createBlock('Magento\Catalog\Block\Adminhtml\Catalog\Form\Renderer\Attribute\Urlkey')
                );
            }
            ...
            if ($tierPrice) {
                $tierPrice->setRenderer(
                    $this->getLayout()->createBlock('Magento\Catalog\Block\Adminhtml\Catalog\Product\Edit\Tab\Price\Tier')
                );
            }
            ...
            if ($groupPrice) {
                $groupPrice->setRenderer(
                    $this->getLayout()->createBlock('Magento\Catalog\Block\Adminhtml\Catalog\Product\Edit\Tab\Price\Group')
                );
            }
            ...
            if ($recurringProfile) {
                $recurringProfile->setRenderer(
                    $this->getLayout()->createBlock('Magento\Catalog\Block\Adminhtml\Catalog\Product\Edit\Tab\Price\Recurring')
                );
            }
            ...
            if (!$form->getElement('media_gallery')
                ...
                $attributeCreate = $this->getLayout()
                    ->createBlock('Magento\Catalog\Block\Adminhtml\Catalog\Product\Edit\Tab\Attributes\Create');
                ...
                $attributeSearch = $this->getLayout()
                    ->createBlock('Magento\Catalog\Block\Adminhtml\Catalog\Product\Edit\Tab\Attributes\Search')
                    ->setGroupId($group->getId())
    ...
    {
        $result = array(
            'price'    => 'Magento\Catalog\Block\Adminhtml\Catalog\Product\Helper\Form\Price',
            'weight'   => 'Magento\Catalog\Block\Adminhtml\Catalog\Product\Helper\Form\Weight',
            'gallery'  => 'Magento\Catalog\Block\Adminhtml\Catalog\Product\Helper\Form\Gallery',
            'image'    => 'Magento\Catalog\Block\Adminhtml\Catalog\Product\Helper\Form\Image',
            'boolean'  => 'Magento\Catalog\Block\Adminhtml\Catalog\Product\Helper\Form\Boolean',
            'textarea' => 'Magento\Catalog\Block\Adminhtml\Catalog\Helper\Form\Wysiwyg',
        );
