...
class Tabs extends \Magento\Backend\Block\Widget\Tabs
{
    ...
    /** @var string */
    protected $_attributeTabBlock = 'Magento\Catalog\Block\Adminhtml\Catalog\Product\Edit\Tab\Attributes';
        ...
        if ($setId) {
            ...
            if (!$this->_storeManager->isSingleStoreMode()) {
                $this->addTab('websites', array(
                    ...
                    'content'   => $this->_translateHtml($this->getLayout()
                        ->createBlock('Magento\Catalog\Block\Adminhtml\Catalog\Product\Edit\Tab\Websites')->toHtml()),
            ...
            if ($this->_coreData->isModuleEnabled('Magento_CatalogInventory')) {
                $this->addTab('advanced-inventory', array(
                    ...
                    'content'   => $this->_translateHtml($this->getLayout()
                        ->createBlock('Magento\Catalog\Block\Adminhtml\Catalog\Product\Edit\Tab\Inventory')->toHtml()),
             ...
             * @see \Magento\Catalog\Block\Adminhtml\Catalog\Product\Edit\Tabs\Configurable
            ...
            if (($alertPriceAllow || $alertStockAllow) && !$product->isGrouped()) {
                $this->addTab('product-alerts', array(
                    ...
                    'content'   => $this->_translateHtml($this->getLayout()
                        ->createBlock('Magento\Catalog\Block\Adminhtml\Catalog\Product\Edit\Tab\Alerts', 'admin.alerts.products')
                        ->toHtml()
                    ),
                    'group_code' => self::ADVANCED_TAB_GROUP_CODE,
                ));
