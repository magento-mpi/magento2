...
class Inventory extends \Magento\Backend\Block\Widget
{
    ...
    public function getFieldValue($field)
    {
        ...
        return $this->_storeConfig->getValue(\Magento\CatalogInventory\Model\Stock\Item::XML_PATH_ITEM . $field, \Magento\Core\Model\StoreManagerInterface::SCOPE_TYPE_STORE);
    }
