 ...
 */
abstract class Magento_Catalog_Model_Product_Attribute_Backend_Groupprice_Abstract
    extends Magento_Catalog_Model_Product_Attribute_Backend_Price
{
    ...
    public function preparePriceData(array $priceData, $productTypeId, $websiteId)
    {
        $rates  = $this->_getWebsiteCurrencyRates();
        $data   = array();
        $price  = Mage::getSingleton('Magento_Catalog_Model_Product_Type')->priceFactory($productTypeId);
     ...
     *
     * @param Magento_Catalog_Model_Product $object
     * @return Magento_Catalog_Model_Product_Attribute_Backend_Groupprice_Abstract
     */
