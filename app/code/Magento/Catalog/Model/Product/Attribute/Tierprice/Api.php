        ...
        try {
            ...
            if (is_array($errors = $product->validate())) {
                ...
                foreach($errors as $code=>$error) {
                    $strErrors[] = ($error === true)? Mage::helper('Magento_Catalog_Helper_Data')->__('Please correct the value for "%s".', $code) : Mage::helper('Magento_Catalog_Helper_Data')->__('Please correct the value for "%s": %s.', $code, $error);
                }
