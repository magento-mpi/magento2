...
class Magento_Catalog_Model_Product_Visibility extends Magento_Object
{
    ...
    {
        return array(
            self::VISIBILITY_NOT_VISIBLE=> Mage::helper('Magento_Catalog_Helper_Data')->__('Not Visible Individually'),
            self::VISIBILITY_IN_CATALOG => Mage::helper('Magento_Catalog_Helper_Data')->__('Catalog'),
            self::VISIBILITY_IN_SEARCH  => Mage::helper('Magento_Catalog_Helper_Data')->__('Search'),
            self::VISIBILITY_BOTH       => Mage::helper('Magento_Catalog_Helper_Data')->__('Catalog, Search')
        );
    }
