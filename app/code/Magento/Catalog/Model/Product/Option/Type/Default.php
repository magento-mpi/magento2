...
class Magento_Catalog_Model_Product_Option_Type_Default extends Magento_Object
{
    ...
    public function getOption()
    {
        ...
        Mage::throwException(Mage::helper('Magento_Catalog_Helper_Data')->__('The option instance type in options group is incorrect.'));
    }
    ...
    public function getProduct()
    {
        ...
        Mage::throwException(Mage::helper('Magento_Catalog_Helper_Data')->__('The product instance type in options group is incorrect.'));
    }
    ...
    public function getConfigurationItemOption()
    {
        ...
        Mage::throwException(Mage::helper('Magento_Catalog_Helper_Data')->__('The configuration item option instance in options group is incorrect.'));
    }
    ...
    public function getConfigurationItem()
    {
        ...
        Mage::throwException(Mage::helper('Magento_Catalog_Helper_Data')->__('The configuration item instance in options group is incorrect.'));
    }
    ...
    public function getRequest()
    {
        ...
        Mage::throwException(Mage::helper('Magento_Catalog_Helper_Data')->__('The BuyRequest instance in options group is incorrect.'));
    }
    ...
    public function prepareForCart()
    {
        ...
        Mage::throwException(Mage::helper('Magento_Catalog_Helper_Data')->__('We couldn\'t add the product to the cart because of an option validation issue.'));
    }
