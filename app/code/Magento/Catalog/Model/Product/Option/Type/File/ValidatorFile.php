...
class ValidatorFile extends Validator
{
    ...
    public function validate($processingParams, $option)
    {
        ...
        if ($upload->isUploaded($file) && $upload->isValid($file)) {
            ...
            $tmpDirectory = $this->filesystem->getDirectoryRead(\Magento\Framework\App\Filesystem::SYS_TMP_DIR);
            ...
            $uri = $this->filesystem->getUri(\Magento\Framework\App\Filesystem::MEDIA_DIR);
            $userValue = array(
                'type' => $fileInfo['type'],
                'title' => $fileInfo['name'],
