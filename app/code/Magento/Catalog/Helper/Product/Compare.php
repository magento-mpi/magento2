...
class Compare extends \Magento\Core\Helper\Url
{
    ...
    public function getListUrl()
    {
        ...
        $params = array(
            ...
            \Magento\Core\App\Action\Plugin\LastUrl::PARAM_NAME_URL_ENCODED => $this->getEncodedUrl()
        );
    ...
    public function getAddToWishlistUrl($product)
    {
        ...
        $params = array(
            'product'=>$product->getId(),
            \Magento\Core\App\Action\Plugin\LastUrl::PARAM_NAME_URL_ENCODED => $this->getEncodedUrl($beforeCompareUrl)
        );
