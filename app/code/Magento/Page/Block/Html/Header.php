...
class Magento_Page_Block_Html_Header extends Magento_Core_Block_Template
{
    ...
    /**
     * @param Magento_Core_Model_Config_Primary $primary
    ...
    public function __construct(
        Magento_Core_Model_Config_Primary $primary,
    ...
    public function getWelcome()
    {
        if (empty($this->_data['welcome'])) {
            if ($this->_primary->getInstallDate() && $this->_customerSession->isLoggedIn()) {
