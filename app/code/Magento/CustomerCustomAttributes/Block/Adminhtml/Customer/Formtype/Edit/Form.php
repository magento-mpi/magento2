    ...
    protected function _prepareForm()
    {
        ...
        if ($showNew) {
            ...
            array_unshift($options, array(
                'label' => Mage::helper('Magento_CustomerCustomAttributes_Helper_Data')->__('-- Please Select --'),
                'value' => ''
            ));
            $fieldset->addField('type_id', 'select', array(
                'name'      => 'type_id',
                'label'     => Mage::helper('Magento_CustomerCustomAttributes_Helper_Data')->__('Based On'),
                'title'     => Mage::helper('Magento_CustomerCustomAttributes_Helper_Data')->__('Based On'),
                'required'  => true,
                'values'    => $options
            ));
            ...
            $fieldset->addField('label', 'text', array(
                'name'      => 'label',
                'label'     => Mage::helper('Magento_CustomerCustomAttributes_Helper_Data')->__('Form Label'),
                'title'     => Mage::helper('Magento_CustomerCustomAttributes_Helper_Data')->__('Form Label'),
                'required'  => true,
            ));
