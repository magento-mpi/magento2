 ...
 */
class Magento_CustomerCustomAttributes_Block_Adminhtml_Customer_Attribute_Edit
    extends Magento_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if ($this->_getAttribute()->getId()) {
            ...
            return Mage::helper('Magento_CustomerCustomAttributes_Helper_Data')->__('Edit Customer Attribute "%s"', $label);
        } else {
            return Mage::helper('Magento_CustomerCustomAttributes_Helper_Data')->__('New Customer Attribute');
        }
    }
