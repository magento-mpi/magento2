...
class Magento_Adminhtml_Controller_System_Email_Template extends Magento_Adminhtml_Controller_Action
{
    public function indexAction()
    {
        ...
        $this->_addBreadcrumb(Mage::helper('Magento_Adminhtml_Helper_Data')->__('Transactional Emails'), Mage::helper('Magento_Adminhtml_Helper_Data')->__('Transactional Emails'));
        $this->renderLayout();
    }
    ...
    public function editAction()
    {
        ...
        $this->_setActiveMenu('Magento_Adminhtml::system_email_template');
        $this->_addBreadcrumb(Mage::helper('Magento_Adminhtml_Helper_Data')->__('Transactional Emails'), Mage::helper('Magento_Adminhtml_Helper_Data')->__('Transactional Emails'), $this->getUrl('*/*'));

        if ($this->getRequest()->getParam('id')) {
            $this->_addBreadcrumb(Mage::helper('Magento_Adminhtml_Helper_Data')->__('Edit Template'), Mage::helper('Magento_Adminhtml_Helper_Data')->__('Edit System Template'));
        } else {
            $this->_addBreadcrumb(Mage::helper('Magento_Adminhtml_Helper_Data')->__('New Template'), Mage::helper('Magento_Adminhtml_Helper_Data')->__('New System Template'));
        }
    ...
    public function saveAction()
    {
        ...
        if (!$template->getId() && $id) {
            Mage::getSingleton('Magento_Adminhtml_Model_Session')->addError(Mage::helper('Magento_Adminhtml_Helper_Data')->__('This email template no longer exists.'));
            $this->_redirect('*/*/');
            return;
        }
...
*/
            ...
            Mage::getSingleton('Magento_Adminhtml_Model_Session')->addSuccess(Mage::helper('Magento_Adminhtml_Helper_Data')->__('The email template has been saved.'));
            $this->_redirect('*/*');
        }
        catch (Exception $e) {
    ...
    public function deleteAction() {
        ...
        if($template->getId()) {
            try {
                ...
                Mage::getSingleton('Magento_Adminhtml_Model_Session')->addSuccess(Mage::helper('Magento_Adminhtml_Helper_Data')->__('The email template has been deleted.'));
                // go to grid
                $this->_redirect('*/*/');
                return;
            }
                ...
                $this->_getSession()->addError(Mage::helper('Magento_Adminhtml_Helper_Data')->__('An error occurred while deleting email template data. Please review log and try again.'));
                Mage::logException($e);
        ...
        Mage::getSingleton('Magento_Adminhtml_Model_Session')->addError(Mage::helper('Magento_Adminhtml_Helper_Data')->__('We can\'t find an email template to delete.'));
        // go to grid
        $this->_redirect('*/*/');
    }
