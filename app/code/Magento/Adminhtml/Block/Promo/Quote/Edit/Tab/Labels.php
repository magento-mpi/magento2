    ...
    implements Magento_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    {
        return Mage::helper('Magento_SalesRule_Helper_Data')->__('Labels');
    }
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('default_label_fieldset', array(
            'legend' => Mage::helper('Magento_SalesRule_Helper_Data')->__('Default Label')
        ));
        ...
        $fieldset->addField('store_default_label', 'text', array(
            'name'      => 'store_labels[0]',
            'required'  => false,
            'label'     => Mage::helper('Magento_SalesRule_Helper_Data')->__('Default Rule Label for All Store Views'),
