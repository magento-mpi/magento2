    ...
    extends Magento_Adminhtml_Block_Catalog_Product_Edit_Tab_Price_Group_Abstract
{
    ...
    {
        return array(Magento_Customer_Model_Group::CUST_GROUP_ALL => Mage::helper('Magento_Catalog_Helper_Data')->__('ALL GROUPS'));
    }
    ...
    protected function _prepareLayout()
    {
        $button = $this->getLayout()->createBlock('Magento_Adminhtml_Block_Widget_Button')
            ->setData(array(
                'label' => Mage::helper('Magento_Catalog_Helper_Data')->__('Add Tier'),
