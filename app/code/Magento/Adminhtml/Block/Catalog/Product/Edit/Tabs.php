        ...
        if ($setId) {
            ...
            if (!$product->isGrouped()) {
                $this->addTab('customer_options', array(
                    ...
                    'url'   => $this->getUrl('adminhtml/*/options', array('_current' => true)),
                    'class' => 'ajax',
                    'group_code' => self::ADVANCED_TAB_GROUP_CODE,
                ));
            }
            ...
            $this->addTab('related', array(
                ...
                'url'       => $this->getUrl('adminhtml/*/related', array('_current' => true)),
                'class'     => 'ajax',
                'group_code' => self::ADVANCED_TAB_GROUP_CODE,
            ));
            ...
            $this->addTab('upsell', array(
                'label'     => __('Up-sells'),
                'url'       => $this->getUrl('adminhtml/*/upsell', array('_current' => true)),
                'class'     => 'ajax',
                'group_code' => self::ADVANCED_TAB_GROUP_CODE,
            ));
            ...
            $this->addTab('crosssell', array(
                ...
                'url'       => $this->getUrl('adminhtml/*/crosssell', array('_current' => true)),
                'class'     => 'ajax',
                'group_code' => self::ADVANCED_TAB_GROUP_CODE,
            ));
                ...
                if ($this->_catalogData->isModuleEnabled('Magento_Review')) {
                    if ($this->_authorization->isAllowed('Magento_Review::reviews_all')){
                        $this->addTab('product-reviews', array(
                            ...
                            'url'   => $this->getUrl('adminhtml/*/reviews', array('_current' => true)),
                            'class' => 'ajax',
                            'group_code' => self::ADVANCED_TAB_GROUP_CODE,
                        ));
                    }
