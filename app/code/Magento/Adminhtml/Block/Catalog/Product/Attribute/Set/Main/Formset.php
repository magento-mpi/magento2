...
class Magento_Adminhtml_Block_Catalog_Product_Attribute_Set_Main_Formset extends Magento_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('set_name', array('legend'=> Mage::helper('Magento_Catalog_Helper_Data')->__('Edit Set Name')));
        $fieldset->addField('attribute_set_name', 'text', array(
            'label' => Mage::helper('Magento_Catalog_Helper_Data')->__('Name'),
            'note' => Mage::helper('Magento_Catalog_Helper_Data')->__('For internal use'),
        ...
        if( !$this->getRequest()->getParam('id', false) ) {
            ...
            $fieldset->addField('skeleton_set', 'select', array(
                'label' => Mage::helper('Magento_Catalog_Helper_Data')->__('Based On'),
                'name' => 'skeleton_set',
                'required' => true,
