...
class Main extends \Magento\Backend\Block\Template
{
    ...
    protected function _prepareLayout()
    {
        ...
        $this->addChild('delete_button', 'Magento\Adminhtml\Block\Widget\Button', array(
            ...
            'onclick'   => 'deleteConfirm(\''. $this->escapeJsQuote(__('You are about to delete all products in this set. Are you sure you want to delete this attribute set?')) . '\', \'' . $this->getUrl('*/*/delete', array('id' => $setId)) . '\')',
            'class'     => 'delete'
        ));
