...
class Magento_Adminhtml_Block_System_Variable_Edit_Form extends Magento_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('base', array(
            'legend'=>Mage::helper('Magento_Adminhtml_Helper_Data')->__('Variable'),
            'class'=>'fieldset-wide'
        ));

        $fieldset->addField('code', 'text', array(
            'name'     => 'code',
            'label'    => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Variable Code'),
            'title'    => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Variable Code'),
            'required' => true,
        ...
        $fieldset->addField('name', 'text', array(
            'name'     => 'name',
            'label'    => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Variable Name'),
            'title'    => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Variable Name'),
            'required' => true
        ));
        ...
        if ($this->getVariable()->getId() && $this->getVariable()->getStoreId()) {
            ...
            $fieldset->addField('use_default_value', 'select', array(
                ...
                'label'  => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Use Default Variable Values'),
                'title'  => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Use Default Variable Values'),
        ...
        $fieldset->addField('html_value', 'textarea', array(
            'name'     => 'html_value',
            'label'    => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Variable HTML Value'),
            'title'    => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Variable HTML Value'),
            'disabled' => $useDefault
        ));

        $fieldset->addField('plain_value', 'textarea', array(
            'name'     => 'plain_value',
            'label'    => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Variable Plain Value'),
            'title'    => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Variable Plain Value'),
            'disabled' => $useDefault
        ));
