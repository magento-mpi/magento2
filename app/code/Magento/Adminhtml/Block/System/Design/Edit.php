...
class Magento_Adminhtml_Block_System_Design_Edit extends Magento_Adminhtml_Block_Widget
{
    ...
    protected function _prepareLayout()
    {
        ...
        $this->addChild('save_button', 'Magento_Adminhtml_Block_Widget_Button', array(
            'label'     => Mage::helper('Magento_Core_Helper_Data')->__('Save'),
            'class' => 'save',
        ...
        $this->addChild('delete_button', 'Magento_Adminhtml_Block_Widget_Button', array(
            'label'     => Mage::helper('Magento_Core_Helper_Data')->__('Delete'),
            'onclick'   => 'confirmSetLocation(\''.Mage::helper('Magento_Core_Helper_Data')->__('Are you sure?').'\', \''.$this->getDeleteUrl().'\')',
            'class'  => 'delete'
        ));
    ...
    public function getHeader()
    {
        ...
        if (Mage::registry('design')->getId()) {
            $header = Mage::helper('Magento_Core_Helper_Data')->__('Edit Design Change');
        } else {
            $header = Mage::helper('Magento_Core_Helper_Data')->__('New Store Design Change');
        }
        return $header;
    }
}
