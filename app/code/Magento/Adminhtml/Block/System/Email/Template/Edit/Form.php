...
class Magento_Adminhtml_Block_System_Email_Template_Edit_Form extends Magento_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('base_fieldset', array(
            'legend' => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Template Information'),
            'class' => 'fieldset-wide'
        ));
        ...
        if ($templateId) {
            $fieldset->addField('used_currently_for', 'label', array(
                'label' => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Used Currently For'),
        ...
        if (!$templateId) {
            $fieldset->addField('used_default_for', 'label', array(
                'label' => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Used as Default For'),
        ...
        $fieldset->addField('template_code', 'text', array(
            'name'=>'template_code',
            'label' => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Template Name'),
            'required' => true
        ...
        $fieldset->addField('template_subject', 'text', array(
            ...
            'label' => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Template Subject'),
            'required' => true
        ));
        ...
        $insertVariableButton = $this->getLayout()
            ->createBlock('Magento_Adminhtml_Block_Widget_Button', '', array('data' => array(
                'type' => 'button',
                'label' => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Insert Variable...'),
        ...
        $fieldset->addField('template_text', 'textarea', array(
            'name'=>'template_text',
            'label' => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Template Content'),
            'title' => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Template Content'),
            'required' => true,
            'style' => 'height:24em;',
        ));
        ...
        if (!$this->getEmailTemplate()->isPlain()) {
            $fieldset->addField('template_styles', 'textarea', array(
                ...
                'label' => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Template Styles'),
