...
class Magento_Adminhtml_Block_System_Email_Template_Edit extends Magento_Adminhtml_Block_Widget
{
    ...
    protected function _prepareLayout()
    {
        ...
        $this->setChild('delete_button',
            $this->getLayout()->createBlock('Magento_Adminhtml_Block_Widget_Button')
                ->setData(
                    array(
                        'label'   => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Delete Template'),
        ...
        $this->setChild('to_plain_button',
            $this->getLayout()->createBlock('Magento_Adminhtml_Block_Widget_Button')
                ->setData(
                    array(
                        'label'   => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Convert to Plain Text'),
        ...
        $this->setChild('to_html_button',
            $this->getLayout()->createBlock('Magento_Adminhtml_Block_Widget_Button')
                ->setData(
                    array(
                        'label'   => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Return Html Version'),
        ...
        $this->setChild('toggle_button',
            $this->getLayout()->createBlock('Magento_Adminhtml_Block_Widget_Button')
                ->setData(
                    array(
                        'label'   => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Toggle Editor'),
        ...
        $this->setChild('preview_button',
            $this->getLayout()->createBlock('Magento_Adminhtml_Block_Widget_Button')
                ->setData(
                    array(
                        'label'   => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Preview Template'),
        ...
        $this->setChild('save_button',
            $this->getLayout()->createBlock('Magento_Adminhtml_Block_Widget_Button')
                ->setData(
                    array(
                        'label'   => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Save Template'),
        ...
        $this->setChild('load_button',
            $this->getLayout()->createBlock('Magento_Adminhtml_Block_Widget_Button')
                ->setData(
                    array(
                        'label'   => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Load Template'),
    ...
    {
        if($this->getEditMode()) {
          return Mage::helper('Magento_Adminhtml_Helper_Data')->__('Edit Email Template');
        }

        return  Mage::helper('Magento_Adminhtml_Helper_Data')->__('New Email Template');
    }
