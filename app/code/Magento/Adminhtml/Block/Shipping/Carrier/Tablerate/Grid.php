...
class Magento_Adminhtml_Block_Shipping_Carrier_Tablerate_Grid extends Magento_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        $this->addColumn('dest_country', array(
            'header'    => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Country'),
            'index'     => 'dest_country',
            'default'   => '*',
        ));

        $this->addColumn('dest_region', array(
            'header'    => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Region/State'),
            'index'     => 'dest_region',
            'default'   => '*',
        ));

        $this->addColumn('dest_zip', array(
            'header'    => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Zip/Postal Code'),
            'index'     => 'dest_zip',
            'default'   => '*',
        ));
        ...
        $this->addColumn('price', array(
            'header'    => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Shipping Price'),
            'index'     => 'price',
        ));
