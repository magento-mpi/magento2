...
class Packaging extends \Magento\Adminhtml\Block\Template
{
    ...
    public function getConfigDataJson()
    {
        ...
        if ($shipmentId) {
            ...
            $createLabelUrl = $this->getUrl('*/order_shipment/createLabel', $urlParams);
            $itemsGridUrl = $this->getUrl('*/order_shipment/getShippingItemsGrid', $urlParams);
            ...
            $createLabelUrl = $this->getUrl('*/order_shipment/save', $urlParams);
            $itemsGridUrl = $this->getUrl('*/order_shipment/getShippingItemsGrid', $urlParams);
    ...
    public function getPrintButton()
    {
        ...
        $url = $this->getUrl('*/order_shipment/printPackage', $data);
