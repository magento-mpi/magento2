...
class Magento_Adminhtml_Block_Report_Sales_Sales_Grid extends Magento_Adminhtml_Block_Report_Grid_Abstract
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('total_qty_ordered', array(
            'header'    => Mage::helper('Magento_Sales_Helper_Data')->__('Sales Items'),
        ...
        $this->addColumn('total_qty_invoiced', array(
            'header'    => Mage::helper('Magento_Sales_Helper_Data')->__('Items'),
        ...
        $this->addColumn('total_income_amount', array(
            'header'        => Mage::helper('Magento_Sales_Helper_Data')->__('Sales Total'),
            'type'          => 'currency',
        ...
        $this->addColumn('total_revenue_amount', array(
            'header'            => Mage::helper('Magento_Sales_Helper_Data')->__('Revenue'),
            'type'              => 'currency',
            'currency_code'     => $currencyCode,
        ...
        $this->addColumn('total_profit_amount', array(
            'header'            => Mage::helper('Magento_Sales_Helper_Data')->__('Profit'),
            'type'              => 'currency',
            'currency_code'     => $currencyCode,
        ...
        $this->addColumn('total_invoiced_amount', array(
            'header'        => Mage::helper('Magento_Sales_Helper_Data')->__('Invoiced'),
            'type'          => 'currency',
            'currency_code' => $currencyCode,
        ...
        $this->addColumn('total_paid_amount', array(
            'header'            => Mage::helper('Magento_Sales_Helper_Data')->__('Paid'),
            'type'              => 'currency',
            'currency_code'     => $currencyCode,
        ...
        $this->addColumn('total_refunded_amount', array(
            'header'        => Mage::helper('Magento_Sales_Helper_Data')->__('Refunded'),
            'type'          => 'currency',
            'currency_code' => $currencyCode,
        ...
        $this->addColumn('total_tax_amount', array(
            'header'        => Mage::helper('Magento_Sales_Helper_Data')->__('Sales Tax'),
            'type'          => 'currency',
            'currency_code' => $currencyCode,
        ...
        $this->addColumn('total_shipping_amount', array(
            'header'        => Mage::helper('Magento_Sales_Helper_Data')->__('Sales Shipping'),
            'type'          => 'currency',
            'currency_code' => $currencyCode,
        ...
        $this->addColumn('total_shipping_amount_actual', array(
            'header'            => Mage::helper('Magento_Sales_Helper_Data')->__('Shipping'),
            'type'              => 'currency',
            'currency_code'     => $currencyCode,
        ...
        $this->addColumn('total_discount_amount', array(
            'header'        => Mage::helper('Magento_Sales_Helper_Data')->__('Sales Discount'),
            'type'          => 'currency',
            'currency_code' => $currencyCode,
        ...
        $this->addColumn('total_discount_amount_actual', array(
            'header'            => Mage::helper('Magento_Sales_Helper_Data')->__('Discount'),
            'type'              => 'currency',
            'currency_code'     => $currencyCode,
        ...
        $this->addColumn('total_canceled_amount', array(
            'header'        => Mage::helper('Magento_Sales_Helper_Data')->__('Canceled'),
            'type'          => 'currency',
            'currency_code' => $currencyCode,
        ...
        $this->addExportType('*/*/exportSalesCsv', Mage::helper('Magento_Adminhtml_Helper_Data')->__('CSV'));
        $this->addExportType('*/*/exportSalesExcel', Mage::helper('Magento_Adminhtml_Helper_Data')->__('Excel XML'));
