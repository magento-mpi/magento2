...
class Magento_Adminhtml_Block_Customer_Edit_Tab_Newsletter_Grid extends Magento_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _construct()
    {
        ...
        $this->setEmptyText(Mage::helper('Magento_Customer_Helper_Data')->__('No Newsletter Found'));
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('start_at', array(
            'header'    =>  Mage::helper('Magento_Customer_Helper_Data')->__('Start date'),
            'type'      =>  'datetime',
            'align'     =>  'center',
        ...
        $this->addColumn('finish_at', array(
            'header'    =>  Mage::helper('Magento_Customer_Helper_Data')->__('End Date'),
            'type'      =>  'datetime',
            'align'     =>  'center',
        ...
        $this->addColumn('letter_sent_at', array(
            'header'    =>  Mage::helper('Magento_Customer_Helper_Data')->__('Receive Date'),
            'type'      =>  'datetime',
            'align'     =>  'center',
        ...
        $this->addColumn('template_subject', array(
            'header'    =>  Mage::helper('Magento_Customer_Helper_Data')->__('Subject'),
            'align'     =>  'center',
            'index'     =>  'template_subject'
        ));

         $this->addColumn('status', array(
            'header'    =>  Mage::helper('Magento_Customer_Helper_Data')->__('Status'),
            'align'     =>  'center',
