...
class Magento_Adminhtml_Block_Api_User_Edit_Tab_Roles extends Magento_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _construct()
    {
        ...
        $this->setTitle(Mage::helper('Magento_Adminhtml_Helper_Data')->__('User Roles Information'));
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('assigned_user_role', array(
            ...
            'header'    => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Assigned'),
            'type'      => 'radio',
            'html_name' => 'roles[]',
        ...
        /*$this->addColumn('role_id', array(
            'header'    =>Mage::helper('Magento_Adminhtml_Helper_Data')->__('Role ID'),
            'index'     =>'role_id',
            'align'     => 'right',
            'width'    => '50px'
        ));*/
        ...
        $this->addColumn('role_name', array(
            'header'    =>Mage::helper('Magento_Adminhtml_Helper_Data')->__('Role'),
            'index'     =>'role_name'
        ));
