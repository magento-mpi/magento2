...
class Magento_Adminhtml_Block_Review_Grid extends Magento_Backend_Block_Widget_Grid_Extended
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('action',
            array(
                'header'    => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Action'),
                'width'     => '50px',
                'type'      => 'action',
                'getter'     => 'getReviewId',
                'actions'   => array(
                    array(
                        'caption' => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Edit'),
                        'url'     => array(
        ...
        $this->addRssList('rss/catalog/review', Mage::helper('Magento_Catalog_Helper_Data')->__('Pending Reviews RSS'));
