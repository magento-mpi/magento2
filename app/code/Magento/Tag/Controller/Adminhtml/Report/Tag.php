...
class Magento_Tag_Controller_Adminhtml_Report_Tag extends Magento_Adminhtml_Controller_Action
{
    public function _initAction()
    {
        $this->loadLayout()
            ->_addBreadcrumb(
                Mage::helper('Magento_Tag_Helper_Data')->__('Reports'),
                Mage::helper('Magento_Tag_Helper_Data')->__('Reports')
            )
            ->_addBreadcrumb(
                Mage::helper('Magento_Tag_Helper_Data')->__('Tag'),
                Mage::helper('Magento_Tag_Helper_Data')->__('Tag')
            );
    ...
    public function customerAction()
    {
        ...
        $this->_initAction()
            ...
            ->_addBreadcrumb(
                Mage::helper('Magento_Tag_Helper_Data')->__('Customers Report'),
                Mage::helper('Magento_Tag_Helper_Data')->__('Customers Report'))
            ->renderLayout();
    }
    ...
    public function productAction()
    {
        ...
        $this->_initAction()
            ...
            ->_addBreadcrumb(
                Mage::helper('Magento_Tag_Helper_Data')->__('Poducts Report'),
                Mage::helper('Magento_Tag_Helper_Data')->__('Products Report')
            )
            ->renderLayout();
    }
    ...
    public function popularAction()
    {
        ...
        $this->_initAction()
            ...
            ->_addBreadcrumb(
                Mage::helper('Magento_Tag_Helper_Data')->__('Popular Tags'),
                Mage::helper('Magento_Tag_Helper_Data')->__('Popular Tags')
            )
    ...
    public function customerDetailAction()
    {
        ...
        $this->_setActiveMenu('Magento_Tag::report_tags')->_addBreadcrumb(Mage::helper('Magento_Tag_Helper_Data')
                ->__('Customers Report'), Mage::helper('Magento_Tag_Helper_Data')->__('Customers Report'))
            ->_addBreadcrumb(Mage::helper('Magento_Tag_Helper_Data')->__('Customer Tags'),
            Mage::helper('Magento_Tag_Helper_Data')->__('Customer Tags'))->renderLayout();
    }
    ...
    public function productDetailAction()
    {
        ...
        $this->_setActiveMenu('Magento_Tag::report_tags')
            ...
            ->_addBreadcrumb(
                Mage::helper('Magento_Tag_Helper_Data')->__('Product Tags'),
                Mage::helper('Magento_Tag_Helper_Data')->__('Product Tags')
            )->renderLayout();
    }
    ...
    public function tagDetailAction()
    {
        ...
        $this->_setActiveMenu('Magento_Tag::report_tags')
            ...
            ->_addBreadcrumb(
                Mage::helper('Magento_Tag_Helper_Data')->__('Tag Detail'),
                Mage::helper('Magento_Tag_Helper_Data')->__('Tag Detail'))
            ->renderLayout();
    }
