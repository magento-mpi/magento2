 ...
 */
class Magento_Tag_Model_Resource_Product_Collection extends Magento_Catalog_Model_Resource_Product_Collection
{
    /**
     * Customer Id Filter
     *
    ...
    {
        $tagRelationTable = Mage::getSingleton('Magento_Core_Model_Resource')
    ...
    {
        $active = Magento_Tag_Model_Tag_Relation::STATUS_ACTIVE;
    ...
    public function addProductTags($storeId = null)
    {
        foreach ($this->getItems() as $item) {
            $tagsCollection = Mage::getModel('Magento_Tag_Model_Tag')->getResourceCollection();
