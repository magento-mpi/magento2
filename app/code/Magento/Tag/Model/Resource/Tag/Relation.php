 ...
 */
class Magento_Tag_Model_Resource_Tag_Relation extends Magento_Core_Model_Resource_Db_Abstract
{
    /**
     ...
     *
     * @param Magento_Tag_Model_Tag_Relation $model
    ...
    public function deactivate($tagId, $customerId)
    {
        ...
        $data = array('active' => Magento_Tag_Model_Tag_Relation::STATUS_NOT_ACTIVE);
