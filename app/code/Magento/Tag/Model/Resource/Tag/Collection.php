 ...
 */
class Magento_Tag_Model_Resource_Tag_Collection extends Magento_Core_Model_Resource_Db_Collection_Abstract
{
    /**
    ...
    {
        $statusActive = Magento_Tag_Model_Tag_Relation::STATUS_ACTIVE;
