...
class Magento_Sales_Helper_Guest extends Magento_Core_Helper_Data
{
    ...
    public function getBreadcrumbs($controller)
    {
        ...
        $breadcrumbs->addCrumb(
            'home',
            array(
                'label' => Mage::helper('Magento_Sales_Helper_Guest')->__('Home'),
                'title' => Mage::helper('Magento_Sales_Helper_Guest')->__('Go to Home Page'),
        ...
        $breadcrumbs->addCrumb(
            'cms_page',
            array(
                'label' => Mage::helper('Magento_Sales_Helper_Guest')->__('Order Information'),
                'title' => Mage::helper('Magento_Sales_Helper_Guest')->__('Order Information')
            )
        );
    }
