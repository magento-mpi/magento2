 ...
 */
class Magento_Sales_Block_Adminhtml_Recurring_Profile_Edit_Form extends Mage_Backend_Block_Abstract
{
    /**
    ...
    protected function _prepareForm()
    {
        ...
        $schedule = $form->addFieldset('schedule_fieldset', array(
            'legend' => Mage::helper('Magento_Sales_Helper_Data')->__('Schedule'),
            'disabled'  => $this->_isReadOnly
        ));
        $schedule->addField('start_date_is_editable', 'select', array(
            'name'    => 'start_date_is_editable',
            'label'   => Mage::helper('Magento_Sales_Helper_Data')->__('Customer Can Define Start Date'),
            'comment' => Mage::helper('Magento_Sales_Helper_Data')->__('Select whether buyer can define the date when billing for the profile begins.'),
            'options' => $noYes,
            'disabled' => $this->_isReadOnly
        ));
        ...
        $billing = $form->addFieldset('billing_fieldset', array(
            'legend' => Mage::helper('Magento_Sales_Helper_Data')->__('Billing'),
            'disabled'  => $this->_isReadOnly
        ));
        ...
        $trial = $form->addFieldset('trial_fieldset', array(
            'legend' => Mage::helper('Magento_Sales_Helper_Data')->__('Trial Period'),
            'disabled'  => $this->_isReadOnly
        ));
        ...
        $initial = $form->addFieldset('initial_fieldset', array(
            'legend' => Mage::helper('Magento_Sales_Helper_Data')->__('Initial Fees'),
            'disabled'  => $this->_isReadOnly
        ));
