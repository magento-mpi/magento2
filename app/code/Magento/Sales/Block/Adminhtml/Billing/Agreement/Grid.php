...
class Magento_Sales_Block_Adminhtml_Billing_Agreement_Grid extends Magento_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('customer_email', array(
            'header'            => Mage::helper('Magento_Sales_Helper_Data')->__('Email'),
        ...
        $this->addColumn('customer_firstname', array(
            'header'            => Mage::helper('Magento_Sales_Helper_Data')->__('First Name'),
        ...
        $this->addColumn('customer_lastname', array(
            'header'            => Mage::helper('Magento_Sales_Helper_Data')->__('Last Name'),
        ...
        $this->addColumn('reference_id', array(
            'header'            => Mage::helper('Magento_Sales_Helper_Data')->__('Reference ID'),
            'index'             => 'reference_id',
            'type'              => 'text',
        ...
        $this->addColumn('updated_at', array(
            'header'            => Mage::helper('Magento_Sales_Helper_Data')->__('Updated'),
