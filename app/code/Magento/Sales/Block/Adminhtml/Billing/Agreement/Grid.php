...
class Grid extends \Magento\Adminhtml\Block\Widget\Grid
{
    ...
    {
        return $this->getUrl('adminhtml/sales_billing_agreement/grid', array('_current' => true));
    }
    ...
    {
        return $this->getUrl('adminhtml/sales_billing_agreement/view', array('agreement' => $item->getAgreementId()));
    }
