    ...
    extends Magento_Connect_Block_Adminhtml_Extension_Custom_Edit_Tab_Abstract
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('depends_php_fieldset', array(
            'legend'    => Mage::helper('Magento_Connect_Helper_Data')->__('PHP Version')
        ));

        $fieldset->addField('depends_php_min', 'text', array(
            'name'      => 'depends_php_min',
            'label'     => Mage::helper('Magento_Connect_Helper_Data')->__('Minimum'),
            'required'  => true,
            'value'     => '5.2.0',
        ));
        ...
        $fieldset->addField('depends_php_max', 'text', array(
            ...
            'label'     => Mage::helper('Magento_Connect_Helper_Data')->__('Maximum'),
            'required'  => true,
            'value'     => '5.2.20',
        ));
    ...
    {
        return Mage::helper('Magento_Connect_Helper_Data')->__('Dependencies');
    }
