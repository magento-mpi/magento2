...
class Magento_Backup_Model_Backup extends Magento_Object
{
    ...
    public function open($write = false)
    {
        if (is_null($this->getPath())) {
            Mage::exception('Magento_Backup', $this->_helper->__('The backup file path was not specified.'));
        }
    ...
    protected function _getStream()
    {
        if (is_null($this->_stream)) {
            Mage::exception('Magento_Backup', $this->_helper->__('The backup file handler was unspecified.'));
        }
        return $this->_stream;
    }
