    ...
    protected function _getCallbackUrl($actionName)
    {
        if ($this->_requestHttp->getParam('website')) {
            ...
            $secure = $this->_storeConfig->isSetFlag(
                \Magento\Core\Model\Store::XML_PATH_SECURE_IN_FRONTEND, \Magento\Store\Model\ScopeInterface::SCOPE_STORE,
            ...
            $secure = $this->_storeConfig->isSetFlag(\Magento\Core\Model\Store::XML_PATH_SECURE_IN_FRONTEND, \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
