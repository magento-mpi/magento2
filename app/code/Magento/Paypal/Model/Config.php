...
class Magento_Paypal_Model_Config
{
    ...
    {
        return array(
            'wePrefer_150x60'       => Mage::helper('Magento_Paypal_Helper_Data')->__('We prefer PayPal (150 X 60)'),
            'wePrefer_150x40'       => Mage::helper('Magento_Paypal_Helper_Data')->__('We prefer PayPal (150 X 40)'),
            'nowAccepting_150x60'   => Mage::helper('Magento_Paypal_Helper_Data')->__('Now accepting PayPal (150 X 60)'),
            'nowAccepting_150x40'   => Mage::helper('Magento_Paypal_Helper_Data')->__('Now accepting PayPal (150 X 40)'),
            'paymentsBy_150x60'     => Mage::helper('Magento_Paypal_Helper_Data')->__('Payments by PayPal (150 X 60)'),
            'paymentsBy_150x40'     => Mage::helper('Magento_Paypal_Helper_Data')->__('Payments by PayPal (150 X 40)'),
            'shopNowUsing_150x60'   => Mage::helper('Magento_Paypal_Helper_Data')->__('Shop now using (150 X 60)'),
            'shopNowUsing_150x40'   => Mage::helper('Magento_Paypal_Helper_Data')->__('Shop now using (150 X 40)'),
        );
    }
    ...
    {
        return array(
            self::EC_FLAVOR_DYNAMIC => Mage::helper('Magento_Paypal_Helper_Data')->__('Dynamic'),
            self::EC_FLAVOR_STATIC  => Mage::helper('Magento_Paypal_Helper_Data')->__('Static'),
        );
    }
    ...
    {
        return array(
            self::EC_BUTTON_TYPE_SHORTCUT => Mage::helper('Magento_Paypal_Helper_Data')->__('Shortcut'),
            self::EC_BUTTON_TYPE_MARK     => Mage::helper('Magento_Paypal_Helper_Data')->__('Acceptance Mark Image'),
        );
    }
    ...
    public function getPaymentActions()
    {
        $paymentActions = array(
            self::PAYMENT_ACTION_AUTH => Mage::helper('Magento_Paypal_Helper_Data')->__('Authorization'),
            self::PAYMENT_ACTION_SALE => Mage::helper('Magento_Paypal_Helper_Data')->__('Sale')
        );
        if (!is_null($this->_methodCode) && $this->_methodCode == self::METHOD_WPP_EXPRESS) {
            $paymentActions[self::PAYMENT_ACTION_ORDER] = Mage::helper('Magento_Paypal_Helper_Data')->__('Order');
        }
    ...
    {
        return array(
            self::REQUIRE_BILLING_ADDRESS_ALL       => Mage::helper('Magento_Paypal_Helper_Data')->__('Yes'),
            self::REQUIRE_BILLING_ADDRESS_NO        => Mage::helper('Magento_Paypal_Helper_Data')->__('No'),
            self::REQUIRE_BILLING_ADDRESS_VIRTUAL   => Mage::helper('Magento_Paypal_Helper_Data')->__('For Virtual Quotes Only'),
        );
    }
    ...
    {
        return array(
            self::EC_SOLUTION_TYPE_SOLE => Mage::helper('Magento_Paypal_Helper_Data')->__('Yes'),
            self::EC_SOLUTION_TYPE_MARK => Mage::helper('Magento_Paypal_Helper_Data')->__('No'),
        );
    }
    ...
    {
        return array(
            self::EC_BA_SIGNUP_AUTO  => Mage::helper('Magento_Paypal_Helper_Data')->__('Auto'),
            self::EC_BA_SIGNUP_ASK   => Mage::helper('Magento_Paypal_Helper_Data')->__('Ask Customer'),
            self::EC_BA_SIGNUP_NEVER => Mage::helper('Magento_Paypal_Helper_Data')->__('Never')
        );
    }
...
//            self::WPS_TRANSPORT_IPN_PDT  => Mage::helper('Magento_Adminhtml_Helper_Data')->__('Both IPN and PDT'),
    ...
    {
        return array(
            '0' => Mage::helper('Magento_Paypal_Helper_Data')->__('API Signature'),
            '1' => Mage::helper('Magento_Paypal_Helper_Data')->__('API Certificate')
        );
    }
