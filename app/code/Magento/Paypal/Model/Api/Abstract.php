 ...
 */
abstract class Magento_Paypal_Model_Api_Abstract extends \Magento\Object
{
    /**
     * Config instance
   ...
   /**
     ...
     *
     * @param Magento_Paypal_Model_Cart $cart
     * @return Magento_Paypal_Model_Api_Abstract
     */
    public function setPaypalCart(Magento_Paypal_Model_Cart $cart)
    {
        $this->_cart = $cart;
        return $this;
    }
     ...
     * @return Magento_Paypal_Model_Api_Abstract
     */
    public function setConfigObject(Magento_Paypal_Model_Config $config)
    {
        $this->_config = $config;
        return $this;
    }
