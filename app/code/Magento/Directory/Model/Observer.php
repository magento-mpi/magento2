...
class Observer
{
    ...
    public function scheduledUpdateCurrencyRates($schedule)
    {
        ...
        if (!$this->_storeConfig->getValue(self::IMPORT_ENABLE, \Magento\Store\Model\StoreManagerInterface::SCOPE_TYPE_STORE)
            || !$this->_storeConfig->getValue(self::CRON_STRING_PATH, \Magento\Store\Model\StoreManagerInterface::SCOPE_TYPE_STORE)
        ) {
            return;
        }
        ...
        $errors = array();
        $rates = array();
        $service = $this->_storeConfig->getValue(self::IMPORT_SERVICE, \Magento\Store\Model\StoreManagerInterface::SCOPE_TYPE_STORE);
        if ($service) {
            try {
