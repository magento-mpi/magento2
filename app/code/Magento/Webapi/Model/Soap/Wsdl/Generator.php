...
class Generator
{
    ...
    protected function _createOperationInput(Wsdl $wsdl, $operationName, $methodData)
    {
        ...
        $elementData = array('name' => $inputMessageName, 'type' => Wsdl::TYPES_NS . ':' . $complexTypeName);
        ...
        $wsdl->addMessage(
            $inputMessageName,
            array('messageParameters' => array('element' => Wsdl::TYPES_NS . ':' . $inputMessageName))
        );
    ...
    protected function _createOperationOutput(Wsdl $wsdl, $operationName, $methodData)
    {
        ...
        $wsdl->addMessage(
            $outputMessageName,
            array('messageParameters' => array('element' => Wsdl::TYPES_NS . ':' . $outputMessageName))
        );
    ...
    protected function _addGenericFaultComplexTypeNodes($wsdl)
    {
        ...
        $wsdl->addMessage(
            $faultMessageName,
            array('messageParameters' => array('element' => Wsdl::TYPES_NS . ':' . $faultMessageName))
        );
