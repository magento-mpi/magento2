 ...
 */
class Magento_Webapi_Helper_Filters extends Magento_Core_Helper_Abstract
{
    /**
     * @var \stdClass
     */
    ...
    public function validate($filter)
    {
        ...
        if (!$this->_validator->isValid()) {
            throw new Magento_Core_Exception($this->_getSchemaError($this->_validator->getErrors()));
        }
