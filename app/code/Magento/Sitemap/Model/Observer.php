...
class Observer
{
    ...
    public function scheduledGenerateSitemaps($schedule)
    {
        ...
        if (!$this->_storeConfig->isSetFlag(self::XML_PATH_GENERATION_ENABLED, \Magento\Core\Model\StoreManagerInterface::SCOPE_TYPE_STORE)) {
            return;
        }
        ...
        if ($errors && $this->_storeConfig->getValue(self::XML_PATH_ERROR_RECIPIENT, \Magento\Core\Model\StoreManagerInterface::SCOPE_TYPE_STORE)) {
