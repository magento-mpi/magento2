...
class Is3DSecure extends AbstractSpecification
{
    ...
    {
        return $this->storeConfig->isSetFlag(sprintf(self::PATH_PAYMENT_3DSECURE, \Magento\Store\Model\StoreManagerInterface::SCOPE_TYPE_STORE, $paymentMethod))
            || $this->storeConfig->isSetFlag(sprintf(self::PATH_PAYMENT_CENTINEL, \Magento\Store\Model\StoreManagerInterface::SCOPE_TYPE_STORE, $paymentMethod));
    }
}
