...
class Magento_GiftWrapping_Block_Adminhtml_Giftwrapping_Edit extends Magento_Adminhtml_Block_Widget_Form_Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_addButton('save_and_continue_edit', array(
            'class'   => 'save',
            'label'   => Mage::helper('Magento_GiftWrapping_Helper_Data')->__('Save and Continue Edit'),
        ...
        if (Mage::registry('current_giftwrapping_model') && Mage::registry('current_giftwrapping_model')->getId()) {
            $confirmMessage = Mage::helper('Magento_GiftWrapping_Helper_Data')->__('Are you sure you want to delete this gift wrapping?');
    ...
    public function getHeaderText()
    {
        ...
        if ($wrapping->getId()) {
            ...
            return Mage::helper('Magento_GiftWrapping_Helper_Data')->__('Edit Gift Wrapping "%s"', $title);
        }
        else {
            return Mage::helper('Magento_GiftWrapping_Helper_Data')->__('New Gift Wrapping');
        }
    }
