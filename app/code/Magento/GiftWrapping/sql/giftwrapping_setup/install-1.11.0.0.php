...
$table = $installer->getConnection()->newTable(
    ...
    $installer->getFkName('magento_giftwrapping_store_attributes', 'store_id', 'core_store', 'store_id'),
    'store_id',
...
$table = $installer->getConnection()->newTable(
    ...
    $installer->getFkName('magento_giftwrapping_website', 'website_id', 'core_website', 'website_id'),
    'website_id',
