...
class Messages extends \Magento\Backend\Block\Template
{
    ...
    public function getLastCritical()
    {
        ...
        if (isset(
            $items[0]
        ) && $items[0]->getSeverity() == \Magento\Framework\App\Notification\MessageInterface::SEVERITY_CRITICAL
        ) {
            return $items[0];
        }
        return null;
    ...
    {
        return $this->_messages->getCountBySeverity(
            \Magento\Framework\App\Notification\MessageInterface::SEVERITY_MAJOR
        );
    }
