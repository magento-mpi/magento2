 ...
 */
namespace Magento\Ui\Listing\Block\Massaction;
...
class Extended extends \Magento\Backend\Block\Widget
{
     ...
     * @var string
     */
    protected $_template = 'Magento_Ui::grid/massaction_extended.phtml';
    ...
    public function addItem($itemId, array $item)
    {
        $this->_items[$itemId] = $this->getLayout()->createBlock(
            'Magento\Ui\Listing\Block\Massaction\Item'
        )->setData(
            $item
        )->setMassaction(
            $this
     ...
     *
     * @param string $itemId
     * @return \Magento\Ui\Listing\Block\Massaction\Item|null
     */
