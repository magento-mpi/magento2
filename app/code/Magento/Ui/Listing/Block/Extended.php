...
class Extended extends \Magento\Ui\Listing\View implements \Magento\Ui\Listing\Block\ExportInterface
{
    /**
     * Columns array
     *
     ...
     *      'sortable'  => bool,
     *      'index'     => string,
     *      //'renderer'  => \Magento\Ui\Listing\Block\Column\Renderer\Interface,
     *      'format'    => string
     ...
     * @var string
     */
    protected $_massactionBlockName = 'Magento\Ui\Listing\Block\Massaction\Extended';
     ...
     * @var string
     */
    protected $_template = 'Magento_Ui::grid/extended.phtml';
    ...
    public function getColumnSet()
    {
        if (!$this->getChildBlock('grid.columnSet')) {
            $this->setChild(
                'grid.columnSet',
                $this->getLayout()->createBlock('Magento\Ui\Listing\Block\ColumnSet')
            );
        }
    ...
    public function addColumn($columnId, $column)
    {
        if (is_array($column)) {
            $this->getColumnSet()->setChild(
                $columnId,
                $this->getLayout()
                    ->createBlock('Magento\Ui\Listing\Block\Column\Extended')
                    ->setData($column)
                    ->setId($columnId)
                    ->setGrid($this)
            );
    ...
    protected function _prepareMassactionColumn()
    {
        ...
        $massactionColumn = $this->getLayout()
            ->createBlock('Magento\Ui\Listing\Block\Column')
            ->setData(
                array(
