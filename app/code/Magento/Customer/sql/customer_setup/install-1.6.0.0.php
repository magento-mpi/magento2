...
$table = $installer->getConnection()
    ...
    ->addColumn('customer_group_code', Magento_DB_Ddl_Table::TYPE_TEXT, 32, array(
        'nullable'  => false,
        ), 'Customer Group Code')
    ->addColumn('tax_class_id', Magento_DB_Ddl_Table::TYPE_INTEGER, null, array(
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => '0',
        ), 'Tax Class Id')
...
$installer->getConnection()->insertForce($installer->getTable('customer_group'), array(
    'customer_group_id'     => 0,
