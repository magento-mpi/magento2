    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'index'         => 'price',
                'type'          => 'currency',
                'currency_code' => (string)$this->_storeConfig->getValue(Currency::XML_PATH_CURRENCY_BASE, \Magento\Store\Model\ScopeInterface::SCOPE_STORE),
            ]
        );
        ...
        $this->addColumn(
            ...
            [
                ...
                'type'          => 'currency',
                'currency_code' =>
                    (string)$this->_storeConfig->getValue(Currency::XML_PATH_CURRENCY_BASE, \Magento\Store\Model\ScopeInterface::SCOPE_STORE),
            ]
        );
