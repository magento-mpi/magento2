...
class Magento_Banner_Model_Banner extends Magento_Core_Model_Abstract
{
    ...
    protected function _beforeSave()
    {
        if ('' == trim($this->getName())) {
            Mage::throwException(Mage::helper('Magento_Banner_Helper_Data')->__('Please enter a name.'));
        }
        ...
        if (!$flag) {
            ...
            Mage::throwException(Mage::helper('Magento_Banner_Helper_Data')->__('Please specify default content for at least one store view.'));
