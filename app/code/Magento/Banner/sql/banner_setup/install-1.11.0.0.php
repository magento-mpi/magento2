...
/* @var $installer \Magento\Banner\Model\Resource\Setup */
$installer = $this;
...
$table = $installer->getConnection()
    ...
    ->addColumn('is_enabled', \Magento\DB\Ddl\Table::TYPE_INTEGER, null, array(
        'nullable'  => false,
        ), 'Is Enabled')
    ->addColumn('types', \Magento\DB\Ddl\Table::TYPE_TEXT, 255, array(
        ), 'Types')
