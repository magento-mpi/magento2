...
class Coupon extends \Magento\App\Helper\AbstractHelper
{
    ...
    {
        return (int)$this->_storeConfig->getValue(self::XML_PATH_SALES_RULE_COUPON_LENGTH, \Magento\Store\Model\StoreManagerInterface::SCOPE_TYPE_STORE);
    }
    ...
    {
        return $this->_storeConfig->getValue(self::XML_PATH_SALES_RULE_COUPON_FORMAT, \Magento\Store\Model\StoreManagerInterface::SCOPE_TYPE_STORE);
    }
    ...
    {
        return $this->_storeConfig->getValue(self::XML_PATH_SALES_RULE_COUPON_PREFIX, \Magento\Store\Model\StoreManagerInterface::SCOPE_TYPE_STORE);
    }
    ...
    {
        return $this->_storeConfig->getValue(self::XML_PATH_SALES_RULE_COUPON_SUFFIX, \Magento\Store\Model\StoreManagerInterface::SCOPE_TYPE_STORE);
    }
    ...
    {
        return (int)$this->_storeConfig->getValue(self::XML_PATH_SALES_RULE_COUPON_DASH_INTERVAL, \Magento\Store\Model\StoreManagerInterface::SCOPE_TYPE_STORE);
    }
