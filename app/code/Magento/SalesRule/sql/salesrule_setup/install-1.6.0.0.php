...
$table = $installer->getConnection()
    ...
    ->addColumn('uses_per_customer', Magento_DB_Ddl_Table::TYPE_INTEGER, null, array(
        'nullable'  => false,
        'default'   => '0',
        ), 'Uses Per Customer')
    ->addColumn('customer_group_ids', Magento_DB_Ddl_Table::TYPE_TEXT, '64k', array(
        ), 'Customer Group Ids')
    ...
    ->addColumn('actions_serialized', Magento_DB_Ddl_Table::TYPE_TEXT, '2M', array(
        ), 'Actions Serialized')
    ->addColumn('stop_rules_processing', Magento_DB_Ddl_Table::TYPE_SMALLINT, null, array(
        'nullable'  => false,
        'default'   => '1',
        ), 'Stop Rules Processing')
    ->addColumn('is_advanced', Magento_DB_Ddl_Table::TYPE_SMALLINT, null, array(
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => '1',
        ), 'Is Advanced')
    ->addColumn('product_ids', Magento_DB_Ddl_Table::TYPE_TEXT, '64k', array(
        ), 'Product Ids')
    ...
    ->addColumn('simple_action', Magento_DB_Ddl_Table::TYPE_TEXT, 32, array(
        ), 'Simple Action')
    ->addColumn('discount_amount', Magento_DB_Ddl_Table::TYPE_DECIMAL, array(12,4), array(
        'nullable'  => false,
        'default'   => '0.0000',
        ), 'Discount Amount')
    ->addColumn('discount_qty', Magento_DB_Ddl_Table::TYPE_DECIMAL, array(12,4), array(
        ), 'Discount Qty')
    ->addColumn('discount_step', Magento_DB_Ddl_Table::TYPE_INTEGER, null, array(
        'unsigned'  => true,
        'nullable'  => false,
        ), 'Discount Step')
    ->addColumn('simple_free_shipping', Magento_DB_Ddl_Table::TYPE_SMALLINT, null, array(
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => '0',
        ), 'Simple Free Shipping')
    ->addColumn('apply_to_shipping', Magento_DB_Ddl_Table::TYPE_SMALLINT, null, array(
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => '0',
        ), 'Apply To Shipping')
    ->addColumn('times_used', Magento_DB_Ddl_Table::TYPE_INTEGER, null, array(
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => '0',
        ), 'Times Used')
    ->addColumn('is_rss', Magento_DB_Ddl_Table::TYPE_SMALLINT, null, array(
        'nullable'  => false,
        'default'   => '0',
        ), 'Is Rss')
    ->addColumn('website_ids', Magento_DB_Ddl_Table::TYPE_TEXT, 4000, array(
        ), 'Website Ids')
    ->addColumn('coupon_type', Magento_DB_Ddl_Table::TYPE_SMALLINT, null, array(
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => '1',
        ), 'Coupon Type')
...
$table = $installer->getConnection()
    ...
    ->addColumn('usage_limit', Magento_DB_Ddl_Table::TYPE_INTEGER, null, array(
        'unsigned'  => true,
        ), 'Usage Limit')
    ->addColumn('usage_per_customer', Magento_DB_Ddl_Table::TYPE_INTEGER, null, array(
        'unsigned'  => true,
        ), 'Usage Per Customer')
    ->addColumn('times_used', Magento_DB_Ddl_Table::TYPE_INTEGER, null, array(
        'unsigned'  => true,
    ...
    ->addColumn('expiration_date', Magento_DB_Ddl_Table::TYPE_TIMESTAMP, null, array(
        ), 'Expiration Date')
    ->addColumn('is_primary', Magento_DB_Ddl_Table::TYPE_SMALLINT, null, array(
        'unsigned'  => true,
        ), 'Is Primary')
    ->addIndex($installer->getIdxName('salesrule_coupon', array('code'), Magento_DB_Adapter_Interface::INDEX_TYPE_UNIQUE),
        array('code'), array('type' => Magento_DB_Adapter_Interface::INDEX_TYPE_UNIQUE))
    ->addIndex($installer->getIdxName('salesrule_coupon', array('rule_id', 'is_primary'), Magento_DB_Adapter_Interface::INDEX_TYPE_UNIQUE),
        array('rule_id', 'is_primary'), array('type' => Magento_DB_Adapter_Interface::INDEX_TYPE_UNIQUE))
...
$table = $installer->getConnection()
    ...
    ->addColumn('rule_customer_id', Magento_DB_Ddl_Table::TYPE_INTEGER, null, array(
        'identity'  => true,
        'unsigned'  => true,
        'nullable'  => false,
        'primary'   => true,
    ...
    ->addColumn('times_used', Magento_DB_Ddl_Table::TYPE_SMALLINT, null, array(
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => '0',
        ), 'Times Used')
...
$table = $installer->getConnection()
    ...
    ->addColumn('label_id', Magento_DB_Ddl_Table::TYPE_INTEGER, null, array(
        'identity'  => true,
        'unsigned'  => true,
        'nullable'  => false,
        'primary'   => true,
    ...
    ->addIndex($installer->getIdxName('salesrule_label', array('rule_id', 'store_id'), Magento_DB_Adapter_Interface::INDEX_TYPE_UNIQUE),
        array('rule_id', 'store_id'), array('type' => Magento_DB_Adapter_Interface::INDEX_TYPE_UNIQUE))
...
$table = $installer->getConnection()
    ...
    ->addColumn('coupon_code', Magento_DB_Ddl_Table::TYPE_TEXT, 50, array(
        ), 'Coupon Code')
    ->addColumn('coupon_uses', Magento_DB_Ddl_Table::TYPE_INTEGER, null, array(
        'nullable'  => false,
        'default'   => '0',
        ), 'Coupon Uses')
    ->addColumn('subtotal_amount', Magento_DB_Ddl_Table::TYPE_DECIMAL, array(12,4), array(
        'nullable'  => false,
        'default'   => '0.0000',
        ), 'Subtotal Amount')
    ->addColumn('discount_amount', Magento_DB_Ddl_Table::TYPE_DECIMAL, array(12,4), array(
    ...
    ->addColumn('total_amount', Magento_DB_Ddl_Table::TYPE_DECIMAL, array(12,4), array(
        'nullable'  => false,
        'default'   => '0.0000',
        ), 'Total Amount')
    ->addColumn('subtotal_amount_actual', Magento_DB_Ddl_Table::TYPE_DECIMAL, array(12,4), array(
        'nullable'  => false,
        'default'   => '0.0000',
        ), 'Subtotal Amount Actual')
    ->addColumn('discount_amount_actual', Magento_DB_Ddl_Table::TYPE_DECIMAL, array(12,4), array(
        'nullable'  => false,
        'default'   => '0.0000',
        ), 'Discount Amount Actual')
    ->addColumn('total_amount_actual', Magento_DB_Ddl_Table::TYPE_DECIMAL, array(12,4), array(
        'nullable'  => false,
        'default'   => '0.0000',
        ), 'Total Amount Actual')
    ->addIndex($installer->getIdxName('coupon_aggregated', array('period', 'store_id', 'order_status', 'coupon_code'), Magento_DB_Adapter_Interface::INDEX_TYPE_UNIQUE),
        array('period', 'store_id', 'order_status', 'coupon_code'), array('type' => Magento_DB_Adapter_Interface::INDEX_TYPE_UNIQUE))
...
$table = $installer->getConnection()
    ...
    ->addIndex($installer->getIdxName('coupon_aggregated_order', array('period', 'store_id', 'order_status', 'coupon_code'), Magento_DB_Adapter_Interface::INDEX_TYPE_UNIQUE),
        array('period', 'store_id', 'order_status', 'coupon_code'), array('type' => Magento_DB_Adapter_Interface::INDEX_TYPE_UNIQUE))
