...
class Chooser extends Extended
{
    ...
    public function prepareElementHtml(\Magento\Data\Form\Element\AbstractElement $element)
    {
        ...
        $sourceUrl = $this->getChooserUrl(array('uniq_id' => $uniqId));
    ...
    {
        return $this->getChooserUrl(array('_current' => true));
    }

    /**
     * Prepare url for chooser element
     *
     * @param array $parameters
     * @return string
     */
    public function getChooserUrl(array $parameters = array())
    {
        return $this->getUrl(sprintf($this->chooserUrl, $this->type), $parameters);
    }
}
