 ...
 */
class Magento_Backend_Block_Widget_Grid_Column_Filter_Range extends Magento_Backend_Block_Widget_Grid_Column_Filter_Abstract
{
    public function getHtml()
    {
        $html = '<div class="range"><div class="range-line">'
            ...
            . Mage::helper('Magento_Backend_Helper_Data')->__('From') . '" value="' . $this->getEscapedValue('from')
        ...
        $html .= '<div class="range-line">'
            ...
            . Mage::helper('Magento_Backend_Helper_Data')->__('To') . '" value="' . $this->getEscapedValue('to') . '" class="input-text no-changes" '
