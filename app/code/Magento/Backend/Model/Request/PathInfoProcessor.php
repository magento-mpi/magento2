 ...
 */
namespace Magento\Backend\Model\Request;
...
class PathInfoProcessor implements \Magento\App\Request\PathInfoProcessorInterface
{
    ...
    private $_helper;
    /**
     * @var \Magento\Core\Model\Request\PathInfoProcessor
     */
    private $_subject;

    /**
     * @param \Magento\Core\Model\Request\PathInfoProcessor $subject
     * @param \Magento\Backend\Helper\Data $helper
     */
    public function __construct(
        \Magento\Core\Model\Request\PathInfoProcessor $subject, \Magento\Backend\Helper\Data $helper
    ) {
        $this->_helper = $helper;
