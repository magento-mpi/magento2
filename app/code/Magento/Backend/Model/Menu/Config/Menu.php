 ...
 */
class Magento_Backend_Model_Menu_Config_Menu extends Magento_Config_XmlAbstract
{
    /**
    ...
    {
        return $this->_config->getModuleDir('etc', 'Magento_Backend') . DIRECTORY_SEPARATOR . 'menu.xsd';
    }
     ...
     * @return Magento_Backend_Model_Menu_Config_Menu_Dom
     */
    protected function _getDomConfigModel()
    {
        if (is_null($this->_domConfig)) {
            $this->_domConfig = new Magento_Backend_Model_Menu_Config_Menu_Dom(
                $this->_getInitialXml(),
