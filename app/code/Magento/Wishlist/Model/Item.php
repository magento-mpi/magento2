    ...
    */
    ...
    public function validate()
    {
        if (!$this->getWishlistId()) {
            Mage::throwException(Mage::helper('Magento_Wishlist_Helper_Data')->__('We can\'t specify a wish list.'));
        }
        if (!$this->getProductId()) {
            Mage::throwException(Mage::helper('Magento_Wishlist_Helper_Data')->__('Cannot specify product.'));
        }
