...
class Shopcart extends \Magento\Backend\Controller\Adminhtml\Action
{
    ...
    public function customerAction()
    {
        ...
        $this->_initAction()
            ...
            ->_addContent($this->getLayout()->createBlock('Magento\Reports\Block\Adminhtml\Shopcart\Customer'))
            ->renderLayout();
    }
    ...
    public function exportCustomerCsvAction()
    {
        ...
        $content    = $this->getLayout()->createBlock('Magento\Reports\Block\Adminhtml\Shopcart\Customer\Grid')
            ->getCsvFile();
    ...
    public function productAction()
    {
        ...
        $this->_initAction()
            ...
            ->_addContent($this->getLayout()->createBlock('Magento\Reports\Block\Adminhtml\Shopcart\Product'))
            ->renderLayout();
    }
    ...
    public function exportProductCsvAction()
    {
        ...
        $content    = $this->getLayout()->createBlock('Magento\Reports\Block\Adminhtml\Shopcart\Product\Grid')
            ->getCsvFile();
    ...
    public function abandonedAction()
    {
        ...
        $this->_initAction()
            ...
            ->_addContent($this->getLayout()->createBlock('Magento\Reports\Block\Adminhtml\Shopcart\Abandoned'))
            ->renderLayout();
    }
    ...
    public function exportAbandonedCsvAction()
    {
        ...
        $content    = $this->getLayout()->createBlock('Magento\Reports\Block\Adminhtml\Shopcart\Abandoned\Grid')
            ->getCsvFile();
