...
class Sales extends \Magento\Reports\Controller\Adminhtml\Report\AbstractReport
{
    ...
    public function salesAction()
    {
        ...
        $gridBlock = $this->getLayout()->getBlock('adminhtml_sales_sales.grid');
    ...
    public function bestsellersAction()
    {
        ...
        $gridBlock = $this->getLayout()->getBlock('adminhtml_sales_bestsellers.grid');
        $filterFormBlock = $this->getLayout()->getBlock('grid.filter.form');
    ...
    public function exportBestsellersCsvAction()
    {
        ...
        $grid       = $this->getLayout()->createBlock('Magento\Reports\Block\Adminhtml\Sales\Bestsellers\Grid');
    ...
    {
        $fileName   = 'sales.csv';
        $grid       = $this->getLayout()->createBlock('Magento\Reports\Block\Adminhtml\Sales\Sales\Grid');
        $this->_initReportAction($grid);
        $this->_prepareDownloadResponse($fileName, $grid->getCsvFile());
    }
    ...
    public function taxAction()
    {
        ...
        $gridBlock = $this->getLayout()->getBlock('adminhtml_sales_tax.grid');
        $filterFormBlock = $this->getLayout()->getBlock('grid.filter.form');
    ...
    {
        $fileName   = 'tax.csv';
        $grid       = $this->getLayout()->createBlock('Magento\Reports\Block\Adminhtml\Sales\Tax\Grid');
        $this->_initReportAction($grid);
        $this->_prepareDownloadResponse($fileName, $grid->getCsvFile());
    }
    ...
    public function shippingAction()
    {
        ...
        $gridBlock = $this->getLayout()->getBlock('adminhtml_sales_shipping.grid');
        $filterFormBlock = $this->getLayout()->getBlock('grid.filter.form');
    ...
    public function exportShippingCsvAction()
    {
        ...
        $grid       = $this->getLayout()->createBlock('Magento\Reports\Block\Adminhtml\Sales\Shipping\Grid');
        $this->_initReportAction($grid);
        $this->_prepareDownloadResponse($fileName, $grid->getCsvFile());
    }
    ...
    public function invoicedAction()
    {
        ...
        $gridBlock = $this->getLayout()->getBlock('adminhtml_sales_invoiced.grid');
        $filterFormBlock = $this->getLayout()->getBlock('grid.filter.form');
    ...
    public function exportInvoicedCsvAction()
    {
        ...
        $grid       = $this->getLayout()->createBlock('Magento\Reports\Block\Adminhtml\Sales\Invoiced\Grid');
        $this->_initReportAction($grid);
        $this->_prepareDownloadResponse($fileName, $grid->getCsvFile());
    }
    ...
    public function refundedAction()
    {
        ...
        $gridBlock = $this->getLayout()->getBlock('adminhtml_sales_refunded.grid');
        $filterFormBlock = $this->getLayout()->getBlock('grid.filter.form');
    ...
    public function exportRefundedCsvAction()
    {
        ...
        $grid       = $this->getLayout()->createBlock('Magento\Reports\Block\Adminhtml\Sales\Refunded\Grid');
        $this->_initReportAction($grid);
        $this->_prepareDownloadResponse($fileName, $grid->getCsvFile());
    }
    ...
    public function couponsAction()
    {
        ...
        $gridBlock = $this->getLayout()->getBlock('adminhtml_sales_coupons.grid');
        $filterFormBlock = $this->getLayout()->getBlock('grid.filter.form');
    ...
    public function exportCouponsCsvAction()
    {
        ...
        $grid       = $this->getLayout()->createBlock('Magento\Reports\Block\Adminhtml\Sales\Coupons\Grid');
        $this->_initReportAction($grid);
        $this->_prepareDownloadResponse($fileName, $grid->getCsvFile());
    }
