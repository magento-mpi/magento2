...
class Review extends \Magento\Backend\Controller\Adminhtml\Action
{
    ...
    public function productDetailAction()
    {
        ...
        $this->_initAction()
            ...
            ->_addContent($this->getLayout()->createBlock('Magento\Reports\Block\Adminhtml\Review\Detail'))
            ->renderLayout();
    }
    ...
    public function exportProductDetailCsvAction()
    {
        ...
        $content    = $this->getLayout()->createBlock('Magento\Reports\Block\Adminhtml\Review\Detail\Grid')
            ->getCsv();
