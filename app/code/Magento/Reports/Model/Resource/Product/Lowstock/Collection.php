...
class Collection extends \Magento\Reports\Model\Resource\Product\Collection
{
    ...
    public function useManageStockFilter($storeId = null)
    {
        ...
        $manageStockExpr = $this->getConnection()->getCheckSql(
            ...
            (int) $this->_storeConfig->getValue(\Magento\CatalogInventory\Model\Stock\Item::XML_PATH_MANAGE_STOCK, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $storeId),
    ...
    public function useNotifyStockQtyFilter($storeId = null)
    {
        ...
        $notifyStockExpr = $this->getConnection()->getCheckSql(
            ...
            (int)$this->_storeConfig->getValue(\Magento\CatalogInventory\Model\Stock\Item::XML_PATH_NOTIFY_STOCK_QTY, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $storeId),
