...
abstract class Magento_Reports_Model_Resource_Product_Index_Abstract extends Magento_Core_Model_Resource_Db_Abstract
{
     ...
     */
    public function updateCustomerFromVisitor(Magento_Reports_Model_Product_Index_Abstract $object)
    {
        /**
     ...
     * @return Magento_Reports_Model_Resource_Product_Index_Abstract
     */
    public function purgeVisitorByCustomer(Magento_Reports_Model_Product_Index_Abstract $object)
    {
        /**
         * Do nothing if customer not logged in
         */
