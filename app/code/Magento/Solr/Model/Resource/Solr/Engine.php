...
class Engine implements \Magento\CatalogSearch\Model\Resource\EngineInterface
{
     ...
     *
     * @var \Magento\Solr\Model\Adapter\AbstractAdapter
     */
     ...
     * Search coll factory
     *
     * @var \Magento\Solr\Model\Resource\CollectionFactory
     */
     ...
     * Search resource
     *
     * @var \Magento\Solr\Model\Resource\Advanced
     */
    ...
    /**
     * @param \Magento\Solr\Model\Resource\CollectionFactory $searchCollectionFactory
     * @param \Magento\CatalogSearch\Model\Indexer\Fulltext $catalogSearchIndexer
     * @param \Magento\Solr\Model\Resource\Index $searchResourceIndex
     * @param \Magento\Catalog\Model\Product\Visibility $catalogProductVisibility
     * @param \Magento\Solr\Model\Resource\Advanced $searchResource
     * @param \Magento\Framework\App\Config\ScopeConfigInterface $scopeConfig
     * @param \Magento\Framework\StoreManagerInterface $storeManager
     * @param \Magento\Solr\Model\Factory\Factory $searchFactory
     */
    public function __construct(
        \Magento\Solr\Model\Resource\CollectionFactory $searchCollectionFactory,
        \Magento\CatalogSearch\Model\Indexer\Fulltext $catalogSearchIndexer,
        \Magento\Solr\Model\Resource\Index $searchResourceIndex,
        \Magento\Catalog\Model\Product\Visibility $catalogProductVisibility,
        \Magento\Solr\Model\Resource\Advanced $searchResource,
    ...
    protected function _canHoldCommit()
    {
        $commitMode = $this->_scopeConfig->getValue(
            \Magento\Solr\Model\Indexer\Indexer::SEARCH_ENGINE_INDEXATION_COMMIT_MODE_XML_PATH,
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );

        return $commitMode == \Magento\Solr\Model\Indexer\Indexer::SEARCH_ENGINE_INDEXATION_COMMIT_MODE_FINAL ||
            $commitMode == \Magento\Solr\Model\Indexer\Indexer::SEARCH_ENGINE_INDEXATION_COMMIT_MODE_ENGINE;
    }
    ...
    protected function _canAllowCommit()
    {
        ...
        return $commitMode == \Magento\Solr\Model\Indexer\Indexer::SEARCH_ENGINE_INDEXATION_COMMIT_MODE_FINAL ||
            $commitMode == \Magento\Solr\Model\Indexer\Indexer::SEARCH_ENGINE_INDEXATION_COMMIT_MODE_PARTIAL;
    }
     ...
     *
     * @return \Magento\Solr\Model\Resource\Advanced
     */
     ...
     *
     * @return \Magento\Solr\Model\Resource\Collection
     */
