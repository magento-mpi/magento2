...
class Magento_Rma_Block_Return_View extends Magento_Rma_Block_Form
{
    ...
    public function getPrintLabelButton()
    {
        ...
        return $this->getLayout()
            ...
            ->setAnchorText(Mage::helper('Magento_Rma_Helper_Data')->__('Print Shipping Label'))
            ->toHtml();
    }
    ...
    public function getShowPackagesButton()
    {
        return $this->getLayout()
            ...
            ->setData(array(
                ...
                'title'     => Mage::helper('Magento_Rma_Helper_Data')->__('Show Packages'),
                'onclick'   => "popWin(
            ...
            ->setAnchorText(Mage::helper('Magento_Rma_Helper_Data')->__('Show Packages'))
            ->toHtml();
    }
    ...
    public function getPrintShippingLabelButton()
    {
        return $this->getLayout()
            ...
            ->setData(array(
                ...
                'title'     => Mage::helper('Magento_Rma_Helper_Data')->__('Print Shipping Label'),
            ))
            ->setAnchorText(Mage::helper('Magento_Rma_Helper_Data')->__('Print Shipping Label'))
            ->toHtml();
    }
