...
class Magento_Rma_Block_Adminhtml_Rma_Edit_Tab_Items_Grid extends Magento_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('qty_requested', array(
            'header'=> Mage::helper('Magento_Rma_Helper_Data')->__('Requested'),
            'index' => 'qty_requested',
        ...
        $this->addColumn('qty_authorized', array(
            'header'=> Mage::helper('Magento_Rma_Helper_Data')->__('Authorized'),
        ...
        $this->addColumn('qty_returned', array(
            'header'=> Mage::helper('Magento_Rma_Helper_Data')->__('Returned'),
            'index' => 'qty_returned',
            'renderer'  => 'Magento_Rma_Block_Adminhtml_Rma_Edit_Tab_Items_Grid_Column_Renderer_Textinput',
            'validate_class' => 'validate-greater-than-zero',
            'header_css_class'  => 'col-qty',
        ...
        $this->addColumn('qty_approved', array(
            'header'=> Mage::helper('Magento_Rma_Helper_Data')->__('Approved'),
            'index' => 'qty_approved',
            'renderer'  => 'Magento_Rma_Block_Adminhtml_Rma_Edit_Tab_Items_Grid_Column_Renderer_Textinput',
            'validate_class' => 'validate-greater-than-zero',
            'header_css_class'  => 'col-qty',
        ...
        $this->addColumn('reason', array(
            'header'=> Mage::helper('Magento_Rma_Helper_Data')->__('Return Reason'),
        ...
        $this->addColumn('condition', array(
            'header'=> Mage::helper('Magento_Rma_Helper_Data')->__('Item Condition'),
        ...
        $this->addColumn('resolution', array(
            'header'=> Mage::helper('Magento_Rma_Helper_Data')->__('Resolution'),
            'index' => 'resolution',
        ...
        $actionsArray = array(
            array(
                'caption'   => Mage::helper('Magento_Rma_Helper_Data')->__('Details'),
                'class'     => 'item_details'
            ),
        );
        if (!($rma
            && (($rma->getStatus() === Magento_Rma_Model_Rma_Source_Status::STATE_CLOSED)
                ...
                $actionsArray[] = array(
                'caption'   => Mage::helper('Magento_Rma_Helper_Data')->__('Split'),
