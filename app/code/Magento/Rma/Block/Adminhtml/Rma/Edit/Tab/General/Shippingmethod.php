    ...
    extends Magento_Rma_Block_Adminhtml_Rma_Edit_Tab_General_Abstract
{
    ...
    protected function _getShippingAvailability()
    {
        $carriers = array();
        if ($this->getRma()) {
            $carriers = Mage::helper('Magento_Rma_Helper_Data')->getAllowedShippingCarriers($this->getRma()->getStoreId());
        }
    ...
    public function displayCustomsValue()
    {
        ...
        $recipientAddressCountryCode= Mage::helper('Magento_Rma_Helper_Data')->getReturnAddressModel($storeId)->getCountryId();
    ...
    public function getPrintLabelButton()
    {
        ...
        return $this->getLayout()
            ...
            ->setData(array(
                'label'   => Mage::helper('Magento_Rma_Helper_Data')->__('Print Shipping Label'),
    ...
    public function getShowPackagesButton()
    {
        return $this->getLayout()
            ->createBlock('Magento_Adminhtml_Block_Widget_Button')
            ->setData(array(
                'label'   => Mage::helper('Magento_Rma_Helper_Data')->__('Show Packages'),
    ...
    public function getPrintButton()
    {
        ...
        return $this->getLayout()
            ->createBlock('Magento_Adminhtml_Block_Widget_Button')
            ->setData(array(
                'label'   => Mage::helper('Magento_Rma_Helper_Data')->__('Print'),
                'onclick' => 'setLocation(\'' . $url . '\')'
            ))
            ->toHtml();
    }
