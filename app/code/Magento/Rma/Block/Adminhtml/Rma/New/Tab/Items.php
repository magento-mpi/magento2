    ...
    implements Magento_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    {
        $addButtonData = array(
            'label' => Mage::helper('Magento_Rma_Helper_Data')->__('Add Products'),
    ...
    {
        $addButtonData = array(
            'label' => Mage::helper('Magento_Rma_Helper_Data')->__('Add Selected Product(s) to returns'),
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('product_name', 'text', array(
            'label'=> Mage::helper('Magento_Rma_Helper_Data')->__('Product Name'),
            'name' => 'product_name',
            'required'  => false
        ));

        $fieldset->addField('product_sku', 'text', array(
            'label'=> Mage::helper('Magento_Rma_Helper_Data')->__('SKU'),
            'name' => 'product_sku',
            'required'  => false
        ));
        ...
        $fieldset->addField('qty_ordered', 'text', array(
            'label'=> Mage::helper('Magento_Rma_Helper_Data')->__('Remaining Qty'),
            'name' => 'qty_ordered',
            'required'  => false,
        ));

        $fieldset->addField('qty_requested', 'text', array(
            'label'=> Mage::helper('Magento_Rma_Helper_Data')->__('Requested Qty'),
            'name' => 'qty_requested',
            'required' => false,
        ...
        $fieldset->addField('reason', 'select', array(
            'label'=> Mage::helper('Magento_Rma_Helper_Data')->__('Reason to Return'),
            'options' => array(''=>'')
        ...
        $fieldset->addField('condition', 'select', array(
            'label'=> Mage::helper('Magento_Rma_Helper_Data')->__('Item Condition'),
        ...
        $fieldset->addField('resolution', 'select', array(
            'label'=> Mage::helper('Magento_Rma_Helper_Data')->__('Resolution'),
        ...
        $fieldset->addField('delete_link', 'label', array(
            'label'=> Mage::helper('Magento_Rma_Helper_Data')->__('Delete'),
            'name' => 'delete_link',
            'required' => false
        ));

        $fieldset->addField('add_details_link', 'label', array(
            'label'=> Mage::helper('Magento_Rma_Helper_Data')->__('Add Details'),
