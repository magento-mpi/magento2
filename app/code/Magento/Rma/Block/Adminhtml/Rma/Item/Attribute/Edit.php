    ...
    extends Magento_Adminhtml_Block_Widget_Form_Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_addButton(
            ...
            array(
                'label'     => Mage::helper('Magento_Rma_Helper_Data')->__('Save and Continue Edit'),
                'class'     => 'save',
        ...
        $this->_updateButton('save', 'label', Mage::helper('Magento_Rma_Helper_Data')->__('Save Attribute'));

        if (!$this->_getAttribute() || !$this->_getAttribute()->getIsUserDefined()) {
            $this->_removeButton('delete');
        } else {
            $this->_updateButton('delete', 'label', Mage::helper('Magento_Rma_Helper_Data')->__('Delete Attribute'));
        }
    }
    ...
    public function getHeaderText()
    {
        if ($this->_getAttribute()->getId()) {
            ...
            return Mage::helper('Magento_Rma_Helper_Data')->__('Edit Return Item Attribute "%s"', $label);
        } else {
            return Mage::helper('Magento_Rma_Helper_Data')->__('New Return Item Attribute');
        }
    }
