    ...
    public function saveSystemComment()
    {
        $systemComments = array(
            Magento_Rma_Model_Rma_Source_Status::STATE_PENDING =>
                Mage::helper('Magento_Rma_Helper_Data')->__('We placed your Return request.'),
            Magento_Rma_Model_Rma_Source_Status::STATE_AUTHORIZED =>
                Mage::helper('Magento_Rma_Helper_Data')->__('We have authorized your Return request.'),
            Magento_Rma_Model_Rma_Source_Status::STATE_PARTIAL_AUTHORIZED =>
                Mage::helper('Magento_Rma_Helper_Data')->__('We partially authorized your Return request.'),
            Magento_Rma_Model_Rma_Source_Status::STATE_RECEIVED =>
                Mage::helper('Magento_Rma_Helper_Data')->__('We received your Return request.'),
            Magento_Rma_Model_Rma_Source_Status::STATE_RECEIVED_ON_ITEM =>
                Mage::helper('Magento_Rma_Helper_Data')->__('We partially received your Return request.'),
            Magento_Rma_Model_Rma_Source_Status::STATE_APPROVED_ON_ITEM =>
                Mage::helper('Magento_Rma_Helper_Data')->__('We partially approved your Return request.'),
            Magento_Rma_Model_Rma_Source_Status::STATE_REJECTED_ON_ITEM =>
                Mage::helper('Magento_Rma_Helper_Data')->__('We partially rejected your Return request.'),
            Magento_Rma_Model_Rma_Source_Status::STATE_CLOSED =>
                Mage::helper('Magento_Rma_Helper_Data')->__('We closed your Return request.'),
            Magento_Rma_Model_Rma_Source_Status::STATE_PROCESSED_CLOSED =>
                Mage::helper('Magento_Rma_Helper_Data')->__('We processed and closed your Return request.'),
        );
