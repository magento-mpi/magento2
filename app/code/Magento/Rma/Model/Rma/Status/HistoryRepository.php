...
class HistoryRepository
{
     ...
     * @param \Magento\Rma\Model\Resource\Rma\Status\History\CollectionFactory
     * $historyCollectionFactory
     */
    public function __construct(
        \Magento\Rma\Model\Rma\Status\HistoryFactory $historyFactory,
        \Magento\Rma\Model\Resource\Rma\Status\History\CollectionFactory $historyCollectionFactory
    ) {
    ...
    {
        if (empty($id)) {
            throw new \Magento\Framework\Exception\InputException('ID cannot be an empty');
        }
