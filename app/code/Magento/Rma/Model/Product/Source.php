...
class Magento_Rma_Model_Product_Source extends Magento_Eav_Model_Entity_Attribute_Source_Boolean
{
    ...
    public function getAllOptions()
    {
        if (!$this->_options) {
            $this->_options = array(
                array(
                    'label' => Mage::helper('Magento_Rma_Helper_Data')->__('Yes'),
                    'value' => self::ATTRIBUTE_ENABLE_RMA_YES
                ),
                array(
                    'label' => Mage::helper('Magento_Rma_Helper_Data')->__('No'),
                    'value' => self::ATTRIBUTE_ENABLE_RMA_NO
                ),
                array(
                    'label' => Mage::helper('Magento_Rma_Helper_Data')->__('Use config'),
