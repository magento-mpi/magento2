 ...
 */
abstract class Magento_Rule_Model_Resource_Rule_Collection_Abstract
    extends Magento_Core_Model_Resource_Db_Collection_Abstract
{
     ...
     *
     * @return Magento_Rule_Model_Resource_Rule_Collection_Abstract
     */
    protected function _afterLoad()
    {
        parent::_afterLoad();
        if ($this->getFlag('add_websites_to_result') && $this->_items) {
            /** @var Magento_Rule_Model_Abstract $item */
