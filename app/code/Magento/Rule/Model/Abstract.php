 ...
 */
abstract class Magento_Rule_Model_Abstract extends Magento_Core_Model_Abstract
{
    /**
    ...
    protected function _beforeSave()
    {
        ...
        if ($this->hasDiscountAmount()) {
            if ((int)$this->getDiscountAmount() < 0) {
                throw new Magento_Core_Exception(__('Invalid discount amount.'));
            }
        }
     ...
     * Reset rule actions
     *
     * @param null|Magento_Rule_Model_Action_Collection $actions
     *
     * @return Magento_Rule_Model_Abstract
     */
