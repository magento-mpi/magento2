...
abstract class Magento_Eav_Model_Form
{
    ...
    public function getFormCode()
    {
        if (empty($this->_formCode)) {
            Mage::throwException(Mage::helper('Magento_Eav_Helper_Data')->__('Form code is not defined'));
        }
    ...
    public function getEntity()
    {
        if (is_null($this->_entity)) {
            Mage::throwException(Mage::helper('Magento_Eav_Helper_Data')->__('Entity instance is not defined'));
        }
        return $this->_entity;
    }
