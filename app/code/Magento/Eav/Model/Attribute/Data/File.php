    ...
    protected function _validateByRules($value)
    {
        ...
        if (!empty($rules['file_extensions'])) {
            ...
            if (!in_array($extension, $extensions)) {
                return array(
                    Mage::helper('Magento_Eav_Helper_Data')->__('"%s" is not a valid file extension.', $label)
                );
            }
        }
        ...
        if (!empty($rules['max_file_size'])) {
            ...
            if ($rules['max_file_size'] < $size) {
                return array(
                    Mage::helper('Magento_Eav_Helper_Data')->__('"%s" exceeds the allowed file size.', $label)
                );
            };
        }
