 ...
 */
abstract class Magento_Eav_Model_Entity_Abstract extends Magento_Core_Model_Resource_Abstract
    implements Magento_Eav_Model_Entity_Interface
{
    /**
     * Read connection
     *
    ...
    /**
     * For compatibility with Magento_Core_Model_Abstract
     *
     * @return string
     */
     ...
     *
     * @param string|Magento_Eav_Model_Entity_Type $type
     * @return Magento_Eav_Model_Entity_Abstract
     */
     ...
     *
     * @param string|integer|Magento_Core_Model_Config_Element $attribute
    ...
    public function getAttribute($attribute)
    {
        ...
        } elseif ($attribute instanceof Magento_Eav_Model_Entity_Attribute_Abstract) {
        ...
        if (empty($attributeInstance)
            || !($attributeInstance instanceof Magento_Eav_Model_Entity_Attribute_Abstract)
     ...
     * @return  Magento_Eav_Model_Entity_Abstract
     */
    public function addAttribute(Magento_Eav_Model_Entity_Attribute_Abstract $attribute)
    {
     ...
     * Compare attributes
     *
     * @param Magento_Eav_Model_Entity_Attribute $firstAttribute
     * @param Magento_Eav_Model_Entity_Attribute $secondAttribute
     * @return int
     */
     ...
     *
     * @throws Exception|Magento_Eav_Model_Entity_Attribute_Exception
     * @return array
     */
    ...
    public function getEntityIdField()
    {
        if (!$this->_entityIdField) {
            ...
            if (!$this->_entityIdField) {
                $this->_entityIdField = Magento_Eav_Model_Entity::DEFAULT_ENTITY_ID_FIELD;
            }
        }
    ...
    public function getEntityTablePrefix()
    {
        if (empty($this->_entityTablePrefix)) {
            ...
            if (empty($prefix)) {
                ...
                if (empty($prefix)) {
                    $prefix = Magento_Eav_Model_Entity::DEFAULT_ENTITY_TABLE;
                }
            }
     ...
     *
     * @see Magento_Eav_Model_Entity_Abstract::getAttribute for $attribute format
    ...
    {
        return Magento_Eav_Model_Entity::DEFAULT_SOURCE_MODEL;
    }
     ...
     * @return bool
     */
    protected function _canUpdateAttribute(Magento_Eav_Model_Entity_Attribute_Abstract $attribute, $v, array &$origData)
    {
    ...
    protected function _processSaveData($saveData)
    {
         ...
         *
         * @see Magento_Eav_Model_Entity_Abstract::_collectSaveData()
         *
         * @var array $entityRow
         * @var Magento_Core_Model_Abstract $newObject
         * @var array $insert
         * @var array $update
         * @var array $delete
         */
