    ...
    implements Magento_Eav_Model_Entity_Attribute_Interface
{
    ...
    public function loadByCode($entityType, $code)
    {
        ...
        if (empty($entityTypeId)) {
            throw Mage::exception('Magento_Eav', Mage::helper('Magento_Eav_Helper_Data')->__('Invalid entity supplied'));
        }
        ...
        if (empty($this->_source)) {
            ...
            if (!$source) {
                throw Mage::exception('Magento_Eav',
                    Mage::helper('Magento_Eav_Helper_Data')->__('Source model "%s" not found for attribute "%s"',$this->getSourceModel(), $this->getAttributeCode())
                );
            }
