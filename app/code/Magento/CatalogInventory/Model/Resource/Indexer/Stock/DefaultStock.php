    ...
    implements StockInterface
{
    ...
    {
        return $this->_storeConfig->isSetFlag(\Magento\CatalogInventory\Model\Stock\Item::XML_PATH_MANAGE_STOCK, \Magento\Store\Model\StoreManagerInterface::SCOPE_TYPE_STORE);
    }
