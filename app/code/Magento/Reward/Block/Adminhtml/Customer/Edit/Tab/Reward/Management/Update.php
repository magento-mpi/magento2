    ...
    extends Magento_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('update_fieldset', array(
            'legend' => Mage::helper('Magento_Reward_Helper_Data')->__('Update Reward Points Balance')
        ));

        if (!Mage::app()->isSingleStoreMode()) {
            $fieldset->addField('store', 'select', array(
                'name'  => 'store_id',
                'title' => Mage::helper('Magento_Reward_Helper_Data')->__('Store'),
                'label' => Mage::helper('Magento_Reward_Helper_Data')->__('Store'),
        ...
        $fieldset->addField('points_delta', 'text', array(
            'name'  => 'points_delta',
            'title' => Mage::helper('Magento_Reward_Helper_Data')->__('Update Points'),
            'label' => Mage::helper('Magento_Reward_Helper_Data')->__('Update Points'),
            'note'  => Mage::helper('Magento_Reward_Helper_Data')->__('Enter a negative number to subtract from the balance.')
        ));

        $fieldset->addField('comment', 'text', array(
            'name'  => 'comment',
            'title' => Mage::helper('Magento_Reward_Helper_Data')->__('Comment'),
            'label' => Mage::helper('Magento_Reward_Helper_Data')->__('Comment')
        ));

        $fieldset = $form->addFieldset('notification_fieldset', array(
            'legend' => Mage::helper('Magento_Reward_Helper_Data')->__('Reward Points Notifications')
        ));

        $fieldset->addField('update_notification', 'checkbox', array(
            'name'    => 'reward_update_notification',
            'label'   => Mage::helper('Magento_Reward_Helper_Data')->__('Subscribe for balance updates'),
        ...
        $fieldset->addField('warning_notification', 'checkbox', array(
            ...
            'label'   => Mage::helper('Magento_Reward_Helper_Data')->__('Subscribe for points expiration notifications'),
