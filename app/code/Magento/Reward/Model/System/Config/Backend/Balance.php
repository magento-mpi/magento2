...
class Magento_Reward_Model_System_Config_Backend_Balance extends Magento_Core_Model_Config_Data
{
    ...
    protected function _beforeSave()
    {
        ...
        if ($this->getFieldsetDataValue('min_points_balance') < 0) {
            Mage::throwException(Mage::helper('Magento_Reward_Helper_Data')->__('"Minimum Reward Points Balance" should be either a positive number or left empty.'));
        }
        if ($this->getFieldsetDataValue('max_points_balance') < 0) {
            Mage::throwException(Mage::helper('Magento_Reward_Helper_Data')->__('"Cap Reward Points Balance" should be either a positive number or left empty.'));
        }
        if ($this->getFieldsetDataValue('max_points_balance') &&
            ...
            Mage::throwException(Mage::helper('Magento_Reward_Helper_Data')->__('"Minimum Reward Points Balance" should be less or equal to "Cap Reward Points Balance".'));
        }
        return $this;
    }
}
