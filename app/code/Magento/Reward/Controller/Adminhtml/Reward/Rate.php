...
class Magento_Reward_Controller_Adminhtml_Reward_Rate extends Magento_Adminhtml_Controller_Action
{
    ...
    protected function _initAction()
    {
        $this->loadLayout()
            ...
            ->_addBreadcrumb(Mage::helper('Magento_Reward_Helper_Data')->__('Customers'),
                Mage::helper('Magento_Reward_Helper_Data')->__('Customers'))
            ->_addBreadcrumb(Mage::helper('Magento_Reward_Helper_Data')->__('Manage Reward Exchange Rates'),
                Mage::helper('Magento_Reward_Helper_Data')->__('Manage Reward Exchange Rates'));
        return $this;
    }
    ...
    public function saveAction()
    {
        ...
        if ($data) {
            ...
            try {
                $rate->save();
                $this->_getSession()->addSuccess(Mage::helper('Magento_Reward_Helper_Data')->__('You saved the rate.'));
            } catch (Exception $e) {
                Mage::logException($e);
    ...
    public function deleteAction()
    {
        ...
        if ($rate->getId()) {
            try {
                $rate->delete();
                $this->_getSession()->addSuccess(Mage::helper('Magento_Reward_Helper_Data')->__('You deleted the rate.'));
            } catch (Exception $e) {
