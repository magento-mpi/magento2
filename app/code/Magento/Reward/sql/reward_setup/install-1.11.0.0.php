...
$installer->addAttribute('quote', 'reward_points_balance', array('type' => \Magento\Framework\DB\Ddl\Table::TYPE_INTEGER));
$installer->addAttribute('quote', 'base_reward_currency_amount', array('type' => \Magento\Framework\DB\Ddl\Table::TYPE_DECIMAL));
$installer->addAttribute('quote', 'reward_currency_amount', array('type' => \Magento\Framework\DB\Ddl\Table::TYPE_DECIMAL));
...
$installer->addAttribute('order', 'reward_points_balance', array('type' => \Magento\Framework\DB\Ddl\Table::TYPE_INTEGER));
$installer->addAttribute('order', 'base_reward_currency_amount', array('type' => \Magento\Framework\DB\Ddl\Table::TYPE_DECIMAL));
$installer->addAttribute('order', 'reward_currency_amount', array('type' => \Magento\Framework\DB\Ddl\Table::TYPE_DECIMAL));
$installer->addAttribute(
    'order',
...
$installer->addAttribute('order', 'rwrd_crrncy_amnt_refunded', array('type' => \Magento\Framework\DB\Ddl\Table::TYPE_DECIMAL));
...
$installer->addAttribute('invoice', 'reward_currency_amount', array('type' => \Magento\Framework\DB\Ddl\Table::TYPE_DECIMAL));
...
$installer->addAttribute('creditmemo', 'reward_currency_amount', array('type' => \Magento\Framework\DB\Ddl\Table::TYPE_DECIMAL));

$installer->addAttribute('invoice', 'reward_points_balance', array('type' => \Magento\Framework\DB\Ddl\Table::TYPE_INTEGER));

$installer->addAttribute('creditmemo', 'reward_points_balance', array('type' => \Magento\Framework\DB\Ddl\Table::TYPE_INTEGER));
...
$installer->addAttribute('order', 'reward_salesrule_points', array('type' => \Magento\Framework\DB\Ddl\Table::TYPE_INTEGER));
