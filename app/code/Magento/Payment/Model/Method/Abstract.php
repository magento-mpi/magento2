...
abstract class Magento_Payment_Model_Method_Abstract extends Magento_Object
{
     ...
     * @see Magento_Payment_Model_Method_Abstract::isApplicableToQuote
     */
    ...
    {
        return ($this instanceof Magento_Payment_Model_Billing_Agreement_MethodInterface);
    }
    ...
    {
        if (empty($this->_code)) {
            Mage::throwException(Mage::helper('Magento_Payment_Helper_Data')->__('We cannot retrieve the payment method code.'));
        }
        return $this->_code;
    }
    ...
    public function getInfoInstance()
    {
        ...
        if (!($instance instanceof Magento_Payment_Model_Info)) {
            Mage::throwException(Mage::helper('Magento_Payment_Helper_Data')->__('We cannot retrieve the payment information object instance.'));
        }
        return $instance;
    }
    ...
    public function validate()
    {
         ...
         if (!$this->canUseForCountry($billingCountry)) {
             Mage::throwException(Mage::helper('Magento_Payment_Helper_Data')->__('You can\'t use the payment type you selected to make payments to the billing country.'));
         }
         return $this;
    }
    ...
    {
        if (!$this->canOrder()) {
            Mage::throwException(Mage::helper('Magento_Payment_Helper_Data')->__('The order action is not available.'));
        }
        return $this;
    }
    ...
    public function authorize(Magento_Object $payment, $amount)
    {
        if (!$this->canAuthorize()) {
            Mage::throwException(Mage::helper('Magento_Payment_Helper_Data')->__('The authorize action is not available.'));
        }
        return $this;
    }
    ...
    {
        if (!$this->canCapture()) {
            Mage::throwException(Mage::helper('Magento_Payment_Helper_Data')->__('Th capture action is not available.'));
        }
    ...
    {
        if (!$this->canRefund()) {
            Mage::throwException(Mage::helper('Magento_Payment_Helper_Data')->__('The refund action is not available.'));
        }
        return $this;
    }
    ...
    public function void(Magento_Object $payment)
    {
        if (!$this->canVoid($payment)) {
            Mage::throwException(Mage::helper('Magento_Payment_Helper_Data')->__('Void action is not available.'));
        }
        return $this;
    }
    ...
    public function acceptPayment(Magento_Payment_Model_Info $payment)
    {
        if (!$this->canReviewPayment($payment)) {
            Mage::throwException(Mage::helper('Magento_Payment_Helper_Data')->__('The payment review action is unavailable.'));
        }
        return false;
    }
