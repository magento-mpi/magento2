...
class Magento_Rss_Block_Wishlist extends Mage_Wishlist_Block_Abstract
{
    ...
    {
        return Mage::helper('Magento_Rss_Helper_Data')->__('%s\'s Wishlist', $this->_getCustomer()->getName());
    }
    ...
    protected function _toHtml()
    {
        ...
        if ($this->_getWishlist()->getId()) {
            ...
            $rssObj->_addHeader(array(
                'title'         => Mage::helper('Magento_Rss_Helper_Data')->__('We cannot retrieve the wish list.'),
                'description'   => Mage::helper('Magento_Rss_Helper_Data')->__('We cannot retrieve the wish list.'),
                'link'          => Mage::getUrl(),
                'charset'       => 'UTF-8',
            ));
        }
