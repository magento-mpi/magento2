...
class Magento_Rss_Block_Catalog_NotifyStock extends Magento_Core_Block_Abstract
{
    ...
    protected function _toHtml()
    {
        ...
        $title = Mage::helper('Magento_Rss_Helper_Data')->__('Low Stock Products');
    ...
    public function addNotifyItemXmlCallback($args)
    {
        ...
        $description = Mage::helper('Magento_Rss_Helper_Data')->__('%s has reached a quantity of %s.', $product->getName(), $qty);
        $rssObj = $args['rssObj'];
        $data = array(
