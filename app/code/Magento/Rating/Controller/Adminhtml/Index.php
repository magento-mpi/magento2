    ...
    public function saveAction()
    {
        ...
        if ($this->getRequest()->getPost()) {
            try {
                ...
                $this->_objectManager->get('Magento\Backend\Model\Session')->addSuccess(__('You saved the rating.'));
        ...
        if ($this->getRequest()->getParam('id') > 0) {
            try {
                ...
                $model->load($this->getRequest()->getParam('id'))
                    ->delete();
                $this->_objectManager->get('Magento\Backend\Model\Session')->addSuccess(__('You deleted the rating.'));
                $this->_redirect('rating/*/');
            } catch (\Exception $e) {
                $this->_objectManager->get('Magento\Backend\Model\Session')->addError($e->getMessage());
                $this->_redirect('rating/*/edit', array('id' => $this->getRequest()->getParam('id')));
