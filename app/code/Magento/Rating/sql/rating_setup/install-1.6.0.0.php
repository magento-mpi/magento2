...
$table = $installer->getConnection()
    ...
    ->addColumn('entity_id', Magento_DB_Ddl_Table::TYPE_SMALLINT, null, array(
        'identity'  => true,
        'unsigned'  => true,
        'nullable'  => false,
        'primary'   => true,
        ), 'Entity Id')
    ->addColumn('entity_code', Magento_DB_Ddl_Table::TYPE_TEXT, 64, array(
        'nullable'  => false
        ), 'Entity Code')
    ->addIndex($installer->getIdxName('rating_entity', array('entity_code'), Magento_DB_Adapter_Interface::INDEX_TYPE_UNIQUE),
        array('entity_code'), array('type' => Magento_DB_Adapter_Interface::INDEX_TYPE_UNIQUE))
...
$table = $installer->getConnection()
    ...
    ->addColumn('rating_id', Magento_DB_Ddl_Table::TYPE_SMALLINT, null, array(
        'identity'  => true,
        'unsigned'  => true,
        'nullable'  => false,
        'primary'   => true,
    ...
    ->addColumn('rating_code', Magento_DB_Ddl_Table::TYPE_TEXT, 64, array(
        'nullable'  => false
        ), 'Rating Code')
    ...
    ->addIndex($installer->getIdxName('rating', array('rating_code'), Magento_DB_Adapter_Interface::INDEX_TYPE_UNIQUE),
        array('rating_code'), array('type' => Magento_DB_Adapter_Interface::INDEX_TYPE_UNIQUE))
...
$table = $installer->getConnection()
    ...
    ->addColumn('vote_id', Magento_DB_Ddl_Table::TYPE_BIGINT, null, array(
        'identity'  => true,
        'unsigned'  => true,
        'nullable'  => false,
        'primary'   => true,
    ...
    ->addColumn('remote_ip', Magento_DB_Ddl_Table::TYPE_TEXT, 16, array(
        'nullable'  => false
        ), 'Customer IP')
    ->addColumn('remote_ip_long', Magento_DB_Ddl_Table::TYPE_BIGINT, null, array(
        'nullable'  => false,
        'default'   => 0
    ...
    ->addColumn('entity_pk_value', Magento_DB_Ddl_Table::TYPE_BIGINT, null, array(
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => 0
        ), 'Product id')
    ...
    ->addColumn('review_id', Magento_DB_Ddl_Table::TYPE_BIGINT, null, array(
        'unsigned'  => true,
        ), 'Review id')
    ->addColumn('percent', Magento_DB_Ddl_Table::TYPE_SMALLINT, null, array(
        'nullable'  => false,
        'default'   => 0
        ), 'Percent amount')
    ->addColumn('value', Magento_DB_Ddl_Table::TYPE_SMALLINT, null, array(
...
$table = $installer->getConnection()
    ...
    ->addColumn('primary_id', Magento_DB_Ddl_Table::TYPE_INTEGER, null, array(
        'identity'  => true,
        'nullable'  => false,
        'primary'   => true,
        ), 'Vote aggregation id')
    ...
    ->addColumn('vote_count', Magento_DB_Ddl_Table::TYPE_INTEGER, null, array(
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => 0
        ), 'Vote dty')
    ->addColumn('vote_value_sum', Magento_DB_Ddl_Table::TYPE_INTEGER, null, array(
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => 0
        ), 'General vote sum')
    ...
    ->addColumn('percent_approved', Magento_DB_Ddl_Table::TYPE_SMALLINT, null, array(
        'default'   => '0',
