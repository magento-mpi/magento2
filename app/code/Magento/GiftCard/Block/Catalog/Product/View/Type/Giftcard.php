...
class Giftcard extends \Magento\Catalog\Block\Product\View\AbstractView
{
    ...
    public function isMessageAvailable($product)
    {
        if ($product->getUseConfigAllowMessage()) {
            return $this->_storeConfig->isSetFlag(\Magento\GiftCard\Model\Giftcard::XML_PATH_ALLOW_MESSAGE, \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        } else {
    ...
    {
        return (int) $this->_storeConfig->getValue(\Magento\GiftCard\Model\Giftcard::XML_PATH_MESSAGE_MAX_LENGTH, \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    }
