...
class Data extends \Magento\Core\Helper\Url
{
    ...
    {
        return $this->_storeConfig->isSetFlag(\Magento\ProductAlert\Model\Observer::XML_PATH_STOCK_ALLOW, \Magento\Store\Model\StoreManagerInterface::SCOPE_TYPE_STORE);
    }
    ...
    {
        return $this->_storeConfig->isSetFlag(\Magento\ProductAlert\Model\Observer::XML_PATH_PRICE_ALLOW, \Magento\Store\Model\StoreManagerInterface::SCOPE_TYPE_STORE);
    }
}
