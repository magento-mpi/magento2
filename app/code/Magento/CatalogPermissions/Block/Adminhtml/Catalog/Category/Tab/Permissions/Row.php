    ...
    extends Magento_Adminhtml_Block_Catalog_Category_Abstract
{
    ...
    protected function _prepareLayout()
    {
        $this->addChild('delete_button', 'Magento_Adminhtml_Block_Widget_Button', array(
            //'label' => $this->helper('Magento_CatalogPermissions_Helper_Data')->__('Remove Permission'),
    ...
    {
        return array(
            'grant_catalog_category_view' => $this->helper('Magento_CatalogPermissions_Helper_Data')->__('Browsing Category'),
            'grant_catalog_product_price' => $this->helper('Magento_CatalogPermissions_Helper_Data')->__('Display Product Prices'),
            'grant_checkout_items' => $this->helper('Magento_CatalogPermissions_Helper_Data')->__('Add to Cart')
        );
    }
