...
$table = $installer->getConnection()->newTable(
    ...
    $installer->getFkName('magento_catalogpermissions', 'website_id', 'core_website', 'website_id'),
    'website_id',
...
$table = $installer->getConnection()->newTable(
    ...
    $installer->getFkName('magento_catalogpermissions_index', 'website_id', 'core_website', 'website_id'),
    'website_id',
    $installer->getTable('core_website'),
    'website_id',
    \Magento\DB\Ddl\Table::ACTION_CASCADE,
...
$table = $installer->getConnection()->newTable(
    ...
    $installer->getFkName('magento_catalogpermissions_index_product', 'store_id', 'core_store', 'store_id'),
    'store_id',
