...
$table = $installer->getConnection()
    ...
    ->addColumn('code', Magento_DB_Ddl_Table::TYPE_TEXT, 15, array(
        'nullable'  => true,
        ), 'Code')
    ->addColumn('meta_xml', Magento_DB_Ddl_Table::TYPE_BLOB, '64K', array(
        ), 'Meta Xml')
...
$table = $installer->getConnection()
    ...
    ->addColumn('is_listed', Magento_DB_Ddl_Table::TYPE_SMALLINT, null, array(
        'unsigned'  => true,
        ), 'Is Listed')
...
$table = $installer->getConnection()
    ...
    ->addColumn('attribute_code', Magento_DB_Ddl_Table::TYPE_TEXT, 32, array(
        'primary'   => true,
        'nullable'  => false,
        ), 'Attribute Code')
    ->addColumn('store_id', Magento_DB_Ddl_Table::TYPE_SMALLINT, null, array(
    ...
    ->addColumn('option_code', Magento_DB_Ddl_Table::TYPE_TEXT, 32, array(
        'primary'   => true,
        'nullable'  => false,
        ), 'Option Code')
    ->addColumn('label', Magento_DB_Ddl_Table::TYPE_TEXT, 255, array(
...
$table = $installer->getConnection()
    ...
    ->addColumn('is_public', Magento_DB_Ddl_Table::TYPE_SMALLINT, null, array(
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => '1',
        ), 'Is Public')
    ->addColumn('url_key', Magento_DB_Ddl_Table::TYPE_TEXT, 100, array(
        ), 'Url Key')
    ...
    ->addColumn('shipping_address', Magento_DB_Ddl_Table::TYPE_BLOB, '64K', array(
        ), 'Shipping Address')
    ->addColumn('custom_values', Magento_DB_Ddl_Table::TYPE_TEXT, '64k', array(
        ), 'Custom Values')
...
$table = $installer->getConnection()
    ...
    ->addColumn('qty_fulfilled', Magento_DB_Ddl_Table::TYPE_DECIMAL, '12,4', array(
        ), 'Qty Fulfilled')
    ->addColumn('note', Magento_DB_Ddl_Table::TYPE_TEXT, '64k', array(
        ), 'Note')
    ->addColumn('added_at', Magento_DB_Ddl_Table::TYPE_TIMESTAMP, null, array(
        ), 'Added At')
    ->addColumn('custom_options', Magento_DB_Ddl_Table::TYPE_TEXT, '64k', array(
        ), 'Custom Options')
...
$table = $installer->getConnection()
    ...
    ->addColumn('person_id', Magento_DB_Ddl_Table::TYPE_INTEGER, null, array(
        'identity'  => true,
        'unsigned'  => true,
        'nullable'  => false,
        'primary'   => true,
    ...
    ->addColumn('firstname', Magento_DB_Ddl_Table::TYPE_TEXT, 100, array(
        'nullable'  => true,
        ), 'Firstname')
    ->addColumn('lastname', Magento_DB_Ddl_Table::TYPE_TEXT, 100, array(
        'nullable'  => true,
        ), 'Lastname')
    ->addColumn('email', Magento_DB_Ddl_Table::TYPE_TEXT, 150, array(
        'nullable'  => true,
        ), 'Email')
    ->addColumn('role', Magento_DB_Ddl_Table::TYPE_TEXT, 32, array(
        'nullable'  => true,
        ), 'Role')
    ->addColumn('custom_values', Magento_DB_Ddl_Table::TYPE_TEXT, '64k', array(
        'nullable'  => false,
...
$table = $installer->getConnection()
    ...
    ->addColumn('event_date', Magento_DB_Ddl_Table::TYPE_DATE, null, array(
        ), 'Event Date')
    ->addColumn('event_country', Magento_DB_Ddl_Table::TYPE_TEXT, 3, array(
        ), 'Event Country')
    ->addColumn('event_country_region', Magento_DB_Ddl_Table::TYPE_INTEGER, null, array(
        ), 'Event Country Region')
    ->addColumn('event_country_region_text', Magento_DB_Ddl_Table::TYPE_TEXT, 30, array(
        ), 'Event Country Region Text')
    ->addColumn('event_location', Magento_DB_Ddl_Table::TYPE_TEXT, 255, array(
        ), 'Event Location')
    ->addForeignKey(
        $installer->getFkName(
...
$installer->addAttribute(
    'quote_item', 'giftregistry_item_id', array('type' => Magento_DB_Ddl_Table::TYPE_INTEGER, 'visible' => false)
);
$installer->addAttribute(
    'order_item', 'giftregistry_item_id', array('type' => Magento_DB_Ddl_Table::TYPE_INTEGER, 'visible' => false)
);
$installer->addAttribute(
    'quote_address', 'giftregistry_item_id', array('type' => Magento_DB_Ddl_Table::TYPE_INTEGER, 'visible' => false)
);
$installer->addAttribute(
    'order_address', 'giftregistry_item_id', array('type' => Magento_DB_Ddl_Table::TYPE_INTEGER, 'visible' => false)
);
