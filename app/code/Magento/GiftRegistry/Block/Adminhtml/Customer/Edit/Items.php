    ...
    extends Magento_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        $this->addColumn('product_id', array(
            'header' => Mage::helper('Magento_GiftRegistry_Helper_Data')->__('ID'),
            'index'  => 'product_id',
            'type'   => 'number',
            'width'  => '120px'
        ));
        ...
        $this->addColumn('qty', array(
            'header'   => Mage::helper('Magento_GiftRegistry_Helper_Data')->__('Requested'),
            'index'    => 'qty',
            'width'    => '120px',
        ...
        $this->addColumn('note', array(
            'header' => Mage::helper('Magento_GiftRegistry_Helper_Data')->__('Note'),
            'index'  => 'note',
            'width'  => '120px'
        ));

        $this->addColumn('action', array(
            'header' => Mage::helper('Magento_GiftRegistry_Helper_Data')->__('Action'),
            'width'  => '120px',
            'options'   => array(
                 0 => Mage::helper('Magento_GiftRegistry_Helper_Data')->__('Action'),
                'update' => Mage::helper('Magento_GiftRegistry_Helper_Data')->__('Update Quantity'),
                'remove' => Mage::helper('Magento_GiftRegistry_Helper_Data')->__('Remove Item')
            ),
