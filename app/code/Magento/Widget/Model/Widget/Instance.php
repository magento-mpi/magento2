...
class Magento_Widget_Model_Widget_Instance extends Magento_Core_Model_Abstract
{
    ...
    public function validate()
    {
        ...
        return Mage::helper('Magento_Widget_Helper_Data')->__('We cannot create the widget instance because it is missing required information.');
    }
        ...
        if ($this->getWidgetConfig() && ($configTemplates = $this->getWidgetConfig()->parameters->template)) {
            if ($configTemplates->values && $configTemplates->values->children()) {
                ...
                $templates['default'] = array(
                    ...
                    'label' => Mage::helper('Magento_Widget_Helper_Data')->__('Default Template')
                );
            }
        }
        return $templates;
