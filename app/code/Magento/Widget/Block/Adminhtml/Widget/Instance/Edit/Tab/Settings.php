    ...
    implements Magento_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    {
        return Mage::helper('Magento_Widget_Helper_Data')->__('Settings');
    }
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('base_fieldset',
            array('legend'=>Mage::helper('Magento_Widget_Helper_Data')->__('Settings'))
        );
        ...
        $fieldset->addField('theme_id', 'select', array(
            'name'     => 'theme_id',
            'label'    => Mage::helper('Magento_Widget_Helper_Data')->__('Design Theme'),
            'title'    => Mage::helper('Magento_Widget_Helper_Data')->__('Design Theme'),
            'required' => true,
            'values'   => $options
        ));
        $continueButton = $this->getLayout()
            ...
            ->setData(array(
                'label'     => Mage::helper('Magento_Widget_Helper_Data')->__('Continue'),
    ...
    public function getTypesOptionsArray()
    {
        ...
        array_unshift($widgets, array(
            'value' => '',
            'label' => Mage::helper('Magento_Widget_Helper_Data')->__('-- Please Select --')
        ));
        return $widgets;
    }
