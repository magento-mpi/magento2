...
class Magento_Cms_Model_Wysiwyg_Images_Storage extends Magento_Object
{
    ...
    public function createDirectory($name, $path)
    {
        if (!preg_match(self::DIRECTORY_NAME_REGEXP, $name)) {
            Mage::throwException(Mage::helper('Magento_Cms_Helper_Data')->__('Please correct the folder name. Use only letters, numbers, underscores and dashes.'));
        }
        ...
        if ($this->_filesystem->isDirectory($newPath, $path)) {
            Mage::throwException(Mage::helper('Magento_Cms_Helper_Data')->__('We found a directory with the same name. Please try another folder name.'));
        }
        ...
        try {
            ...
            Mage::throwException(Mage::helper('Magento_Cms_Helper_Data')->__('We cannot create a new directory.'));
        }
    }
    ...
    public function deleteDirectory($path)
    {
        ...
        if ($rootCmp == $pathCmp) {
            Mage::throwException(
                Mage::helper('Magento_Cms_Helper_Data')->__('We cannot delete root directory %s.', $path)
            );
        }
        ...
        try {
            ...
            Mage::throwException(Mage::helper('Magento_Cms_Helper_Data')->__('We cannot delete directory %s.', $path));
        }
    ...
    public function uploadFile($targetPath, $type = null)
    {
        ...
        if (!$result) {
            Mage::throwException(Mage::helper('Magento_Cms_Helper_Data')->__('We cannot upload the file.') );
        }
