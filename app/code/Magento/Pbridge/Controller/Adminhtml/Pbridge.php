...
class Magento_Pbridge_Controller_Adminhtml_Pbridge extends Magento_Adminhtml_Controller_Action
{
    ...
    public function iframeAction()
    {
        ...
        if ($methodCode) {
            ...
            Mage::throwException(Mage::helper('Magento_Pbridge_Helper_Data')->__('Payment Method Code is not passed.'));
        }
    }
    ...
    public function resultAction()
    {
        if ($this->getRequest()->getParam('store')) {
            Mage::helper('Magento_Pbridge_Helper_Data')->setStoreId($this->getRequest()->getParam('store'));
        }
