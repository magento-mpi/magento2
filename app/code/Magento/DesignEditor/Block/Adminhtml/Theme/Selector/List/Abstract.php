 ...
 * @method Magento_DesignEditor_Block_Adminhtml_Theme_Selector_List_Abstract setHasThemeAssigned(bool $flag)
 * @method Magento_DesignEditor_Block_Adminhtml_Theme_Selector_List_Abstract|Magento_DesignEditor_Block_Adminhtml_Theme_Selector_List_Available setCollection(Magento_Core_Model_Resource_Theme_Collection $collection)
 * @method Magento_DesignEditor_Block_Adminhtml_Theme_Selector_List_Abstract setIsFirstEntrance(bool $flag)
 *
 * @SuppressWarnings(PHPMD.CouplingBetweenObjects)
 */
// @codingStandardsIgnoreEnd
abstract class Magento_DesignEditor_Block_Adminhtml_Theme_Selector_List_Abstract
