...
$table = $installer->getConnection()
    ...
    ->addColumn('change_id', Magento_DB_Ddl_Table::TYPE_INTEGER, null, array(
        'identity' => true,
        'unsigned' => true,
        'nullable' => false,
        'primary'  => true,
    ...
    ->addColumn('change_time', Magento_DB_Ddl_Table::TYPE_TIMESTAMP, null, array('nullable' => false), 'Change Time')
    ->addForeignKey(
