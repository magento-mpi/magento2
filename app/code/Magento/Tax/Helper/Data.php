...
class Data extends \Magento\App\Helper\AbstractHelper
{
    ...
    {
        return $this->_coreStoreConfig->getConfig(Config::CONFIG_XML_PATH_BASED_ON, $store);
    }
    ...
    {
        return (int) $this->_coreStoreConfig->getConfig(Config::CONFIG_XML_PATH_APPLY_ON, $store) == 0;
    }
    ...
    {
        return (int) $this->_coreStoreConfig->getConfig(Config::CONFIG_XML_PATH_APPLY_ON, $store) == 1;
    }
