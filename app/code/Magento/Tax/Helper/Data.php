...
class Data extends \Magento\App\Helper\AbstractHelper
{
    ...
    {
        return ((int) $this->_storeConfig->getValue(\Magento\Tax\Model\Config::CONFIG_XML_PATH_APPLY_ON, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $store) == 0);
    }
    ...
    {
        return ((int) $this->_storeConfig->getValue(\Magento\Tax\Model\Config::CONFIG_XML_PATH_APPLY_ON, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $store) == 1);
    }
