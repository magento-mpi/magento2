 ...
 */
class Magento_Tax_Model_Resource_Class_Collection extends Magento_Core_Model_Resource_Db_Collection_Abstract
{
    /**
     ...
     * @return Magento_Tax_Model_Resource_Class_Collection
     */
