...
class Magento_TargetRule_Model_Index extends Magento_Index_Model_Indexer_Abstract
{
    ...
    public function getProduct()
    {
        ...
        if (!$product instanceof Magento_Object) {
            Mage::throwException(Mage::helper('Magento_TargetRule_Helper_Data')->__('Please define a product data object.'));
        }
        return $product;
    }
    ...
    {
        return Mage::helper('Magento_TargetRule_Helper_Data')->__('Target Rules');
    }
