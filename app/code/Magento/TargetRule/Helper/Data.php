    ...
    public function getMaximumNumberOfProduct($type)
    {
        switch ($type) {
            ...
            case Magento_TargetRule_Model_Rule::CROSS_SELLS:
                ...
                break;
            default:
                Mage::throwException(Mage::helper('Magento_TargetRule_Helper_Data')->__('Invalid product list type'));
        }
    ...
    public function getRotationMode($type)
    {
        switch ($type) {
            ...
            case Magento_TargetRule_Model_Rule::CROSS_SELLS:
                ...
                break;
            default:
                Mage::throwException(Mage::helper('Magento_TargetRule_Helper_Data')->__('Invalid rotation mode type'));
        }
        return $mode;
    }
}
