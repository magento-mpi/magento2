...
class Magento_TargetRule_Block_Adminhtml_Targetrule_Edit extends Magento_Adminhtml_Block_Widget_Form_Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_addButton('save_and_continue_edit', array(
            'class'   => 'save',
            'label'   => Mage::helper('Magento_TargetRule_Helper_Data')->__('Save and Continue Edit'),
    ...
    public function getHeaderText()
    {
        ...
        if ($rule && $rule->getRuleId()) {
            return Mage::helper('Magento_TargetRule_Helper_Data')->__("Edit Rule '%s'", $this->escapeHtml($rule->getName()));
        }
        else {
            return Mage::helper('Magento_TargetRule_Helper_Data')->__('New Rule');
        }
    }
