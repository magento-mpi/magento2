...
class Enterprise_License_Block_Adminhtml_Checker extends Mage_Adminhtml_Block_Template
{
    ...
    public function getMessage()
    {
        ...
        if($days < 0) {
            ...
            $message = __('Act soon! Your Magento Enteprise Edition will expire in %d days. Please contact <a href="mailto:sales@magento.com">sales@magento.com</a> to renew the license.', $days);
        }
