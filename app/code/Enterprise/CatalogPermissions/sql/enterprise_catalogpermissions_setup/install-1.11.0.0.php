...
$table = $installer->getConnection()
    ...
    ->addIndex($installer->getIdxName('enterprise_catalogpermissions', array('category_id', 'website_id', 'customer_group_id'), Magento_DB_Adapter_Interface::INDEX_TYPE_UNIQUE),
...
$table = $installer->getConnection()
    ...
    ->addIndex($installer->getIdxName('enterprise_catalogpermissions_index_product', array('product_id', 'store_id', 'category_id', 'customer_group_id'), Magento_DB_Adapter_Interface::INDEX_TYPE_UNIQUE),
