...
class Enterprise_Pci_Controller_Adminhtml_Crypt_Key extends Magento_Adminhtml_Controller_Action
{
    ...
    public function saveAction()
    {
        try {
            ...
            if (!$key) {
                Mage::getSingleton('Magento_Adminhtml_Model_Session')->addNotice(Mage::helper('Enterprise_Pci_Helper_Data')->__('This is your new encryption key: <span style="font-family:monospace;">%s</span>. Be sure to write it down and take good care of it!', $newKey));
            }
            Mage::app()->cleanCache();
        }
        catch (Exception $e) {
