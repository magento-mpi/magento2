...
$table = $installer->getConnection()
    ...
    ->addIndex($installer->getIdxName('enterprise_customersegment_customer', array('segment_id', 'website_id', 'customer_id'), Magento_DB_Adapter_Interface::INDEX_TYPE_UNIQUE),
