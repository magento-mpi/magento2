...
class Enterprise_PromotionPermissions_Model_Observer
{
     ...
     * Sets necessary data
     *
     * @param Enterprise_PromotionPermissions_Helper_Data $promoPermData
     */
    public function __construct(
        Enterprise_PromotionPermissions_Helper_Data $promoPermData
    ) {
        ...
        $this->_isEnterpriseBannerEnabled = $promoPermData->isModuleEnabled('Enterprise_Banner');
        $this->_isEnterpriseReminderEnabled = $promoPermData->isModuleEnabled('Enterprise_Reminder');
    }
