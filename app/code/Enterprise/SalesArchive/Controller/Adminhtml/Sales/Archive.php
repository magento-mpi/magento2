 ...
 *
 */
class Enterprise_SalesArchive_Controller_Adminhtml_Sales_Archive extends Magento_Adminhtml_Controller_Action
{
    /**
     * Render archive grid
     *
     * @return Enterprise_SalesArchive_Controller_Adminhtml_Sales_Archive
     */
