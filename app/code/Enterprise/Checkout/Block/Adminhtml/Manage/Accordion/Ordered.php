    ...
    extends Enterprise_Checkout_Block_Adminhtml_Manage_Accordion_Abstract
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_getStore()) {
            $this->setHeaderText(
                Mage::helper('Enterprise_Checkout_Helper_Data')->__('Last ordered items (%1)', $this->getItemsCount())
            );
        }
    }
        ...
        if (!$this->hasData('items_collection')) {
            ...
            if (isset($order)) {
                ...
                if ($productIds) {
                    ...
                    Mage::getSingleton('Mage_CatalogInventory_Model_Stock_Status')->addIsInStockFilterToCollection($products);
