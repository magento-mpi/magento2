...
class Enterprise_Rma_Block_Adminhtml_Rma_Create_Header extends Enterprise_Rma_Block_Adminhtml_Rma_Create_Abstract
{
    protected function _toHtml()
    {
        ...
        if ($customerId && $storeId) {
            ...
            $out .= Mage::helper('Enterprise_Rma_Helper_Data')->__('Create New RMA for %1 in %2', $customerName, $storeName);
        } elseif ($customerId) {
            $out.= Mage::helper('Enterprise_Rma_Helper_Data')->__('Create New RMA for %1', $this->getCustomerName());
        } else {
