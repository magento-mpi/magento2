...
if ($page) {
    ...
    $blocks = array(
        array(
            'Flaunt yourself',
            'flaunt_yourself',
            '<img src="{{view url="Enterprise_Enterprise::images/callouts/home/flaunt_yourself.jpg"}}"'
                . ' alt="Flaunt yourself" />'
        ),
        array(
            ...
            '<a href="{{store direct_url="privatesales/"}}">'
                . '<img src="{{view url="Enterprise_Enterprise::images/callouts/home/link_private_sales.gif"}}" '
        ...
        array(
            ...
            '<a href="{{store direct_url="gift-cards"}}">'
                . '<img src="{{view url="Enterprise_Enterprise::images/callouts/home/link_gift_cards.gif"}}"'
                . ' alt="Gift Cards" /></a>'
        ),
        array(
            ...
            '<a href="{{store direct_url="apparel/women/handbags"}}">'
                ...
                . 'src="{{view url="Enterprise_Enterprise::images/callouts/home/link_handbags.jpg"}}"'
                . ' alt="Handbags" /></a>'
        ),
    );
    $createdBlocks = array();
