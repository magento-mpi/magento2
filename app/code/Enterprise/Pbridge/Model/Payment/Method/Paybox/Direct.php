 ...
 * @author      Magento
 */
class Enterprise_Pbridge_Model_Payment_Method_Paybox_Direct extends Magento_Payment_Model_Method_Cc
{
    ...
    {
        Mage::throwException(Mage::helper('Magento_Payment_Helper_Data')->__('Refund action is not available.'));
    }
