 ...
 */
class Enterprise_Pbridge_Model_Payment_Method_Payflow_Pro extends Magento_Paypal_Model_Payflowpro
{
    /**
    ...
    public function __construct(
        ...
        parent::__construct($coreData, $moduleList, $paymentData, $data);
    }
