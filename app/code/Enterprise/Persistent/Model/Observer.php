...
class Enterprise_Persistent_Model_Observer
{
     ...
     */
    protected $_ePersistentData;

    /**
     * @var Magento_Persistent_Helper_Data
     */
    protected $_mPersistentData;
