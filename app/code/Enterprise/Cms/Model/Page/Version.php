...
//                }
    ...
    protected function _beforeDelete()
    {
        ...
        if ($this->isPublic()) {
            if ($resource->isVersionLastPublic($this)) {
                Mage::throwException(
                    __('Version "%s" cannot be removed because it is the last public page version.', $this->getLabel())
                );
            }
        }
        ...
        if ($resource->isVersionHasPublishedRevision($this)) {
            Mage::throwException(
                __('Version "%s" cannot be removed because its revision is published.', $this->getLabel())
            );
        }
