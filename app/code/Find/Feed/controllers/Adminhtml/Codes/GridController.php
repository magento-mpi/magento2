...
class Find_Feed_Adminhtml_Codes_GridController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function massEnableAction()
    {
        ...
        if ($updatedCodes > 0) {
            $this->_getSession()->addSuccess(__("%s codes imported", $updatedCodes));
        }
    ...
    public function massDisableAction()
    {
        ...
        if ($updatedCodes > 0) {
            $this->_getSession()->addSuccess(__("%s codes not imported", $updatedCodes));
        }
        $this->_redirect('*/*/index');
    }
    ...
    public function deleteAction()
    {
        ...
        if ($updatedCodes > 0) {
            $this->_getSession()->addSuccess(__("%s codes deleted", $updatedCodes));
        }
        $this->_redirect('*/*/index');
    }
