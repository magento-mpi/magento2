...
class Mage_Adminhtml_Promo_QuoteController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function editAction()
    {
        ...
        $this->_title($model->getRuleId() ? $model->getName() : $this->__('New Cart Price Rule'));
        ...
        if (!$rule->getId()) {
            ...
            try {
                ...
                if (!$generator->validateData($data)) {
                    ...
                    $this->_getSession()->addSuccess(Mage::helper('Mage_SalesRule_Helper_Data')->__('%1 coupon(s) have been generated.', $generated));
