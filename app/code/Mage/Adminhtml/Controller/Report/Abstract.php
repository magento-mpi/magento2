...
abstract class Mage_Adminhtml_Controller_Report_Abstract extends Mage_Adminhtml_Controller_Action
{
    ...
    protected function _showLastExecutionTime($flagCode, $refreshCode)
    {
        ...
        Mage::getSingleton('Mage_Adminhtml_Model_Session')->addNotice(__('Last updated: %s. To refresh last day\'s <a href="%s">statistics</a>, click <a href="%s">here</a>.', $updatedAt, $refreshStatsLink, $directRefreshLink));
        return $this;
    }
}
