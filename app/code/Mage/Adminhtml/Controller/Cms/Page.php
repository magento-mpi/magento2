 ...
 */
class Mage_Adminhtml_Controller_Cms_Page extends Mage_Adminhtml_Controller_Action
{
    ...
    public function deleteAction()
    {
        ...
        // display error message
        Mage::getSingleton('Mage_Adminhtml_Model_Session')->addError(__('We can\'t find a page to delete.'));
        // go to grid
        $this->_redirect('*/*/');
    }
