 ...
 */
class Mage_Adminhtml_Controller_Customer_Cart_Product_Composite_Cart extends Mage_Adminhtml_Controller_Action
{
    /**
     ...
     *
     * @return Mage_Adminhtml_Controller_Customer_Cart_Product_Composite_Cart
     */
