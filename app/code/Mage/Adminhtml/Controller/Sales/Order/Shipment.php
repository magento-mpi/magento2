 ...
 */
class Mage_Adminhtml_Controller_Sales_Order_Shipment extends Mage_Adminhtml_Controller_Sales_Shipment_ShipmentAbstract
{
    /**
     ...
     * @return Mage_Adminhtml_Controller_Sales_Order_Shipment
     */
