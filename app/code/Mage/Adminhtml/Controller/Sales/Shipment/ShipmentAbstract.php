 ...
 */
class Mage_Adminhtml_Controller_Sales_Shipment_ShipmentAbstract extends Mage_Adminhtml_Controller_Action
{
    /**
     ...
     *
     * @return Mage_Adminhtml_Controller_Sales_Shipment
     */
