...
<div id="{$htmlId}-container" class="images"
    ...
    <div class="image image-placeholder">
        ...
        <p class="image-placeholder-text">{__('Click here or drag and drop to add images')}</p>
    </div>
    <script id="{$htmlId}-template" class="image-template" type="text/x-jquery-tmpl">
        <div class="image">
            ...
            <div class="actions">
                <button class="action-delete" data-role="delete-button" title="{__('Delete image')}">
                    <span>{__('Delete image')}</span>
                </button>
                <button class="action-make-base" data-role="make-base-button" title="{__('Make Base')}">
                    <span>{__('Make Base')}</span>
                </button>
