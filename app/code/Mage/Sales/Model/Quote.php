...
class Mage_Sales_Model_Quote extends Magento_Core_Model_Abstract
{
    ...
    public function addProductAdvanced(Mage_Catalog_Model_Product $product, $request = null, $processMode = null)
    {
        ...
        if (!($request instanceof Magento_Object)) {
            Mage::throwException(
                Mage::helper('Mage_Sales_Helper_Data')->__('We found an invalid request for adding product to quote.')
            );
        }
    ...
    public function updateItem($itemId, $buyRequest, $params = null)
    {
        ...
        if (!$item) {
            Mage::throwException(
                Mage::helper('Mage_Sales_Helper_Data')->__('This is the wrong quote item id to update configuration.')
            );
        }
