    ...
    protected function _validate()
    {
        if (!$this->getQuote()->isVirtual()) {
            ...
            if ($addressValidation !== true) {
                Mage::throwException(
                    __('Please check the shipping address information. %s', implode(' ', $addressValidation))
                );
            }
        ...
        if ($addressValidation !== true) {
            Mage::throwException(
                __('Please check the billing address information. %s', implode(' ', $addressValidation))
            );
        }
