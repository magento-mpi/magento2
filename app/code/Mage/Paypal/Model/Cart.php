...
class Mage_Paypal_Model_Cart
{
    ...
    protected function _render()
    {
        ...
        if ($originalDiscount > 0.0001 && isset($this->_totalLineItemDescriptions[self::TOTAL_DISCOUNT])) {
            $this->_totalLineItemDescriptions[self::TOTAL_DISCOUNT][] = Mage::helper('Mage_Sales_Helper_Data')->__('Discount (%1)', Mage::app()->getStore()->convertPrice($originalDiscount, true, false));
        }
