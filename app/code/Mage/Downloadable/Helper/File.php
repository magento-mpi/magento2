 ...
 */
class Mage_Downloadable_Helper_File extends Magento_Core_Helper_Abstract
{
    /**
        ...
        if (isset($file[0])) {
            ...
            if ($file[0]['status'] == 'new') {
                try {
                    ...
                    Mage::throwException(Mage::helper('Mage_Downloadable_Helper_Data')->__('Something went wrong while saving the file(s).'));
                }
            }
            return $fileName;
        }
