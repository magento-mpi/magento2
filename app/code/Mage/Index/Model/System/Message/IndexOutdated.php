...
class Mage_Index_Model_System_Message_IndexOutdated implements Mage_AdminNotification_Model_System_MessageInterface
{
    ...
    public function getText()
    {
        ...
        $text = $helper->__('One or more of the Indexes are not up to date: %1', $indexList) . '. ';
        $text .= $helper->__('Please go to <a href="%1">Index Management</a> and rebuild required indexes.', $url);
        return $text;
    }
