 ...
 */
class Mage_Index_Model_Resource_Event_Collection extends Magento_Core_Model_Resource_Db_Collection_Abstract
{
    /**
     * Initialize resource
     *
    ...
    {
        $this->_init('Mage_Index_Model_Event', 'Mage_Index_Model_Resource_Event');
    }
