...
class Mage_Index_Model_Process extends Mage_Core_Model_Abstract
{
    ...
    {
        if ($this->isLocked()) {
            Mage::throwException(__('%s Index process is not working now. Please try running this process later.', $this->getIndexer()->getName()));
        }
    ...
    public function getIndexer()
    {
        if ($this->_indexer === null) {
            ...
            if ($model instanceof Mage_Index_Model_Indexer_Abstract) {
                ...
                Mage::throwException(__('Indexer model should extend Mage_Index_Model_Indexer_Abstract.'));
            }
        }
