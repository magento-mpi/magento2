    ...
    public function forgotpasswordAction()
    {
        ...
        if (!empty($email) && !empty($params)) {
            ...
            if (Zend_Validate::is($email, 'EmailAddress')) {
                ...
                $this->_getSession()
                    ->addSuccess(__('If there is an account associated with %1 you will receive an email with a link to reset your password.', Mage::helper('Mage_User_Helper_Data')->escapeHtml($email)));
