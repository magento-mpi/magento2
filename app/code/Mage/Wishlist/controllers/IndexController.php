    ...
    implements Mage_Catalog_Controller_Product_View_Interface
{
    ...
    public function addAction()
    {
        ...
        try {
            ...
            $message = __('%1 has been added to your wishlist. Click <a href="%2">here</a> to continue shopping.', $helper->escapeHtml($product->getName()), Mage::helper('Mage_Core_Helper_Data')->escapeUrl($referer));
        ...
        if($post && isset($post['description']) && is_array($post['description'])) {
            ...
            foreach ($post['description'] as $itemId => $description) {
                ...
                try {
                    ...
                    Mage::getSingleton('Mage_Customer_Model_Session')->addError(
                        __('Can\'t save description %1', Mage::helper('Mage_Core_Helper_Data')->escapeHtml($description))
                    );
                }
            }
