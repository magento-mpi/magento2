 ...
 */
class Mage_Wishlist_Model_Resource_Item_Option_Collection extends Magento_Core_Model_Resource_Db_Collection_Abstract
{
    /**
    ...
    {
        $this->_init('Mage_Wishlist_Model_Item_Option', 'Mage_Wishlist_Model_Resource_Item_Option');
    }
