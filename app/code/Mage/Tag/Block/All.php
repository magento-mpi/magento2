...
class Mage_Tag_Block_All extends Magento_Core_Block_Template
{
    ...
    protected function _loadTags()
    {
        if (empty($this->_tags)) {
            $this->_tags = array();
            $tags = Mage::getModel('Mage_Tag_Model_Tag')->getPopularCollection()
    ...
    {
        return Mage::helper('Mage_Tag_Helper_Data')->__('All Tags');
    }
}
