 ...
 */
class Mage_GoogleShopping_Helper_SiteVerification extends Magento_Core_Helper_Abstract
{
    /**
     ...
     */
    public function __construct(Magento_Core_Helper_Context $context, Mage_GoogleShopping_Model_Config $config)
    {
        $this->_config = $config;
