 ...
 */
class Mage_Webapi_Model_Acl_Resource_Config_Reader_Filesystem extends Magento_Config_Reader_Filesystem
{
    /**
    ...
    public function __construct(
        ...
        $schema = $moduleReader->getModuleDir('etc', 'Mage_Webapi') . DIRECTORY_SEPARATOR . 'acl.xsd';
        parent::__construct(
            $fileResolver,
            $converter,
            $fileName,
