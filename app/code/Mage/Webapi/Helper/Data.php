...
class Mage_Webapi_Helper_Data extends Mage_Core_Helper_Abstract
{
     ...
     * @param Mage_Core_Service_ConfigAbstract $apiConfig
    ...
    public function prepareMethodParams(
        ...
        $methodName,
        $requestData,
        Mage_Core_Service_ConfigAbstract $apiConfig
    ) {
     ...
     */
    protected function _formatParamData($data, $dataType, Mage_Core_Service_ConfigAbstract $apiConfig)
    {
