    ...
    implements Mage_AdminNotification_Model_System_MessageInterface
{
    ...
    public function getText()
    {
        ...
        return $this->_helperFactory->get('Mage_AdminNotification_Helper_Data')->__('We appreciate our merchants\' feedback. Please <a href="#" data-mage-init=%1>take our survey</a> and tell us about features you\'d like to see in Magento.', json_encode($params, JSON_FORCE_OBJECT));
    }
