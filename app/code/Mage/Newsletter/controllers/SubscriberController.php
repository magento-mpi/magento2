        ...
        if ($this->getRequest()->isPost() && $this->getRequest()->getPost('email')) {
            ...
            try {
                ...
                if (Mage::getStoreConfig(Mage_Newsletter_Model_Subscriber::XML_PATH_ALLOW_GUEST_SUBSCRIBE_FLAG) != 1 && 
                    ...
                    Mage::throwException(__('Sorry, but the administrator denied subscription for guests. Please <a href="%s">register</a>.', Mage::helper('Mage_Customer_Helper_Data')->getRegisterUrl()));
                }
                ...
                $session->addException($e, __('There was a problem with the subscription: %s', $e->getMessage()));
            }
            catch (Exception $e) {
