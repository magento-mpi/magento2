...
class Mage_Usa_Block_Adminhtml_Dhl_Unitofmeasure extends Mage_Backend_Block_System_Config_Form_Field
{
    ...
    public function _construct()
    {
        ...
        $this->setDivideOrderWeightNoteKg(
            $this->jsQuoteEscape($this->__('This allows breaking total order weight into smaller pieces if it exceeds %1 %2 to ensure accurate calculation of shipping charges.', $kgWeight, 'kg'))
        );
        ...
        $this->setDivideOrderWeightNoteLbp(
            $this->jsQuoteEscape($this->__('This allows breaking total order weight into smaller pieces if it exceeds %1 %2 to ensure accurate calculation of shipping charges.', $weight, 'pounds'))
        );
