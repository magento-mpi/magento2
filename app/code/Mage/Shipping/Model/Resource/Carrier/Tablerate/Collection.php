 ...
 */
class Mage_Shipping_Model_Resource_Carrier_Tablerate_Collection extends Magento_Core_Model_Resource_Db_Collection_Abstract
{
    /**
    ...
    {
        $this->_init('Mage_Shipping_Model_Carrier_Tablerate', 'Mage_Shipping_Model_Resource_Carrier_Tablerate');
