    ...
    implements Mage_Shipping_Model_Carrier_Interface
{
    ...
    public function getCode($type, $code='')
    {
        ...
        if (!isset($codes[$type])) {
            throw Mage::exception('Mage_Shipping', __('Please correct Table Rate code type: %1.', $type));
        }
        ...
        if (!isset($codes[$type][$code])) {
            throw Mage::exception('Mage_Shipping', __('Please correct Table Rate code for type %1: %2.', $type, $code));
        }
