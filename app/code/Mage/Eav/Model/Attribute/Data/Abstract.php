...
abstract class Mage_Eav_Model_Attribute_Data_Abstract
{
    ...
    protected function _validateInputRule($value)
    {
            ...
            switch ($validateRules['input_validation']) {
                case 'alphanumeric':
                    ...
                    $validator->setMessage(
                        __('"%s" invalid type entered.', $label),
                        Zend_Validate_Alnum::INVALID
                    );
                    $validator->setMessage(
                        __('"%s" contains non-alphabetic or non-numeric characters.', $label),
                        Zend_Validate_Alnum::NOT_ALNUM
                    );
                    $validator->setMessage(
                        __('"%s" is an empty string.', $label),
                ...
                case 'numeric':
                    ...
                    $validator->setMessage(
                        __('"%s" contains non-numeric characters.', $label),
                ...
                case 'alpha':
                    ...
                    $validator->setMessage(
                        __('"%s" contains non-alphabetic characters.', $label),
        ...
        */
                    ...
                    $validator->setMessage(
                        __('"%s" is not a valid email address.', $label),
                        Zend_Validate_EmailAddress::INVALID_FORMAT
                    );
                    $validator->setMessage(
                        __('"%s" is not a valid hostname.', $label),
                    ...
                    $validator->setMessage(
                        __('"%s" exceeds the allowed length.', $label),
                ...
                case 'url':
                    ...
                    if ($parsedUrl === false || empty($parsedUrl['scheme']) || empty($parsedUrl['host'])) {
                        return array(__('"%s" is not a valid URL.', $label));
                    }
                ...
                case 'date':
                    ...
                    $validator->setMessage(
                        __('"%s" is not a valid date.', $label),
                        Zend_Validate_Date::INVALID_DATE
                    );
                    $validator->setMessage(
                        __('"%s" does not fit the entered date format.', $label),
