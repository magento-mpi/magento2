...
class Mage_Backend_Block_Widget_Grid_Column_Filter_Date extends Mage_Backend_Block_Widget_Grid_Column_Filter_Abstract
{
    ...
    public function getEscapedValue($index=null)
    {
        ...
        if ($value instanceof Zend_Date) {
            return $value->toString($this->getLocale()->getDateFormat(Mage_Core_Model_LocaleInterface::FORMAT_TYPE_SHORT));
        }
        return $value;
    }
    ...
    protected function _convertDate($date, $locale)
    {
        try {
            ...
            $dateObj->setTimezone(Mage_Core_Model_LocaleInterface::DEFAULT_TIMEZONE);
