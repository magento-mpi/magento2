...
class Mage_Sendfriend_Model_Sendfriend extends Mage_Core_Model_Abstract
{
    ...
    public function send()
    {
        if ($this->isExceedLimit()){
            Mage::throwException(__('You\'ve met your limit of %d sends in an hour.', $this->getMaxSendsToFriend()));
        }
    ...
    public function validate()
    {
        ...
        if (count($this->getRecipients()->getEmails()) > $maxRecipients) {
            $errors[] = __('No more than %d emails can be sent at a time.', $this->getMaxRecipients());
        }
