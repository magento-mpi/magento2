...
class Mage_CatalogSearch_Block_Result extends Mage_Core_Block_Template
{
    ...
    protected function _prepareLayout()
    {
        ...
        if ($breadcrumbs) {
            $title = __("Search results for: '%s'", $this->helper('Mage_CatalogSearch_Helper_Data')->getQueryText());
        ...
        // modify page title
        $title = __("Search results for: '%s'", $this->helper('Mage_CatalogSearch_Helper_Data')->getEscapedQueryText());
...
//           ->setCollection($this->_getProductCollection());
    ...
    public function getNoResultText()
    {
        if (Mage::helper('Mage_CatalogSearch_Helper_Data')->isMinQueryLength()) {
            return __('Minimum Search query length is %s', $this->_getQuery()->getMinQueryLength());
        }
