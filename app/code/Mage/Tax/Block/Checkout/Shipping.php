...
class Mage_Tax_Block_Checkout_Shipping extends Mage_Checkout_Block_Total_Default
{
    ...
    {
        return $this->helper('Mage_Tax_Helper_Data')->__('Shipping Incl. Tax (%1)', $this->escapeHtml($this->getTotal()->getAddress()->getShippingDescription()));
    }
    ...
    {
        return $this->helper('Mage_Tax_Helper_Data')->__('Shipping Excl. Tax (%1)', $this->escapeHtml($this->getTotal()->getAddress()->getShippingDescription()));
    }
}
