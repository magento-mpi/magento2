...
class Mage_Checkout_Controller_Onepage extends Mage_Checkout_Controller_Action
{
    /**
     * @var array
     */
    ...
    /**
     * @return Mage_Checkout_Controller_Onepage|null
     */
    ...
    /**
     * @return Mage_Checkout_Controller_Onepage
     */
    ...
    public function indexAction()
    {
        if (!Mage::helper('Mage_Checkout_Helper_Data')->canOnepageCheckout()) {
            Mage::getSingleton('Mage_Checkout_Model_Session')->addError(__('The onepage checkout is disabled.'));
