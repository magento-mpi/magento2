 ...
 */
class Mage_Core_Service_Config_Reader_Rest extends Mage_Core_Service_Config_ReaderAbstract
{
    /**
     * Config type.
     */
     ...
     *
     * @param Mage_Core_Service_Config_Reader_Rest_ClassReflector $classReflector
     * @param Mage_Core_Model_Config $appConfig
     * @param Mage_Core_Model_CacheInterface $cache
     * @param Mage_Webapi_Helper_Config $configHelper
     */
    public function __construct(
        Mage_Core_Service_Config_Reader_Rest_ClassReflector $classReflector,
