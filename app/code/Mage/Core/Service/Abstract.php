...
class Mage_Core_Service_Abstract
{
    /**
    ...
    public function __construct(Magento_ObjectManager $objectManager, Mage_Core_Service_Manager $serviceManager)
    {
     ...
     */
    protected function _getObject($objectId, $fieldsetId = '')
    {
     ...
     */
    protected function _getObjectCollection(array $objectIds, $fieldsetId = '')
    {
     ...
     * @return array
     */
    protected function _getDictionary($object)
    {
        return array();
    }
