 ...
 */
class Mage_Core_Model_File_Storage_Config
{
    /**
    ...
    /**
     * @param Mage_Core_Model_File_Storage $storage
     * @param Magento_Filesystem_Stream_LocalFactory $streamFactory
     * @param string $cacheFile
     */
    public function __construct(
        Mage_Core_Model_File_Storage $storage, Magento_Filesystem_Stream_LocalFactory $streamFactory, $cacheFile
    ) {
