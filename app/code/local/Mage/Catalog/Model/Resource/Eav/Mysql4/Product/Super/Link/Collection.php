 ...
 */
class Mage_Catalog_Model_Resource_Eav_Mysql4_Product_Super_Link_Collection extends Mage_Catalog_Model_Resource_Eav_Mysql4_Product_Collection
{
    ...
    {
        $this->_init('catalog/product_super_link', 'catalog/product');
    }
