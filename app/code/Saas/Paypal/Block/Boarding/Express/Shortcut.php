 ...
 */
class Saas_Paypal_Block_Boarding_Express_Shortcut extends Mage_Core_Block_Template
{
    /**
     ...
     * @var string
     */
    protected $_paymentMethodCode = Saas_Paypal_Model_Boarding_Config::METHOD_EXPRESS_BOARDING;
