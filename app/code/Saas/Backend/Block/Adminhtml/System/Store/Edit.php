...
class Saas_Backend_Block_Adminhtml_System_Store_Edit extends Mage_Adminhtml_Block_System_Store_Edit
{
    ...
    protected function _updateDeleteButton()
    {
        if (self::STORE_TYPE_STORE == $this->_registry->registry('store_type')) {
            ...
            $message = $this->__('Deleting a %1 will not delete the information associated with the %1 (e.g. categories, products, etc.), but the %1 will not be able to be restored.', $title);
