 ...
 */
class Saas_PrintedTemplate_Adminhtml_PrintController extends Mage_Adminhtml_Controller_Action
{
    /**
    ...
    public function entityAction()
    {
        ...
        try {
            ...
            if (!$entity) {
                Mage::throwException(__('Cannot load %s entity; please reload page and try again.', $type));
            }

            $entity->load($orderTypeId);
            if (!$entity->getId()) {
                Mage::throwException(
                    __('Cannot load %s entity #%s; please reload page and try again.', $type, $orderTypeId)
                );
            }
