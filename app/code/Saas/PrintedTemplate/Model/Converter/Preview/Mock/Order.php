...
class Saas_PrintedTemplate_Model_Converter_Preview_Mock_Order extends Mage_Sales_Model_Order
{
    ...
    protected function _getMockData()
    {
        return array (
            ...
            'coupon_code' => '111000',
            'protect_code' => '226910',
            'shipping_description' => __('Flat Rate - Fixed'),
            'is_virtual' => '0',
            'store_id' => '1',
            'customer_id' => '4',
            ...
            'customer_firstname' => __('Ramona'),
            'customer_lastname' => __('Hill'),
            'customer_middlename' => '',
            'customer_prefix' => __('Mrs.'),
            'customer_suffix' => __('K.'),
            'customer_taxvat' => '',
            'discount_description' => __('Your Coupon:'),
