    ...
    $.widget('mage.ticker', {
        ...
        _create: function() {
            ...
            setInterval($.proxy(function(){
                ...
                if (daySec > 0) {
                    $('ul.ticker li').css('display','inline-block');
                    this.element.find('[data-container="second"]').closest("li").css('display','none');
                } else {
                    $('ul.ticker li').css('display','inline-block');
                    this.element.find('[data-container="days"]').closest("li").css('display','none');
                }
