...
<div id ="container">
	...
	<div id="west:center" class="x-layout-inactive-content">
		
	</div>
	
	<div id="west:south" class="controls-list x-layout-active-content">
		<div id="west:south:toolbar"></div>
	</div>
	...
	<div id="dashboard" class="x-layout-inactive-content">
		<p><a href="#" onclick="Admin.toggleWest(this);return false;">Show West Region</a></p>
	...
	<div id="props-panel" class="x-layout-inactive-content" style="width:200px;height:200px;overflow:hidden;"></div>
	<div id="status" class="x-layout-inactive-content" style="background-color:#c3daf9"><strong>Status Bar</strong></div>
</div>
</body>
</html>