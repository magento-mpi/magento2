...
INSERT INTO `eav_attribute` (`attribute_id`, `entity_type_id`, `attribute_code`, `attribute_model`, `backend_model`, `backend_type`, `backend_table`, `frontend_model`, `frontend_input`, `frontend_label`, `frontend_class`, `source_model`, `is_required`, `is_user_defined`, `default_value`, `is_unique`, `note`) VALUES
	...
	(131, 4, 'gift_message_available', NULL, 'Magento_Catalog_Model_Product_Attribute_Backend_Boolean', 'varchar', NULL, NULL, 'select', 'Allow Gift Message', NULL, 'Mage_Eav_Model_Entity_Attribute_Source_Boolean', 0, 0, NULL, 0, NULL),
