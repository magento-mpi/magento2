...
interface CurrencyInterface
{
     ...
     * @param  string|\Magento\Locale $locale   (Optional) Locale to display informations
     * @return string
     */
     ...
     * @param  string|\Magento\Locale $locale   OPTIONAL The locale
     * @return string
     */
     ...
     *
     * @param  string|\Magento\Locale $locale (Optional) Locale for parsing input
