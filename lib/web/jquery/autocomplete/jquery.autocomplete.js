...
(function (factory) {
    ...
    function Autocomplete(el, options, elValue) {
        var noop = function () { },
            that = this,
            defaults = {
    ...
    Autocomplete.prototype = {
        ...
        initialize: function () {
            ...
            that.elValue.subscribe(that._onChange.bind(that), 'change');
        ...
        onKeyPress: function (e) {
            ...
            switch (e.which) {
                case keys.ESC:
                    this.elValue(this.currentValue);
                    this.hide();
                    break;
                case keys.RIGHT:
                ...
                case keys.RETURN:
                    ...
                    if (e.which === keys.TAB && this.options.tabDisabled === false) {
                        return;
                    }
                    break;
                case keys.UP:
        ...
        findBestHint: function () {
            var that = this,
                value = that.elValue().toLowerCase(),
                bestMatch = null;
        ...
        onSelect: function (index) {
            ...
            if (that.currentValue !== that.elValue()) {
                that.elValue(that.currentValue);
            }
