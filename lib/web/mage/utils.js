...
define([], function () {
    ...
    function removeNested(parent, parts, field) {
        parent = getNested(parent, parts);
    ...
    return {
        ...
        template: function(tpl, source){
            var result;

            if(_.isString(tpl)){
                result = template.apply(null, arguments);
            }
            else{
                result = {};
                
                _.each(tpl, function(tpl, key){
                    result[key] = template(tpl, source);
                }, this);
            }
