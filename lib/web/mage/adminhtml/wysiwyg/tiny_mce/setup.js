...
define([
    ...
    tinyMceWysiwygSetup.prototype = {
        ...
        initialize: function(htmlId, config) {
            ...
            _.bindAll(this, 'parseContent', 'onChangeContent', 'openFileBrowser');

            varienGlobalEvents.attachEventHandler('tinymceChange', this.onChangeContent);
            varienGlobalEvents.attachEventHandler('tinymceBeforeSetContent', this.parseContent);
            varienGlobalEvents.attachEventHandler('tinymceSaveContent', this.parseContent);
