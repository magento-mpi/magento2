 ...
 */
class Varien_Controller_Router_Route_Module implements Zend_Controller_Router_Route_Interface
{
    /**
    ...
    public function match($path)
    {
        ...
        if ($path != '') {
            ...
            } elseif ('default' != $this->_defaults['module'] && $this->isValidModule($this->_defaults['module'])) {
