    ...
    public function getElementHtml()
    {
        if( $this->getWysiwyg() === true ) 
        {
            $html = '
                ...
                <textarea name="'.$this->getName().'" title="'.$this->getTitle().'" id="'.$this->getHtmlId().'" class="textarea '.$this->getClass().'" style="width:400px;height:200px">'.$this->getEscapedValue().'</textarea>';
            return $html;            
        }
        else 
        {
