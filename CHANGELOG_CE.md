...
* Fixed bugs:
  ...
  * Fixed an issue where a wrong category structure displayed on the Category page
  ...
  * Fixed an issue where a fatal error was thrown when opening a fixed bundle product with custom options page on the frontend
...
* Added the following functional test:
  * Advanced Search
