...
class Mage_Api2_Model_AuthTest extends Magento_TestCase
{
    ...
    {
        $_SERVER['HTTP_HOST'] = TESTS_HTTP_HOST;
        $_SERVER['REQUEST_URI'] = '/testuri/';
        $_SERVER['HTTP_AUTHORIZATION'] = 'OAuth realm="",oauth_consumer_key="gon2usj587jwrtn2e3bz4xvuf1mrrc0e",'
            . 'oauth_nonce="ece8476b11faa8175848babbbd6862e3",oauth_signature_method="HMAC-SHA1",'
            . 'oauth_timestamp="1326801017",oauth_version="1.0",oauth_token="dojb2hup7mtydd4w8jq3489yopsyqqd9",'
            . 'oauth_signature="xuWm8W05dGCvvX3n2Oj63C2b%2Fbs%3D"';
