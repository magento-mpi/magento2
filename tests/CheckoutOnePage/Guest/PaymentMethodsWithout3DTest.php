 ...
 * @license     http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */
class CheckoutOnePage_PaymentMethodsWithout3DTest extends Mage_Selenium_TestCase
{
     ...
     * <p>4.Fill billing and shipping addresses with correct data.</p>
     * <p>5.Choose Flat Rate / Fixed shipping method.</p>
     * <p>6.Choose 'Check / Money order' in payment method.</p>
    ...
    public function authorizeNet($productData)
    {
        //Preconditions
        $this->loginAdminUser();
        $this->systemConfigurationHelper()->configure('authorize_net_without_3d_enable');
        $this->assertTrue($this->successMessage('success_saved_config'), $this->messages);
        //Data
    ...
    public function payPalUKDirect($productData)
    {
        //Preconditions
        $this->loginAdminUser();
        $this->systemConfigurationHelper()->configure('paypal_uk_direct_wo_3d_enable');
        $this->assertTrue($this->successMessage('success_saved_config'), $this->messages);
        //Data
    ...
    public function payFlowProVerisign($productData)
    {
        //Preconditions
        $this->loginAdminUser();
        $this->systemConfigurationHelper()->configure('payflow_pro_wo_3d_enable');
        $this->assertTrue($this->successMessage('success_saved_config'), $this->messages);
        //Data
    ...
    public function payPalDirect($productData)
    {
        //Preconditions
        $this->loginAdminUser();
        $this->systemConfigurationHelper()->configure('website_payments_pro_wo_3d_enable');
        $this->assertTrue($this->successMessage('success_saved_config'), $this->messages);
        //Data
