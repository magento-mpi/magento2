...
class ProductAttribute_Create_PriceTest extends Mage_Selenium_TestCase
{
     ...
     * 3.Choose "Price" in 'Catalog Input Type for Store Owner' dropdown
     * 4.Fill all required fields
     * 5.Click on "Save Attribute" button
     *
     * Expected result: new attribute ["Price" type] successfully created.
    ...
    public function test_WithRequiredFieldsOnly()
    {
        ...
        $attrData = $this->loadData('product_attribute_price', null, null);
     ...
     * 5.Click on "Save Attribute" button
     *
     * Expected result: new attribute ["Price" type] shouldn't be created.
    ...
    {
        $this->assertTrue($this->navigate('manage_attributes'),'Wrong page is displayed');
        $attrData = $this->loadData('product_attribute_price', array('attribute_code' => ''));
        $this->creteAttribute($attrData);
    ...
    {
        $this->assertTrue($this->navigate('manage_attributes'),'Wrong page is displayed');
        $attrData = $this->loadData('product_attribute_price', array('admin_title' => ''));
        $this->creteAttribute($attrData);
        $this->clickButton('save_attribute', false);
    ...
    {
        $this->assertTrue($this->navigate('manage_attributes'),'Wrong page is displayed');
        $attrData = $this->loadData('product_attribute_price', array('attribute_code' => '111'));
        $this->creteAttribute($attrData);
        $this->clickButton('save_attribute', false);
    ...
    {
        $this->assertTrue($this->navigate('manage_attributes'),'Wrong page is displayed');
        $attrData = $this->loadData('product_attribute_price', array(
            'attribute_code' => $this->generate('string', 11, ':punct:'),
            'default_value'  => $this->generate('string', 12, ':alnum:'),
    ...
    public function test_WithSpecialCharactersExclAttributeCode()
    {
        ...
        $attrData = $this->loadData('product_attribute_price', array(
            ...
            'default_value'  => $this->generate('string', 12, ':punct:'),
    ...
    public function test_WithSpecialCharactersExclDefaultValue()
    {
        ...
        $attrData = $this->loadData('product_attribute_price', array(
            'attribute_code' => $this->generate('string', 12, ':alnum:'),
            'default_value'  => $this->generate('string', 12, ':digit:'),
            'admin_title'  => $this->generate('string', 12, ':punct:'),
            'storeview_title'  => $this->generate('string', 13, ':punct:')));
        $this->creteAttribute($attrData);
        $this->clickButton('save_attribute', false);
    ...
    {
        $this->assertTrue($this->navigate('manage_attributes'),'Wrong page is displayed');
        $attrData = $this->loadData('product_attribute_price', array('position' => 'abcdefg'));
        $this->creteAttribute($attrData);
        $this->clickButton('save_attribute', false);
    ...
    public function test_OnProductPage_WithRequiredFieldsOnly()
    {
        ...
        $attrData = $this->loadData('product_attribute_price', null, 'attribute_code');
        $this->creteAttribute($attrData);
        $this->clickButton('save_attribute', true);
        $this->assertFalse($this->successMessage('success_saved_attribute'), $this->messages);
    }
