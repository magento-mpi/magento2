 ...
 * @license     http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */
class ProductAttribute_Create_FPTTest extends Mage_Selenium_TestCase
{
    /**
    ...
    public function test_WithRequiredFieldsOnly()
    {
        ...
        $attrData = $this->loadData('product_attribute_fpt', null, null);
    ...
    {
        $this->assertTrue($this->navigate('manage_attributes'),'Wrong page is displayed');
        $attrData = $this->loadData('product_attribute_fpt', array('attribute_code' => ''));
        $this->creteAttribute($attrData);
    ...
    {
        $this->assertTrue($this->navigate('manage_attributes'),'Wrong page is displayed');
        $attrData = $this->loadData('product_attribute_fpt', array('admin_title' => ''));
        $this->creteAttribute($attrData);
        $this->clickButton('save_attribute', false);
    ...
    {
        $this->assertTrue($this->navigate('manage_attributes'),'Wrong page is displayed');
        $attrData = $this->loadData('product_attribute_fpt', array('attribute_code' => '111'));
        $this->creteAttribute($attrData);
        $this->clickButton('save_attribute', false);
    ...
    {
        $this->assertTrue($this->navigate('manage_attributes'),'Wrong page is displayed');
        $attrData = $this->loadData('product_attribute_fpt', array(
    ...
    public function test_OnProductPage_WithRequiredFieldsOnly()
    {
        ...
        $attrData = $this->loadData('product_attribute_fpt', null, 'attribute_code');
        $this->creteAttribute($attrData);
        $this->clickButton('save_attribute', true);
        $this->assertFalse($this->successMessage('success_saved_attribute'), $this->messages);
    }
