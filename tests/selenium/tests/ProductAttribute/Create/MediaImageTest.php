...
class ProductAttribute_Create_MediaImageTest extends Mage_Selenium_TestCase
{
    ...
    /**
     * Create new Media Image type Product Attribute by using required fields only
     */
    public function test_WithRequiredFieldsOnly()
    {
        ...
        $this->fillForm($this->loadData('product_attribute_mediaimage', NULL, NULL));
    ...
    public function test_WithRequiredFieldsEmpty_EmptyAttributeCode()
    {
        ...
        $this->fillForm($this->loadData('product_attribute_mediaimage', array(
            'attribute_code' => '')));
        $this->clickButton('save_attribute');
        $this->assertFalse($this->errorMessage(), $this->messages);
        $this->assertTrue($this->successMessage(), 'No success message is displayed');
    ...
    public function test_OnProductPage_WithRequiredFieldsOnly()
    {
        ...
        $this->fillForm($this->loadData('product_attribute_mediaimage', NULL, 'attribute_code'));
        $this->clickButton('save_attribute');
        $this->assertFalse($this->errorMessage(), $this->messages);
        $this->assertTrue($this->successMessage(), 'No success message is displayed');
    }
