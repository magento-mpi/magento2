...
class ProductAttribute_Create_YesNoTest extends Mage_Selenium_TestCase
{
     ...
     * 3.Choose "Yes/No" in 'Catalog Input Type for Store Owner' dropdown
     * 4.Fill all required fields
     * 5.Click on "Save Attribute" button
     *
     * Expected result: new attribute ["Yes/No" type] successfully created.
     ...
     * 5.Click on "Save Attribute" button
     *
     * Expected result: new attribute ["Yes/No" type] shouldn't be created.
