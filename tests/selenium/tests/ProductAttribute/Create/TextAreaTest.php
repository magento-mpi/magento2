...
class ProductAttribute_Create_TextAreaTest extends Mage_Selenium_TestCase
{
    ...
    public function test_WithRequiredFieldsOnly()
    {
        ...
        $this->fillForm($this->loadData('product_attribute_textarea', null, null));
    ...
    public function test_WithRequiredFieldsEmpty_EmptyAttributeCode()
    {
        ...
        $this->fillForm($this->loadData('product_attribute_textarea', array(
            'attribute_code' => '')));
        $this->clickButton('save_attribute');
        $this->assertFalse($this->errorMessage(), $this->messages);
        $this->assertTrue($this->successMessage(), 'No success message is displayed');
    ...
    public function test_WithLongValues()
    {
        ...
        $this->fillForm($this->loadData('product_attribute_textarea', array(
            ...
            'default_value'  => $this->generate('string', 500, ':alnum:'),
