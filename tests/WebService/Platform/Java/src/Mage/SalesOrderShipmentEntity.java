...
public class SalesOrderShipmentEntity  implements java.io.Serializable {
    ...
    private Mage.SalesOrderShipmentItemEntity[] items;

    private Mage.SalesOrderShipmentTrackEntity[] tracks;

    private Mage.SalesOrderShipmentCommentEntity[] comments;
    ...
    public SalesOrderShipmentEntity(
           ...
           Mage.SalesOrderShipmentItemEntity[] items,
           Mage.SalesOrderShipmentTrackEntity[] tracks,
           Mage.SalesOrderShipmentCommentEntity[] comments) {
     ...
     * @return items
     */
    public Mage.SalesOrderShipmentItemEntity[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(Mage.SalesOrderShipmentItemEntity[] items) {
        this.items = items;
    }
     ...
     * @return tracks
     */
    public Mage.SalesOrderShipmentTrackEntity[] getTracks() {
        return tracks;
    }
     ...
     * @param tracks
     */
    public void setTracks(Mage.SalesOrderShipmentTrackEntity[] tracks) {
        this.tracks = tracks;
    }
     ...
     * @return comments
     */
    public Mage.SalesOrderShipmentCommentEntity[] getComments() {
        return comments;
    }
     ...
     * @param comments
     */
    public void setComments(Mage.SalesOrderShipmentCommentEntity[] comments) {
        this.comments = comments;
    }
