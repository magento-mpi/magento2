...
public class ApiEntity  implements java.io.Serializable {
    ...
    private Mage.ApiMethodEntity[] methods;
     ...
     * @return methods
     */
    public Mage.ApiMethodEntity[] getMethods() {
        return methods;
    }
     ...
     * @param methods
     */
    public void setMethods(Mage.ApiMethodEntity[] methods) {
        this.methods = methods;
    }
