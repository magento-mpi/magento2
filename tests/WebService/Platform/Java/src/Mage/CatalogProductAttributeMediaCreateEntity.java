...
public class CatalogProductAttributeMediaCreateEntity  implements java.io.Serializable {
    private Mage.CatalogProductImageFileEntity file;
    ...
    public CatalogProductAttributeMediaCreateEntity(
           Mage.CatalogProductImageFileEntity file,
     ...
     * @return file
     */
    public Mage.CatalogProductImageFileEntity getFile() {
        return file;
    }
     ...
     * @param file
     */
    public void setFile(Mage.CatalogProductImageFileEntity file) {
        this.file = file;
    }
