...
public class SalesOrderAddressEntity  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SalesOrderAddressEntity)) return false;
        SalesOrderAddressEntity other = (SalesOrderAddressEntity) obj;
        ...
        _equals = true && 
            ...
            ((this.address_id==null && other.getAddress_id()==null) || 
             (this.address_id!=null &&
              this.address_id.equals(other.getAddress_id())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getAddress_id() != null) {
            _hashCode += getAddress_id().hashCode();
        }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SalesOrderAddressEntity.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:Magento", "salesOrderAddressEntity"));
