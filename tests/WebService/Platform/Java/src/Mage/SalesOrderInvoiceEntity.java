...
public class SalesOrderInvoiceEntity  implements java.io.Serializable {
    ...
    private Mage.SalesOrderInvoiceItemEntity[] items;

    private Mage.SalesOrderInvoiceCommentEntity[] comments;
    ...
    public SalesOrderInvoiceEntity(
           ...
           Mage.SalesOrderInvoiceItemEntity[] items,
           Mage.SalesOrderInvoiceCommentEntity[] comments) {
     ...
     * @return items
     */
    public Mage.SalesOrderInvoiceItemEntity[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(Mage.SalesOrderInvoiceItemEntity[] items) {
        this.items = items;
    }
     ...
     * @return comments
     */
    public Mage.SalesOrderInvoiceCommentEntity[] getComments() {
        return comments;
    }
     ...
     * @param comments
     */
    public void setComments(Mage.SalesOrderInvoiceCommentEntity[] comments) {
        this.comments = comments;
    }
