...
public class SalesOrderEntity  implements java.io.Serializable {
    ...
    private Mage.SalesOrderAddressEntity shipping_address;

    private Mage.SalesOrderAddressEntity billing_address;

    private Mage.SalesOrderItemEntity[] items;

    private Mage.SalesOrderPaymentEntity payment;

    private Mage.SalesOrderStatusHistoryEntity[] status_history;
    ...
    public SalesOrderEntity(
           ...
           Mage.SalesOrderAddressEntity shipping_address,
           Mage.SalesOrderAddressEntity billing_address,
           Mage.SalesOrderItemEntity[] items,
           Mage.SalesOrderPaymentEntity payment,
           Mage.SalesOrderStatusHistoryEntity[] status_history) {
     ...
     */
    public Mage.SalesOrderAddressEntity getShipping_address() {
        return shipping_address;
    }
     ...
     */
    public void setShipping_address(Mage.SalesOrderAddressEntity shipping_address) {
        this.shipping_address = shipping_address;
    }
     ...
     */
    public Mage.SalesOrderAddressEntity getBilling_address() {
        return billing_address;
    }
     ...
     */
    public void setBilling_address(Mage.SalesOrderAddressEntity billing_address) {
        this.billing_address = billing_address;
    }
     ...
     * @return items
     */
    public Mage.SalesOrderItemEntity[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(Mage.SalesOrderItemEntity[] items) {
        this.items = items;
    }
     ...
     * @return payment
     */
    public Mage.SalesOrderPaymentEntity getPayment() {
        return payment;
    }
     ...
     * @param payment
     */
    public void setPayment(Mage.SalesOrderPaymentEntity payment) {
        this.payment = payment;
    }
     ...
     */
    public Mage.SalesOrderStatusHistoryEntity[] getStatus_history() {
        return status_history;
    }
     ...
     */
    public void setStatus_history(Mage.SalesOrderStatusHistoryEntity[] status_history) {
        this.status_history = status_history;
    }
