...
public class Filters  implements java.io.Serializable {
    private Mage.AssociativeEntity[] filter;

    private Mage.ComplexFilter[] complex_filter;

    public Filters() {
    }

    public Filters(
           Mage.AssociativeEntity[] filter,
           Mage.ComplexFilter[] complex_filter) {
           this.filter = filter;
     ...
     * @return filter
     */
    public Mage.AssociativeEntity[] getFilter() {
        return filter;
    }
     ...
     * @param filter
     */
    public void setFilter(Mage.AssociativeEntity[] filter) {
        this.filter = filter;
    }
     ...
     */
    public Mage.ComplexFilter[] getComplex_filter() {
        return complex_filter;
    }
     ...
     */
    public void setComplex_filter(Mage.ComplexFilter[] complex_filter) {
        this.complex_filter = complex_filter;
    }
