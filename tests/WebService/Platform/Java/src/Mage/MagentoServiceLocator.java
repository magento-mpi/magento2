...
public class MagentoServiceLocator extends org.apache.axis.client.Service implements Mage.MagentoService {
    ...
    private java.lang.String Mage_Api_Model_Server_V2_HandlerPort_address = "http://vkorotovskih.gostorego.com/index.php/api/v2_soap/index/";
    ...
    public MagentoServiceLocator setMage_Api_Model_Server_V2_HandlerPortAddress(java.lang.String portAddress) {
        Mage_Api_Model_Server_V2_HandlerPort_address = portAddress;
        return this;
    }
    ...
    public Mage.Mage_Api_Model_Server_V2_HandlerPortType getMage_Api_Model_Server_V2_HandlerPort() throws javax.xml.rpc.ServiceException {
    ...
    public Mage.Mage_Api_Model_Server_V2_HandlerPortType getMage_Api_Model_Server_V2_HandlerPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Mage.Mage_Api_Model_Server_V2_HandlerBindingStub _stub = new Mage.Mage_Api_Model_Server_V2_HandlerBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (Mage.Mage_Api_Model_Server_V2_HandlerPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                Mage.Mage_Api_Model_Server_V2_HandlerBindingStub _stub = new Mage.Mage_Api_Model_Server_V2_HandlerBindingStub(new java.net.URL(Mage_Api_Model_Server_V2_HandlerPort_address), this);
                _stub.setPortName(getMage_Api_Model_Server_V2_HandlerPortWSDDServiceName());
                return _stub;
            }
        }
