...
class ProductAttribute_Create_FPTTest extends Mage_Selenium_TestCase
{
     ...
     * 2.Choose "Fixed Product Tax" in 'Catalog Input Type for Store Owner' dropdown
     * 3.Fill all required fields
     * 4.Click on "Save Attribute" button
     *
     * Expected result:
     * New attribute ["Fixed Product Tax" type] successfully created.
     ...
     *
     * Expected result:
     * New attribute ["Fixed Product Tax" type] shouldn't be created.
     ...
     * 6.Choose "Fixed Product Tax" in 'Catalog Input Type for Store Owner' dropdown
