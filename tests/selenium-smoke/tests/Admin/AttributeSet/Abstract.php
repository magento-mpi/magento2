...
abstract class Test_Admin_AttributeSet_Abstract extends Test_Admin_Abstract {
    ...
    */
    public function addSet($setName)
    {
        ...
        if ($this->waitForElement($this->getUiElement("admin/pages/catalog/attributes/manageAttributeSets/messages/setNotSaved"),20)) {
            ...
            if (!$this->waitForElement($this->getUiElement("admin/pages/catalog/attributes/manageAttributeSets/messages/setSaved"),2)) {
