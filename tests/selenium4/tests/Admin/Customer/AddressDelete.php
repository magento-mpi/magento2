...
class Admin_Customer_AddressDelete extends TestCaseAbstract {
    ...
    /**
     * Delete Address For Exist Customer
     */
    function testDeleteAddressForExistCustomer()
    {
        $Data = array(
            //Customer Data
        ...
        if ($this->model->doLogin()) {
            $this->model->doDelete($Data, 'address');
        }
    }
