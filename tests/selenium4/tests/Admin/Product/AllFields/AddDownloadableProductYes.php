...
class Admin_Product_AllFields_AddDownloadableProductYes extends TestCaseAbstract {
    ...
    function testDownloadableProductCreation()
    {
        $arrayData = array(
            ...
            // <!-- Genral tab -->
            'name'                  => 'Downloadable Product 03(Purchase=Yes).All Fields',
            ...
            'downloadable_links_purchase_type'       => 'Yes',
            'downloadable_link_title'               => 'link_title_1',
            'downloadable_link_price'               => 50,
