...
class Product_Linking_SimpleLinkingTest extends Mage_Selenium_TestCase
{
     ...
     * <p>Steps:</p>
     * <p>1. Create 1 simple product in stock; Attach all types of products to the first one as related products</p>
     ...
     * <p>Expected result:</p>
     * <p>Products are created, The simple product contains block with related products; Prices for related products are correct</p>
     *
     ...
     * <p>Expected result:</p>
     * <p>Products are created, The simple product does not contains any related products;</p>
     *
     ...
     * <p>Create All Types of products (in stock) and realize next test for all of them;</p>
     * <p>Steps:</p>
     * <p>1. Create 1 simple product in stock;  Attach all types of products to the first one as cross-sell product</p>
     * <p>2. Navigate to frontend;</p>
     * <p>3. Open product details page;</p>
     ...
     * <p>Expected result:</p>
     * <p>Products are created, The simple product contains block with cross-sell products; Prices for cross-sell products are correct</p>
     *
     * @depends createProductsForLinkingInStock
     * @test
     */
     ...
     * <p>Create All Types of products (out of stock) and realize next test for all of them;</p>
     * <p>Steps:</p>
     * <p>1. Create 1 simple products in stock; Attach all types of products to the first one as cross-sell product</p>
     * <p>2. Navigate to frontend;</p>
     * <p>3. Open product details page;</p>
     * <p>4. Add product to shopping cart;</p>
     * <p>5. Validate that shopping cart page with the added product does not contains any cross-sell products;</p>
     * <p>Expected result:</p>
     * <p>Products are created, The simple product in the shopping cart does not contain the cross-sell products</p>
     *
     * @depends createProductsForLinkingOutOfStock
     * @test
     */
     ...
     * <p>Create All Types of products (in stock) and realize next test for all of them;</p>
     * <p>Steps:</p>
     * <p>1. Create 1 simple product in stock; Attach all types of products to the first one as up-sell products</p>
     * <p>2. Navigate to frontend;</p>
     * <p>3. Open product details page;</p>
     * <p>4. Validate prices for up-sell products in "up-sell products block";</p>
     * <p>Expected result:</p>
     * <p>Products are created, The simple product contains block with up-sell products; Prices for up-sell products are correct</p>
     *
     * @depends createProductsForLinkingInStock
     * @test
     */
     ...
     * <p>Expected result:</p>
     * <p>Products are created, The simple product details page does not contain any up-sell product</p>
     *
     * @depends createProductsForLinkingOutOfStock
     * @test
     */
