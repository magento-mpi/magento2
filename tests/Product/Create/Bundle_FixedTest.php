...
/**
 * Bundle Fixed product creation tests
 *
 * @package     selenium
 * @subpackage  tests
 * @license     http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */
class Product_Create_Bundle_FixedTest extends Mage_Selenium_TestCase
{
    ...
    {
        //Data
        $productData = $this->loadData('bundle_fixed_product_required', null,
