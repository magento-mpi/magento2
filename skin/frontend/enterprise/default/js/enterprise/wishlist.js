...
Enterprise.Wishlist.Widget.Form = Class.create(Enterprise.Widget, {
    ...
    initialize: function($super, action) {
        var _templateString = '<ul class="form-list">' +
                '<li><label for="wishlist-name">' + Translator.translate('Wishlist Name') + '</label><div class="input-box"><input type="text" id="wishlist-name" class="input-text required-entry" name="name"/></div>' +
