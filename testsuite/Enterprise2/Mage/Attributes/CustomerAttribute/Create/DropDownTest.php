...
/**
 * Create new customer attribute. Type: Dropdown
 *
 * @package     selenium
 * @subpackage  tests
 * @license     http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */
class Enterprise2_Mage_Attributes_CustomerAttribute_Create_DropDownTest extends Mage_Selenium_TestCase
{
    /**
     * <p>Preconditions:</p>
    ...
    /**
     * <p>Create "DropDown type Customer Attributes  (required fields only)</p>
     * <p>Steps:</p>
