...
/**
 * Create new customer address attribute. Type: Text Area
 *
 * @package     selenium
 * @subpackage  tests
 * @license     http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */
class Enterprise2_Mage_Attributes_CustomerAddressAttribute_TextAreaTest extends Mage_Selenium_TestCase
{
    /**
     * <p>Preconditions:</p>
    ...
    /**
     * <p>Create "Text Area" type Customer Address Attribute (required fields only)</p>
     * <p>Steps:</p>
