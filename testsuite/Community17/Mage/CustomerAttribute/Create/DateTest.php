 ...
 * @license     http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */
class Community17_Mage_CustomerAttribute_Create_DateTest extends Mage_Selenium_TestCase
{
    /**
     * <p>Preconditions:</p>
    ...
    {
        //Data
        $attrData = $this->loadDataSet('CustomerAttribute', 'customer_attribute_date', array($emptyField => '%noValue%'));
        //Steps
        $this->customerAttributeHelper()->createAttribute($attrData);
        //Verifying
    ...
    {
        //Data
        $attrData = $this->loadDataSet('CustomerAttribute', 'customer_attribute_date', array('attribute_code' => $wrongAttributeCode));
        //Steps
        $this->customerAttributeHelper()->createAttribute($attrData);
        //Verifying
