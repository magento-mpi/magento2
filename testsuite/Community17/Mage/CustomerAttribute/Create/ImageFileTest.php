...
/**
 * Create new customer attribute. Type: Image File
 *
 * @package     selenium
 * @subpackage  tests
 * @license     http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */
class Community17_Mage_CustomerAttribute_Create_ImageFileTest extends Mage_Selenium_TestCase
{
    /**
     * <p>Preconditions:</p>
    ...
    /**
     * <p>Create "Image File" type Customer Attribute (required fields only)</p>
     * <p>Steps:</p>
     * <p>1.Click on "Add New Attribute" button</p>
     * <p>2.Choose "Image File" in 'Input Type' dropdown</p>
     * <p>3.Fill all required fields</p>
     * <p>4.Click on "Save Attribute" button</p>
     * <p>Expected result:</p>
     * <p>New attribute ["Image File" type] successfully created.</p>
     ...
     * <p>Expected result:</p>
     * <p>New attribute ["Image File" type] should not be created.</p>
    ...
    {
        //Data
        $attrData = $this->loadDataSet('CustomerAttribute', 'customer_attribute_image_file', array($emptyField => '%noValue%'));
        //Steps
        $this->customerAttributeHelper()->createAttribute($attrData);
        //Verifying
    ...
    {
        //Data
        $attrData = $this->loadDataSet('CustomerAttribute', 'customer_attribute_image_file', array('attribute_code' => $wrongAttributeCode));                                      
        //Steps
        $this->customerAttributeHelper()->createAttribute($attrData);
        //Verifying
