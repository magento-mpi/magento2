...
/**
 * Create new customer attribute. Type: Drop Down
 *
 * @package     selenium
 * @subpackage  tests
 * @license     http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */
class Community17_Mage_CustomerAttribute_Create_DropDownTest extends Mage_Selenium_TestCase
{
    /**
     * <p>Preconditions:</p>
    ...
    /**
     * <p>Create "Dropdown" type Customer Attribute (required fields only)</p>
     * <p>Steps:</p>
    ...
    {
        //Data
        $attrData = $this->loadDataSet('CustomerAttribute', 'customer_attribute_dropdown', array($emptyField => '%noValue%'));
        //Steps
        $this->customerAttributeHelper()->createAttribute($attrData);
        //Verifying
     ...
     * @depends withRequiredFieldsOnly
     * @TestlinkId TL-MAGE-5546 
     */
    
    public function withInvalidAttributeCode($wrongAttributeCode, $validationMessage)
    {
        //Data
        $attrData = $this->loadDataSet('CustomerAttribute', 'customer_attribute_dropdown', array('attribute_code' => $wrongAttributeCode));
        //Steps
        $this->customerAttributeHelper()->createAttribute($attrData);
        //Verifying
     ...
     * @test
     * @depends withRequiredFieldsOnly
     * @TestlinkId  TL-MAGE-5547
     */
    public function withSpecialCharactersInTitle()
    {
        //Data
        $attrData = $this->loadData('customer_attribute_dropdown',
