...
class Core_Mage_Product_Linking_DownloadableLinkingTest extends Mage_Selenium_TestCase
{
     ...
     * <p>Steps:</p>
     * <p>1. Create 1 downloadable product in stock; Attach all types of products to the first one as related products</p>
     ...
     * <p>Expected result:</p>
     * <p>Products are created, The downloadable product contains block with related products; Names of related products are correct</p>
     *
     * @depends createProductsForLinkingInStock
     * @test
     */
    public function relatedInStock($productsInStock)
    {
        $productData1 = $this->loadData('downloadable_product_for_linking_products');
        $productData2 = $this->loadData('downloadable_product_for_linking_products');
        $i = 1;
     ...
     * <p>Expected result:</p>
     * <p>Products are created, The downloadable product does not contains any related products;</p>
     *
     * @depends createProductsForLinkingOutOfStock
     * @test
     */
    public function relatedOutOfStock($productsOutOfStock)
    {
        $productData = $this->loadData('downloadable_product_for_linking_products');
        $i = 1;
     ...
     * <p>Create All Types of products (in stock) and realize next test for all of them;</p>
     * <p>Steps:</p>
     * <p>1. Create 1 downloadable product in stock;  Attach all types of products to the first one as cross-sell product</p>
     * <p>2. Navigate to frontend;</p>
     * <p>3. Open product details page;</p>
     ...
     * <p>Expected result:</p>
     * <p>Products are created, The downloadable product contains block with cross-sell products; Names of cross-sell products are correct</p>
     *
     * @depends createProductsForLinkingInStock
     * @test
     */
    public function crossSellsInStock($productsInStock)
    {
        $productData1 = $this->loadData('downloadable_product_for_linking_products');
        $productData2 = $this->loadData('downloadable_product_for_linking_products');
        $i = 1;
     ...
     * <p>Create All Types of products (out of stock) and realize next test for all of them;</p>
     * <p>Steps:</p>
     * <p>1. Create 1 downloadable products in stock; Attach all types of products to the first one as cross-sell product</p>
     * <p>2. Navigate to frontend;</p>
     * <p>3. Open product details page;</p>
     * <p>4. Add product to shopping cart;</p>
     * <p>5. Validate that shopping cart page with the added product does not contains any cross-sell products;</p>
     * <p>Expected result:</p>
     * <p>Products are created, The downloadable product in the shopping cart does not contain the cross-sell products</p>
     *
     * @depends createProductsForLinkingOutOfStock
     * @test
     */
    public function crossSellsOutOfStock($productsOutOfStock)
    {
        $productData = $this->loadData('downloadable_product_for_linking_products');
        $i = 1;
        foreach ($productsOutOfStock as $prod) {
     ...
     * <p>Create All Types of products (in stock) and realize next test for all of them;</p>
     * <p>Steps:</p>
     * <p>1. Create 1 downloadable product in stock; Attach all types of products to the first one as up-sell products</p>
     * <p>2. Navigate to frontend;</p>
     * <p>3. Open product details page;</p>
     * <p>4. Validate names of up-sell products in "up-sell products block";</p>
     * <p>Expected result:</p>
     * <p>Products are created, The downloadable product contains block with up-sell products; Names of up-sell products are correct</p>
     *
     * @depends createProductsForLinkingInStock
     * @test
     */
    public function upSellsInStock($productsInStock)
    {
        $productData1 = $this->loadData('downloadable_product_for_linking_products');
        $productData2 = $this->loadData('downloadable_product_for_linking_products');
        $i = 1;
     ...
     * <p>Expected result:</p>
     * <p>Products are created, The downloadable product details page does not contain any up-sell product</p>
     *
     * @depends createProductsForLinkingOutOfStock
     * @test
     */
    public function upSellsOutOfStock($productsOutOfStock)
    {
        $productData = $this->loadData('downloadable_product_for_linking_products');
        $i = 1;
        foreach ($productsOutOfStock as $prod) {
