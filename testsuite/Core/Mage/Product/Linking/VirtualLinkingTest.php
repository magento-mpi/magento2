...
class Core_Mage_Product_Linking_VirtualLinkingTest extends Mage_Selenium_TestCase
{
     ...
     * <p>Expected result:</p>
     * <p>Products are created, The virtual product contains block with related products; Names of related products are correct</p>
     *
    ...
    {
        $productData1 = $this->loadData('virtual_product_for_linking_products');
        $productData2 = $this->loadData('virtual_product_for_linking_products');
        $i = 1;
        ...
        $this->loginAdminUser();
        $this->navigate('manage_products');
        $this->productHelper()->createProduct($productData1, 'virtual');
        $this->assertMessagePresent('success', 'success_saved_product');
        $this->productHelper()->createProduct($productData2, 'virtual');
        $this->assertMessagePresent('success', 'success_saved_product');
    ...
    {
        $productData = $this->loadData('virtual_product_for_linking_products');
        $i = 1;
     ...
     * <p>Expected result:</p>
     * <p>Products are created, The virtual product contains block with cross-sell products; Names of cross-sell products are correct</p>
     *
     * @depends createProductsForLinkingInStock
     * @test
     */
     ...
     * <p>Expected result:</p>
     * <p>Products are created, The virtual product contains block with up-sell products; Names of up-sell products are correct</p>
     *
     * @depends createProductsForLinkingInStock
     * @test
     */
