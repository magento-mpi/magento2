...
/**
 * Create new customer attribute. Type: Multiple Select 
 *
 * @package     selenium
 * @subpackage  tests
 * @license     http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */
class Core_Mage_CustomerAttribute_Create_MultipleSelectTest extends Mage_Selenium_TestCase
{
    /**
     * <p>Preconditions:</p>
     ...
     * <p>2.Choose "Multiple Select" in Input Type' dropdown</p>
     ...
     * @test
     * @depends navigation
     * @TestlinkId TL-MAGE-5564	
     */
    public function withRequiredFieldsOnly()
    {
        //Data
        $attrData = $this->loadDataSet('CustomerAttribute', 'customer_attribute_multiselect');
        //Steps
     ...
     * @TestlinkId TL-MAGE-5567
     */
    public function withRequiredFieldsEmpty($emptyField, $messageCount)
    {
        //Data
        $attrData = $this->loadDataSet('CustomerAttribute', 'customer_attribute_multiselect', array($emptyField => '%noValue%'));
        //Steps
        $this->customerAttributeHelper()->createAttribute($attrData);
        //Verifying
     ...
     * @depends withRequiredFieldsOnly
     * @TestlinkId TL-MAGE-5568
     */
    public function withInvalidAttributeCode($wrongAttributeCode, $validationMessage)
    {
        //Data
        $attrData = $this->loadDataSet('CustomerAttribute', 'customer_attribute_multiselect', array('attribute_code' => $wrongAttributeCode));
        //Steps
        $this->customerAttributeHelper()->createAttribute($attrData);
        //Verifying
     ...
     * @test
     * @depends withRequiredFieldsOnly
     * @TestlinkId TL-MAGE-5569
     */
    public function withSpecialCharactersInTitle()
    {
        //Data
        $attrData = $this->loadData('customer_attribute_multiselect',
