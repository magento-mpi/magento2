 ...
 * @license     http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */
class Core_Mage_CustomerAttribute_Create_TextAreaTest extends Mage_Selenium_TestCase
{
    /**
     * <p>Preconditions:</p>
     ...
     * <p>2.Choose "Text Area" in 'Input Type' dropdown</p>
    ...
    {
        //Data
        $attrData = $this->loadDataSet('CustomerAttribute', 'customer_attribute_textarea', array($emptyField => '%noValue%'));
        //Steps
        $this->customerAttributeHelper()->createAttribute($attrData);
        //Verifying
    ...
    {
        //Data
        $attrData = $this->loadDataSet('CustomerAttribute', 'customer_attribute_textarea', array('attribute_code' => $wrongAttributeCode, 'sort_order' => '1'));
        //Steps
        $this->customerAttributeHelper()->createAttribute($attrData);
        //Verifying
    ...
    public function withSpecialCharactersInTitle()
    {
        //Data
        $attrData = $this->loadDataSet('CustomerAttribute', 'customer_attribute_textarea',
                array('admin_title' => $this->generate('string', 32, ':punct:'), 'attribute_code' => 'text_%randomize%'));
