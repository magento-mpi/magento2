 ...
 * @license     http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */
class Enterprise_Mage_GiftWrapping_GiftWrappingMessageTest extends Mage_Selenium_TestCase
{
    ...
    /**
     * <p>TL-MAGE-850: Gift Message for entire Order is allowed</p>
    ...
    public function giftMessageForEntireOrder($productData,$userData)
    {
        ...
        $this->orderHelper()->verifyGiftOptions($checkoutData['shipping_data']['add_gift_options']);
    }
