 ...
 * @license     http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */
class Enterprise_Mage_GiftWrapping_GiftWrappingTest extends Mage_Selenium_TestCase
{
    ...
    public function createOrder($customerData, $productData)
    {
        ...
        $checkoutData = $this->loadData('multiple_with_gift_wrapping_message_card_receipt',
        ...
        $this->logoutCustomer();
        $orderId = $this->checkoutMultipleAddressesHelper()->frontCreateMultipleCheckout($checkoutData);
        //Verification
