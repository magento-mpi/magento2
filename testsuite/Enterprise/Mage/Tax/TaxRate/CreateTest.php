 ...
 * @license     http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */
class Enterprise_Mage_Tax_TaxRate_CreateTest extends Mage_Selenium_TestCase
{
    /**
     * <p>Preconditions:</p>
    ...
    public function withInvalidValuesForRangeDataProvider()
    {
        return array(
            ...
            array($this->generate('string', 4, ':digit:') . " "
                . $this->generate('string', 4, ':digit:')), // Number with space (input limited to 9 chars)
