...
\Magento\Autoload\IncludePath::addIncludePath([BP . '/dev/tests/static/framework', realpath(__DIR__ . '/../../..')]);
...
$deployer = new \Magento\Tools\View\Deployer($filesUtil, $logger, $isDryRun);
