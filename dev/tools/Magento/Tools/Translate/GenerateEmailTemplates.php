...
define('USAGE', <<<USAGE
 ...
 Apply translation to e-mail templates
  php -f GenerateEmailTemplates.php -- --locale <locale_NAME> --translate <CSV file|directory> --output <directory>

 Merge two different locales
  php -f GenerateEmailTemplates.php -- --merge-locales en_US-translate.csv de_DE-translate.csv de_DE.csv

 Split one translation file with sections to the separate files
  php -f GenerateEmailTemplates.php -- --split en_US.csv
