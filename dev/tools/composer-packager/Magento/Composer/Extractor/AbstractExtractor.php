...
abstract class AbstractExtractor implements  \Magento\Composer\Extractor{
    ...
    public abstract function createComponent($name);
    ...
    public function create(\Magento\Composer\Model\ArrayAndObjectAccess $definition)
    {
        ...
        if(isset($definition->dependencies) && !empty($definition->dependencies)){
            foreach ($definition->dependencies as $dependency) {
                $dependentComponentName = \Magento\Composer\Helper\Converter::nametoVendorPackage($dependency);
