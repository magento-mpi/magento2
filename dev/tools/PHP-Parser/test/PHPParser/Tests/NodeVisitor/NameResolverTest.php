...
EOC;
    ...
    {
        $stmts = [new PHPParser_Node_Expr_New(new PHPParser_Node_Name('self'))];
    ...
    {
        $stmts = $this->createNamespacedAndNonNamespaced([
    ...
    {
        $stmts = [
            new PHPParser_Node_Stmt_Use([
                new PHPParser_Node_Stmt_UseUse(new PHPParser_Node_Name('A\B'), 'B', ['startLine' => 1]),
                new PHPParser_Node_Stmt_UseUse(new PHPParser_Node_Name('C'),   'B', ['startLine' => 2]),
            ]),
        ];
