...
/**
 * Test category products resource for customer
 *
 * @category    Magento
 * @package     Magento_Test
 * @author      Magento Api Team <api-team@magento.com>
 */
class Api2_Catalog_Category_Product_CustomerTest extends Magento_Test_Webservice_Rest_Customer
{
    /**
    ...
    /**
     * Test that list of products assigned to category is forbidden for customer
     *
    ...
    /**
     * Test that product assign to category is forbidden for customer
     *
    ...
    /**
     * Test that product assigned to category change is forbidden for customer
     *
    ...
    /**
     * Test that product unassign from category is forbidden for customer
     *
