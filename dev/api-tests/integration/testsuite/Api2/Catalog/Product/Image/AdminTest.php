...
class Api2_Catalog_Product_Image_AdminTest extends Magento_Test_Webservice_Rest_Admin
{
     ...
     * Test image create
     *
     * @magentoDataFixture testsuite/Api2/Catalog/Product/Image/_fixture/product_simple.php
     ...
     *
     * @magentoDataFixture fixture/Catalog/Product/Simple/product_simple_on_new_store.php
     * @resourceOperation product_image::update
     */
     ...
     *
     * @magentoDataFixture fixture/Catalog/Category/category_on_new_store.php
     * @magentoDataFixture testsuite/Api2/Catalog/Product/Image/_fixture/product_simple.php
     * @resourceOperation product_image::get
     */
     ...
     * @param array $data
     * @param int $store
     * @return \Api2_Catalog_Product_Image_AdminTest
     */
    ...
    protected function _getImageFixture()
    {
        ...
        $this->_getIoAdapter()->cp(TEST_FIXTURE_DIR . '/_data/Catalog/Product/product.jpg', $fileFixture);
