 ...
 */
class Api2_Catalog_Products_Configurable_AssociatedProduct_AdminTest extends Magento_Test_Webservice_Rest_Admin
{
    /**
     ...
     *
     * @magentoDataFixture Api2/Catalog/Products/Configurable/_fixtures/configurable.php
     * @magentoDataFixture Api2/Catalog/Products/Configurable/_fixtures/product_simple_with_configurable_attribute_set.php
     ...
     *
     * @magentoDataFixture Api2/Catalog/Products/Configurable/_fixtures/configurable.php
     * @magentoDataFixture Api2/Catalog/Products/Configurable/_fixtures/product_downloadable_with_configurable_attribute_set.php
     * @resourceOperation configurable_associated_product::create
     */
     ...
     *
     * @magentoDataFixture Api2/Catalog/Products/Configurable/_fixtures/configurable.php
     * @magentoDataFixture Api2/Catalog/Products/Configurable/_fixtures/product_giftcard_with_configurable_attribute_set.php
     * @resourceOperation configurable_associated_product::create
     */
     ...
     *
     * @magentoDataFixture Api2/Catalog/Products/Configurable/_fixtures/configurable.php
     * @magentoDataFixture Api2/Catalog/Products/Configurable/_fixtures/product_simple_without_configurable_attribute.php
     * @resourceOperation configurable_associated_product::create
     */
