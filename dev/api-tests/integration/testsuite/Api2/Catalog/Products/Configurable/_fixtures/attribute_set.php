...
if (!Magento_Test_Webservice::getFixture('attribute_set_with_configurable')) {
    ...
    $attributeSet = require TEST_FIXTURE_DIR . '/_block/Catalog/Product/Attribute/Set.php';
    $attributeSet->save();
    ...
    $attributeFixture = require TEST_FIXTURE_DIR . '/_block/Catalog/Product/Attribute.php';
