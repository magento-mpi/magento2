 ...
 */
class Api2_Catalog_Products_Websites_AdminTest extends Magento_Test_Webservice_Rest_Admin
{
    /**
     * Delete fixtures
     */
     ...
     *
     * @magentoDataFixture Api2/Catalog/Products/Websites/_fixture/websites.php
