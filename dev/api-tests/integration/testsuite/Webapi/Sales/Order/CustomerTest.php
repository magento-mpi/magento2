...
/**
 * Test for order item Webapi
 *
 * @category    Magento
 * @package     Magento_Test
 * @author      Magento Api Team <api-team@magento.com>
 */
class Webapi_Sales_Order_CustomerTest extends Magento_Test_Webservice_Rest_Customer
{
    /**
     * Delete fixtures
     */
     ...
     *
     * @magentoDataFixture fixture/Sales/Order/orders_list_customer.php
