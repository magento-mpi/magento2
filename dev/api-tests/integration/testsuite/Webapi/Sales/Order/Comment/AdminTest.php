...
/**
 * Test for sales order comments Webapi by admin api user
 *
 * @category    Magento
 * @package     Magento_Test
 * @author      Magento Api Team <api-team@magento.com>
 */
class Webapi_Sales_Order_Comment_AdminTest extends Magento_Test_Webservice_Rest_Admin
{
    /**
     ...
     * @return Webapi_Sales_Order_Comment_AdminTest
     */
