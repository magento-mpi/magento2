...
/**
 * Test for configurable associated products resource (customer role)
 *
 * @category    Magento
 * @package     Magento_Test
 * @author      Magento Api Team <api-team@magento.com>
 */
class Webapi_Catalog_Product_Configurable_AssociatedProduct_CustomerTest extends Magento_Test_Webservice_Rest_Customer
{
    /**
     * Test that list of products assigned to configurable product is forbidden for customer
     *
    ...
    /**
     * Test that product assign to configurable product is forbidden for customer
     *
    ...
    /**
     * Test that product unassign from configurable product is forbidden for customer
     *
