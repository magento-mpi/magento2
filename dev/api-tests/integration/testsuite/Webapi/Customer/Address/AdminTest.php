...
/**
 * Test for customer address Webapi (admin)
 *
 * @category    Magento
 * @package     Magento_Test
 * @author      Magento Api Team <api-team@magento.com>
 */
class Webapi_Customer_Address_AdminTest extends Magento_Test_Webservice_Rest_Admin
{
    /**
        ...
        foreach ($dataForCreate as $field => $value) {
            if ('street' == $field) {
                ...
                $this->assertEquals(implode(
                        Mage_Customer_Model_Webapi_Customer_Address_Validator::STREET_SEPARATOR,
