...
/**
 * Test for customer address Webapi (customer)
 *
 * @category    Magento
 * @package     Magento_Test
 * @author      Magento Api Team <api-team@magento.com>
 */
class Webapi_Customer_Address_CustomerTest extends Magento_Test_Webservice_Rest_Customer
{
    /**
     * Current customer
     *
     ...
     *
     * @param $dataForCreate
     * @magentoDataFixture testsuite/Webapi/Customer/Address/_fixture/add_addresses_to_current_customer.php
     * @dataProvider providerAddressData
     * @resourceOperation customer_address::create
     */
