 ...
 * Mage_Core_Config_Options class should change default etc_dir path. It is neccessary for vestions < 1.10.0.0
 *
 * @category   Mage
 * @package    Mage_Core
...
class Mage_Core_Model_Config_Options extends Varien_Object
{
    ...
    /**
     * Returns current test 'etc' dir
     *
     * @return string
     */
    public function getCurrentEtcDir()
    {
        $appObject = Mage_PHPUnit_Initializer_Factory::getInitializer('Mage_PHPUnit_Initializer_App');
        if ($appObject && $appObject->getTestEtcDir()) {
            return $appObject->getTestEtcDir();
        }
