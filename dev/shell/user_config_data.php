...
$usage = 'Usage: php -f user_config_data.php -- --data=<string> - pairs of \'path=value\' separated by \'&\', where
    ...
    ' . ' --data=' . escapeshellarg('web/seo/use_rewrites=1&web/unsecure/base_url=http://127.0.0.1/')
