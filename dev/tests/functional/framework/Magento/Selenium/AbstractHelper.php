 ...
 * @method Magento_Selenium_Uimap_Fieldset|Magento_Selenium_Uimap_Tab _findUimapElement(string $elementType, string $elementName, mixed $uimap = null)
 * @method Magento_Selenium_Uimap_Tab  _getActiveTabUimap()
 ...
 * @method Magento_Selenium_TestCase   addParameter(string $name, string $value)
 * @method void                     addVerificationMessage($message)
 * @method Magento_Selenium_TestCase   admin(string $page = null, bool $validatePage = true)
 * @method bool                     alertIsPresent()
 * @method Magento_Selenium_TestCase   appendParamsDecorator(Magento_Selenium_Helper_Params $paramsHelperObject)
 ...
 * @method Magento_Selenium_TestCase   clickButton(string $button, bool $willChangePage = true)
 * @method void                     clickButtonAndConfirm(string $buttonName, string $message, bool $willChangePage = true)
 * @method Magento_Selenium_TestCase   clickControl(string $controlType, string $controlName, bool $willChangePage = true)
 * @method void                     clickControlAndConfirm(string $controlType, string $controlName, string $message, bool $willChangePage = true)
 * @method Magento_Selenium_TestCase   clickControlAndWaitMessage(string $controlType, string $controlName, bool $validate = true)
 ...
 * @method Magento_Selenium_TestCase   frontend(string $page = 'home_page', bool $validatePage = true)
 ...
 * @method Magento_Selenium_Helper_Config getConfigHelper()
 ...
 * @method Magento_Selenium_Uimap_Page getCurrentLocationUimapPage()
 * @method string                   getCurrentPage()
 * @method Magento_Selenium_Uimap_Page getCurrentUimapPage()
 ...
 * @method string                   getPageUrl(string $area, string $page, Magento_Selenium_Helper_Params $paramsDecorator = null)
 * @method string                   getParameter(string $name)
 * @method Magento_Selenium_Helper_Params getParamsHelper()
 ...
 * @method Magento_Selenium_Uimap_Page getUimapPage(string $area, string $pageKey)
 * @method string                   getUrlPrefix(string $area = 'frontend')
 * @method Magento_Selenium_TestCase   goToArea(string $area = 'frontend', string $page = '', bool $validatePage = true)
 * @method bool                     isControlExpanded(string $controlType, string $controlName)
 * @method Magento_Selenium_TestCase   helper(string $className)
 ...
 * @method Magento_Selenium_TestCase   loginAdminUser()
 * @method Magento_Selenium_TestCase   logoutAdminUser()
 * @method Magento_Selenium_TestCase   logoutCustomer()
 * @method string                   locationToString()
 * @method array                    messagesToString($message)
 * @method Magento_Selenium_TestCase   navigate(string $page, bool $validatePage = true)
 ...
 * @method Magento_Selenium_TestCase   pleaseWait(int $waitDisappear = 30)
 ...
 * @method Magento_Selenium_TestCase   saveForm(string $buttonName, bool $validate = true)
 ...
 * @method Magento_Selenium_TestCase   setArea(string $name)
 * @method Magento_Selenium_TestCase   setCurrentPage(string $page)
 * @method void                     setDataParams(string &$value)
 * @method Magento_Selenium_TestCase   setDefaultScreenshotPath(string $path)
 * @method Magento_Selenium_TestCase   setScreenshotPath(string $path)
...
class Magento_Selenium_AbstractHelper
{
    /**
     * Test object
     * @var Magento_Selenium_TestCase
     */
     ...
     *
     * @param  Magento_Selenium_TestCase $testObject
     */
    public function __construct(Magento_Selenium_TestCase $testObject)
    {
    ...
    /**
     * @return Magento_Selenium_AbstractHelper
     */
    ...
    /**
     * Delegate method calls to Magento_Selenium_TestCase class.
     *
     ...
     * Set Test Instance
     */
    public function setTestInstance(Magento_Selenium_TestCase $testInstance)
    {
