 ...
 * Class ExchangeRate
 */
class ExchangeRate extends InjectableFixture
{
    /**
     * @var string
     */
    protected $repositoryClass = 'Magento\Reward\Test\Repository\ExchangeRate';

    /**
     * @var string
     */
    protected $handlerInterface = 'Magento\Reward\Test\Handler\ExchangeRate\ExchangeRateInterface';
