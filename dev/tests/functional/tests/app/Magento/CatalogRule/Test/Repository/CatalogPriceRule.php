...
class CatalogPriceRule extends AbstractRepository
{
    ...
    public function __construct(array $defaultConfig, array $defaultData)
    {
        ...
        $this->_data['catalog_price_rule'] = $this->_getCatalogPriceRule();
        $this->_data['customer_group_catalog_rule'] = $this->_getCustomerGroupCatalogRule();
    }
