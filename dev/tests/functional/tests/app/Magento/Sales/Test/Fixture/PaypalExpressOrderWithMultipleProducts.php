 ...
 */
class PaypalExpressOrderWithMultipleProducts extends Checkout
{
    /**
     * Order ID
     *
    ...
    {
        $this->checkoutFixture = Factory::getFixtureFactory()->getMagentoCheckoutPaypalExpressWithMultipleProducts();
        //Verification data
        $this->_data = array(
            'totals' => array(
                'grand_total' => '22.73'
