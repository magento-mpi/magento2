...
namespace Magento\GiftCard\Test\Handler\Curl;
...
/**
 * Curl handler for creating Gift Card.
 *
 * @package Magento\Bundle\Test\Handler\Curl
 */
class CreateGiftCard extends Curl
{
    /**
     * Prepare POST data for creating Gift Card product request
     *
     * @param array $params
