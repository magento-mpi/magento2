...
class ApplyConfig extends Direct
{
    ...
    public function execute(Fixture $fixture = null)
    {
        ...
        $objectManager->configure($objectManager->get('Magento\Core\Model\ObjectManager\ConfigLoader')->load('adminhtml'));

        $objectManager->configure(
            array(
                'preferences' => array(
                    'Magento\Authorization\Policy' => 'Magento\Authorization\Policy\Default',
                    'Magento\Authorization\RoleLocator' => 'Magento\Authorization\RoleLocator\Default'
                )));
