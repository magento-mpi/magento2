 ...
 */
class AssertCatalogEventIsClosed extends AbstractConstraint
{
    const EVENT_STATUS = 'Closed';
    /**
    ...
    /**
     * Assert that Event block has closed status
     *
    ...
    /**
     * Event block has closed status on Category Page
     */
    ...
    /**
     * Event block has closed status on Product Page
     */
