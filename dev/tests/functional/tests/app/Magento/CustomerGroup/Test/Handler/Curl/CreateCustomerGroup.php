...
namespace Magento\CustomerGroup\Test\Handler\Curl;
 ...
 *
 * @package Magento\CustomerGroup\Test\Handler\Curl
 */
class CreateCustomerGroup
{
    /**
     * Prepare POST data for creating customer group request
     *
    ...
    /**
     * Post request for creating customer group in backend
     *
    ...
    public function execute(Fixture $fixture = null)
    {
        ...
        $url = $_ENV['app_backend_url'] . 'customer/group/save';
