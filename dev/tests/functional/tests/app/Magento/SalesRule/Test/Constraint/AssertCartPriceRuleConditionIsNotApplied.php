 ...
 * 6. Check that shopping cart subtotal equals with grand total(excluding shipping price if exist).
 */
class AssertCartPriceRuleConditionIsNotApplied extends AbstractConstraint
{
    /**
    ...
    public function processAssert(
        ...
        \PHPUnit_Framework_Assert::assertEquals(
            ...
            . '\' not equals with grand total: \'' . $grandTotal . '\''
        );
    }
    ...
    {
        return 'Shopping cart subtotal not with grand total - price rule condition is not applied.';
    }
}
