...
/**
 * Class Curl
 * Curl handler for creating Web site.
 */
class Curl extends AbstractCurl implements WebsiteInterface
{
    /**
     * POST request for creating web site
     *
    ...
    public function persist(FixtureInterface $fixture = null)
    {
        ...
        if (!strpos($response, 'data-ui-id="messages-message-success"')) {
            throw new \Exception("Web site entity creating by curl handler was not successful! Response: $response");
        }
    ...
    /**
     * Get web site id by web site name
     *
    ...
    {
        //Set pager limit to 2000 in order to find created web site by name
