...
/**
 * Class AssertWidgetCatalogCategoryLinkOnFrontendAllPages
 * Check that created widget displayed on frontent on Home page and on Advanced Search
 */
class AssertWidgetCatalogCategoryLinkOnFrontendAllPages extends AbstractConstraint
{
    /**
    ...
    {
        return "Widget with type catalog category link is present on Home page and on Advanced Search.";
    }
}
