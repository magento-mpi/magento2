...
class Cart extends Block
{
    ...
    /**
     * Get shipping and tax block
     *
     * @return \Magento\Checkout\Test\Block\Cart\Shipping
     */
    public function getShippingAndTaxBlock()
    {
        return $this->blockFactory->create(
            'Magento\Checkout\Test\Block\Cart\Shipping',
            ['element' => $this->_rootElement->find('#block-shipping')]
        );
    }

    /**
     * Get discount codes block
     *
    ...
    public function getDiscountCodesBlock()
    {
        return $this->blockFactory->create(
            ...
            ['element' => $this->_rootElement->find('#block-discount')]
        );
    }

    /**
     * Get gift cards block
     *
    ...
    {
        return $this->blockFactory->create(
            'Magento\GiftCardAccount\Test\Block\Checkout\Cart\Giftcardaccount',
            ['element' => $this->_rootElement->find('#block-giftcard')]
        );
    }
    ...
    {
        return $this->blockFactory->create(
            'Magento\Checkout\Test\Block\Cart\Totals',
            ['element' => $this->_rootElement->find('.cart.totals')]
        );
    }
    ...
    {
        return $this->blockFactory->create(
            'Magento\Checkout\Test\Block\Onepage\Link',
            ['element' => $this->_rootElement->find('.action.primary.checkout')]
        );
    }
}
