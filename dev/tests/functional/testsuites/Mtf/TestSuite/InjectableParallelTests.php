...
/**
 * Class InjectableParallelTests
 *
 * @package Mtf\TestSuite
 */
class InjectableParallelTests extends \PHPUnit_Framework_TestSuite
{
    /**
     * @var ObjectManager
     */
    ...
    {
        $this->init();
        return $this->objectManager->create('Mtf\TestSuite\AppStateParallel');
    }
