...
class Core_Mage_Product_SkuAutoGenerationTest extends Mage_Selenium_TestCase
{
    ...
    public function verificationOfSkuAutogeneration()
    {
        ...
        $this->productHelper()->createProductWithAutoGeneration($productData, false, array('general_sku'));
        //Verifying
        $this->openTab('general');
        $this->assertSame($productData['general_name'],
            $this->getControlAttribute('field', 'general_sku', 'selectedLabel'), 'SKU is not equal to product name.');
    }
    ...
    public function saveWithAutogeneratedSku()
    {
        ...
        //Steps
        $this->navigate('manage_products');
        $this->productHelper()->createProductWithAutoGeneration($productData, true, array('general_sku'));
        //Verifying
