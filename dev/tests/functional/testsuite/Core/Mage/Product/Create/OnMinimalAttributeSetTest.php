...
class Core_Mage_Product_Create_OnMinimalAttributeSetTest extends Mage_Selenium_TestCase
{
    ...
    public function preconditionsForTests()
    {
        ...
        //Data for creating simple product for configurable
        ...
        return array(
            ...
            'attributeCode' => $attrData['attribute_code'],
     ...
     * @TestlinkId TL-MAGE-5701, TL-MAGE-5702, TL-MAGE-5703, TL-MAGE-5706, TL-MAGE-5707
     */
    public function createAllProducts($productType, $testData)
    {
        ...
        switch ($productType) {
            ...
            case 'dynamic_bundle':
                ...
                $productData['general_bundle_items']['item_1']['add_product_1']['associated_search_sku'] =
                    $testData['simple_sku'];
                $productType = 'bundle';
                break;
            case 'grouped':
