 ...
 */
class Core_Magento_CheckoutOnePage_LoggedIn_PaymentMethodZeroSubtotalTest extends Mage_Selenium_TestCase
{
    ...
    public function zeroSubtotalCheckoutCapture($testData)
    {
        ...
        $paymentConfig = $this->loadDataSet('PaymentMethod', 'zerosubtotal_enable', array(
