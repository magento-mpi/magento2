...
class Core_Mage_Acl_SystemConfigurationTest extends Mage_Selenium_TestCase
{
    ...
    public function systemConfigurationOneTabDataProvider()
    {
        return array(
            ...
            array('stores-settings-configuration-facebook_section', 'social_facebook'),
...
//            array('stores-settings-configuration-paypal_section', ''),
            ...
            array('stores-settings-configuration-moneybookers_settings', 'sales_moneybookers'),
