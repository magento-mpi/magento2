...
class Core_Mage_Store_SingleStoreMode_MultiStoreModeWithDisableSingleStoreModeTest extends Mage_Selenium_TestCase
{
     ...
     */
    public function verificationSelectStoreDuringOrderCreation()
    {
        $userData = $this->loadDataSet('Customers', 'generic_customer_account');
        $this->navigate('manage_customers');
        $this->customerHelper()->createCustomer($userData);
