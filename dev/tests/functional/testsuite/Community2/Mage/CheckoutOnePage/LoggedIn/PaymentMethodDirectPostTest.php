 ...
 */
class Community2_Mage_CheckoutOnePage_LoggedIn_PaymentMethodDirectPostTest extends Mage_Selenium_TestCase
{
     ...
     * <p>9. Select Authorize.net Direct post(by data provider).</p>
