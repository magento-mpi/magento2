...
/**
 * Create new customer address attribute. Type: Drop Down
 *
 * @package     selenium
 * @subpackage  tests
 * @license     http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */
class Enterprise2_Mage_Attributes_CustomerAddressAttribute_DropDownTest extends Mage_Selenium_TestCase
{
    /**
     * <p>Preconditions:</p>
