<?php
     ...
     */
class Enterprise2_Mage_ImportExportScheduled_Export_CustomerTest_Add_Update_Delete extends Mage_Selenium_TestCase
{
...
//        print_r($exportData);
     ...
     */
    public function deleteScheduledExport()
    {
        // Precondition
        $exportData = $this->loadDataSet('ImportExportScheduled', 'scheduled_export',
            array(
