...
/**
 * Test admin order workflow with Bank Transfer Payment  method
 *
 * @package     selenium
 * @subpackage  tests
 * @license     http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */
class Community17_Mage_Order_BankTransferPayment_NewCustomerWithSimpleSmokeTest extends Mage_Selenium_TestCase
{
    /**
     * <p>Preconditions:</p>
    ...
    {
        //Data
        $config = $this->loadDataSet('PaymentMethod', 'banktransfer');
        //Steps
        $this->loginAdminUser();
    ...
    {
        //Data
        $orderData = $this->loadDataSet('SalesOrder', 'order_newcustomer_BankTransferPayment_flatrate_usa',
     ...
     * <p>9.Check payment method 'Bank Transfer Payment';</p>
