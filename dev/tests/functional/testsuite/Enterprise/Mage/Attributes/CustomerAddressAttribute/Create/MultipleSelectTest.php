...
/**
 * Create new customer address attribute. Type: Multiple Select
 *
 * @package     selenium
 * @subpackage  tests
 * @license     http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */
class Enterprise_Mage_Attributes_CustomerAddressAttribute_MultipleSelectTest extends Mage_Selenium_TestCase
{
    /**
     * <p>Preconditions:</p>
    ...
    /**
     * <p>Create "Multiple Select" type Customer Address Attributes (required fields only)</p>
     * <p>Steps:</p>
