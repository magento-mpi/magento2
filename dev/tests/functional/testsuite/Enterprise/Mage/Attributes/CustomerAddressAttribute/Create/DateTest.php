...
/**
 * Create new customer address attribute. Type: Date
 *
 * @package     selenium
 * @subpackage  tests
 * @license     http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */
class Enterprise_Mage_Attributes_CustomerAddressAttribute_Create_DateTest extends Mage_Selenium_TestCase
{
    ...
    /**
     * <p>Create "Date type Customer Address Attributes  (required fields only)</p>
     *
     * @return array
     * @test
     * @depends navigation
    ...
    {
        //Data
        $attrData = $this->loadDataSet('CustomerAddressAttribute', 'customer_address_attribute_date');
        //Steps
    ...
    {
        //Data
        $attrData = $this->loadDataSet('CustomerAddressAttribute', 'customer_address_attribute_date', array(
