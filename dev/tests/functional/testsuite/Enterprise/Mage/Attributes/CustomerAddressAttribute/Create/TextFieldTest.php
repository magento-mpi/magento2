...
/**
 * Create new customer address attribute. Type: Text Field
 *
 * @package     selenium
 * @subpackage  tests
 * @license     http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */
class Enterprise_Mage_Attributes_CustomerAddressAttribute_Create_TextFieldTest extends Mage_Selenium_TestCase
{
    ...
    /**
     * <p>Create "Text Field" type Customer Address Attribute (required fields only)</p>
     *
     * @return array
     * @test
     * @depends navigation
     ...
     * @test
     * @depends withRequiredFieldsOnly
     * @TestlinkId TL-MAGE-5585
     */
    public function withLongValues()
    {
        //Data
        $attrData = $this->loadDataSet('CustomerAddressAttribute', 'customer_address_attribute_textfield', array(
