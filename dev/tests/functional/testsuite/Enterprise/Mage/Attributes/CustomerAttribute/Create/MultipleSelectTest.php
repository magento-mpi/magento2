 ...
 */
class Enterprise_Mage_Attributes_CustomerAttribute_Create_MultipleSelectTest extends Mage_Selenium_TestCase
{
    ...
    /**
     * <p>Create "Multiple Select" type Customer Attributes (required fields only)</p>
     *
     * @return array
     * @test
     * @depends navigation
    ...
    {
        //Data
        $attrData = $this->loadDataSet('CustomerAttribute', 'customer_attribute_multiselect', array(
