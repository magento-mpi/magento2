...
/**
 * Create new customer  attribute. Type: Yes/No
 *
 * @package     selenium
 * @subpackage  tests
 * @license     http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */
class Enterprise_Mage_Attributes_CustomerAttribute_Create_YesNoTest extends Mage_Selenium_TestCase
{
    ...
    /**
     * <p>Create "Yes/No" type Customer Attribute (required fields only)</p>
     *
     * @return array
     * @test
     * @depends navigation
    ...
    {
        //Data
        $attrData = $this->loadDataSet('CustomerAttribute', 'customer_attribute_yesno', array(
