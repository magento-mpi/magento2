...
class Enterprise_Mage_AddBySku_ProductTest extends Mage_Selenium_TestCase
{
    ...
    protected function _createSimpleProduct($customOptionsReq, $customOptionsNReq, $website, $category, $attrData)
    {
        ...
        $option1 = $attrData['option_1']['admin_option_name'];
        $option2 = $attrData['option_2']['admin_option_name'];
        $simple['simple'] = $this->loadDataSet('Product', 'simple_sku');
        $simple['simple']['general_user_attr']['dropdown'][$attrCode] = $option1;
        $simple['withBackorders'] = $this->loadDataSet('Product', 'simple_sku', array(
            'inventory_backorders_default' => 'No',
            'inventory_backorders' => 'Allow Qty Below 0'
        ));
        $simple['withBackorders']['general_user_attr']['dropdown'][$attrCode] = $option2;
        $simple['disabled'] = $this->loadDataSet('Product', 'simple_sku',
    ...
    public function preconditionsForTests()
    {
        ...
        $productData['configurable'] = array(
            ...
            'qty' => 1,
            'Options' => array('option_1' => array(
                'parameters' => array('title' => $attrData['admin_title']),
