...
class Enterprise_Reminder_Model_Rule_Condition_CartTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testDaysDiffCondition($operator, $value, $expectedResult, $checkGmtDate = false)
    {
        ...
        $this->_model = Mage::getModel('Enterprise_Reminder_Model_Rule_Condition_Cart', array(
