...
class Enterprise_CustomerSegment_Model_Segment_Condition_Combine_RootTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var Enterprise_CustomerSegment_Model_Segment_Condition_Combine_Root
     */
    protected $_model;
    ...
    {
        return array(
            array(null, new Zend_Db_Expr(1), array('`root`.`entity_id`', '`root`.`website_id`', 'where (website_id=1)')),
