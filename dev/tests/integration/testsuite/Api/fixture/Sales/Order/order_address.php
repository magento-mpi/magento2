...
$productFixture = require 'API/fixture/_block/Catalog/Product.php';

/* @var $quote Mage_Sales_Model_Quote */
$quote = require 'API/fixture/_block/Sales/Quote/Quote.php';

/* @var $address Mage_Sales_Model_Quote_Address */
$address = require 'API/fixture/_block/Sales/Quote/Address.php';

/* @var $rateFixture Mage_Sales_Model_Quote_Address_Rate */
$rateFixture = require 'API/fixture/_block/Sales/Quote/Rate.php';
