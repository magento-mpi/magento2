...
class Api_Catalog_Product_Helper_Simple extends Magento_Test_TestCase_ApiAbstract
{
    /**
    ...
    {
        return require 'API/_fixture/_data/Catalog/Product/Simple/' . $fixtureName . '.php';
    }
