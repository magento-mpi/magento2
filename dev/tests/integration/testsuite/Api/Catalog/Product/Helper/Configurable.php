 ...
 */
class Api_Catalog_Product_Helper_Configurable extends Magento_Test_TestCase_ApiAbstract
{
    /**
    ...
    {
        require 'API/_fixture/Catalog/Product/Configurable/attribute_set.php';
        // Prepare fixture
    ...
    {
        require 'API/_fixture/Catalog/Product/Configurable/attribute_set_with_invalid_attribute.php';
        // Prepare fixture
        $productData = $this->_getValidProductPostData();
    ...
    {
        require 'API/_fixture/Catalog/Product/Configurable/attribute_set_with_one_attribute.php';
        // Prepare fixture
        $productData = $this->_getValidProductPostData();
        /** @var $attributeSet Mage_Eav_Model_Entity_Attribute_Set */
    ...
    {
        return require 'API/_fixture/_data/Catalog/Product/Configurable/product_configurable_all_fields.php';
    }
}
