...
$productData = Magento_Test_TestCase_ApiAbstract::simpleXmlToObject($fixture->fixtureProduct);
...
$data = Magento_Test_TestCase_ApiAbstract::simpleXmlToObject($fixture->fixtureCustomOption);
