...
$customerData = Magento_Test_TestCase_ApiAbstract::simpleXmlToObject($tagFixture->customer);
...
$productData = Magento_Test_TestCase_ApiAbstract::simpleXmlToObject($tagFixture->product);
