...
$quote2->save();
Magento_Test_Webservice::setFixture('quote2', $quote2, Magento_Test_Webservice::AUTO_TEAR_DOWN_AFTER_CLASS);
...
$order2->place();
$order2->save();
Magento_Test_Webservice::setFixture('order2', $order2, Magento_Test_Webservice::AUTO_TEAR_DOWN_AFTER_CLASS);
