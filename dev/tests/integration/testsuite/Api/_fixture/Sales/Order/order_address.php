...
$quote = require 'API/_fixture/_block/Sales/Quote/Quote.php';

/* @var $address Mage_Sales_Model_Quote_Address */
$address = require 'API/_fixture/_block/Sales/Quote/Address.php';
...
Magento_Test_TestCase_ApiAbstract::setFixture('product1', $product1);
Magento_Test_TestCase_ApiAbstract::setFixture('product2', $product2);
Magento_Test_TestCase_ApiAbstract::setFixture('quote', $quote);
Magento_Test_TestCase_ApiAbstract::setFixture('order', Mage::getModel('Mage_Sales_Model_Order')->load($order->getId()));
