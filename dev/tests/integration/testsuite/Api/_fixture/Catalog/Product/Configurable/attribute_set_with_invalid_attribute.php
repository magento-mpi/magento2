...
$validAttribute->save();
Magento_Test_TestCase_ApiAbstract::setFixture('eav_valid_configurable_attribute', $validAttribute);
...
Magento_Test_TestCase_ApiAbstract::setFixture('eav_invalid_configurable_attribute', $invalidAttribute);
