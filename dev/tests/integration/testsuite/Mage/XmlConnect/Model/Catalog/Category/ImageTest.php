...
class Mage_XmlConnect_Model_Catalog_Category_ImageTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $model = Mage::getModel('Mage_XmlConnect_Model_Catalog_Category_Image');
    ...
    public function testGetUrlPlaceholder($model)
    {
        $this->assertStringMatchesFormat(
            'http://localhost/pub/media/theme/frontend/%s/Mage_XmlConnect/images/catalog/category/placeholder/image.jpg',
            $model->getUrl()
        );
    }
}
