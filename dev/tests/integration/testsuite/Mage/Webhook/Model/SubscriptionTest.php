...
class Mage_Webhook_Model_SubscriptionTest extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $aclCache = Magento_Test_Helper_Bootstrap::getObjectManager()->get('Magento_Acl_CacheInterface');
        $aclCache->clean();
    ...
    public function testGetUser()
    {
        ...
        $userFactory = Magento_Test_Helper_Bootstrap::getObjectManager()->create('Mage_Webhook_Model_User_Factory');
        /** @var Mage_Webhook_Model_Webapi_User_Factory $webapiUserFactory */
        $webapiUserFactory = Magento_Test_Helper_Bootstrap::getObjectManager()
            ->create('Mage_Webhook_Model_Webapi_User_Factory');
