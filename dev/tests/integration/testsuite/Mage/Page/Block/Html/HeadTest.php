...
class Mage_Page_Block_Html_HeadTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        Mage::getDesign()->setDesignTheme('mage_demo', 'frontend');
    ...
    public function testGetCssJsHtml()
    {
        ...
        $this->assertEquals(
            ...
            . 'src="http://localhost/pub/static/frontend/mage_demo/en_US/Mage_Bundle/bundle.js">'
            . '</script>' . "\n"
            . '<link rel="stylesheet" type="text/css" media="all"'
            . ' href="http://localhost/pub/lib/tiny_mce/themes/advanced/skins/default/ui.css" />' . "\n"
            . '<link rel="stylesheet" type="text/css" media="print" '
                . 'href="http://localhost/pub/static/frontend/mage_demo/en_US/css/styles.css" />'
                . "\n"
