...
class Mage_Page_Block_Html_HeadTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testGetCssJsHtml()
    {
        $this->_block->addItem('js', 'zero.js', null, null, 'nonexisting_condition')
            ->addItem('js', 'varien/product.js')
            ->addItem('skin_js', 'Mage_Bundle::bundle.js')
            ->addItem('js_css', 'calendar/calendar-system.css')
            ...
            ->addItem('js', 'calendar/calendar.js', null, 'ie6')
        ;
        $this->assertEquals(
            '<script type="text/javascript" src="http://localhost/js/varien/product.js"></script>' . "\n"
            . '<script type="text/javascript" '
            . 'src="http://localhost/media/skin/frontend/default/default/default/en_US/Mage_Bundle/bundle.js">'
            . '</script>' . "\n"
            . '<link media="all" rel="stylesheet" type="text/css" '
                . 'href="http://localhost/js/calendar/calendar-system.css" />' . "\n"
            . '<link media="all" rel="stylesheet" type="text/css" '
            ...
            . '<!--[if ie6]>' . "\n"
            . '<script type="text/javascript" src="http://localhost/js/calendar/calendar.js"></script>' . "\n"
            . '<![endif]-->' . "\n",
