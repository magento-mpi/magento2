...
class Mage_Core_Model_TranslateTest extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        Magento_Test_Helper_Bootstrap::getObjectManager()->addSharedInstance(
            $this->_viewFileSystem, 'Mage_Core_Model_View_FileSystem'
        );
        ...
        Magento_Test_Helper_Bootstrap::getObjectManager()->addSharedInstance(
            $this->_designModel, 'Mage_Core_Model_View_Design'
        );
