...
class Mage_Core_Model_Config_DataTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        Mage::getObjectManager()->get('Mage_Core_Model_Config_Storage_Writer')
    ...
    {
        Mage::getObjectManager()->get('Mage_Core_Model_Config_Storage_Writer')->delete(self::SAMPLE_CONFIG_PATH);
        self::_refreshConfiguration();
    }
