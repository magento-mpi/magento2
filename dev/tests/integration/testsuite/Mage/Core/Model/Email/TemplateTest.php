    ...
    protected function setUp()
    {
        ...
        $this->_model = $this->getMockBuilder('Mage_Core_Model_Email_Template')
            ...
            ->setConstructorArgs(array(
                ...
                Magento_Test_Helper_Bootstrap::getObjectManager()->create('Magento_Filesystem'),
                Magento_Test_Helper_Bootstrap::getObjectManager()->create('Mage_Core_Model_View_Url'),
                Magento_Test_Helper_Bootstrap::getObjectManager()->create('Mage_Core_Model_View_FileSystem')
            ))
            ->getMock();
