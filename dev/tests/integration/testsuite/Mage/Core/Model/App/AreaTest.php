...
class Mage_Core_Model_App_AreaTest extends PHPUnit_Framework_TestCase
{
    ...
    /**
     * @magentoConfigFixture current_store design/theme/ua_regexp a:1:{s:1:"_";a:2:{s:6:"regexp";s:10:"/firefox/i";s:5:"value";s:14:"magento_modern";}}
     * @magentoAppIsolation enabled
     */
     ...
     *
     * @magentoConfigFixture current_store design/theme/ua_regexp a:1:{s:1:"_";a:2:{s:6:"regexp";s:10:"/firefox/i";s:5:"value";s:17:"magento_demo_blue";}}
     * magentoDataFixture Mage/Core/_files/design_change.php
     * @magentoAppIsolation enabled
     */
    // @codingStandardsIgnoreEnd
    public function testDetectDesignNonFrontend()
    {
        ...
        $this->assertNotEquals('magento_modern', Mage::getDesign()->getDesignTheme()->getThemePath());
        $this->assertNotEquals('magento_demo_blue', Mage::getDesign()->getDesignTheme()->getThemePath());
    }
}
