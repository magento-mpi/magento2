...
class Mage_Core_Model_StoreTest extends PHPUnit_Framework_TestCase
{
    ...
    public function getBaseUrlDataProvider()
    {
        return array(
            ...
            array(Mage_Core_Model_Store::URL_TYPE_THEME, false, false, 'http://localhost/pub/media/skin/'),
            array(Mage_Core_Model_Store::URL_TYPE_THEME, false, true,  'http://localhost/pub/media/skin/'),
            array(Mage_Core_Model_Store::URL_TYPE_THEME, true,  false, 'http://localhost/pub/media/skin/'),
            array(Mage_Core_Model_Store::URL_TYPE_THEME, true,  true,  'http://localhost/pub/media/skin/')
        );
    }
