 ...
 */
class Mage_Webapi_Block_Adminhtml_Role_Edit_FormTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    /**
     * @var Mage_Webapi_Block_Adminhtml_Role_Edit_Form
     */
    protected $_block;
    ...
    protected function setUp()
    {
        ...
        $this->_block = $this->_blockFactory->createBlock('Mage_Webapi_Block_Adminhtml_Role_Edit_Form', array(
