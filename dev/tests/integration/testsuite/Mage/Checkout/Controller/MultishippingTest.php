...
/**
 * Test class for Mage_Checkout_Controller_Multishipping
 *
 * @magentoAppArea frontend
 */
class Mage_Checkout_Controller_MultishippingTest extends Magento_Test_TestCase_ControllerAbstract
{
    /**
