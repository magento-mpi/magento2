...
class Mage_Sales_Model_Resource_Report_Invoiced_Collection_OrderTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $this->_collection = Mage::getResourceModel('Mage_Sales_Model_Resource_Report_Invoiced_Collection_Order');
        $this->_collection
            ->setPeriod('day')
