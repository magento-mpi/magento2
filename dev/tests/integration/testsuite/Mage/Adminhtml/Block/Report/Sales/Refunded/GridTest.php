...
class Mage_Adminhtml_Block_Report_Sales_Refunded_GridTest extends PHPUnit_Framework_TestCase
{
    /**
     * Creates and inits block
     *
     * @param string|null $reportType
     * @return Mage_Adminhtml_Block_Report_Sales_Refunded_Grid
     */
    protected function _createBlock($reportType = null)
    {
        $block = Mage::getModel('Mage_Adminhtml_Block_Report_Sales_Refunded_Grid');
