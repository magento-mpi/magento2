 ...
 */
class Mage_Adminhtml_Block_Report_Sales_Coupons_GridTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $block = Mage::app()->getLayout()->createBlock('Mage_Adminhtml_Block_Report_Sales_Coupons_Grid');
