...
class IndexTest extends \Magento\Backend\Utility\Controller
{
    ...
    public function testSaveActionWithInvalidFormData()
    {
         ...
         */
        $this->assertSessionMessages($this->logicalNot($this->isEmpty()), \Magento\Message\InterfaceMessage::TYPE_ERROR);
        /**
    ...
    public function testSaveActionWithValidCustomerDataAndValidAddressData()
    {
         ...
         */
        $this->assertSessionMessages($this->logicalNot($this->isEmpty()), \Magento\Message\InterfaceMessage::TYPE_SUCCESS);
    ...
    public function testSaveActionExistingCustomerAndExistingAddressData()
    {
        ...
        $this->assertSessionMessages(
            $this->equalTo(array('You saved the customer.')), \Magento\Message\InterfaceMessage::TYPE_SUCCESS
        );
