...
class CustomerGroupV1Test extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->_groupService = $this->_objectManager->get('Magento\Customer\Service\CustomerGroupV1Interface');
    }
    ...
    {
        /** @var \Magento\Customer\Service\CustomerGroupV1Interface $customerGroupService */
        $customerGroupService = \Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
            'Magento\Customer\Service\CustomerGroupV1Interface'
        );
