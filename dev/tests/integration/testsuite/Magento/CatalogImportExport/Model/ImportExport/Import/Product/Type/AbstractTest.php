...
{
    /**
     * @var \Magento\CatalogImportExport\Model\ImportExport\Import\Product\Type\AbstractType
     */
    protected $_model;
    ...
    protected function setUp()
    {
        ...
        $params = array($objectManager->create('Magento\CatalogImportExport\Model\ImportExport\Import\Product'), 'simple');
