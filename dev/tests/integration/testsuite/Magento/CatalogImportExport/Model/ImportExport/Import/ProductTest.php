...
class ProductTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        $this->_uploaderFactory = $this->getMock(
            'Magento\CatalogImportExport\Model\ImportExport\Import\UploaderFactory',
            array('create'),
            array(),
            '',
            false
        ...
        foreach ($productData['data'] as $data) {
            ...
            if (!empty($data['_custom_option_row_title']) && empty($data['_custom_option_store'])) {
                ...
                foreach ($this->_assertOptionValues as $assertKey) {
                    $valueKey = \Magento\CatalogImportExport\Model\ImportExport\Import\Product\Option::COLUMN_PREFIX .
                        'row_' .
                        $assertKey;
