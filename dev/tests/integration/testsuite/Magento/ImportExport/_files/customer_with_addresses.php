...
$objectManager->get('Magento\Registry')->unregister('_fixture/Magento_ImportExport_Customers_Array');
$objectManager->get('Magento\Registry')->register('_fixture/Magento_ImportExport_Customers_Array', $customers);
