...
$ruleData = array(
    ...
    'priority' => '0',
    'position' => '0',
    'customer_tax_class_ids' => array($customerTaxClass1->getId(), $customerTaxClass2->getId()),
    'product_tax_class_ids' => array($productTaxClass1->getId(), $productTaxClass2->getId()),
    'tax_rate_ids' => array($rate->getId())
);
