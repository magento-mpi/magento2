...
class Magento_Tax_Model_Rate_CsvImportHandlerTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->_importHandler = Mage::getModel('Magento_Tax_Model_Rate_CsvImportHandler');
    }
    ...
    public function testImportFromCsvFileWithCorrectData()
    {
        ...
        $importedRuleCA = Mage::getModel('Magento_Tax_Model_Calculation_Rate')->loadByCode('US-CA-*-Rate Import Test');
        ...
        $importedRuleFL = Mage::getModel('Magento_Tax_Model_Calculation_Rate')->loadByCode('US-FL-*-Rate Import Test');
