...
class CreateTest extends \Magento\Backend\Utility\Controller
{
    ...
    public function testConfigureProductToAddAction()
    {
        ...
        $this->assertContains(
            '"label":"Option 1","price":"5","oldPrice":"5","inclTaxPrice":"5.0000","exclTaxPrice":"5.0000","products":[',
            $body
        );
        $this->assertContains(
            '"label":"Option 2","price":"5","oldPrice":"5","inclTaxPrice":"5.0000","exclTaxPrice":"5.0000","products":[',
            $body
        );
