...
class ServiceNameCollisionTest extends \PHPUnit_Framework_TestCase
{
     ...
     *
     * @see \Magento\Webapi\Helper\Config::getServiceName()
     * @SuppressWarnings(PHPMD.UnusedLocalVariable)
     */
    public function testServiceNameCollisions()
    {
        $objectManager = \Magento\TestFramework\Helper\Bootstrap::getObjectManager();
        /** @var \Magento\Webapi\Helper\Config $configHelper */
        $configHelper = $objectManager->get('Magento\Webapi\Helper\Config');
        ...
        foreach ($webapiConfig->getServices() as $serviceClassName => $serviceData) {
            $newServiceName = $configHelper->getServiceName($serviceClassName);
