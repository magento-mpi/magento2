 ...
 */
class Magento_Test_Integrity_Modular_AdminGwsConfigFilesTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var Magento_AdminGws_Model_Config_Reader
     */
    protected $_model;
    ...
    public function setUp()
    {
        ...
        $this->_model = $objectManager->create('Magento_AdminGws_Model_Config_Reader', array(
