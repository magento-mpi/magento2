...
class RouteConfigFilesTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->_schemaFile = $magentoBaseDir . '/lib/internal/Magento/App/etc/routes.xsd';
        $this->_mergedSchemaFile = $magentoBaseDir . '/lib/internal/Magento/App/etc/routes_merged.xsd';
    }
