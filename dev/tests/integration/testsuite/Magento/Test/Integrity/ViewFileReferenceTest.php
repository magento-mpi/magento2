...
class ViewFileReferenceTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @return array
     */
    static protected function _getThemeLocales(\Magento\View\Design\Theme $theme)
    {
        $result = array();
     ...
     * @throws \Exception
     */
    static protected function _getLocalePatternDir(\Magento\View\Design\Theme $theme)
    {
     ...
     * @return array
     */
    protected function _getFileResolutions(\Magento\View\Design\Theme $theme, $file)
    {
        $found = array();
