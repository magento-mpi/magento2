...
class Magento_Test_Integrity_Magento_Checkout_Block_CartTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testCustomTemplateSetters($layoutFile)
    {
        ...
        foreach ($nodes as $node) {
            ...
            $this->assertFileExists(
                Magento_TestFramework_Helper_Bootstrap::getObjectmanager()->get('Magento_Core_Model_View_FileSystem')
