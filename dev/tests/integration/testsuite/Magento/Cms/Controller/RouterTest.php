...
class Magento_Cms_Controller_RouterTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->_model = new Magento_Cms_Controller_Router(
            Magento_Test_Helper_Bootstrap::getObjectManager()->get('Magento_Core_Controller_Varien_Action_Factory'),
    ...
    public function testMatch()
    {
        ...
        //Open Node
        Magento_Test_Helper_Bootstrap::getObjectManager()->get('Magento_Core_Controller_Response_Http')
