...
/**
 * Test for class \Magento\CustomerImportExport\Model\ImportExport\Import\Customer which covers validation logic
 */
class CustomerTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->_model = \Magento\TestFramework\Helper\Bootstrap::getObjectManager()
            ->create('Magento\CustomerImportExport\Model\ImportExport\Import\Customer');
