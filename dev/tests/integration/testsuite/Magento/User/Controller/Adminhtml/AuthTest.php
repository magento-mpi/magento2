...
class Magento_User_Controller_Adminhtml_AuthTest extends Magento_Backend_Utility_Controller
{
    ...
    public function testForgotpasswordAction()
    {
        ...
        $this->assertRedirect($this->equalTo(
            Magento_TestFramework_Helper_Bootstrap::getObjectManager()->get('Magento_Backend_Helper_Data')->getHomePageUrl()
        ));
    }
    ...
    public function testResetPasswordAction()
    {
        ...
        $resetPasswordToken = Magento_TestFramework_Helper_Bootstrap::getObjectManager()->get('Magento_User_Helper_Data')
