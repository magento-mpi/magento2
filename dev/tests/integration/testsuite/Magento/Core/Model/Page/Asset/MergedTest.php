...
class MergedTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        \Magento\TestFramework\Helper\Bootstrap::getInstance()->reinitialize(array(
            \Magento\Filesystem::PARAM_APP_DIRS => array(
                \Magento\Filesystem::THEMES => array('absolute_path' => dirname(dirname(__DIR__)) . '/_files/design'),
                \Magento\Filesystem::PUB => array('absolute_path' => BP),
            )
        ));
    ...
    protected function tearDown()
    {
        ...
        self::$_viewPublicMergedDir->delete(\Magento\Core\Model\Page\Asset\Merged::PUBLIC_MERGE_DIR);
    }
