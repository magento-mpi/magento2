...
class TranslateTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $theme = $this->getMock('Magento\View\Design\Theme', array('getId', 'getCollection'), array(), '', false);
        $theme->expects($this->any())
            ->method('getId')
            ->will($this->returnValue(10));

        $collection = $this->getMock('Magento\View\Design\Theme', array('getThemeByFullPath'), array(), '', false);
