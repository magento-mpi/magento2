...
class Magento_Rule_Model_Condition_AbstractTest extends PHPUnit_Framework_TestCase
{
    public function testGetValueElement()
    {
        ...
        $editableBlock = Magento_TestFramework_Helper_Bootstrap::getObjectManager()->create('Magento_Rule_Block_Editable');
        ...
        $model->setRule($rule->setForm(Magento_TestFramework_Helper_Bootstrap::getObjectManager()->create('Magento_Data_Form')));
