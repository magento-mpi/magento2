...
class QueueTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSendPerSubscriber()
    {
        ...
        $objectManager->get('Magento\App\State')->setAreaCode(\Magento\App\Area::AREA_FRONTEND);
        $area = $objectManager->get('Magento\App\AreaList')->getArea(\Magento\App\Area::AREA_FRONTEND);
        $area->load();
    ...
    public function testSendPerSubscriberProblem()
    {
        ...
        \Magento\TestFramework\Helper\Bootstrap::getInstance()
            ->loadArea(\Magento\App\Area::AREA_FRONTEND);
