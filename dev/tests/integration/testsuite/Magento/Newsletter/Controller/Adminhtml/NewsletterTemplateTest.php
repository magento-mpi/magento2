...
class NewsletterTemplateTest extends \Magento\Backend\Utility\Controller
{
    ...
    public function testSaveActionCreateNewTemplateAndVerifySuccessMessage()
    {
        ...
        $this->assertSessionMessages(
            $this->equalTo(array('The newsletter template has been saved.')), \Magento\Message\MessageInterface::TYPE_SUCCESS
        );
    }
    ...
    public function testDeleteActionTemplateAndVerifySuccessMessage()
    {
         ...
         */
        $this->assertSessionMessages(
            $this->equalTo(array('The newsletter template has been deleted.')), \Magento\Message\MessageInterface::TYPE_SUCCESS
        );
    }
}
