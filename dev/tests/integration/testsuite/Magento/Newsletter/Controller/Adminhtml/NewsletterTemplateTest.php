...
class NewsletterTemplateTest extends \Magento\Backend\Utility\Controller
{
    ...
    public function testSaveActionCreateNewTemplateAndVerifySuccessMessage()
    {
        ...
        $this->assertSessionMessages(
            $this->equalTo(array('The newsletter template has been saved.')), \Magento\Message\InterfaceMessage::TYPE_SUCCESS
        );
    }
    ...
    public function testSaveActionTemplateWithInvalidDataAndVerifySuccessMessage()
    {
         ...
         */
        $this->assertSessionMessages($this->isEmpty(), \Magento\Message\InterfaceMessage::TYPE_SUCCESS);
    }
    ...
    public function testDeleteActionTemplateAndVerifySuccessMessage()
    {
         ...
         */
        $this->assertSessionMessages(
            $this->equalTo(array('The newsletter template has been deleted.')), \Magento\Message\InterfaceMessage::TYPE_SUCCESS
        );
    }
}
