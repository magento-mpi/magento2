...
/**
 * Test for Magento_Adminhtml_Block_Urlrewrite_Catalog_Category_Edit
 * @magentoAppArea adminhtml
 */
class Magento_Adminhtml_Block_Urlrewrite_Catalog_Category_EditTest extends PHPUnit_Framework_TestCase
{
    /**
     * Test prepare layout
     *
    ...
    public function testPrepareLayout($blockAttributes, $expected)
    {
        ...
        $block = $layout->createBlock(
            'Magento_Adminhtml_Block_Urlrewrite_Catalog_Category_Edit', '', array('data' => $blockAttributes)
        );
     ...
     * Check selector
     *
     * @param Magento_Adminhtml_Block_Urlrewrite_Catalog_Category_Edit $block
     * @param array $expected
     */
    ...
    private function _checkLinks($block, $expected)
    {
        ...
        /** @var $categoryBlock Magento_Adminhtml_Block_Urlrewrite_Link|bool */
        $categoryBlock = $layout->getChildBlock($blockName, 'category_link');

        if ($expected['category_link']) {
            $this->assertInstanceOf('Magento_Adminhtml_Block_Urlrewrite_Link', $categoryBlock,
