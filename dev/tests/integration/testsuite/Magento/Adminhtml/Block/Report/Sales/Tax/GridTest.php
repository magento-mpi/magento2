 ...
 */
class Magento_Adminhtml_Block_Report_Sales_Tax_GridTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $block = Mage::app()->getLayout()->createBlock('Magento_Adminhtml_Block_Report_Sales_Tax_Grid');
