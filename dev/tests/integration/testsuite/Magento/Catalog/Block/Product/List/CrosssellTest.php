...
class Magento_Catalog_Block_Product_List_CrosssellTest extends PHPUnit_Framework_TestCase
{
    public function testAll()
    {
        ...
        $block = Magento_TestFramework_Helper_Bootstrap::getObjectManager()->get('Magento_Core_Model_Layout')
            ->createBlock('Magento_Catalog_Block_Product_List_Crosssell');
        $block->setLayout(Magento_TestFramework_Helper_Bootstrap::getObjectManager()->get('Magento_Core_Model_Layout'));
