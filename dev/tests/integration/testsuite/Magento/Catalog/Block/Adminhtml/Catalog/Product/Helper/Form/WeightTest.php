...
class WeightTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testIsVirtualChecked($type)
    {
        ...
        /** @var $block \Magento\Catalog\Block\Adminhtml\Catalog\Product\Helper\Form\Weight */
        $block = $this->_objectManager->create('Magento\Catalog\Block\Adminhtml\Catalog\Product\Helper\Form\Weight');
