...
namespace Magento\Catalog\Block\Adminhtml\Catalog\Product\Attribute\Set\Toolbar;
...
class AddTest extends \PHPUnit_Framework_TestCase
{
    public function testToHtmlFormId()
    {
        ...
        $block = $layout->addBlock('Magento\Catalog\Block\Adminhtml\Catalog\Product\Attribute\Set\Toolbar\Add',
            'block');
