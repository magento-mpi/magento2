...
class SettingsTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetContinueUrl($productId, $expectedUrl)
    {
        ...
        /** @var $block \Magento\Catalog\Block\Adminhtml\Catalog\Product\Edit\Tab\Super\Settings */
        $block = $layout->createBlock(
            'Magento\Catalog\Block\Adminhtml\Catalog\Product\Edit\Tab\Super\Settings',
            'block',
            array(
               'context' => $context
            )
