...
class ProductTest extends \Magento\Backend\Utility\Controller
{
    ...
    public function testSaveActionWithDangerRequest()
    {
        ...
        $this->assertSessionMessages(
            $this->equalTo(array('Unable to save product')), \Magento\Message\InterfaceMessage::TYPE_ERROR
        );
    ...
    public function testSaveActionAndNew()
    {
        ...
        $this->assertSessionMessages(
            $this->contains('You saved the product.'), \Magento\Message\InterfaceMessage::TYPE_SUCCESS
        );
    }
    ...
    public function testSaveActionAndDuplicate()
    {
        ...
        $this->assertSessionMessages(
            $this->contains('You duplicated the product.'), \Magento\Message\InterfaceMessage::TYPE_SUCCESS
        );
    }
