 ...
 * @method Magento_Catalog_Model_Product_Api_Helper_Simple _getHelper()
 */
class Magento_Catalog_Model_Product_Api_SimpleTest extends Magento_Catalog_Model_Product_Api_TestCaseAbstract
{
    /**
     ...
     * @var string
     */
    protected $_defaultHelper = 'Magento_Catalog_Model_Product_Api_Helper_Simple';
    ...
    public function testCreateSimpleRequiredFieldsOnly()
    {
        ...
        $actualProduct = Mage::getModel('Magento_Catalog_Model_Product');
    ...
    public function testSetSpecialPrice()
    {
        ...
        $result = Magento_Test_Helper_Api::call(
            ...
            array(
                ...
                'toDate' => $specialTo,
                'store' => Magento_Catalog_Model_Abstract::DEFAULT_STORE_ID
            )
        );
     ...
     *
     * @magentoDataFixture Magento/Catalog/Model/Product/Api/_files/ProductWithOptionCrud.php
     * @magentoDbIsolation enabled
     */
     ...
     *
     * @magentoDbIsolation enabled
     * @magentoDataFixture Magento/Catalog/Model/Product/Api/_files/store_on_new_website.php
     */
    public function testProductUpdateCustomStore()
    {
        ...
        $productDefault = Mage::getModel('Magento_Catalog_Model_Product');
        ...
        // Load product in test store
        $productTestStore = Mage::getModel('Magento_Catalog_Model_Product');
