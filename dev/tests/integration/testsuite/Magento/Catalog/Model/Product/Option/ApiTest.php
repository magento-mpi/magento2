 ...
 * @magentoDataFixture Magento/Catalog/Model/Product/Api/_files/CustomOption.php
 * @magentoDbIsolation enabled
 */
class Magento_Catalog_Model_Product_Option_ApiTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var array
     */
