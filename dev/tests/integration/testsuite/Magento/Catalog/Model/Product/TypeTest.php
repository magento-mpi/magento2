...
class Magento_Catalog_Model_Product_TypeTest extends PHPUnit_Framework_TestCase
{
    ...
    public function factoryDataProvider()
    {
        return array(
            ...
            array(Magento_Catalog_Model_Product_Type::TYPE_BUNDLE, 'Mage_Bundle_Model_Product_Type'),
    ...
    public function priceFactoryDataProvider()
    {
        return array(
            ...
            array(Magento_Catalog_Model_Product_Type::TYPE_BUNDLE, 'Mage_Bundle_Model_Product_Price'),
