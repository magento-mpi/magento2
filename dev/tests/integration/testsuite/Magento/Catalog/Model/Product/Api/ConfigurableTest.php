...
class Magento_Catalog_Model_Product_Api_ConfigurableTest extends Magento_Catalog_Model_Product_Api_TestCaseAbstract
{
    ...
    public function testCreate()
    {
        ...
        // Validate outcome
        /** @var $actual Magento_Catalog_Model_Product */
        $actual = Mage::getModel('Magento_Catalog_Model_Product')->load($productId);
        ...
        $expected = Mage::getModel('Magento_Catalog_Model_Product');
