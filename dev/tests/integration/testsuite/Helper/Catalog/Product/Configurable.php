...
class Helper_Catalog_Product_Configurable extends Magento_Test_Webservice
{
    ...
    {
        require 'API/fixture/Catalog/Product/Configurable/attribute_set.php';
        // Prepare fixture
    ...
    {
        require 'API/fixture/Catalog/Product/Configurable/attribute_set_with_invalid_attribute.php';
        // Prepare fixture
        $productData = $this->_getValidProductPostData();
    ...
    {
        require 'API/fixture/Catalog/Product/Configurable/attribute_set_with_one_attribute.php';
        // Prepare fixture
        $productData = $this->_getValidProductPostData();
        /** @var $attributeSet Mage_Eav_Model_Entity_Attribute_Set */
    ...
    {
        return require 'API/fixture/_data/Catalog/Product/Configurable/product_configurable_all_fields.php';
    }
}
