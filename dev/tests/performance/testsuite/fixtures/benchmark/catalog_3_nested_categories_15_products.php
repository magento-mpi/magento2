...
while ($categoryIndex <= $categoriesNumber) {
    $category->setId(null)
        ->setName("Sample Category $categoryIndex")
        ->setUrlKey(null)
...
$productsCount = 15; //number of products
...
while ($productsCount) {
    ...
    $product->setTypeId('simple')
        ...
        ->setName("Simple product {$productsCount}")
        ->setShortDescription("Simple product {$productsCount} short description")
        ->setWeight(1)
        ->setDescription("Simple product {$productsCount} description")
        ->setSku('product_'. $productsCount)
        ->setPrice(10)
