...
return array(
    ...
    array('Find_Feed_Block_Adminhtml_Edit_Codes_Edit_Form'),
    array('Find_Feed_Block_Adminhtml_Edit_Codes'),
    array('Find_Feed_Block_Adminhtml_List_Codes_Grid'),
    array('Find_Feed_Block_Adminhtml_List_Items_Grid'),
    array('Find_Feed_Block_Adminhtml_List_Codes'),
    array('Find_Feed_Block_Adminhtml_List_Items'),
    array('Find_Feed_Adminhtml_Codes_GridController'),
    array('Find_Feed_Adminhtml_Items_GridController'),
    array('Find_Feed_Helper_Data'),
    array('Find_Feed_Model_Adminhtml_System_Source_Cron_Frequency'),
    array('Find_Feed_Model_Adminhtml_System_Source_Cron_Hours'),
    array('Find_Feed_Model_Resource_Codes_Collection'),
    array('Find_Feed_Model_Resource_Codes'),
    array('Find_Feed_Model_Resource_Setup'),
    array('Find_Feed_Model_Codes'),
    array('Find_Feed_Model_Import'),
    array('Find_Feed_Model_Observer'),
    array('Social_Facebook_Block_Adminhtml_Facebuttons'),
    array('Social_Facebook_Block_Adminhtml_Select'),
    array('Social_Facebook_Block_Action'),
    array('Social_Facebook_Block_Box'),
    array('Social_Facebook_Block_Head'),
    array('Social_Facebook_Block_Like'),
    array('Social_Facebook_Block_Start'),
    array('Social_Facebook_IndexController'),
    array('Social_Facebook_Helper_Data'),
    array('Social_Facebook_Model_Resource_Facebook_Collection'),
    array('Social_Facebook_Model_Resource_Facebook'),
    array('Social_Facebook_Model_Resource_Setup'),
    array('Social_Facebook_Model_Api'),
