...
return array(
    ...
    $this->_getRule('cleanVarFolder'),
    $this->_getRule('cleanVarSubFolders'),
    ...
    $this->_getRule('crear'),
    $this->_getRule('createDirIfNotExists', 'Mage_Core_Model_Config'),
    ...
    $this->_getRule('getOption', 'Mage_Captcha_Helper_Data'),
    ...
    $this->_getRule('getTempVarDir', 'Mage_Core_Model_Config'),
    ...
    $this->_getRule('getVarDir', 'Mage_Core_Model_Config'),
