...
return array(
    ...
    array('_canBeStoreCodeInUrl', 'Mage_Core_Controller_Request_Http'),
    ...
    array('_decodeInput', 'Mage_Adminhtml_Controller_Catalog_Product'),
    ...
    array('_filterPostData', 'Mage_Adminhtml_Controller_Catalog_Product_Attribute'),
    ...
    array('_getCollectionNames', 'Mage_Adminhtml_Controller_Report_Sales'),
    ...
    array('_saveCache', 'Mage_Backend_Model_Menu_Config'),
    ...
    array('_sendUploadResponse', 'Mage_Adminhtml_Controller_Customer'),
    array('_sendUploadResponse', 'Mage_Adminhtml_Controller_Newsletter_Subscriber'),
    ...
    array('bundlesAction', 'Mage_Adminhtml_Controller_Catalog_Product'),
    ...
    array('changeLocaleAction', 'Mage_Adminhtml_Controller_Index'),
    ...
    array('cleanMergedJsCss', 'Mage_Core_Model_Design_Package', 'Mage_Core_Model_Page_Asset_MergeService'),
    array('cleanMergedJsCss', 'Mage_Core_Model_Design_Package_Proxy', 'Mage_Core_Model_Page_Asset_MergeService'),
    array('cleanMergedJsCss', 'Mage_Core_Model_Design_PackageInterface', 'Mage_Core_Model_Page_Asset_MergeService'),
    ...
    array('deleteAction', 'Mage_Adminhtml_Controller_Catalog_Product'),
    ...
    array('editAction', 'Mage_Tag_Controller_Customer'),
    ...
    array('getOptimalCssUrls', 'Mage_Core_Model_Design_Package_Proxy', 'Mage_Core_Model_Page_Asset_Merged'),
    array('getOptimalJsUrls', 'Mage_Core_Model_Design_Package_Proxy', 'Mage_Core_Model_Page_Asset_Merged'),
    array('getOptimalCssUrls', 'Mage_Core_Model_Design_Package', 'Mage_Core_Model_Page_Asset_Merged'),
    array('getOptimalJsUrls', 'Mage_Core_Model_Design_Package', 'Mage_Core_Model_Page_Asset_Merged'),
    ...
    array('getOriginalRequest', 'Mage_Core_Controller_Request_Http'),
    ...
    array('getStoreCodeFromPath', 'Mage_Core_Controller_Request_Http'),
    ...
    array('mergeFiles', 'Mage_Core_Helper_Data', 'Mage_Core_Model_Page_Asset_MergeStrategyInterface'),
    array('mergeFiles', 'Mage_Core_Model_Design_Package', 'Mage_Core_Model_Page_Asset_MergeStrategyInterface'),
    array('mergeFiles', 'Mage_Core_Model_Design_Package_Proxy', 'Mage_Core_Model_Page_Asset_MergeStrategyInterface'),
    array('mergeFiles', 'Mage_Core_Model_Design_PackageInterface', 'Mage_Core_Model_Page_Asset_MergeStrategyInterface'),
    array('order_success_page_view', 'Mage_GoogleAnalytics_Model_Observer'),
    array('orderedAction', 'Mage_Adminhtml_Controller_Report_Product'),
    ...
    array('saveAction', 'Mage_Tag_Controller_Customer'),
    ...
    array('superGroupGridOnlyAction', 'Mage_Adminhtml_Controller_Catalog_Product'),
    ...
    array('_getUsers', 'Mage_Adminhtml_Block_Api_Role_Grid_User', 'getUsers'),
    array('_getGridHtml', 'Mage_Adminhtml_Block_Api_Tab_Rolesusers', 'getGridHtml'),
    array('_getSelectedRoles', 'Mage_Adminhtml_Block_Api_User_Edit_Tab_Roles', 'getSelectedRoles'),
    array('_getProduct', 'Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Super_Config_Matrix', 'getProduct'),
    array('_getImageUploadUrl', 'Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Super_Config_Matrix',
        'getImageUploadUrl'),
    array('_getProduct', 'Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Super_Config_Simple', 'getProduct'),
    array('_getProduct', 'Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Super_Config', 'getProduct'),
    array('_getProduct', 'Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Super_Settings', 'getProduct'),
    array('_getProduct', 'Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Crosssell', 'getProduct'),
    array('_getProduct', 'Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Related', 'getProduct'),
    array('_getProduct', 'Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Upsell', 'getProduct'),
    array('_renderCellTemplate', 'Mage_Backend_Block_System_Config_Form_Field_Array_Abstract', 'renderCellTemplate'),
    array('_showSingle', 'Mage_Bundle_Block_Catalog_Product_View_Type_Bundle_Option', 'showSingle'),
    array('_getDefaultValues', 'Mage_Bundle_Block_Catalog_Product_View_Type_Bundle_Option', 'getDefaultValues'),
    array('_isSelected', 'Mage_Bundle_Block_Catalog_Product_View_Type_Bundle_Option', 'isSelected'),
    array('_getProduct', 'Mage_Catalog_Block_Product_Configurable_AssociatedSelector_Backend_Grid_ColumnSet',
        'getProduct'),
    array('_getProduct', 'Mage_CatalogInventory_Block_Stockqty_Abstract', 'getProduct'),
    array('_getProduct', 'Mage_CatalogInventory_Block_Qtyincrements', 'getProduct'),
    array('_getPageTrackingCode', 'Mage_GoogleAnalytics_Block_Ga', 'getPageTrackingCode'),
    array('_getOrdersTrackingCode', 'Mage_GoogleAnalytics_Block_Ga', 'getOrdersTrackingCode'),
    array('_toJson', 'Mage_GoogleShopping_Block_Adminhtml_Types_Edit_Attributes', 'jsonFormat'),
