...
return array(
    ...
    $this->_getRule('parse', 'Mage_Catalog_Model_Convert_Parser_Product'),
    $this->_getRule('parse', 'Mage_Customer_Model_Convert_Parser_Customer'),
    ...
    $this->_getRule('_buildPublicSkinFilename', 'Mage_Core_Model_Design_Package', '_buildPublicViewFilename'),
    $this->_getRule('_buildPublicSkinRedundantFilename', 'Mage_Core_Model_Design_Package',
        '_buildPublicViewRedundantFilename'),
    $this->_getRule('_buildPublicSkinSufficientFilename', 'Mage_Core_Model_Design_Package',
        '_buildPublicViewSufficientFilename'),
    $this->_getRule('_publishRelatedSkinFile', 'Mage_Core_Model_Design_Package', '_publishRelatedViewFile'),
    $this->_getRule('_publishSkinFile', 'Mage_Core_Model_Design_Package', '_publishViewFile'),
    $this->_getRule('getPublicSkinDir', null, 'getPublicDir'),
    $this->_getRule('getSkinFile', null, 'getViewFile'),
    $this->_getRule('getSkinUrl', null, 'getViewFileUrl'),
    $this->_getRule('notifySkinFilePublished', null, 'notifyViewFilePublished'),
    $this->_getRule('skinDirective', 'Mage_Catalog_Model_Template_Filter', 'viewDirective'),
    $this->_getRule('skinDirective', 'Mage_Core_Model_Email_Template_Filter', 'viewDirective'),
);
