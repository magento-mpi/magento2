...
return array(
    ...
    $this->_getRule('_updateMediaPathUseRewrites', 'Mage_Core_Model_Store', '_getMediaScriptUrl'),
    ...
    $this->_getRule('cleanVarFolder', null, 'Varien_Io_File::rmdirRecursive()'),
    $this->_getRule('cleanVarSubFolders', null, 'glob() on Mage::getBaseDir(Mage_Core_Model_App_Dir::VAR_DIR)'),
    ...
    $this->_getRule('crear'),
    $this->_getRule('createDirIfNotExists', 'Mage_Core_Model_Config', 'mkdir()'),
    ...
    $this->_getRule('getDefaultBasePath', 'Mage_Core_Model_Store'),
    $this->_getRule('getDirectOutput', 'Mage_Core_Model_Layout'),
    $this->_getRule('getDistroServerVars', 'Mage_Core_Model_Config', 'getDistroBaseUrl'),
    ...
    $this->_getRule('getOption', 'Mage_Captcha_Helper_Data', 'Mage_Core_Model_Dir::getDir()'),
    $this->_getRule('getOptions', 'Mage_Core_Model_Config'),
    ...
    $this->_getRule('getTempVarDir', 'Mage_Core_Model_Config', 'Mage_Core_Model_Dir::getDir()'),
    ...
    $this->_getRule('getVarDir', 'Mage_Core_Model_Config', 'Mage_Core_Model_Dir::getDir()'),
    ...
    $this->_getRule('renderView', null, 'Mage_Core_Block_Template::_toHtml()'),
    ...
    $this->_getRule('setOption', 'Mage_Captcha_Helper_Data'),
    ...
    $this->_getRule('setScriptPath', 'Mage_Core_Block_Template'),
    $this->_getRule('setVarSubFolders'),
    $this->_getRule('setWatermarkHeigth', null, 'setWatermarkHeight'),
    $this->_getRule('getWatermarkHeigth', null, 'getWatermarkHeight'),
    $this->_getRule('setOption', 'Mage_Captcha_Helper_Data'),
    $this->_getRule('setOptions', 'Mage_Core_Model_Config'),
    ...
    $this->_getRule('seetVarSubFolders'),
    ...
    $this->_getRule('substDistroServerVars', 'Mage_Core_Model_Config'),
