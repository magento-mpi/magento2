...
return array(
     ...
     $this->_getRule('_getCreateSql', 'Enterprise_Staging_Model_Resource_Adapter_Abstract'),
     $this->_getRule('_getFieldSql', 'Enterprise_Staging_Model_Resource_Adapter_Abstract'),
     $this->_getRule('_getKeySql', 'Enterprise_Staging_Model_Resource_Adapter_Abstract'),
     $this->_getRule('_getFlatConstraintSql', 'Enterprise_Staging_Model_Resource_Adapter_Abstract'),
     $this->_getRule('_getConstraintSql', 'Enterprise_Staging_Model_Resource_Adapter_Abstract'),
     $this->_getRule('_prepareFields', 'Enterprise_Staging_Model_Resource_Adapter_Abstract'),
     $this->_getRule('canShow', 'Enterprise_Staging_Helper_Store'),
     $this->_getRule('canShow', 'Enterprise_Staging_Helper_Website'),
