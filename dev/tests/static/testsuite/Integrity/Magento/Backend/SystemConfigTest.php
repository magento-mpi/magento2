 ...
 */
class Integrity_Magento_Backend_SystemConfigTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testSchema($configFile)
    {
        ...
        $schema = Utility_Files::init()->getPathToSource() . '/app/code/Magento/Backend/etc/system_file.xsd';
