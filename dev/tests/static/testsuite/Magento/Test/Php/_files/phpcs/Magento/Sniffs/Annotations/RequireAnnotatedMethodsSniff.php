 ...
 */
class Magento_Sniffs_Annotations_RequireAnnotatedMethodsSniff extends Magento_Sniffs_AnnotationsAbstract
{
    /**
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($code === T_COMMENT) {
            ...
            $this->addMessage($error, $commentEnd, self::WRONG_END, array(trim($tokens[$commentEnd]['content'])));
            return;
        }
    ...
    protected function processSees($commentStart)
    {
        ...
        if (empty($sees) === false) {
            ...
            foreach ($sees as $i => $see) {
                ...
                /* Magento standard doesn't require indenting @see with 4 spaces
    ...
    protected function processThrows($commentStart)
    {
        ...
        foreach ($this->commentParser->getThrows() as $i => $throw) {
            ...
            if (empty($exception) === true) {
                ...
                // Magento standard doesn't require comments so it's okay to skip
                ...
                /* Magento doesn't require a period at the end of comments
        ...
        if (empty($params) === false) {
            ...
            foreach ($params as $param) {
                ...
                if ($previousParam !== null) {
                    ...
                    /* Magento doesn't allign comments
