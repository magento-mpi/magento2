...
return array(
    ...
    array('Magento_Convert_Action'),
    array('Magento_Convert_Action_Abstract'),
    array('Magento_Convert_Action_Interface'),
    array('Magento_Convert_Adapter_Abstract'),
    array('Magento_Convert_Adapter_Db_Table'),
    array('Magento_Convert_Adapter_Http'),
    array('Magento_Convert_Adapter_Http_Curl'),
    array('Magento_Convert_Adapter_Interface'),
    array('Magento_Convert_Adapter_Io'),
    array('Magento_Convert_Adapter_Soap'),
    array('Magento_Convert_Adapter_Std'),
    array('Magento_Convert_Adapter_Zend_Cache'),
    array('Magento_Convert_Adapter_Zend_Db'),
    array('Magento_Convert_Container_Collection'),
    array('Magento_Convert_Container_Generic'),
    array('Magento_Convert_Container_Interface'),
    array('Magento_Convert_Mapper_Abstract'),
    array('Magento_Convert_Parser_Abstract'),
    array('Magento_Convert_Parser_Csv'),
    array('Magento_Convert_Parser_Interface'),
    array('Magento_Convert_Parser_Serialize'),
    array('Magento_Convert_Parser_Xml_Excel'),
    array('Magento_Convert_Profile'),
    array('Magento_Convert_Profile_Abstract'),
    array('Magento_Convert_Profile_Collection'),
    array('Magento_Convert_Validator_Abstract'),
    array('Magento_Convert_Validator_Column'),
    array('Magento_Convert_Validator_Dryrun'),
    array('Magento_Convert_Validator_Interface'),
    array('Mage_File_Uploader_Image'),
    array('Magento_Profiler', 'Magento_Profiler'),
