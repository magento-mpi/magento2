...
return array(
    ...
    [
        ...
        'Magento\Paypal\Model\Api\Nvp',
        '\Magento\PayPalRecurringPayment\Model\Api\Nvp::callManageRecurringPaymentsProfileStatus'
    ],
    [
        'callGetRecurringPaymentsProfileDetails',
        'Magento\Paypal\Model\Api\Nvp',
        '\Magento\PayPalRecurringPayment\Model\Api\Nvp::callGetRecurringPaymentsProfileDetails'
    ],
    [
        '_filterRecurringProfileActionToNvp',
        'Magento\Paypal\Model\Api\Nvp',
        '\Magento\PayPalRecurringPayment\Model\Api\Nvp::_filterRecurringProfileActionToNvp'
    ],
    [
        '_analyzeRecurringProfileStatus',
        'Magento\Paypal\Model\Api\Nvp',
        '\Magento\PayPalRecurringPayment\Model\Api\Nvp::_analyzeRecurringProfileStatus'
    ],
);
