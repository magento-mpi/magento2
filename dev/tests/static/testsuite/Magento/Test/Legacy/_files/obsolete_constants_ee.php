...
return array(
    ...
    ['XML_PATH_GRANT_CATALOG_CATEGORY_VIEW', 'Magento\CatalogPermissions\Helper\Data',
        'Magento\CatalogPermissions\App\ConfigInterface::XML_PATH_GRANT_CATALOG_CATEGORY_VIEW'],
    ['XML_PATH_GRANT_CATALOG_PRODUCT_PRICE', 'Magento\CatalogPermissions\Helper\Data',
        'Magento\CatalogPermissions\App\ConfigInterface::XML_PATH_GRANT_CATALOG_PRODUCT_PRICE'],
    ['XML_PATH_GRANT_CHECKOUT_ITEMS', 'Magento\CatalogPermissions\Helper\Data',
        'Magento\CatalogPermissions\App\ConfigInterface::XML_PATH_GRANT_CHECKOUT_ITEMS'],
    ['XML_PATH_DENY_CATALOG_SEARCH', 'Magento\CatalogPermissions\Helper\Data',
        'Magento\CatalogPermissions\App\ConfigInterface::XML_PATH_DENY_CATALOG_SEARCH'],
    ['XML_PATH_LANDING_PAGE', 'Magento\CatalogPermissions\Helper\Data',
        'Magento\CatalogPermissions\App\ConfigInterface::XML_PATH_LANDING_PAGE'],
    ['GRANT_ALL', 'Magento\CatalogPermissions\Helper\Data',
        'Magento\CatalogPermissions\App\ConfigInterface::GRANT_ALL'],
    ['GRANT_CUSTOMER_GROUP', 'Magento\CatalogPermissions\Helper\Data',
        'Magento\CatalogPermissions\App\ConfigInterface::GRANT_CUSTOMER_GROUP'],
    ['GRANT_NONE', 'Magento\CatalogPermissions\Helper\Data',
        'Magento\CatalogPermissions\App\ConfigInterface::GRANT_NONE'],
    ['XML_PATH_GRANT_CATALOG_CATEGORY_VIEW', 'Magento\CatalogPermissions\Model\Observer',
        'Magento\CatalogPermissions\App\ConfigInterface::XML_PATH_GRANT_CATALOG_CATEGORY_VIEW'],
    ['XML_PATH_GRANT_CATALOG_PRODUCT_PRICE', 'Magento\CatalogPermissions\Model\Observer',
        'Magento\CatalogPermissions\App\ConfigInterface::XML_PATH_GRANT_CATALOG_PRODUCT_PRICE'],
    ['XML_PATH_GRANT_CHECKOUT_ITEMS', 'Magento\CatalogPermissions\Model\Observer',
        'Magento\CatalogPermissions\App\ConfigInterface::XML_PATH_GRANT_CHECKOUT_ITEMS'],
    ['XML_PATH_GRANT_BASE', 'Magento\CatalogPermissions\Model\Resource\Permission\Index'],
