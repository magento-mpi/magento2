...
class Classes
{
    ...
    {
        $generatedClasses = 'Factory|Proxy|Repository|Converter|Mapper|SearchResults|SearchResultsBuilder|Builder';
        if (preg_match('/.*\\\\[a-zA-Z0-9]{1,' . $generatedClasses .'}()$/', $className)) {
            return true;
        }
