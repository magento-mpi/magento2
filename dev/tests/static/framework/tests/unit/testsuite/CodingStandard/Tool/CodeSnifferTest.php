...
class CodingStandard_Tool_CodeSnifferTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $this->_wrapper = $this->getMock('CodingStandard_Tool_CodeSniffer_Wrapper');
        $this->_tool = new CodingStandard_Tool_CodeSniffer(self::RULE_SET, self::REPORT_FILE, $this->_wrapper);
    }
