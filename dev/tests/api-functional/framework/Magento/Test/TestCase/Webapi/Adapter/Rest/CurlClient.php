...
class Magento_Test_TestCase_Webapi_Adapter_Rest_CurlClient
{
    ...
    public function get($resourcePath, $data = array(), $headers = array())
    {
        ...
        $curlOpts = array();
        $curlOpts[CURLOPT_CUSTOMREQUEST] = Mage_Webapi_Model_Rest_Config::HTTP_METHOD_GET;
    ...
    public function delete($resourcePath, $headers = array())
    {
        ...
        $curlOpts = array();
        $curlOpts[CURLOPT_CUSTOMREQUEST] = Mage_Webapi_Model_Rest_Config::HTTP_METHOD_DELETE;
    ...
    protected function _postOrPut($resourcePath, $data, $put = false, $headers = array())
    {
        ...
        $curlOpts[CURLOPT_CUSTOMREQUEST] = $put
            ? Mage_Webapi_Model_Rest_Config::HTTP_METHOD_PUT : Mage_Webapi_Model_Rest_Config::HTTP_METHOD_POST;
