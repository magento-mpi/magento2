...
class Enterprise_GiftCard_Model_Catalog_Product_Type_GiftcardTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $helpers = array(
            'Enterprise_GiftCard_Helper_Data'        => $this->getMock('Enterprise_GiftCard_Helper_Data', array(), array(), '', false, false),
            'Mage_Core_Helper_Data'                  => $this->getMock('Mage_Core_Helper_Data', array(), array(), '', false, false),
            'Mage_Catalog_Helper_Data'               => $this->getMock('Mage_Catalog_Helper_Data', array(), array(), '', false, false),
            'Mage_Core_Helper_File_Storage_Database' => $this->getMock('Mage_Core_Helper_File_Storage_Database', array(), array(), '', false, false)
        );
