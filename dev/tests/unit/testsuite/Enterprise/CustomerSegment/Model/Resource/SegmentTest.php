...
class Enterprise_CustomerSegment_Model_Resource_SegmentTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var Enterprise_CustomerSegment_Model_Resource_Segment
     */
    ...
    protected function setUp()
    {
        ...
        $this->_conditions = $this->getMock('Enterprise_CustomerSegment_Model_Segment_Condition_Combine_Root',
            array('getConditionsSql', 'getConditions'), array(), '', false);

        $this->_resourceModel = new Enterprise_CustomerSegment_Model_Resource_Segment(
            $this->_resource,
            $this->_configShare
        );
    }
