...
class Enterprise_CustomerSegment_Model_CustomerTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $website = new Varien_Object(array('id' => 5));
    ...
    {
        $customer = new Varien_Object(array('id' => 100500));
        $this->_registry
