...
class Enterprise_CustomerSegment_Helper_DataTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testAddSegmentFieldsToForm(array $fixtureFormData, $expectedUseSegments, $expectedSegmentNote)
    {
        $this->_storeConfig
            ->expects($this->once())
            ->method('getConfig')
            ->with(Enterprise_CustomerSegment_Helper_Data::XML_PATH_CUSTOMER_SEGMENT_ENABLER)
