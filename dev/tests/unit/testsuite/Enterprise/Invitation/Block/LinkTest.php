...
class Enterprise_Invitation_Block_LinkTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testGetHref()
    {
        ...
        $invitationHelper = $this->getMockBuilder('Enterprise_Invitation_Helper_Data')
    ...
    {
        /** @var Mage_Customer_Model_Session $customerSession |PHPUnit_Framework_MockObject_MockObject */
        $customerSession = $this->getMockBuilder('Mage_Customer_Model_Session')
            ->disableOriginalConstructor()->getMock();

        /** @var Enterprise_Invitation_Model_Config $invitationConfiguration |PHPUnit_Framework_MockObject_MockObject */
        $invitationConfiguration = $this->getMockBuilder('Enterprise_Invitation_Model_Config')
            ->disableOriginalConstructor()->getMock();
