...
class Enterprise_Banner_Model_Resource_BannerTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $writeAdapter = $this->getMockForAbstractClass(
            'Varien_Db_Adapter_Interface', array(), '', false, true, true, array('getTransactionLevel', 'fetchOne')
        );
        ...
        $this->_resourceModel = new Enterprise_Banner_Model_Resource_Banner(
            $this->_resource,
            $this->_eventManager,
            $this->_bannerConfig
        );
    ...
    public function testGetStoreContent()
    {
            ...
            ->with($this->logicalAnd(
                ...
                $this->equalTo(
                    'SELECT "main_table"."banner_content"'
                        . ' FROM "enterprise_banner_content" AS "main_table"'
        ...
        $this->_eventManager
            ->expects($this->once())
            ->method('dispatch')
            ->with('enterprise_banner_resource_banner_content_select_init', $this->arrayHasKey('select'))
        ;
            ...
            ->with($this->logicalAnd(
                ...
                $this->equalTo(
                    'SELECT "main_table"."banner_content", "banner".*'
                        . ' FROM "enterprise_banner_content" AS "main_table"' . "\n"
                        . ' INNER JOIN "enterprise_banner" AS "banner"'
