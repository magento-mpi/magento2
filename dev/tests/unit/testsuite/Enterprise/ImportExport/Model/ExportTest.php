...
/**
 * Test class for Enterprise_ImportExport_Model_Export
 */
class Enterprise_ImportExport_Model_ExportTest extends PHPUnit_Framework_TestCase
{
    /**
     * Enterprise data export model
     *
     * @var Enterprise_ImportExport_Model_Export
     */
    protected $_model;
