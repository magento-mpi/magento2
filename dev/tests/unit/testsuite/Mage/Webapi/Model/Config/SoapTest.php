...
class Mage_Webapi_Model_Config_SoapTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function _createResourceConfig($pathToResources)
    {
        ...
        $classReflector = new Mage_Webapi_Model_Config_Reader_Soap_ClassReflector($helperClone, $typeProcessor);
        $reader = new Mage_Webapi_Model_Config_Reader_Soap($classReflector, $helperClone, $appConfig, $cache);
        ...
        /** Initialize SUT. */
        $apiConfig = new Mage_Webapi_Model_Config_Soap($reader, $helperClone, $app);
