 ...
 * @copyright {}
 */
class Mage_Webapi_Model_Acl_Role_FactoryTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->_expectedObject = $this->getMockBuilder('Mage_Webapi_Model_Acl_Role')
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function testCreate()
    {
        ...
        $this->_objectManager->expects($this->once())
            ->method('create')
            ->with('Mage_Webapi_Model_Acl_Role', $arguments)
