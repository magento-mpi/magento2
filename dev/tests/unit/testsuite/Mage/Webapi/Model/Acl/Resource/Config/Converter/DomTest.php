 ...
 */
class Mage_Webapi_Model_Acl_Resource_Config_Converter_DomTest extends Magento_Acl_Resource_Config_Converter_DomTest
{
    protected function setUp()
    {
        $this->_converter = new Mage_Webapi_Model_Acl_Resource_Config_Converter_Dom();
    }
