 ...
 */
class Mage_Reports_Model_Resource_Report_CollectionTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var Mage_Reports_Model_Resource_Report_Collection
     */
    protected $_model;
    ...
    protected function setUp()
    {
        ...
        $this->_model = $helper->getObject('Mage_Reports_Model_Resource_Report_Collection', $arguments);
    }
