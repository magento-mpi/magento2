...
/**
 * Test class for Mage_Centinel_Model_State_Jcb.
 */
class Mage_Centinel_Model_State_JcbTest extends PHPUnit_Framework_TestCase
{
    /**
     * State model
     *
     * @var Mage_Centinel_Model_State_Jcb
     */
    protected $_model;

    public function setUp()
    {
        $this->_model = new Mage_Centinel_Model_State_Jcb();
        $this->_model->setDataStorage(new Varien_Object());
    }
    ...
    {
        $this->_model->setLookupResult(new Varien_Object($lookupResults));
        $this->_model->setAuthenticateResult(new Varien_Object($params));
    ...
    public function testIsAuthenticateAllowedDataProvider()
    {
        return array(
            ...
            'wrong lookup and empty authentication' => array(
                false,
                array(),
                array()
            ),
            ...
            'wrong lookup and not empty authentication' => array(
                false,
                array(),
                array(
                    'eci_flag' => 'value'
    ...
    public function testIsAuthenticateSuccessful($result, $strictMode, $params)
    {
        ...
        $this->_model->setLookupResult(new Varien_Object($lookupResult));
        $this->_model->setAuthenticateResult(new Varien_Object($params));
        ...
        return array_merge(
            ...
            array(
                'Centinel case 2' => array(
                    false, true,
                    array('pa_res_status' => 'Y', 'eci_flag' => '05', 'xid' => 'some string', 'cavv' => 'some string',
                        'error_no' => '0', 'signature_verification' => 'N'
                    )
                ),
                'Centinel case 3' => array(
                    false, true,
                    array('pa_res_status' => 'N', 'signature_verification' => 'Y', 'eci_flag' => '07',
                        'xid' => 'some string', 'cavv' => '', 'error_no' => '0'
                    )
                ),
                'Centinel case 10' => array(
                    false, true,
                    array('pa_res_status' => '', 'signature_verification' => '', 'eci_flag' => '07', 'xid' => '',
                        'cavv' => '', 'error_no' => 'not zero'
                    )
                ),
            )
        );
    ...
    protected function _getAuthenticationSuccessfulData()
    {
        return array(
            'Centinel case 1' => array(
                true, true,
                array('pa_res_status' => 'Y', 'eci_flag' => '05', 'xid' => 'some string', 'cavv' => 'some string',
                    'error_no' => '0', 'signature_verification' => 'Y'
                )
            ),
            'Centinel case 1 pa_res_status is absent' => array(
                false, true,
                array('eci_flag' => '05', 'xid' => 'some string', 'cavv' => 'some string', 'error_no' => '0',
                    'signature_verification' => 'Y'
                )
            ),
            'Centinel case 1 eci_flag is absent' => array(
                false, true,
                array('pa_res_status' => 'Y', 'xid' => 'some string', 'cavv' => 'some string', 'error_no' => '0',
                    'signature_verification' => 'Y'
                )
            ),
            'Centinel case 1 xid is absent' => array(
                false, true,
                array('pa_res_status' => 'Y', 'eci_flag' => '05', 'cavv' => 'some string', 'error_no' => '0',
                    'signature_verification' => 'Y'
                )
            ),
            'Centinel case 1 cavv is absent' => array(
                false, true,
                array('pa_res_status' => 'Y', 'eci_flag' => '05', 'xid' => 'some string', 'error_no' => '0',
                    'signature_verification' => 'Y'
                )
            ),
            ...
            'Centinel case 1 wrong pa_res_status' => array(
                false, true,
                array('pa_res_status' => 'wrong value', 'eci_flag' => '05', 'xid' => 'some string',
                    'cavv' => 'some string', 'error_no' => '0', 'signature_verification' => 'Y'
                )
            ),
            'Centinel case 1 wrong eci_flag' => array(
                false, true,
                array('pa_res_status' => 'Y', 'eci_flag' => 'wrong value', 'xid' => 'some string',
                    'cavv' => 'some string', 'error_no' => '0', 'signature_verification' => 'Y'
                )
            ),
            'Centinel case 1 empty xid' => array(
                false, true,
                array('pa_res_status' => 'Y', 'eci_flag' => '05', 'xid' => '', 'cavv' => 'some string',
                    'error_no' => '0', 'signature_verification' => 'Y'
                )
            ),
            'Centinel case 1 empty cavv' => array(
                false, true,
                array('pa_res_status' => 'Y', 'eci_flag' => '05', 'xid' => 'some string', 'cavv' => '',
                    'error_no' => '0', 'signature_verification' => 'Y'
                )
            ),
            'Centinel case 1 no zero error_no' => array(
                false, true,
                array('pa_res_status' => 'Y', 'eci_flag' => '05', 'xid' => 'some string', 'cavv' => 'some string',
                    'error_no' => 'no zero', 'signature_verification' => 'Y'
                )
            ),
            'Centinel case 1 wrong signature_verification' => array(
                false, true,
                array('pa_res_status' => 'Y', 'eci_flag' => '05', 'xid' => 'some string', 'cavv' => 'some string',
                    'error_no' => '0', 'signature_verification' => 'wrong value'
                )
            ),
            'Centinel case 1 no params' => array(
                false, true, array()
            ),
        );
    }
    ...
    protected function _getAuthenticationUnavailableData()
    {
        return array(
            'Centinel case 4,5 in strict mode' => array(
                false, true,
                array('pa_res_status' => 'U', 'signature_verification' => 'Y', 'eci_flag' => '07',
                    'xid' => 'some string', 'cavv' => '', 'error_no' => '0'
                )
            ),
            ...
            'Centinel case 4,5 pa_res_status is absent' => array(
                false, false,
                array('signature_verification' => 'Y', 'eci_flag' => '07', 'xid' => 'some string',
                    'cavv' => '', 'error_no' => '0'
                )
            ),
            'Centinel case 4,5 signature_verification is absent' => array(
                false, false,
                array('pa_res_status' => 'U', 'eci_flag' => '07', 'xid' => 'some string', 'cavv' => '',
                    'error_no' => '0'
                )
            ),
            'Centinel case 4,5 eci_flag is absent' => array(
                false, false,
                array('pa_res_status' => 'U', 'signature_verification' => 'Y', 'xid' => 'some string',
                    'cavv' => '', 'error_no' => '0'
                )
            ),
            ...
            'Centinel case 4,5 cavv is absent' => array(
                false, false,
                array('pa_res_status' => 'U', 'signature_verification' => 'Y', 'eci_flag' => '07',
                    'xid' => 'some string', 'error_no' => '0'
                )
            ),
            'Centinel case 4,5 error_no is absent' => array(
                false, false,
                array('pa_res_status' => 'U', 'signature_verification' => 'Y', 'eci_flag' => '07',
                    'xid' => 'some string', 'cavv' => '',
                )
            ),
            'Centinel case 4,5 wrong pa_res_status' => array(
                false, false,
                array('pa_res_status' => 'wrong value', 'signature_verification' => 'Y', 'eci_flag' => '07',
                    'xid' => 'some string', 'cavv' => '', 'error_no' => '0'
                )
            ),
            'Centinel case 4,5 wrong signature_verification' => array(
                false, false,
                array('pa_res_status' => 'U', 'signature_verification' => 'wrong value', 'eci_flag' => '07',
                    'xid' => 'some string', 'cavv' => '', 'error_no' => '0'
                )
            ),
            'Centinel case 4,5 wrong eci_flag' => array(
                false, false,
                array('pa_res_status' => 'U', 'signature_verification' => 'Y', 'eci_flag' => 'wrong value',
                    'xid' => '', 'cavv' => '', 'error_no' => '0'
                )
            ),
            ...
            'Centinel case 4,5 not empty cavv' => array(
                false, false,
                array('pa_res_status' => 'U', 'signature_verification' => 'Y', 'eci_flag' => '07',
                    'xid' => 'some string', 'cavv' => 'not empty', 'error_no' => '0'
                )
            ),
            'Centinel case 4,5 no zero error_no' => array(
                false, false,
                array('pa_res_status' => 'U', 'signature_verification' => 'Y', 'eci_flag' => '07',
                    'xid' => 'some string', 'cavv' => '', 'error_no' => 'no zero'
                )
            ),
            'Centinel case 4,5 no params' => array(
                false, false, array()
            ),
        );
    }
    ...
    protected function _getProcessingAttemptsPerformedData()
    {
        return array(
            'Centinel case 11' => array(
                true, true,
                array('pa_res_status' => 'A', 'signature_verification' => 'Y', 'eci_flag' => '06',
                    'xid' => 'some string', 'cavv' => 'some string', 'error_no' => '0'
                )
            ),
            'Centinel case 11 pa_res_status is absent' => array(
                false, true,
                array('signature_verification' => 'Y', 'eci_flag' => '06', 'xid' => 'some string',
                    'cavv' => 'some string', 'error_no' => '0'
                )
            ),
            'Centinel case 11 signature_verification is absent' => array(
                false, true,
                array('pa_res_status' => 'A', 'eci_flag' => '06', 'xid' => 'some string', 'cavv' => 'some string',
                    'error_no' => '0'
                )
            ),
            'Centinel case 11 eci_flag is absent' => array(
                false, true,
                array('pa_res_status' => 'A', 'signature_verification' => 'Y', 'xid' => 'some string',
                    'cavv' => 'some string', 'error_no' => '0'
                )
            ),
            ...
            'Centinel case 11 error_no is absent' => array(
                false, true,
                array('pa_res_status' => 'A', 'signature_verification' => 'Y', 'eci_flag' => '06',
                    'xid' => 'some string', 'cavv' => 'some string',
                )
            ),
            'Centinel case no params' => array(
                false, true, array()
            ),
            'Centinel case 11 wrong pa_res_status' => array(
                false, true,
                array('pa_res_status' => 'wrong value', 'signature_verification' => 'Y', 'eci_flag' => '06',
                    'xid' => 'some string', 'cavv' => 'some string', 'error_no' => '0'
                )
            ),
            'Centinel case 11 wrong signature_verification' => array(
                false, true,
                array('pa_res_status' => 'A', 'signature_verification' => 'wrong value', 'eci_flag' => '06',
                    'xid' => 'some string', 'cavv' => 'some string', 'error_no' => '0'
                )
            ),
            'Centinel case 11 wrong eci_flag' => array(
                false, true,
                array('pa_res_status' => 'A', 'signature_verification' => 'Y', 'eci_flag' => 'wrong value',
                    'xid' => 'some string', 'cavv' => 'some string', 'error_no' => '0'
                )
            ),
            'Centinel case 11 empty xid' => array(
                false, true,
                array('pa_res_status' => 'A', 'signature_verification' => 'Y', 'eci_flag' => '06',
                    'xid' => '', 'cavv' => 'some string', 'error_no' => '0'
                )
            ),
            ...
            'Centinel case 11 no zero' => array(
                false, true,
                array('pa_res_status' => 'A', 'signature_verification' => 'Y', 'eci_flag' => '06',
                    'xid' => 'some string', 'cavv' => 'some string', 'error_no' => 'no zero'
                )
            ),
        );
    }
    ...
    {
        $this->_model->setLookupResult(new Varien_Object($params));
        $this->_model->setIsModeStrict($strictMode);
    ...
    {
        return array_merge(
            $this->_getSoftSuccessfulLookupData(),
            $this->_getStrictSuccessfulLookupData()
        );
    }
    ...
    protected function _getSoftSuccessfulLookupData()
    {
        return array(
            ...
            'Centinel case 5 no params' => array(
                false, false, array(),
            ),
            ...
            'Centinel case 7,8,9 error_no no params' => array(
                false,false, array(),
            ),
    ...
    protected function _getStrictSuccessfulLookupData()
    {
        return array(
            ...
            'Centinel cases 1-4, 6, 10-11 no params' => array(
                false, true, array(),
            ),
            'Centinel cases 1-4, 6, 10-11 wrong enrolled' => array(
                false, true,
                array('enrolled' => 'wrong value', 'acs_url' => 'some string', 'payload' => 'some string',
                    'error_no' => '0'
                ),
            ),
