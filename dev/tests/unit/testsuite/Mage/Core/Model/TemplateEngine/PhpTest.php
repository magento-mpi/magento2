...
class Mage_Core_Model_TemplateEngine_PhpTest extends PHPUnit_Framework_TestCase
{
    const TEST_PROP_VALUE = 'TEST_PROP_VALUE';

    /** @var  Mage_Core_Model_TemplateEngine_Php */
    ...
    {
        $this->_phpEngine = new Mage_Core_Model_TemplateEngine_Php();
    }
