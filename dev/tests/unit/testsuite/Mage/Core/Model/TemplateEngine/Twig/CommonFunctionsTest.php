 ...
 */
class Mage_Core_Model_TemplateEngine_Twig_CommonFunctionsTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->_urlHelperMock = $this->getMockBuilder('Mage_Core_Helper_Url')
            ->disableOriginalConstructor()
            ->getMock();
        $this->_dataHelperMock = $this->getMockBuilder('Mage_Core_Helper_Data')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->_loggerMock = $this->getMockBuilder('Mage_Core_Model_Logger')
            ->disableOriginalConstructor()
            ->getMock();
        $this->_localeMock = $this->getMockBuilder('Mage_Core_Model_LocaleInterface')
            ->disableOriginalConstructor()
            ->getMock();

        $this->_commonFunctions = new Mage_Core_Model_TemplateEngine_Twig_CommonFunctions(
    ...
    {
        $selectBlockMock = $this->getMockBuilder('Mage_Core_Block_Html_Select')
            ->disableOriginalConstructor()
            ->getMock();;
