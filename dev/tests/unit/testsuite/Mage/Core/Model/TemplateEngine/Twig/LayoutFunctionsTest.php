 ...
 */
class Mage_Core_Model_TemplateEngine_Twig_LayoutFunctionsTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->_layoutFunctions = new Mage_Core_Model_TemplateEngine_Twig_LayoutFunctions(
            $this->_layoutMock
        );
    ...
    public function testGetChildHtml()
    {
        ...
        $parentBlockMock = $this->getMockBuilder('Mage_Core_Block_Template')
            ->disableOriginalConstructor()
            ->getMock();
