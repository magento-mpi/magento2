...
class Mage_Core_Model_Config_Loader_ModulesTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->_resourceMock = $this->getMock('Mage_Core_Model_Config_Resource', array(), array(), '', false, false);
        $this->_readerMock = $this->getMock('Mage_Core_Model_Config_Modules_Reader', array(), array(), '', false);
        $this->_loaderMock = $this->getMock('Mage_Core_Model_Config_Loader_Local', array(), array(), '', false);

        $this->_model = new Mage_Core_Model_Config_Loader_Modules(
            $this->_configMock,
            $this->_resourceMock,
            $this->_readerMock,
            $this->_loaderMock
