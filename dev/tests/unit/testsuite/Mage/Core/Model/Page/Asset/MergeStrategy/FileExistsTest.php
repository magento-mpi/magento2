...
class Mage_Core_Model_Page_Asset_MergeStrategy_FileExistsTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var Mage_Core_Model_Page_Asset_MergeStrategy_FileExists
     */
    protected $_object;
