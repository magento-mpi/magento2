 ...
 */
class Mage_Core_Model_Router_ConfigTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $this->_readerMock = $this->getMock('Mage_Core_Model_Router_Config_Reader', array(), array(), '', false);
        $this->_cacheMock = $this->getMock('Magento_Config_CacheInterface');
        $this->_config = new Mage_Core_Model_Router_Config(
            $this->_readerMock,
            $this->_cacheMock
        );
    }
    ...
    public function testGetIfCacheIsArray()
    {
        $this->_cacheMock->expects($this->once())
            ->method('get')->with('areaCode', 'RouterConfig-routerCode')
    ...
    public function testGetRoutes()
    {
        ...
        $this->_cacheMock->expects($this->once())
            ->method('put')->with('Expected Value', 'areaCode', 'RouterConfig-routerCode');
