...
class Mage_Core_Model_ModuleManagerTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->_moduleList = $this->getMockForAbstractClass('Mage_Core_Model_ModuleListInterface');
        $this->_storeConfig = $this->getMockForAbstractClass('Mage_Core_Model_Store_ConfigInterface');
        $this->_model = new Mage_Core_Model_ModuleManager($this->_storeConfig, $this->_moduleList, array(
