 ...
 */
class Mage_Core_Model_ObjectManager_ConfigLoaderTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->_model = new Mage_Core_Model_ObjectManager_ConfigLoader($this->_cacheMock, $this->_readerMock);
    }
