...
class Mage_Core_Model_Layout_FileTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $this->_theme = $this->getMockForAbstractClass('Mage_Core_Model_ThemeInterface');
        $this->_model = new Mage_Core_Model_Layout_File(__FILE__, 'Fixture_TestModule', $this->_theme);
    }
