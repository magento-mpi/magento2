...
class Mage_Core_Model_Layout_File_Source_AggregatedTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var Mage_Core_Model_Layout_File_Source_Aggregated
     */
    private $_model;
    ...
    {
        $this->_fileList = $this->getMock('Mage_Core_Model_Layout_File_List', array(), array(), '', false);
        $this->_baseFiles = $this->getMockForAbstractClass('Mage_Core_Model_Layout_File_SourceInterface');
    ...
    public function testGetFiles()
    {
        ...
        $files = array(
            new Mage_Core_Model_Layout_File('0.xml', 'Module_One'),
            new Mage_Core_Model_Layout_File('1.xml', 'Module_One', $parentTheme),
            new Mage_Core_Model_Layout_File('2.xml', 'Module_One', $parentTheme),
            new Mage_Core_Model_Layout_File('3.xml', 'Module_One', $parentTheme),
            new Mage_Core_Model_Layout_File('4.xml', 'Module_One', $theme),
            new Mage_Core_Model_Layout_File('5.xml', 'Module_One', $theme),
            new Mage_Core_Model_Layout_File('6.xml', 'Module_One', $theme),
        );
