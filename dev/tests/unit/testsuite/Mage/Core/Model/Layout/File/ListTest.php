...
class Mage_Core_Model_Layout_File_ListTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->_model = new Mage_Core_Model_Layout_File_List();
    ...
    protected function _createLayoutFile($filename, $module, $themeFullPath = '')
    {
        ...
        return new Mage_Core_Model_Layout_File($filename, $module, $theme);
    }
