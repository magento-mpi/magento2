 ...
 */
class Mage_Core_Model_File_Storage_RequestTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->_model = new Mage_Core_Model_File_Storage_Request($this->_workingDir, $this->_requestMock);
    }
