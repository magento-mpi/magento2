 ...
 */
class Mage_Core_Model_Module_Declaration_Reader_FilesystemTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var Mage_Core_Model_Module_Declaration_Reader_Filesystem
     */
    protected $_model;
    ...
    protected function setUp()
    {
        ...
        $applicationDirs->expects($this->any())->method('getDir')
            ->will($this->returnValueMap(array(
                array(
                    Mage_Core_Model_Dir::CONFIG, $baseDir . DIRECTORY_SEPARATOR . 'app' . DIRECTORY_SEPARATOR .'etc',
                ),
                array(
                    Mage_Core_Model_Dir::MODULES, $baseDir . DIRECTORY_SEPARATOR . 'app' . DIRECTORY_SEPARATOR .'code',
                ),
            )));
