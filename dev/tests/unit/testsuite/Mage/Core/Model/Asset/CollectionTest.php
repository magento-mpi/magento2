...
class Mage_Core_Model_Asset_CollectionTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $this->_object = new Mage_Core_Model_Asset_Collection();
    ...
    {
        $assetNew = new Mage_Core_Model_Asset_Remote('http://127.0.0.1/magento/test.js');
    ...
    {
        $assetOverridden = new Mage_Core_Model_Asset_Remote('http://127.0.0.1/magento/test_overridden.css');
