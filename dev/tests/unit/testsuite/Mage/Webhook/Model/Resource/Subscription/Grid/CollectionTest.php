...
class Mage_Webhook_Model_Resource_Subscription_Grid_CollectionTest extends PHPUnit_Framework_TestCase
{
    public function testConstructor()
    {
        ...
        $configMock = $this->_makeMock('Mage_Webhook_Model_Subscription_Config');
        ...
        $resourceMock = $this-> _makeMock('Mage_Webhook_Model_Resource_Subscription');
        $resourceMock->expects($this->any())
            ->method('getReadConnection')
            ->will($this->returnValue($connectionMock));

        new Mage_Webhook_Model_Resource_Subscription_Grid_Collection(
