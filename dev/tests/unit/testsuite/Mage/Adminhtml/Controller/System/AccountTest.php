<?php
/**
 * Unit test for Mage_Adminhtml_Controller_System_Account controller
 *
 * {license_notice}
 *
...
class Mage_Adminhtml_System_AccountTest extends PHPUnit_Framework_TestCase
{
    /** @var Mage_Adminhtml_Controller_System_Account */
