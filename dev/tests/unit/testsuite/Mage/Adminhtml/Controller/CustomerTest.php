<?php
/**
 * Unit test for Mage_Adminhtml_Controller_Customer controller
 *
 * {license_notice}
 *
...
/**
 * Class Mage_Adminhtml_Controller_CustomerTest
 */
class Mage_Adminhtml_Controller_CustomerTest extends PHPUnit_Framework_TestCase
{
    /**
     ...
     *
     * @var PHPUnit_Framework_MockObject_MockObject|Mage_Adminhtml_Controller_Customer
     */
    ...
    public function setUp()
    {
        ...
        $this->_testedObject = $helperObjectManager->getObject('Mage_Adminhtml_Controller_Customer', $args);
    }

    /**
     * Test Mage_Adminhtml_Controller_Customer::resetPasswordAction()
     */
