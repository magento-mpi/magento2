 ...
 */
class Mage_Adminhtml_Controller_Sales_Order_CreditmemoTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var Mage_Adminhtml_Controller_Sales_Order_Creditmemo
     */
    ...
    protected function setUp()
    {
        ...
        $this->_controller = $helper->getObject('Mage_Adminhtml_Controller_Sales_Order_Creditmemo',
