...
class Mage_Backend_Block_System_Config_Form_Field_Select_AllowspecificTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testGetHtmlWhenValueIsEmpty($value)
    {
        ...
        $elementMock = $this->getMock('Varien_Data_Form_Element_Select',
