...
class Mage_Backend_Model_Config_Structure_Element_Dependency_FieldTest extends PHPUnit_Framework_TestCase
{
    /**#@+
     * SUT values
     */
    ...
    protected function _getFieldObject($data, $isNegative)
    {
        ...
        return new Mage_Backend_Model_Config_Structure_Element_Dependency_Field($data, self::PREFIX);
    }
