...
class Mage_Backend_Model_Config_Backend_File_RequestDataTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->_model = new Mage_Backend_Model_Config_Backend_File_RequestData();
    }
