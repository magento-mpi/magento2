...
/**
 * Test class for Mage_Backend_Model_Menu_Director_Director
 */
class Mage_Backend_Model_Menu_Director_DirectorTest extends PHPUnit_Framework_TestCase
{

    /**
     * @var Mage_Backend_Model_Menu_Director_Director
     */
    protected $_model;
    ...
    {
        $this->_builderMock =
            $this->getMock('Mage_Backend_Model_Menu_Builder', array(), array(), '', false);
        $this->_logger = $this->getMock(
            'Mage_Core_Model_Logger', array('addStoreLog', 'log', 'logException'), array(), '', false
        );
        $this->_commandMock =
            $this->getMock('Mage_Backend_Model_Menu_Builder_CommandAbstract',
                array('getId', '_execute', 'execute', 'chain'), array(), '', false);
        $this->_commandFactoryMock =
            $this->getMock('Mage_Backend_Model_Menu_Builder_CommandFactory', array('create'), array(), '', false);
        $this->_commandFactoryMock
        ...
        $this->_model = new Mage_Backend_Model_Menu_Director_Director(
            $this->_commandFactoryMock
        );
    }
