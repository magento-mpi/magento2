...
class Mage_Backend_Controller_Adminhtml_System_Config_SaveTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var Mage_Backend_Controller_Adminhtml_System_Config_Save
     */
    ...
    public function setUp()
    {
        ...
        $this->_controller = $this->getMock(
            'Mage_Backend_Controller_Adminhtml_System_Config_Save',
            array('deniedAction'),
            array(
                $context,
                $configStructureMock,
