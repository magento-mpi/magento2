...
class Mage_Launcher_Model_Storelauncher_Payments_Savehandlers_PayflowLinkSaveHandlerTest
    extends Mage_Launcher_Model_Storelauncher_Payments_Savehandlers_TestCaseAbstract
{
    /**
     * @var Mage_Launcher_Model_Storelauncher_Payments_Savehandlers_PayflowLinkSaveHandler
     */
    ...
    protected function setUp()
    {
        ...
        $this->_saveHandler = new Mage_Launcher_Model_Storelauncher_Payments_Savehandlers_PayflowLinkSaveHandler(
            $config,
            $backendConfigModel
        );
    }
    ...
    {
        $data = array();
        $data['groups']['payflow_link']['fields']['partner']['value'] = 'PayPal Partner ';
        $data['groups']['payflow_link']['fields']['vendor']['value'] = 'PayPal Vendor ';
        $data['groups']['payflow_link']['fields']['user']['value'] = 'user ';
        $data['groups']['payflow_link']['fields']['pwd']['value'] = 'password ';

        $preparedData = array();
        $preparedData['payflow_link']['fields']['partner']['value'] = 'PayPal Partner';
        $preparedData['payflow_link']['fields']['vendor']['value'] = 'PayPal Vendor';
        $preparedData['payflow_link']['fields']['user']['value'] = 'user';
        $preparedData['payflow_link']['fields']['pwd']['value'] = 'password';
        ...
        $saveHandler = new Mage_Launcher_Model_Storelauncher_Payments_Savehandlers_PayflowLinkSaveHandler(
            $config,
            $backendConfigModel
        );
