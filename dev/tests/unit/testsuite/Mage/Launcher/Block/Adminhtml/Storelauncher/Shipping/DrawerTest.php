...
class Mage_Launcher_Block_Adminhtml_Storelauncher_Shipping_DrawerTest extends PHPUnit_Framework_TestCase
{
     ...
     * Drawer Block
     *
     * @var Mage_Launcher_Block_Adminhtml_Storelauncher_Shipping_Drawer
     */
    ...
    {
        return array(
            array(array('carriers/dhlint/id' => 'user'), 'carriers/dhlint/id', 'user'),
            array(array(), 'carriers/dhlint/id', ''),
        );
    }
}
