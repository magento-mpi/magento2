...
class Mage_Checkout_Controller_CartTest extends PHPUnit_Framework_TestCase
{
    public function testControllerImplementsProductViewInterface()
    {
        $this->assertInstanceOf(
            'Mage_Catalog_Controller_Product_View_Interface',
            $this->getMock('Mage_Checkout_Controller_Cart', array(), array(), '', false)
        );
    }
    ...
    public function testGoBack()
    {
        ...
        $controller = $helper->getObject('Mage_Checkout_Controller_Cart', $arguments);
