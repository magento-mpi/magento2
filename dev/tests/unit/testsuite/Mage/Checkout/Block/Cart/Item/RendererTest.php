...
class Mage_Checkout_Block_Cart_Item_RendererTest extends PHPUnit_Framework_TestCase
{
    public function testGetProductThumbnailUrlForConfigurable()
    {
        ...
        $designPackage = $this->getMock('Mage_Core_Model_Design_Package', array('getViewConfig'), array($filesystem), '', false);
        ...
        $arguments = array(
            'errorInfo' => $this->getMock('Mage_Sales_Model_Status_List', array(), array(), '', false),
        );
