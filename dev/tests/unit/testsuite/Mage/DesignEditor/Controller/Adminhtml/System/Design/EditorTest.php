...
{
    /**
     * @var Mage_DesignEditor_Controller_Adminhtml_System_Design_Editor
     */
    protected $_model;
    ...
    protected function setUp()
    {
        ...
        $constructArguments = $objectManagerHelper->getConstructArguments(
            'Mage_DesignEditor_Controller_Adminhtml_System_Design_Editor',
            array(
                'request' => $request,
        ...
        $this->_model = $objectManagerHelper
            ->getObject('Mage_DesignEditor_Controller_Adminhtml_System_Design_Editor', $constructArguments);
    }
    ...
    /**
     * @covers Mage_DesignEditor_Controller_Adminhtml_System_Design_Editor::indexAction
    ...
    /**
     * @covers Mage_DesignEditor_Controller_Adminhtml_System_Design_Editor::firstEntranceAction
