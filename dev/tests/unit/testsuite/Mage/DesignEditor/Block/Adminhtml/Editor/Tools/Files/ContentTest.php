 ...
 */
class Mage_DesignEditor_Block_Adminhtml_Editor_Tools_Files_ContentTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    /**
     * @var Mage_DesignEditor_Block_Adminhtml_Editor_Tools_Files_Content|PHPUnit_Framework_MockObject_MockObject
     */
    ...
    public function setUp()
    {
        ...
        $this->_filesContent = $this->getMock(
            'Mage_DesignEditor_Block_Adminhtml_Editor_Tools_Files_Content', array('helper'), $constructArguments
        );
