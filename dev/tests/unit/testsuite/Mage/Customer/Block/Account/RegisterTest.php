...
/**
 * Test class for Mage_Customer_Block_Account_Register
 */
class Mage_Customer_Block_Account_RegisterTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testToHtml()
    {
        ...
        $link = $this->_objectManager->getObject(
            'Mage_Customer_Block_Account_Register',
            array(
                'context' => $context,
                'session' => $session,
            )
