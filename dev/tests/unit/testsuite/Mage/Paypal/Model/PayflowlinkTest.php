...
/**
 * Test class for Mage_Paypal_Model_Payflowlink
 *
 */
class Mage_Paypal_Model_PayflowlinkTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var
     */
    ...
    public function testSetResponseData()
    {
        ...
        /** @var $model Mage_Paypal_Model_Payflowlink */
    ...
    public function testDefaultRequestParameters($cscrequired, $cscedit, $emailcustomer, $urlmethod)
    {
        ...
        $request = Mage_Paypal_Model_PayflowlinkTest::$request;
     ...
     *
     * @param Mage_Paypal_Model_Payflowlink $model
     * @param array() $params
     */
    protected function _prepareRequest(Mage_Paypal_Model_Payflowlink $model, $params)
    {
        $request = new Mage_Paypal_Model_Payflow_Request;
        ...
        $checkRequest = create_function('$request', 'Mage_Paypal_Model_PayflowlinkTest::$request = $request;');
        $model->expects($this->any())->method('_postRequest')->will($this->returnCallback($checkRequest));
        Mage_Paypal_Model_PayflowlinkTest::$request = null;
        $model->initialize(Mage_Paypal_Model_Config::PAYMENT_ACTION_AUTH, new Magento_Object());
    }
     ...
     * @param Mage_Paypal_Model_Payflowlink $model
     */
    protected function _assertRequestBaseParameters(Mage_Paypal_Model_Payflowlink $model)
    {
        ...
        $this->assertEquals(Mage_Paypal_Model_Payflowlink::LAYOUT_TEMPLATE, $request->getData('template'));
     ...
     * @param Mage_Paypal_Model_Payflowlink $model
     */
    protected function _assertResponseData(Mage_Paypal_Model_Payflowlink $model)
    {
