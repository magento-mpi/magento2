 ...
 */
class Mage_Catalog_Block_Catalog_Product_View_OptionsTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testGetOptionHtml()
    {
        ...
        $this->_optionsBlock = new Mage_Catalog_Block_Product_View_Options($context, $option);
