...
class Mage_Page_Model_Asset_GroupedCollectionTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $objectManager
            ->expects($this->any())
            ->method('create')
            ->with('Mage_Page_Model_Asset_PropertyGroup')
    ...
    {
        return new Mage_Page_Model_Asset_PropertyGroup($arguments['properties']);
    }
