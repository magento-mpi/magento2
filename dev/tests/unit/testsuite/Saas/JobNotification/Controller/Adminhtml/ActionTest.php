 ...
 */
class Saas_JobNotification_Controller_Adminhtml_ActionTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var Saas_JobNotification_Controller_Adminhtml_Action
     */
    ...
    protected function setUp()
    {
        ...
        $this->_responseMock = $this->getMock('Magento_Core_Controller_Response_Http', array(), array(), '', false);
        ...
        $this->_controller = $helper->getObject('Saas_JobNotification_Controller_Adminhtml_Action', $arguments);
    }
