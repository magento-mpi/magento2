 ...
 */
class Saas_Downloadable_Model_Limitation_Specification_Backend_ReportProductTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->_modelSpecification = $objectManagerHelper->getObject(
            'Saas_Downloadable_Model_Limitation_Specification_Backend_ReportProduct'
        );
    }
