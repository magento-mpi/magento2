 ...
 */
class Saas_Sales_Model_Limitation_Specification_Frontend_RecurringTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->_modelSpecification = $objectManagerHelper->getObject(
            'Saas_Sales_Model_Limitation_Specification_Frontend_Recurring'
        );
    }
