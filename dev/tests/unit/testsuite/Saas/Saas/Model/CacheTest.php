...
class Saas_Saas_Model_CacheTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->_eventManagerMock = $this->getMockBuilder('Magento_Core_Model_Event_Manager')
    ...
    public function testInvalidateType()
    {
        ...
        $objectManager->expects($this->once())
            ->method('get')
            ->with($this->equalTo('Magento_Core_Model_Event_Manager'))
            ->will($this->returnValue($this->_eventManagerMock));

        $modelCacheMock = $this->getMockBuilder('Saas_Saas_Model_Cache')
            ->setConstructorArgs(array(
                $objectManager,
                $this->getMock('Magento_Core_Model_Cache_Frontend_Pool', array(), array(), '', false),
                $this->getMock('Magento_Core_Model_Cache_Types', array(), array(), '', false),
                $this->getMock('Magento_Core_Model_ConfigInterface', array(), array(), '', false),
                $this->getMock('Magento_Core_Model_Dir', array(), array(), '', false),
                $this->getMock('Magento_Core_Model_Factory_Helper', array(), array(), '', false)
            ))
