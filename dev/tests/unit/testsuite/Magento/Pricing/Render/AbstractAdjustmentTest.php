...
class AbstractAdjustmentTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $amountRender = $this->getMock('Magento\Pricing\Render\Amount', [], [], '', false);
    ...
    {
        $amountRender = $this->getMock('Magento\Pricing\Render\Amount', [], [], '', false);
        $price = $this->getMockForAbstractClass('Magento\Pricing\Price\PriceInterface');
        $sealableItem = $this->getMockForAbstractClass('Magento\Pricing\Object\SaleableInterface');
        $priceInfo = $this->getMock('Magento\Pricing\PriceInfo\Base', [], [], '', false);
    ...
    {
        $amountRender = $this->getMock('Magento\Pricing\Render\Amount', [], [], '', false);
        $adjustment = $this->getMockForAbstractClass('Magento\Pricing\Adjustment\AdjustmentInterface');
        $sealableItem = $this->getMockForAbstractClass('Magento\Pricing\Object\SaleableInterface');
        $priceInfo = $this->getMock('Magento\Pricing\PriceInfo\Base', [], [], '', false);
        $adjustmentCode = 'tax';
