...
class LanguagePackExtractorTest extends \PHPUnit_Framework_TestCase {
    ...
    protected function setUp()
    {
        ...
        $logger = $this->getMockBuilder('Zend_Log')
            ...
            ->getMock();
        $this->parser = $objectManagerHelper->getObject('\Magento\Tools\Composer\Parser\LanguagePackXmlParser');
        $this->extractor = $objectManagerHelper->getObject('\Magento\Tools\Composer\Extractor\LanguagePackExtractor', array('rootDir' => $rootDir, 'logger' => $logger, 'parser' => $this->parser));
