...
class Magento_Core_Model_EntryPoint_CronTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->_model = new Mage_Core_Model_EntryPoint_Cron($config, $this->_objectManagerMock);
    }
    ...
    public function testProcessRequest()
    {
        ...
        $configScopeMock = $this->getMock('Mage_Core_Model_Config_Scope', array(), array(), '', false);

        $map = array(
            array('Mage_Core_Model_App', $appMock),
            array('Mage_Core_Model_Event_Manager', $eventManagerMock),
            array('Mage_Core_Model_Config_Scope', $configScopeMock),
        );
