...
{
    /**
     * @var Magento_Core_Model_Layout_File_Source_Theme
     */
    private $_model;
    ...
    protected function setUp()
    {
        ...
        $this->_model = new Magento_Core_Model_Layout_File_Source_Theme(
    ...
    public function testGetFiles()
    {
        ...
        $fileOne = new Magento_Core_Model_Layout_File('1.xml', 'Module_One', $theme);
        $fileTwo = new Magento_Core_Model_Layout_File('2.xml', 'Module_One', $theme);
        $fileThree = new Magento_Core_Model_Layout_File('3.xml', 'Module_Two', $theme);
        $this->_fileFactory
            ->expects($this->at(0))
            ->method('create')
