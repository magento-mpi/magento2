 ...
 */
class Magento_Core_Model_Cache_TypesTest extends PHPUnit_Framework_TestCase
{
    /**
     ...
     * @param bool $appInstalled
     * @param bool $banAll
     * @return Magento_Core_Model_Cache_Types
     */
    protected function _buildModel(
        ...
        $this->_cacheFrontend->expects($this->any())
            ->method('load')
            ->with(Magento_Core_Model_Cache_Types::CACHE_ID)
        ...
        $this->_model = new Magento_Core_Model_Cache_Types($this->_resource, $cacheFrontendPool, $appState, $banAll);
