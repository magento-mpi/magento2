...
/**
 * Listing Class ViewTest
 * @package Magento\Ui\Listing
 */
class ViewTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Magento\Ui\Configuration |\PHPUnit_Framework_MockObject_MockObject
     */
    protected $configuration;

    /**
     * @var \Magento\Ui\ConfigurationStorage |\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    public function setUp()
    {
        ...
        $this->actionPool = $this->getMock('\Magento\Ui\Control\ActionPool', [], [], '', false);
        $this->optionsFactory = $this->getMock('\Magento\Ui\DataProvider\OptionsFactory', [], [], '', false);
        $this->rowPool = $this->getMock('\Magento\Ui\DataProvider\RowPool', [], [], '', false);
    ...
    public function testRender()
    {
        ...
        $this->listingView->setData(
            [
                View::ROW_DATA_PROVIDER_KEY => [0 => ['class' => 'someClass']],
                'meta' => ['fields' => $data],
                'client_root' => 'root',
