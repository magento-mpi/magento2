 ...
 */
class Magento_Webhook_Block_Adminhtml_Subscription_GridTest extends Magento_Test_Block_Adminhtml
{
    ...
    public function setUp()
    {
        ...
        $this->_subxConfigMock = $this->_makeMock('Magento_Webhook_Model_Subscription_Config');
        $this->_subxFactoryMock = $this->_makeMock('Magento_Webhook_Model_Subscription_Factory');
        $this->_subscriptionMock = $this->_makeMock('Magento_Webhook_Model_Subscription');
        ...
        $this->_gridMock =  $this->getMock('Magento_Webhook_Block_Adminhtml_Subscription_Grid', $methods, $arguments);
    }
