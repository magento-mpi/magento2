...
class CustomerMetadataServiceTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetAttributeMetadata()
    {
        ...
        $validationRuleBuilder = new \Magento\Customer\Service\V1\Dto\Eav\ValidationRuleBuilder();

        $attributeMetadataBuilder =
            new \Magento\Customer\Service\V1\Dto\Eav\AttributeMetadataBuilder($optionBuilder, $validationRuleBuilder);
