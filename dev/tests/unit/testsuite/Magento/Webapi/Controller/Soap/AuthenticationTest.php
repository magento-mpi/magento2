 ...
 */
class Magento_Webapi_Controller_Soap_AuthenticationTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->_roleLocatorMock = $this->getMockBuilder('Magento_Webapi_Model_Authorization_RoleLocator')
            ...
            ->getMock();
        /** Initialize SUT. */
        $this->_soapAuthentication = new Magento_Webapi_Controller_Soap_Authentication(
            $this->_tokenFactoryMock,
