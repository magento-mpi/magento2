 ...
 */
class Magento_Webapi_Controller_Response_Rest_Renderer_XmlTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        /** Initialize SUT. */
        $this->_restXmlRenderer = new \Magento\Webapi\Controller\Response\Rest\Renderer\Xml($xmlGenerator);
        parent::setUp();
    }
