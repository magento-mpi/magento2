...
class AssociatedProductsTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->contextMock = $this->getMock('Magento\View\Element\Template\Context', array(), array(), '', false);
        $this->block = new AssociatedProducts($this->contextMock);
    }

    /**
     * @cover Magento\GroupedProduct\Block\Product\Grouped\AssociatedProducts::getParentTab
     */
    ...
    /**
     * @cover Magento\GroupedProduct\Block\Product\Grouped\AssociatedProducts::getTabLabel
     */
