...
/**
 * Test class for Magento_Cardgate_Model_Base
 */
class Magento_Cardgate_Model_BaseTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    /**
     * @var Magento_Cardgate_Helper_Data|PHPUnit_Framework_MockObject_MockObject
     */
    ...
    public function _createModel(array $config = array())
    {
        ...
        $this->_orderFactoryMock = $this->getMock('Magento_Sales_Model_OrderFactory', array('create'), array(), '',
            false);
        ...
        $this->_baseModel = new Magento_Cardgate_Model_Base(
