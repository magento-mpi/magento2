...
(
    'page_layout_handle_must_be_unique' => array(
        ...
        array("Element 'pageLayout': Duplicate key-sequence ['node_one_two'] in unique identity-constraint "
    ...
    'menu_layout_name_must_be_unique' => array(
        ...
        array("Element 'menuLayout': Duplicate key-sequence ['name_one'] in unique identity-constraint "
    ...
    'handle_with_not_required_name' => array(
        '<?xml version="1.0"?><config><menuLayout name="name_one" label="One" handle="handle_name"><pageLayout '
        . 'handle="node12" /></menuLayout></config>',
        array("Element 'pageLayout', attribute 'handle': [facet 'pattern'] The value 'node12' is not accepted by the "
        . "pattern '[A-Za-z_]+'.", "Element 'pageLayout', attribute 'handle': 'node12' is not a valid value of the "
        . "atomic type 'handleName'.", "Element 'pageLayout', attribute 'handle': Warning: No precomputed value "
    ...
    'optional_attributes_with_invalid_names' => array(
        ...
        . '</config>',
        array("Element 'menuLayout', attribute 'handle': [facet 'pattern'] The value 'handle123' is not accepted by the"
        . " pattern '[A-Za-z_]+'.", "Element 'menuLayout', attribute 'handle': 'handle123' is not a valid value of the "
        . "atomic type 'handleName'.", "Element 'menuLayout', attribute 'isDefault': '12' is not a valid value of the "
        . "atomic type 'xs:boolean'."
        )),
    'menuLayout_has_required_attribute_label' => array(
        '<?xml version="1.0"?><config><menuLayout name="name_one" handle="handle_one" />'
        . '</config>',
        array("Element 'menuLayout': The attribute 'label' is required but missing."
        )),
    'menuLayout_has_required_attribute_handle' => array(
        '<?xml version="1.0"?><config><menuLayout name="name_one" label="handle123" /></config>',
        array("Element 'menuLayout': The attribute 'handle' is required but missing.")),
);