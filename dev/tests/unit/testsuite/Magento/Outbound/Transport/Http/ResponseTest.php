...
class Magento_Outbound_Transport_Http_ResponseTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $uut = new Magento_Outbound_Transport_Http_Response("HTTP/2.0 299 OK");
        $this->assertTrue($uut->isSuccessful());
    }

    public function testIsSuccessfulFalse()
    {
        $uut = new Magento_Outbound_Transport_Http_Response("HTTP/2.0 301 Moved Permanently");
    ...
    {
        $uut = new Magento_Outbound_Transport_Http_Response("HTTP/2.0 299 A-OK");
