...
class GuestTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->appContextHelperMock = $this->getMock('Magento\App\Helper\Context', [], [], '', false);
        $this->scopeConfigInterfaceMock = $this->getMock('Magento\App\Config\ScopeConfigInterface');
        ...
        $this->viewInterfaceMock = $this->getMock('Magento\App\ViewInterface');
    ...
    public function testLoadValidOrderNotEmptyPost()
    {
        ...
        $requestMock = $this->getMock('Magento\App\Request\Http', [], [], '', false);
        ...
        $responseMock = $this->getMock('Magento\App\Response\Http', [], [], '', false);
