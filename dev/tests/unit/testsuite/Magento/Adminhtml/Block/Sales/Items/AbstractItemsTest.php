...
class AbstractItemsTest extends \PHPUnit_Framework_TestCase
{
    public function testGetItemRenderer()
    {
        ...
        $renderer = new \Magento\Adminhtml\Block\Sales\Order\View\Items\Renderer\DefaultRenderer(
        ...
        $block = new \Magento\Adminhtml\Block\Sales\Items\AbstractItems($product, $coreData, $context, $registry);
    ...
    public function testGetItemRendererThrowsExceptionForNonexistentRenderer()
    {
        ...
        $block = $objectManager->getObject(
            'Magento\Adminhtml\Block\Sales\Items\AbstractItems',
            array(
