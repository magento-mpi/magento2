...
class PoolTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->defaultValidatorMock =
            $this->getMock('Magento\Catalog\Model\Product\Option\Validator\DefaultValidator', [], [], '', false);
        $this->selectValidatorMock =
            $this->getMock('Magento\Catalog\Model\Product\Option\Validator\Select', [], [], '', false);
