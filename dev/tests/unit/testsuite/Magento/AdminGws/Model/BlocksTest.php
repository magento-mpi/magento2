...
class Magento_AdminGws_Model_BlocksTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testDisableTaxRelatedMultiselects()
    {
        ...
        $element1 = new Magento_Data_Form_Element_Editablemultiselect($factory, $collectionFactory);
        $element1->setId('tax_customer_class');
        $element2 = new Magento_Data_Form_Element_Editablemultiselect($factory, $collectionFactory);
        $element2->setId('tax_product_class');
        $element3 = new Magento_Data_Form_Element_Editablemultiselect($factory, $collectionFactory);
