...
class ProcessorTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $modelMock = $this->getMockBuilder('Magento\Sales\Model\Quote')->disableOriginalConstructor()->getMock();
    ...
    public function testLogActionDenied()
    {
        ...
        $loggingEventMock->expects($this->once())->method('setInfo')->with($this->equalTo('Access denied'));
    ...
    protected function _setUpModelActionAfter()
    {
        ...
        $this->_changesMock->expects(
            ...
            $this->equalTo('Magento\Sales\Model\Quote')
        );
