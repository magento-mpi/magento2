...
class Magento_Backend_Model_Menu_ConfigTest extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->_configMenuMock = $this->getMock('Magento_Backend_Model_Menu_Config_Menu', array(), array(), '', false);
    ...
    /**
     * @covers Magento_Backend_Model_Menu_Config::getMenu
     */
    public function testGetMenuWhenEnabledCache()
    {
        ...
        $this->_directorDomMock->expects($this->exactly(1))
            ->method('buildMenu')
            ->with($this->isInstanceOf('Magento_Backend_Model_Menu_Builder'));
    ...
    {
        if ($model == 'Magento_Backend_Model_Menu_Director_Dom') {
            return $this->_directorDomMock;
        } elseif ($model == 'Magento_Backend_Model_Menu_Config_Menu') {
            return $this->_configMenuMock;
        } elseif ($model == 'Magento_Backend_Model_Menu_Builder') {
