...
(
    'add_action_attribute_empty_value' => array(
        ...
        array("Element 'add', attribute 'action': [facet 'pattern'] The value '' is not accepted by the "
    ...
    'add_action_attribute_less_minLenght_value' => array(
        '<?xml version="1.0"?><config><menu><add action="ad" id="Test_Value::some_value" '
            . 'title="Notifications" module="Test_Value" '
            . 'resource="Test_Value::value"/></menu></config>',
        array("Element 'add', attribute 'action': [facet 'pattern'] The value 'ad' is not accepted by the "
            . "pattern '[a-zA-Z0-9/_]{3,}'.",
    ...
    'add_action_attribute_notallowed_symbols_value' => array(
        '<?xml version="1.0"?><config><menu><add action="adm$#@inhtml/notification"'
            ...
            '</menu></config>',
        array("Element 'add', attribute 'action': [facet 'pattern'] The value 'adm$#@inhtml/notification' is not "
    ...
    'add_dependsOnConfig_attribute_empty_value' => array(
        '<?xml version="1.0"?><config><menu><add dependsOnConfig="" '
            ...
            . 'module="Test_Value" resource="Test_Value::value"/>'
            . '</menu></config>',
        array("Element 'add', attribute 'dependsOnConfig': [facet 'pattern'] The value '' is not accepted by the "
    ...
    'add_dependsOnConfig_attribute_less_minLenght_value' => array(
        '<?xml version="1.0"?><config><menu><add dependsOnConfig="v" '
            ...
            . 'module="Test_Value" resource="Test_Value::value"/>'
            . '</menu></config>',
        array("Element 'add', attribute 'dependsOnConfig': [facet 'pattern'] The value 'v' is not accepted by the "
            . "pattern '[A-Za-z0-9_/]{3,}'.",
    ...
    'add_dependsOnConfig_attribute_notallowed_symbols_value' => array(
        '<?xml version="1.0"?><config><menu><add dependsOnConfig="name#1" '
            ...
            . 'module="Test_Value" resource="Test_Value::value"/>'
            . '</menu></config>',
        array("Element 'add', attribute 'dependsOnConfig': [facet 'pattern'] The value 'name#1' is not accepted by "
    ...
    'add_dependsOnModule_attribute_empty_value' => array(
        '<?xml version="1.0"?><config><menu><add dependsOnModule="" '
            ...
            . 'module="Test_Value" resource="Test_Value::value"/>'
            . '</menu></config>',
        array("Element 'add', attribute 'dependsOnModule': [facet 'pattern'] The value '' is not accepted by the "
            . "pattern '[A-Za-z0-9_]{3,}'.",
    ...
    'add_dependsOnModule_attribute_less_minLenght_value' => array(
        '<?xml version="1.0"?><config><menu><add dependsOnModule="w" '
            ...
            . 'module="Test_Value" resource="Test_Value::value"/>'
            . '</menu></config>',
        array("Element 'add', attribute 'dependsOnModule': [facet 'pattern'] The value 'w' is not accepted by the "
            . "pattern '[A-Za-z0-9_]{3,}'.",
    ...
    'add_dependsOnModule_attribute_notallowed_symbols_value' => array(
        '<?xml version="1.0"?><config><menu><add dependsOnModule="@#erw" '
            ...
            . 'module="Test_Value" resource="Test_Value::value"/>'
            . '</menu></config>',
        array("Element 'add', attribute 'dependsOnModule': [facet 'pattern'] The value '@#erw' is not "
    ...
    'add_id_attribute_empty_value' => array(
        '<?xml version="1.0"?><config><menu><add id="" title="Notifications" module="Test_Value" '
            . 'resource="Test_Value::value"/></menu></config>',
        array("Element 'add', attribute 'id': [facet 'pattern'] The value '' is not accepted by the "
            . "pattern '[A-Za-z0-9/_:]{3,}'.",
    ...
    'add_id_attribute_less_minLenght_value' => array(
        '<?xml version="1.0"?><config><menu><add id="ma" title="Notifications" module="Test_Value" '
            . 'resource="Test_Value::value"/></menu></config>',
        array("Element 'add', attribute 'id': [facet 'pattern'] The value 'ma' is not accepted by the "
            . "pattern '[A-Za-z0-9/_:]{3,}'.",
    ...
    'add_id_attribute_notallowed_symbols_value' => array(
        '<?xml version="1.0"?><config><menu><add id="Magento)value::some_value" '
            . 'title="Notifications" module="Test_Value" '
            . 'resource="Test_Value::value"/></menu></config>',
        array("Element 'add', attribute 'id': [facet 'pattern'] The value 'Magento)value::some_value' is not "
            . "accepted by the pattern '[A-Za-z0-9/_:]{3,}'.",
    ...
    'add_module_attribute_empty_value' => array(
        ...
        array("Element 'add', attribute 'module': [facet 'pattern'] The value '' is not accepted by the "
            . "pattern '[A-Za-z0-9_]{3,}'.",
    ...
    'add_module_attribute_less_minLenght_value' => array(
        '<?xml version="1.0"?><config><menu><add module="we" '
            . 'id="Test_Value::some_value" title="Notifications" '
            . 'resource="Test_Value::value"/></menu></config>',
        array("Element 'add', attribute 'module': [facet 'pattern'] The value 'we' is not accepted by the "
            . "pattern '[A-Za-z0-9_]{3,}'.",
    ...
    'add_module_attribute_notallowed_symbols_value' => array(
        '<?xml version="1.0"?><config><menu><add module="Test_Va%lue" '
            . 'id="Test_Value::some_value" title="Notifications" '
            . 'resource="Test_Value::value"/></menu></config>',
        array("Element 'add', attribute 'module': [facet 'pattern'] The value 'Test_Va%lue' is not accepted by the "
            . "pattern '[A-Za-z0-9_]{3,}'.",
    ...
    'add_parent_attribute_empty_value' => array(
        '<?xml version="1.0"?><config><menu><add parent="" id="Test_Value::some_value" '
            . 'title="Notifications" module="Test_Value" '
            . 'resource="Test_Value::value"/></menu></config>',
        array("Element 'add', attribute 'parent': [facet 'pattern'] The value '' is not accepted by the " 
            . "pattern '[A-Za-z0-9/_:]{3,}'.",
    ...
    'add_parent_attribute_less_minLenght_value' => array(
        '<?xml version="1.0"?><config><menu><add parent="Ma" id="Test_Value::some_value" '
            . 'title="Notifications" module="Test_Value" '
            . 'resource="Test_Value::value"/></menu></config>',
        array("Element 'add', attribute 'parent': [facet 'pattern'] The value 'Ma' is not accepted by the " 
            . "pattern '[A-Za-z0-9/_:]{3,}'.",
    ...
    'add_parent_attribute_notallowed_symbols_value' => array(
        '<?xml version="1.0"?><config><menu><add parent="Some#Name::system_other_settings" '
            ...
            . 'module="Test_Value" resource="Test_Value::value"/>'
            . '</menu></config>',
        array("Element 'add', attribute 'parent': [facet 'pattern'] The value 'Some#Name::system_other_settings' "
    ...
    'add_resource_attribute_notvalid_regexp_value1' => array(
        '<?xml version="1.0"?><config><menu><add id="Test_Value::some_value" '
            . 'title="Notifications" module="Test_Value" '
            . 'resource="test_Value::value"/></menu></config>',
        array("Element 'add', attribute 'resource': [facet 'pattern'] The value 'test_Value::value' is not "
    ...
    'add_resource_attribute_notvalid_regexp_value3' => array(
        ...
        array("Element 'add', attribute 'resource': [facet 'pattern'] The value 'M#$%23_value::value' is not "
            . "accepted by the pattern '[A-Z]+[a-z0-9]{1,}_[A-Z]+[A-Z0-9a-z]{1,}::[A-Za-z_0-9]{1,}'.",
    ...
    'add_resource_attribute_notvalid_regexp_value4' => array(
        ...
        array("Element 'add', attribute 'resource': [facet 'pattern'] The value '_value::value' is not accepted by "
    ...
    'add_resource_attribute_notvalid_regexp_value5' => array(
        '<?xml version="1.0"?><config><menu><add id="Test_Value::some_value" '
            ...
            . '</menu></config>',
        array("Element 'add', attribute 'resource': [facet 'pattern'] The value 'Magento_::value' is not "
            . "accepted by the pattern '[A-Z]+[a-z0-9]{1,}_[A-Z]+[A-Z0-9a-z]{1,}::[A-Za-z_0-9]{1,}'.",
    ...
    'add_resource_attribute_notvalid_regexp_value7' => array(
        ...
        array("Element 'add', attribute 'resource': [facet 'pattern'] The value 'Test_Value::' is not "
            . "accepted by the pattern '[A-Z]+[a-z0-9]{1,}_[A-Z]+[A-Z0-9a-z]{1,}::[A-Za-z_0-9]{1,}'.",
    ...
    'add_sortOrder_attribute_wrong_value_type' => array(
        '<?xml version="1.0"?><config><menu><add sortOrder="string value" '
            ...
            . 'module="Test_Value" resource="Test_Value::value"/>'
            . '</menu></config>',
        array("Element 'add', attribute 'sortOrder': 'string value' is not a valid value of the atomic "
            ."type 'xs:int'.")),
    'add_title_attribute_empty_value' => array(
        '<?xml version="1.0"?><config><menu><add title="" id="Test_Value::some_value" '
            . 'module="Test_Value" resource="Test_Value::value"/>'
            . '</menu></config>',
        array("Element 'add', attribute 'title': [facet 'minLength'] The value '' has a length of '0'; this "
    ...
    'add_title_attribute_less_minLenght_value' => array(
        '<?xml version="1.0"?><config><menu><add title="No" id="Test_Value::some_value" '
            . 'module="Test_Value" resource="Test_Value::value"/>'
            . '</menu></config>',
        array("Element 'add', attribute 'title': [facet 'minLength'] The value 'No' has a length of '2'; this "
            ."underruns the allowed minimum length of '3'.",
    ...
    'add_title_attribute_more_maxLenght_value' => array(
        '<?xml version="1.0"?><config><menu><add title="Lorem ipsum dolor sit amet, consectetur adipisicing" '
            ...
            . 'resource="Test_Value::value"/></menu></config>',
        array("Element 'add', attribute 'title': [facet 'maxLength'] The value 'Lorem ipsum dolor sit amet, ".
    ...
    'add_toolTip_attribute_empty_value' => array(
        '<?xml version="1.0"?><config><menu><add toolTip="" id="Test_Value::some_value" '
            . 'title="Notifications" module="Test_Value" '
            . 'resource="Test_Value::value"/></menu></config>',
        array("Element 'add', attribute 'toolTip': [facet 'minLength'] The value '' has a length of '0'; this "
            . "underruns the allowed minimum length of '3'.",
    ...
    'add_toolTip_attribute_less_minLenght_value' => array(
        '<?xml version="1.0"?><config><menu><add toolTip="st" id="Test_Value::some_value" '
            . 'title="Notifications" module="Test_Value" '
            . 'resource="Test_Value::value"/></menu></config>',
        array("Element 'add', attribute 'toolTip': [facet 'minLength'] The value 'st' has a length of '2'; this "
            . "underruns the allowed minimum length of '3'.",
    ...
    'add_toolTip_attribute_more_maxLenght_value' => array(
        '<?xml version="1.0"?><config><menu><add toolTip="Lorem ipsum dolor sit amet, consectetur adipisicing" '
            ...
            . 'module="Test_Value" resource="Test_Value::value"/>'
            . '</menu></config>',
        array("Element 'add', attribute 'toolTip': [facet 'maxLength'] The value 'Lorem ipsum dolor sit amet, "
            . "consectetur adipisicing' has a length of '51'; this exceeds the allowed maximum length of '50'.",
    ...
    'add_with_same_id_attribute_value' => array(
        '<?xml version="1.0"?><config><menu><add id="Test_Value::some_value" '
            ...
            . '</menu></config>',
        array("Element 'add': Duplicate key-sequence ['Test_Value::some_value'] in unique "
    ...
    'remove_id_attribute_empty_value' => array(
        ...
        array("Element 'remove', attribute 'id': [facet 'pattern'] The value '' is not accepted by the "
            . "pattern '[A-Za-z0-9/_:]{3,}'.",
    ...
    'remove_id_attribute_less_minLenght_value' => array(
        ...
        array("Element 'remove', attribute 'id': [facet 'pattern'] The value 'Test_Value::system_%currency' is not "
            ."accepted by the pattern '[A-Za-z0-9/_:]{3,}'.",
    ...
    'remove_id_attribute_notallowed_symbols_value' => array(
        ...
        array("Element 'remove', attribute 'id': [facet 'pattern'] The value 'Test_Value::system#currency' is not "
            ."accepted by the pattern '[A-Za-z0-9/_:]{3,}'.",
    ...
    'update_action_attribute_empty_value' => array(
        '<?xml version="1.0"?><config><menu><update action="" '
            . 'id="Test_Value::some_value"/></menu></config>',
        array("Element 'update', attribute 'action': [facet 'pattern'] The value '' is not accepted by the "
            ."pattern '[a-zA-Z0-9/_]{3,}'.",
    ...
    'update_action_attribute_less_minLenght_value' => array(
        '<?xml version="1.0"?><config><menu><update action="v" '
            ...
            . 'resource="Test_Value::value"/></menu></config>',
        array("Element 'update', attribute 'action': [facet 'pattern'] The value 'v' is not accepted by the "
            ."pattern '[a-zA-Z0-9/_]{3,}'.",
    ...
    'update_action_attribute_notallowed_symbols_value' => array(
        '<?xml version="1.0"?><config><menu><update action="/@##gt;" '
            . 'id="Test_Value::some_value"/></menu></config>',
        array("Element 'update', attribute 'action': [facet 'pattern'] The value '/@##gt;' is not "
            . "accepted by the pattern '[a-zA-Z0-9/_]{3,}'.",
    ...
    'update_dependsOnConfig_attribute_empty_value' => array(
        '<?xml version="1.0"?><config><menu><update id="Module_Name::system_config" dependsOnConfig=""/></menu>'
            . '</config>',
        array("Element 'update', attribute 'dependsOnConfig': [facet 'pattern'] The value '' is not accepted by the "
            . "pattern '[A-Za-z0-9_/]{3,}'.",
    ...
    'update_dependsOnConfig_attribute_less_minLenght_value' => array(
        ...
        array("Element 'update', attribute 'dependsOnConfig': [facet 'pattern'] The value 'we' is not accepted by "
            . "the pattern '[A-Za-z0-9_/]{3,}'.",
    ...
    'update_dependsOnConfig_attribute_notallowed_symbols_value' => array(
        '<?xml version="1.0"?><config><menu><update id="Module_Name::system_config" dependsOnConfig="someconf%"/>'
            . '</menu></config>',
        array("Element 'update', attribute 'dependsOnConfig': [facet 'pattern'] The value 'someconf%' is not "
            . "accepted by the pattern '[A-Za-z0-9_/]{3,}'.",
    ...
    'update_dependsOnModule_attribute_empty_value' => array(
        ...
        array("Element 'update', attribute 'dependsOnModule': [facet 'pattern'] The value '' is not accepted by "
            . "the pattern '[A-Za-z0-9_]{3,}'.",
    ...
    'update_dependsOnModule_attribute_less_minLenght_value' => array(
        ...
        array("Element 'update', attribute 'dependsOnModule': [facet 'pattern'] The value 'qw' is not accepted "
    ...
    'update_dependsOnModule_attribute_notallowed_symbols_value' => array(
        ...
        array("Element 'update', attribute 'dependsOnModule': [facet 'pattern'] The value 'someModule#1' is not "
            . "accepted by the pattern '[A-Za-z0-9_]{3,}'.",
    ...
    'update_id_attribute_empty_value' => array(
        ...
        array("Element 'update', attribute 'id': [facet 'pattern'] The value '' is not accepted by the "
            . "pattern '[A-Za-z0-9/_:]{3,}'.",
    ...
    'update_id_attribute_less_minLenght_value' => array(
        ...
        array("Element 'update', attribute 'id': [facet 'pattern'] The value 'g' is not accepted by the "
            . "pattern '[A-Za-z0-9/_:]{3,}'.",
    ...
    'update_id_attribute_notallowed_symbols_value' => array(
        '<?xml version="1.0"?><config><menu><update id="Magento+value::some_value"/>'
            . '</menu></config>',
        array("Element 'update', attribute 'id': [facet 'pattern'] The value 'Magento+value::some_value' is not "
            . "accepted by the pattern '[A-Za-z0-9/_:]{3,}'.",
    ...
    'update_module_attribute_empty_value' => array(
        ...
        array("Element 'update', attribute 'module': [facet 'pattern'] The value '' is not accepted by the "
            . "pattern '[A-Za-z0-9_]{3,}'.",
    ...
    'update_module_attribute_less_minLenght_value' => array(
        ...
        array("Element 'update', attribute 'module': [facet 'pattern'] The value 'we' is not accepted by the "
            . "pattern '[A-Za-z0-9_]{3,}'.",
    ...
    'update_parent_attribute_empty_value' => array(
        '<?xml version="1.0"?><config><menu><update parent="" '
            . 'id="Test_Value::some_value"/></menu></config>',
        array("Element 'update', attribute 'parent': [facet 'pattern'] The value '' is not accepted by the "
            . "pattern '[A-Za-z0-9/_:]{3,}'.",
    ...
    'update_parent_attribute_less_minLenght_value' => array(
        '<?xml version="1.0"?><config><menu><update parent="fg" '
            . 'id="Test_Value::some_value"/></menu></config>',
        array("Element 'update', attribute 'parent': [facet 'pattern'] The value 'fg' is not accepted by "
    ...
    'update_parent_attribute_notallowed_symbols_value' => array(
        '<?xml version="1.0"?><config><menu><update parent="Test_Value::system_other%settings" '
            . 'id="Test_Value::some_value"/></menu></config>',
        array("Element 'update', attribute 'parent': [facet 'pattern'] The value "
    ...
    'update_resource_attribute_notvalid_regexp_value1' => array(
        '<?xml version="1.0"?><config><menu><update id="Module_Name::system_config" '
            . 'resource="test_Value::value"/></menu></config>',
        array("Element 'update', attribute 'resource': [facet 'pattern'] The value 'test_Value::value' is not "
            . "accepted by the pattern '[A-Z]+[a-z0-9]{1,}_[A-Z]+[A-Z0-9a-z]{1,}::[A-Za-z_0-9]{1,}'.",
    ...
    'update_resource_attribute_notvalid_regexp_value3' => array(
        '<?xml version="1.0"?><config><menu><update id="Module_Name::system_config" '
            . 'resource="M#$%23_value::value"/></menu></config>',
        array("Element 'update', attribute 'resource': [facet 'pattern'] The value 'M#$%23_value::value' is not "
            . "accepted by the pattern '[A-Z]+[a-z0-9]{1,}_[A-Z]+[A-Z0-9a-z]{1,}::[A-Za-z_0-9]{1,}'.",
    ...
    'update_resource_attribute_notvalid_regexp_value4' => array(
        '<?xml version="1.0"?><config><menu><update id="Module_Name::system_config" '
            . 'resource="_value::value"/></menu></config>',
        array("Element 'update', attribute 'resource': [facet 'pattern'] The value '_value::value' is not "
            . "accepted by the pattern '[A-Z]+[a-z0-9]{1,}_[A-Z]+[A-Z0-9a-z]{1,}::[A-Za-z_0-9]{1,}'.",
    ...
    'update_resource_attribute_notvalid_regexp_value5' => array(
        ...
        array("Element 'update', attribute 'resource': [facet 'pattern'] The value 'Magento_::value' is not "
            . "accepted by the pattern '[A-Z]+[a-z0-9]{1,}_[A-Z]+[A-Z0-9a-z]{1,}::[A-Za-z_0-9]{1,}'.",
    ...
    'update_resource_attribute_notvalid_regexp_value7' => array(
        '<?xml version="1.0"?><config><menu><update id="Module_Name::system_config" '
            . 'resource="Test_Value::"/></menu></config>',
        array("Element 'update', attribute 'resource': [facet 'pattern'] The value 'Test_Value::' is not "
            . "accepted by the pattern '[A-Z]+[a-z0-9]{1,}_[A-Z]+[A-Z0-9a-z]{1,}::[A-Za-z_0-9]{1,}'.",
    ...
    'update_sortOrder_attribute_empty_value' => array(
        '<?xml version="1.0"?><config><menu><update sortOrder="" '
            . 'id="Test_Value::some_value"/></menu></config>',
    ...
    'update_title_attribute_empty_value' => array(
        ...
        array("Element 'update', attribute 'title': [facet 'minLength'] The value '' has a length of '0'; this "
            . "underruns the allowed minimum length of '3'.",
    ...
    'update_title_attribute_less_minLenght_value' => array(
        ...
        array("Element 'update', attribute 'title': [facet 'minLength'] The value 'am' has a length of '2'; this "
            . "underruns the allowed minimum length of '3'.",
    ...
    'update_title_attribute_more_maxLenght_value' => array(
        ...
        array("Element 'update', attribute 'title': [facet 'maxLength'] The value 'Lorem ipsum dolor sit amet, "
            . "consectetur adipisicing' has a length of '51'; this exceeds the allowed maximum length of '50'.",
    ...
    'update_toolTip_attribute_empty_value ' => array(
        ...
        array("Element 'update', attribute 'toolTip': [facet 'minLength'] The value '' has a length of '0'; this "
            . "underruns the allowed minimum length of '3'.",
    ...
    'update_toolTip_attribute_less_minLenght_value' => array(
        ...
        array("Element 'update', attribute 'toolTip': [facet 'minLength'] The value 'we' has a length of '2'; this "
            . "underruns the allowed minimum length of '3'.",
    ...
    'update_toolTip_attribute_more_maxLenght_value' => array(
        ...
        array("Element 'update', attribute 'toolTip': [facet 'maxLength'] The value 'Lorem ipsum dolor sit "
