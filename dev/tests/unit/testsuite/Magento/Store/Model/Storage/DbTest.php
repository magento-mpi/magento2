...
class DbTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->_websiteFactoryMock = $this->getClassMock('Magento\Store\Model\Website\Factory');
        $this->_groupFactoryMock = $this->getClassMock('Magento\Store\Model\Group\Factory', array('create'));
        $this->_appStateMock = $this->getClassMock('Magento\App\State');
        $this->_helperDataMock = $this->getClassMock('Magento\Core\Helper\Data');
    ...
    public function testIsSingleStoreMode()
    {
        $this->_helperDataMock
            ->expects($this->any())
            ->method('isSingleStoreModeEnabled')
    ...
    public function testGetSetCurrentStore()
    {
        $storeCode = 'store_code';
        $this->assertNull($this->_model->getCurrentStore());
        $this->_model->setCurrentStore($storeCode);
        $this->assertEquals($storeCode, $this->_model->getCurrentStore());
    }
    ...
    public function testGetAnyStoreViewDefaultStoreView()
    {
        ...
        $this->_groupMock
            ...
            ->method('getDefaultStore')
            ->will($this->returnValue($this->_storeMock));
        $this->assertSame($this->_storeMock, $this->_model->getAnyStoreView());
    }
