...
class Magento_Code_Minify_Strategy_LiteTest extends PHPUnit_Framework_TestCase
{
    public function testGetMinifiedFile()
    {
        ...
        $strategy = new Magento_Code_Minify_Strategy_Lite($adapter, $filesystem, $baseDir);
