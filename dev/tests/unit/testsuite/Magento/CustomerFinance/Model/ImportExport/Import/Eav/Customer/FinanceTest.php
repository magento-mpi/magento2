...
/**
 * Test class for \Magento\CustomerFinance\Model\ImportExport\Import\Eav\Customer\Finance
 */
class FinanceTest extends \PHPUnit_Framework_TestCase
{
     ...
     *
     * @var \Magento\CustomerFinance\Model\ImportExport\Import\Eav\Customer\Finance
     */
    protected $_model;
    ...
    protected function setUp()
    {
        ...
        $this->_model = new \Magento\CustomerFinance\Model\ImportExport\Import\Eav\Customer\Finance(
            $coreData,
        ...
        return array(
            ...
            'no website' => array(
                ...
                '$behaviors' => array(
                    \Magento\ImportExport\Model\Import::BEHAVIOR_ADD_UPDATE => array(
                        'errors' => array(
                            Finance::ERROR_WEBSITE_IS_EMPTY => array(
                                array(
                                    1,
            ...
            'no email' => array(
                ...
                '$behaviors' => array(
                    \Magento\ImportExport\Model\Import::BEHAVIOR_ADD_UPDATE => array(
                        'errors' => array(
                            Finance::ERROR_EMAIL_IS_EMPTY => array(
                                array(
                                    1,
            ...
            'empty finance website' => array(
                ...
                '$behaviors' => array(
                    \Magento\ImportExport\Model\Import::BEHAVIOR_ADD_UPDATE => array(
                        'errors' => array(
                            Finance::ERROR_FINANCE_WEBSITE_IS_EMPTY => array(
                                array(
                                    1,
            ...
            'invalid email' => array(
                ...
                '$behaviors' => array(
                    \Magento\ImportExport\Model\Import::BEHAVIOR_ADD_UPDATE => array(
                        'errors' => array(
                            Finance::ERROR_INVALID_EMAIL => array(
                                array(
                                    1,
                                    Finance::COLUMN_EMAIL
                                )
            ...
            'invalid website' => array(
                ...
                '$behaviors' => array(
                    \Magento\ImportExport\Model\Import::BEHAVIOR_ADD_UPDATE => array(
                        'errors' => array(
                            Finance::ERROR_INVALID_WEBSITE => array(
                                array(
                                    1,
                                    Finance::COLUMN_WEBSITE
                                )
            ...
            'invalid finance website' => array(
                ...
                '$behaviors' => array(
                    \Magento\ImportExport\Model\Import::BEHAVIOR_ADD_UPDATE => array(
                        'errors' => array(
                            Finance::ERROR_INVALID_FINANCE_WEBSITE => array(
                                array(
                                    1,
                                    Finance::COLUMN_FINANCE_WEBSITE
                                )
            ...
            'no customer' => array(
                ...
                '$behaviors' => array(
                    \Magento\ImportExport\Model\Import::BEHAVIOR_ADD_UPDATE => array(
                        'errors' => array(
                            Finance::ERROR_CUSTOMER_NOT_FOUND => array(
                                array(1, null)
                            )
                        )
                    ),
            ...
            'empty_required_attribute_value' => array(
                ...
                '$behaviors' => array(
                    \Magento\ImportExport\Model\Import::BEHAVIOR_ADD_UPDATE => array(
                        'errors' => array(
                            Finance::ERROR_VALUE_IS_REQUIRED => array(
                                array(1, 'store_credit')
                            )
                        )
                    ),
     ...
     *
     * @covers \Magento\CustomerFinance\Model\ImportExport\Import\Eav\Customer\Finance::_validateRowForUpdate
    ...
    public function testValidateRowForUpdateDuplicateRows()
    {
        ...
        $errors = array(
            Finance::ERROR_DUPLICATE_PK => array(
                array(2, null)
            )
        );
     ...
     *
     * @covers \Magento\CustomerFinance\Model\ImportExport\Import\Eav\Customer\Finance::_validateRowForDelete
     * @dataProvider validateRowDataProvider
     *
     * @param array $rowData
     * @param array $behaviors
     ...
     *
     * @covers \Magento\CustomerFinance\Model\ImportExport\Import\Eav\Customer\Finance::getEntityTypeCode
     */
     ...
     * Test data import
     *
     * @covers \Magento\CustomerFinance\Model\ImportExport\Import\Eav\Customer\Finance::importData
     */
