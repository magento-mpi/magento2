...
class RepositoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Magento\View\Asset\Source|\PHPUnit_Framework_MockObject_MockObject
     */
    private $source;
    ...
    public function testCreateAsset()
    {
        ...
        $this->assertInstanceOf('\Magento\View\Asset\File\FallbackContext', $asset->getContext());
    ...
    public function testGetStaticViewFileContext()
    {
        ...
        $this->assertInstanceOf('\Magento\View\Asset\ContextInterface', $context);
    ...
    public function testProductionModeWorkaround()
    {
        ...
        $mode = \Magento\App\State::MODE_PRODUCTION;
    ...
    {
        $similarTo = $this->getMockForAbstractClass('\Magento\View\Asset\LocalInterface');
        $context = $this->getMockForAbstractClass('\Magento\View\Asset\ContextInterface');
    ...
    {
        $relativeTo = $this->getMockForAbstractClass('\Magento\View\Asset\LocalInterface');
        $context = $this->getMockForAbstractClass('\Magento\View\Asset\ContextInterface');
    ...
    public function testCreateRemoteAsset()
    {
        ...
        $this->assertInstanceOf('\Magento\View\Asset\Remote', $asset);
