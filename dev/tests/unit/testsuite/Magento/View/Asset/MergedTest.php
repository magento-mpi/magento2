...
class MergedTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        new \Magento\View\Asset\Merged($this->_logger, $this->_mergeStrategy, $this->_assetRepo, array());
    }
    ...
    public function testIteratorInterfaceMerge()
    {
        ...
        $mergedAsset = $this->getMock('Magento\View\Asset\File', array(), array(), '', false);
        $this->_mergeStrategy
            ->expects($this->once())
            ->method('merge')
