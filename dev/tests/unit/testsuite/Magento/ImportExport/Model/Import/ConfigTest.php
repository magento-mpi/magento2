 ...
 */
class Magento_ImportExport_Model_Import_ConfigTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $this->_readerMock
            = $this->getMock('Magento_ImportExport_Model_Import_Config_Reader', array(), array(), '', false);
    ...
    public function testGetEntities($value, $expected)
    {
        ...
        $this->_model = new Magento_ImportExport_Model_Import_Config(
            $this->_readerMock,
