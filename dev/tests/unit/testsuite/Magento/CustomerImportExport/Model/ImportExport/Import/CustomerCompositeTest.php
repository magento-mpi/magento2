...
class CustomerCompositeTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Magento\CustomerImportExport\Model\Resource\ImportExport\Import\CustomerComposite\DataFactory
     */
    ...
    protected function setUp()
    {
        ...
        $this->_dataFactory = $this->getMock(
            'Magento\CustomerImportExport\Model\Resource\ImportExport\Import\CustomerComposite\DataFactory',
            array(),
            array(),
            '',
            false
        ...
        $this->_customerFactory = $this->getMock(
            'Magento\CustomerImportExport\Model\ImportExport\Import\CustomerFactory',
            array(),
            array(),
            '',
            false
        ...
        $this->_addressFactory = $this->getMock(
            'Magento\CustomerImportExport\Model\ImportExport\Import\AddressFactory',
            array(),
            array(),
            '',
            false
    ...
    protected function _getCustomerEntityMock(array $mockedMethods = null)
    {
        ...
        $customerEntity = $this->getMock(
            'Magento\CustomerImportExport\Model\ImportExport\Import\Customer',
            $mockedMethods,
            array(),
            '',
            false
    ...
    protected function _getAddressEntityMock(array $mockedMethods = null)
    {
        ...
        $addressEntity = $this->getMock(
            'Magento\CustomerImportExport\Model\ImportExport\Import\Address',
            $mockedMethods,
            array(),
            '',
            false
