...
/**
 * Test class for \Magento\CustomerImportExport\Model\ImportExport\Import\AbstractCustomer
 */
namespace Magento\CustomerImportExport\Model\ImportExport\Import;
...
class AbstractCustomerTest extends \PHPUnit_Framework_TestCase
{
     ...
     *
     * @var \Magento\CustomerImportExport\Model\ImportExport\Import\AbstractCustomer|PHPUnit_Framework_MockObject_MockObject
     */
    protected $_model;
     ...
     *
     * @return \Magento\CustomerImportExport\Model\ImportExport\Import\AbstractCustomer|PHPUnit_Framework_MockObject_MockObject
     */
    protected function _getModelMock()
    {
        ...
        $modelMock = $this->getMockBuilder('Magento\CustomerImportExport\Model\ImportExport\Import\AbstractCustomer')
    ...
    public function testCheckUniqueKey(array $rowData, array $errors, $isValid = false)
    {
        $checkUniqueKey = new \ReflectionMethod(
            'Magento\CustomerImportExport\Model\ImportExport\Import\AbstractCustomer',
            '_checkUniqueKey'
        );
