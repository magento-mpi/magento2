 ...
 */
namespace Magento\CustomerImportExport\Model\ImportExport\Export;
...
class AddressTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->_model = new \Magento\CustomerImportExport\Model\ImportExport\Export\Address(
            ...
            $this->getMock(
                'Magento\CustomerImportExport\Model\ImportExport\Export\CustomerFactory',
                array(),
                array(),
                '',
                false
     ...
     *
     * @covers \Magento\CustomerImportExport\Model\ImportExport\Export\Address::exportItem
     */
    ...
    {
        $billingColumn = \Magento\CustomerImportExport\Model\ImportExport\Export\Address::COLUMN_NAME_DEFAULT_BILLING;
        $this->assertEquals($this->_customerData['default_billing'], $row[$billingColumn]);

        $shippingColumn = \Magento\CustomerImportExport\Model\ImportExport\Export\Address::COLUMN_NAME_DEFAULT_SHIPPING;
        $this->assertEquals($this->_customerData['default_shipping'], $row[$shippingColumn]);

        $idColumn = \Magento\CustomerImportExport\Model\ImportExport\Export\Address::COLUMN_ADDRESS_ID;
        $this->assertEquals($this->_addressData['id'], $row[$idColumn]);

        $emailColumn = \Magento\CustomerImportExport\Model\ImportExport\Export\Address::COLUMN_EMAIL;
        $this->assertEquals($this->_customerData['email'], $row[$emailColumn]);

        $websiteColumn = \Magento\CustomerImportExport\Model\ImportExport\Export\Address::COLUMN_WEBSITE;
