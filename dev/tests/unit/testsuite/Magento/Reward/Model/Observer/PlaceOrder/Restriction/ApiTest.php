...
{
    /**
     * @var \Magento\Reward\Model\Observer\PlaceOrder\Restriction\Api
     */
    protected $_model;
    ...
    protected function setUp()
    {
        ...
        $this->frontendMock = $this->getMock(
            '\Magento\Reward\Model\Observer\PlaceOrder\Restriction\Frontend', [], [], '', false
        );
        $this->backendMock = $this->getMock(
            '\Magento\Reward\Model\Observer\PlaceOrder\Restriction\Backend', [], [], '', false
        );

        $this->_model = new \Magento\Reward\Model\Observer\PlaceOrder\Restriction\Api(
            $this->frontendMock,
            $this->backendMock,
