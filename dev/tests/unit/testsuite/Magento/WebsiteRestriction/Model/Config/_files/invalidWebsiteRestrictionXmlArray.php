...
(
    ...
    'action_path_invalid_value' => array(
        ...
        array("Element 'action', attribute 'path': [facet 'pattern'] The value '1234' is not accepted by the "
            . "pattern '[a-zA-Z_]+'.",
    ...
    'action_path_empty_value' => array(
        ...
        array("Element 'action', attribute 'path': [facet 'pattern'] The value '' is not accepted by the "
            . "pattern '[a-zA-Z_]+'.",
    ...
    'action_type_invalid_value' => array(
        ...
        array("Element 'action', attribute 'type': [facet 'enumeration'] The value 'invalidvalue' is not an "
