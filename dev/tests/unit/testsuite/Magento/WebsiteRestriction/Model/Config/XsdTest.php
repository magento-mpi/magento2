 ...
 */
class Magento_WebsiteRestriction_Model_Config_XsdTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $this->_xsdSchema = BP . '/app/code/Magento/WebsiteRestriction/etc/webrestrictions.xsd';
