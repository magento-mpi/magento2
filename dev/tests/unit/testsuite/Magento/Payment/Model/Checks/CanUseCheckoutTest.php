...
class CanUseCheckoutTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function paymentMethodDataProvider()
    {
        ...
        $paymentMethodCanUseCheckout->expects($this->once())->method('canUseCheckout')->will($this->returnValue(true));
        $paymentMethodCantUseCheckout = $this->_getPaymentMethod();
        $paymentMethodCantUseCheckout->expects($this->once())->method('canUseCheckout')->will(
