...
class FileFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCreateIfFileNotExist()
    {
        ...
        $this->_fileSystem->expects($this->once())->method('getFileSize')->will($this->returnValue('string'));
        $this->_fileSystem->expects($this->once())->method('isFile')->with($file)->will($this->returnValue(false));
