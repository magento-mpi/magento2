...
<xsl:template match="PDepend">
    ...
    <h1><a name="top">PDepend Analysis</a></h1>
    <hr size="2" />
    ...
    <p>The following explanations are for quick reference and are lifted directly from the original <a href="http://www.clarkware.com/software/JDepend.html">PDepend documentation</a>.</p>
