        ...
        fireFormEvent:function() {
            ...
            return this.each(function(){
                ...
                validator.form = function() {
                    ...
                    mage.Event.trigger('BeforeformValidation', oldForm);
                    console.log(oldForm.status);
                    if (!oldForm.status){
                        oldForm.status = oldForm.apply(this, arguments);

                    }
                    mage.Event.trigger((oldForm.status == true) ? 'mageEventformValidationSuccess' : 'mageEventformValidationError', oldForm);
                    mage.Event.trigger('afterformValidation', oldForm);
...
// constructor for validator
    ...
    $.extend($.validator, {
        ...
        dataAttributeRules: function(element) {
            var rules = {};
            var classes = $(element).attr('data-form-validation');
            classes && $.each(classes.split(' '), function() {
                if (this in $.validator.classRuleSettings) {
                    $.extend(rules, $.validator.classRuleSettings[this]);
                }
